...
model GasSourceP "Pressure source for gas flows"
  ...
  parameter Medium.AbsolutePressure p_start=101325 "Pressure";
  ...
  SiemensPowerOMCtest.Interfaces.portGasOut portGas(
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
        ...
        Text(
          ...
          textString="P"),
        Text(extent={{-100,-84},{100,-112}}, textString="%name")}),
...
<p>The actual gas used in the component is determined by the replaceable <code>Medium</code> package.In the case of multiple componet, variable composition gases, the nominal gas composition is given by <code>Xi_start</code>, whose default value is <code>Medium.reference_X</code> . </p>
...
"), Commands(file="Scripts/ConvertSiemensPower_from_1.8_to_2.0.mos"));
end GasSourceP;
