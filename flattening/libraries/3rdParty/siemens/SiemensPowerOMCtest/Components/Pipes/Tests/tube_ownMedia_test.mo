within SiemensPowerOMCtest.Components.Pipes.Tests;
model tube_ownMedia_test "Test of tube"
  ...
  SiemensPowerOMCtest.Boundaries.PrescribedHeatFlow prescribedHeatFlow(numberOfCells=
                                                     20)
    annotation (Placement(transformation(extent={{-32,74},{-12,94}}, rotation=0)));
  SiemensPowerOMCtest.Components.Pipes.TubeOwnMedia EVA(
    numberOfNodes=20,
    alphaOffset=5000,
    geoPipe(L=40, Nt=100),
    considerMassAccelaration=false,
    considerDynamicPressure=true,
    m_flow_start=50,
    hIn_start=1000e3,
    hOut_start=1000e3,
    pIn_start=3100000,
    ...
    useINTH2O=false)
          ...
          rotation=0)));
  SiemensPowerOMCtest.Blocks.TimeTable timeTable(table=[0,0; 1000,100e6; 2000,100e6])
    annotation (Placement(transformation(extent={{-80,74},{-60,94}}, rotation=0)));
  SiemensPowerOMCtest.Components.Pipes.TubeOwnMedia ECO(
    numberOfNodes=10,
    geoPipe(L=10, Nt=100),
    considerMassAccelaration=false,
    considerDynamicPressure=true,
    delayInnerHeatTransfer=true,
    m_flow_start=50,
    hIn_start=500e3,
    hOut_start=1000e3,
    pIn_start=3100000,
    ...
    useINTH2O=false)
          ...
          rotation=0)));
  SiemensPowerOMCtest.Blocks.TimeTable timeTable1(table=[0,30e5; 1100,30e5; 1400,31e5; 2000,31e5])
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=25e6)
    annotation (Placement(transformation(extent={{-102,-12},{-82,8}}, rotation=
            0)));
  SiemensPowerOMCtest.Boundaries.PrescribedHeatFlow prescribedHeatFlow1(numberOfCells=
                                                      10)
    annotation (Placement(transformation(extent={{-60,-20},{-40,0}}, rotation=0)));
  SiemensPowerOMCtest.Components.Pipes.TubeOwnMedia SH(
    numberOfNodes=10,
    geoPipe(L=10, Nt=100),
    considerMassAccelaration=false,
    considerDynamicPressure=true,
    initializeInletPressure=false,
    m_flow_start=50,
    hOut_start=2000e3,
    delayInnerHeatTransfer=true,
    pIn_start=3200000,
    ...
    hIn_start=2000e3)
          ...
          rotation=0)));
  SiemensPowerOMCtest.Boundaries.WaterSink watersink_ph1(
                                                h_start=
                                                   2000e3, p_start=
                                                              3000000)
  ...
  SiemensPowerOMCtest.Boundaries.PrescribedHeatFlow prescribedHeatFlow2(numberOfCells=
                                                      10)
  ...
  SiemensPowerOMCtest.Blocks.TimeTable timeTable2(table=[0,32e5; 200,32e5; 800,35e5; 2000,35e5])
