...
equation
  ...
  Re = SiemensPowerOMCtest.Utilities.Functions.CharacteristicNumbers.ReynoldsNumber(
    m_flow,  lengthRe,  Psi * ACrossFlow,  eta);

 // heat transfer
  for i in 1:numberOfNodes loop
      Nu[i] = SiemensPowerOMCtest.Utilities.Functions.CharacteristicNumbers.NusseltNumber(
