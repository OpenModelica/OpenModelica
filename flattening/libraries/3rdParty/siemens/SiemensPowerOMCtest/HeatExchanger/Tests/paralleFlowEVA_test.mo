within SiemensPowerOMCtest.HeatExchanger.Tests;
model paralleFlowEVA_test "Test case for Benson parallelFlowEvaporator"
  extends Modelica.Icons.Example;
  SiemensPowerOMCtest.HeatExchanger.ParallelFlowEvaporator EVA1(
  ...
  SiemensPowerOMCtest.HeatExchanger.ParallelFlowEvaporator EVA2(
    geoPipe(Nt=80),
