...
function cp_pT "cp(p,T)"
  ...
  external "C" cp= TTSE_cp_pT(phase, p,T);

  annotation(Library={"TTSEmoI", "TTSE"}, Documentation(info="<html>
<p>This function returns heat capacity Cp as function of p and T. The water/steam functions are computed according to TTSE. </p>
</html>
<HTML>
       <p>
           <table>
