...
package Modelica  "Modelica Standard Library - Version 3.2.2" 
      ...
      package SinglePhase  "Single phase AC components" 
        ...
        package Basic  "Basic components for AC singlephase models" 
          ...
          equation
            ...
            v = R_actual * i;
            LossPower = .Modelica.ComplexMath.real(v * .Modelica.ComplexMath.conj(i));
          end Resistor;
          ...
          equation
            v = .Modelica.ComplexMath.j * omega * L * i;
          end Inductor;
        end Basic;
        ...
        package Sensors  "AC singlephase sensors" 
          ...
          equation
            ...
            y = v * .Modelica.ComplexMath.conj(i);
          end PowerSensor;
        end Sensors;
  ...
  package Math  "Library of mathematical functions (e.g., sin, cos) and of functions operating on vectors and matrices" 
    ...
    function atan3  "Four quadrant inverse tangent (select solution that is closest to given angle y0)" 
      ...
      output Modelica.SIunits.Angle y;
    protected
      constant Real pi2 = 2 * .Modelica.Constants.pi;
      Real w;
    algorithm
      ...
      if y0 == 0 then
        ...
        y := w + pi2 * integer((.Modelica.Constants.pi + y0 - w) / pi2);
      end if;
    end atan3;
