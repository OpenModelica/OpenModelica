...
//   pendulum.pendulum.I22 = (pendulum.pendulum.mo * (pendulum.pendulum.length ^ 2.0 + 3.0 * pendulum.pendulum.Radius ^ 2.0) - pendulum.pendulum.mi * (pendulum.pendulum.length ^ 2.0 + 3.0 * pendulum.pendulum.InnerRadius ^ 2.0)) / 12.0;
...
//   motor.inductor.p.i + motor.resistor.n.i = 0.0;
...
//   pendulum.pendulumJoint.axis.tau + pendulum.pendulumDamper.flange_b.tau + pendulum.angleSensor.flange_a.tau = 0.0;
...
//   pendulum.pendulum.frame_a.t[1] + pendulum.pendulumJoint.frame_b.t[1] = 0.0;
//   pendulum.pendulum.frame_a.t[2] + pendulum.pendulumJoint.frame_b.t[2] = 0.0;
//   pendulum.pendulum.frame_a.t[3] + pendulum.pendulumJoint.frame_b.t[3] = 0.0;
//   pendulum.pendulum.frame_a.f[1] + pendulum.pendulumJoint.frame_b.f[1] = 0.0;
//   pendulum.pendulum.frame_a.f[2] + pendulum.pendulumJoint.frame_b.f[2] = 0.0;
//   pendulum.pendulum.frame_a.f[3] + pendulum.pendulumJoint.frame_b.f[3] = 0.0;
//   pendulum.sliderDamper.flange_b.f + pendulum.sliderConstraint.axis.f + (-pendulum.flange_a.f) + pendulum.positionSensor.flange_a.f = 0.0;
...
//   pendulum.pendulum.body.frame_a.t[1] + pendulum.pendulum.frameTranslation.frame_a.t[1] + (-pendulum.pendulum.frame_a.t[1]) = 0.0;
//   pendulum.pendulum.body.frame_a.t[2] + pendulum.pendulum.frameTranslation.frame_a.t[2] + (-pendulum.pendulum.frame_a.t[2]) = 0.0;
//   pendulum.pendulum.body.frame_a.t[3] + pendulum.pendulum.frameTranslation.frame_a.t[3] + (-pendulum.pendulum.frame_a.t[3]) = 0.0;
//   pendulum.pendulum.body.frame_a.f[1] + pendulum.pendulum.frameTranslation.frame_a.f[1] + (-pendulum.pendulum.frame_a.f[1]) = 0.0;
//   pendulum.pendulum.body.frame_a.f[2] + pendulum.pendulum.frameTranslation.frame_a.f[2] + (-pendulum.pendulum.frame_a.f[2]) = 0.0;
//   pendulum.pendulum.body.frame_a.f[3] + pendulum.pendulum.frameTranslation.frame_a.f[3] + (-pendulum.pendulum.frame_a.f[3]) = 0.0;
...
//   pendulum.cart.body.frame_a.t[1] + pendulum.cart.frameTranslation.frame_a.t[1] + (-pendulum.cart.frame_a.t[1]) = 0.0;
//   pendulum.cart.body.frame_a.t[2] + pendulum.cart.frameTranslation.frame_a.t[2] + (-pendulum.cart.frame_a.t[2]) = 0.0;
//   pendulum.cart.body.frame_a.t[3] + pendulum.cart.frameTranslation.frame_a.t[3] + (-pendulum.cart.frame_a.t[3]) = 0.0;
//   pendulum.cart.body.frame_a.f[1] + pendulum.cart.frameTranslation.frame_a.f[1] + (-pendulum.cart.frame_a.f[1]) = 0.0;
//   pendulum.cart.body.frame_a.f[2] + pendulum.cart.frameTranslation.frame_a.f[2] + (-pendulum.cart.frame_a.f[2]) = 0.0;
//   pendulum.cart.body.frame_a.f[3] + pendulum.cart.frameTranslation.frame_a.f[3] + (-pendulum.cart.frame_a.f[3]) = 0.0;
//   pendulum.toMidCart.frame_a.t[1] + pendulum.cart.frame_b.t[1] = 0.0;
//   pendulum.toMidCart.frame_a.t[2] + pendulum.cart.frame_b.t[2] = 0.0;
//   pendulum.toMidCart.frame_a.t[3] + pendulum.cart.frame_b.t[3] = 0.0;
//   pendulum.toMidCart.frame_a.f[1] + pendulum.cart.frame_b.f[1] = 0.0;
//   pendulum.toMidCart.frame_a.f[2] + pendulum.cart.frame_b.f[2] = 0.0;
//   pendulum.toMidCart.frame_a.f[3] + pendulum.cart.frame_b.f[3] = 0.0;
