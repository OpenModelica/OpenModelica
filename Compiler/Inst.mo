  ...
  matchcontinue (inCache,inEnv,inIH,store,inMod2,inPrefix3,inSets4,inState5,className,inClassDef6,inRestriction7,inBoolean8,inInstDims9,inBoolean10,inGraph,instSingleCref,stopInst)
    ...
    case (cache,env,ih,store,mods,pre,csets,ci_state,className,
      ...
      equation
        ...
        instList(cache, env5, ih, mods, pre, csets1, ci_state2, instEquation, eqs_1, impl, alwaysUnroll, graph) ;

        //Instantiate inital equations (see function "instInitialEquation")
        (cache,env5,ih,dae3,csets3,ci_state4,graph) =
          instList(cache, env5, ih, mods, pre, csets2, ci_state3, instInitialEquation, initeqs_1, impl, alwaysUnroll, graph);
        ...
        instList(cache,env5,ih, mods, pre, csets3, ci_state4, instAlgorithm, alg_1, impl, unrollForLoops, graph);

        //Instantiate algorithms  (see function "instInitialAlgorithm")
        (cache,env5,ih,dae5,csets5,ci_state6,graph) =
          instList(cache,env5,ih, mods, pre, csets4, ci_state5, instInitialAlgorithm, initalg_1, impl, unrollForLoops, graph);
    ...
    case (cache,env,ih,store,mods,pre,csets,ci_state,className,
      ...
      equation
        ...
        (cache,dims,fdae1) = elabArraydimOpt(cache,cenv_2, Absyn.CREF_IDENT("",{}),cn, ad, eq, impl, NONE,true,pre) "owncref not valid here" ;
  ...
  matchcontinue (inCache,inEnv,inIH,store,inSCodeElementLst2,inSCodeElementLst3,inMod4,inInstDims5,stopInst)
    ...
    case (cache,env,ih,store,{SCode.EXTENDS(baseClassPath = path,modifications = mod)},{},mods,inst_dims,stopInst)
      equation
        ...
        (cache,m_1,fdae) = Mod.elabModForBasicType(cache, env, ih, Prefix.NOPRE(), mod, true);
  ...
  matchcontinue (inCache,inEnv,inIH,inMod,inPrefix,inSets,inState,inClassDef,inRestriction,inPartialPrefix,inProt,inInstDims,inClassName)
    ...
    */
      ...
      equation
        ...
        InstExtends.instExtendsAndClassExtendsList(cache,env1,ih, mods, extendselts, classextendselts, ci_state, className, true, true)
        "2. EXTENDS Nodes inst_Extends_List only flatten inhteritance structure. It does not perform component instantiations." ;
  ...
  matchcontinue (inCache,inEnv,inIH,inPrefix,inTplSCodeElementModLst,inState,inSets,inBoolean)
    ...
    case (cache,env,ih,pre,((comp,(cmod as DAE.REDECL(_,{(redComp,redMod)}))) :: xs),ci_state,csets,impl)
      equation
        ...
        (cache,cmod_1,dae2) = Mod.updateMod(cache, env2, ih, pre, cmod, impl);
    ...
    case (cache,env,ih,store,mods,pre,csets,ci_state,
      ...
      equation
        ...
        */
        ...
        //(cache,mods_1,fdae1) = Mod.updateMod(cache, env2, ih, pre, mods, impl) ;
        ...
        (cache,classmod_1,fdae0) = Mod.updateMod(cache, env2, ih, pre, classmod, impl);
        (cache,mm_1,fdae1) = Mod.updateMod(cache, env2, ih, pre, mm, impl);
...
*/
    ...
    case (cache,env,ih,store,mods,pre,csets,ci_state,
      ...
      equation
        ...
        // mm_1 = Mod.lookupCompModification(mods_1, n);
        // (cache,m) = removeSelfModReference(cache,n,m); // Remove self-reference i.e. A a(x=a.y);
        (cache,m_1,fdae) = Mod.elabMod(cache, env, ih, pre, m, impl); // In case we want to EQBOUND a complex type, e.g. when declaring constants. /sjoelund 2009-10-30
  ...
  (outCache,outEnv,outIH,outElement,outMod,outSets,outDae) := matchcontinue (inCache,inEnv,inIH,inMod,inElement,inPrefix,inState,inSets,inBoolean,cmod)
    ...
    case (cache,env,ih,(m as DAE.REDECL(tplSCodeElementModLst = (((redecl as
      ...
      equation
        ...
        (cache,env_1,ih,csets,dae1) = updateComponentsInEnv(cache, env, ih, pre, DAE.NOMOD(), crefs, ci_state, csets, impl);
        (cache,m_1,dae2) = Mod.elabMod(cache,env_1, ih, pre, mod, impl);
        (cache,old_m_1,dae3) = Mod.elabMod(cache,env_1, ih, pre, old_mod, impl);
...
// no constraining type on comp, throw away modifiers prior to redeclaration
    case (cache,env,ih,(m as DAE.REDECL(tplSCodeElementModLst = (((redecl as
          SCode.COMPONENT(component = n1,typeSpec = t,modifications = mod,comment = comment)),rmod) :: rest))),
          SCode.COMPONENT(component = n2,finalPrefix = false,replaceablePrefix = repl2,protectedPrefix = prot2,
...
algorithm str := matchcontinue(cc,env)
  ...
  case(SOME(Absyn.CONSTRAINCLASS(elementSpec = Absyn.EXTENDS(path,args,annOpt))),env)
    equation
      ...
      (_,_,_,_,extcomps,_,_,_,_) = InstExtends.instExtendsAndClassExtendsList(Env.emptyCache(), env, InnerOuter.emptyInstHierarchy, DAE.NOMOD(), extendselts, classextendselts, ClassInf.UNKNOWN(Absyn.IDENT("")), name, true, false);
  ...
  matchcontinue (inCache,inEnv,inIH,store,inState,inMod,inPrefix,inSets,inIdent,inClass,inAttributes,protection,inDimensionLst,inIntegerLst,inInstDims,inBoolean,inSCodeCommentOption,io,finalPrefix,info,inGraph)
    ...
    case (cache,env,ih,store,ci_state,mod,pre,csets,n,(cl as SCode.CLASS(name = id)),attr,prot,dims,idxs,inst_dims,impl,comment,io,finalPrefix,info,graph)
      ...
      equation
        ...
        (cache,(dims_1 as (_ :: _)),cl,fdae,type_mods) = getUsertypeDimensions(cache, env, ih, mod, pre, cl, inst_dims, impl);
...
algorithm
  (outCache,outDimensionLst,classToInstantiate,outDae,outMods) := matchcontinue (inCache,inEnv,inIH,inMod,inPrefix,inClass,inInstDims,inBoolean)
    ...
    case (cache,_,_,_,_,cl as SCode.CLASS(name = "Real"),_,_) then (cache,{},cl,DAEUtil.emptyDae,DAE.NOMOD);  /* impl */
    case (cache,_,_,_,_,cl as SCode.CLASS(name = "Integer"),_,_) then (cache,{},cl,DAEUtil.emptyDae,DAE.NOMOD);
    case (cache,_,_,_,_,cl as SCode.CLASS(name = "String"),_,_) then (cache,{},cl,DAEUtil.emptyDae,DAE.NOMOD);
    case (cache,_,_,_,_,cl as SCode.CLASS(name = "Boolean"),_,_) then (cache,{},cl,DAEUtil.emptyDae,DAE.NOMOD);
    ...
    /*------------------------*/
    /* MetaModelica extension */
    case (cache,env,ih,_,pre,cl as SCode.CLASS(name = id,
      ...
      equation
        ...
        (cache,dim1,fdae) = elabArraydim(cache,env, owncref, Absyn.IDENT("Integer"), ad_1, NONE, impl, NONE,true, false,pre);
    ...
    case (cache,env,ih,_,_,SCode.CLASS(name = id,restriction = SCode.R_FUNCTION(),partialPrefix = false),_,_)
      equation
        Error.addMessage(Error.META_FUNCTION_TYPE_NO_PARTIAL_PREFIX, {id});
      then fail();

      // MetaModelica Uniontype. Added 2009-05-11 sjoelund
    case (cache,env,ih,_,_,cl as SCode.CLASS(name = id,restriction = SCode.R_UNIONTYPE()),_,_) then (cache,{},cl,DAEUtil.emptyDae,DAE.NOMOD);
      /*----------------------*/
          
    /* Derived classes with restriction type, e.g. type Point = Real[3]; */
    case (cache,env,ih,mods,pre,inClass as SCode.CLASS(name = id,restriction = SCode.R_TYPE(),
      ...
      equation
        ...
        (cache,dim1,cl,fdae2,type_mods) = getUsertypeDimensions(cache,cenv,ih, mods_3, pre, cl, dims, impl);
        type_mods = Mod.merge(mod_1, type_mods, env, pre);
        (cache,dim2,fdae3) = elabArraydim(cache,env, owncref, cn, ad_1, eq, impl, NONE,true, false,pre);
    ...
    case (cache,env,ih,mods,pre,SCode.CLASS(name = id,restriction = _,
      ...
      equation
        ...
        (cache,mod_1,fdae) = Mod.elabModForBasicType(cache, env, ih, pre, mod, impl);
        mods_2 = Mod.merge(mods, mod_1, env, pre);
        (cache,cl,cenv) = Lookup.lookupClass(cache,env, path, true);
        (cache,res,cl,fdae2,type_mods) = getUsertypeDimensions(cache,env,ih,mods_2,pre,cl,{},impl);
  ...
  matchcontinue (cache,env,inIH,pre,mod,cref,ci_state,csets,impl,updatedComps)
    ...
    case (cache,env,ih,pre,mods,cref,ci_state,csets,impl,updatedComps)
      equation
        ...
        (cache,env_1,ih,csets_1,updatedComps,dae) = updateComponentInEnv2(cache,env2,cenv,ih,pre,t,n,ad,cl,attr,DAE.ATTR(flowPrefix,streamPrefix,acc,param,dir,io),prot,finalPrefix,io,info,m,cmod,mods,cref,ci_state,csets,impl,updatedComps);
...
" Helper function, checks if the component was already instantiated.
  ...
  output DAE.DAElist outDae "contains functions";
algorithm
  (outCache,outEnv,outIH,outSets,outUpdatedComps,outDae) := matchcontinue (cache,env,cenv,inIH,pre,path,name,ad,cl,attr,dattr,prot,finalPrefix,io,info,m,cmod,mod,cref,ci_state,csets,impl,updatedComps)
    local
      tuple<DAE.TType, Option<Absyn.Path>> ty;
      String n,id,str,str2,str3;
      Boolean finalPrefix,repl,prot,flowPrefix,streamPrefix;
    ...
    case (cache,env,cenv,ih,pre,path,name,ad,cl,attr,dattr,prot,finalPrefix,io,info,m,cmod,mod,cref,ci_state,csets,impl,updatedComps)
      equation        
        ...
        (cache,m_1,dae1) = Mod.elabMod(cache, env, ih, Prefix.NOPRE(), m, impl)
        ...
        (cache,mod_3,dae2) = Mod.updateMod(cache, env, ih, Prefix.NOPRE(),mod_2,impl);        
        ...
        dae = DAEUtil.joinDaeLst({DAE.DAE({},funcs),dae1,dae2,dae3}); // Collect the functions, but not dae variable        
      then (cache,env,ih,csets_1,updatedComps,dae);
    case (cache,env,cenv,ih,pre,path,name,ad,cl,attr,dattr,prot,finalPrefix,io,info,m,cmod,mod,cref,ci_state,csets,impl,updatedComps)
      equation
  ...
  (outCache,outDimensionLst,outDae) := matchcontinue (inCache,inEnv,inComponentRef)
    ...
    case (cache,env,cref as DAE.CREF_IDENT(ident = id))
      equation
        ...
        (cache,m_2,fdae) = Mod.elabMod(cache, env, InnerOuter.emptyInstHierarchy, Prefix.NOPRE(), m_1, false);
...
algorithm
  ...
  matchcontinue (inCache,inEnv,inComponentRef,path,inAbsynArrayDimOption,inTypesEqModOption,inBoolean,inInteractiveInteractiveSymbolTableOption,performVectorization,inPrefix)
    local
      ...
      DAE.DAElist dae;
      Prefix pre;
    case (cache,env,owncref,path,SOME(ad),eq,impl,st,doVect,pre)
      equation
        (cache,res,dae) = elabArraydim(cache,env, owncref, path,ad, eq, impl, st,doVect, false,pre);
      then
        (cache,res,dae);
    case (cache,env,owncref,path,NONE,eq,impl,st,doVect,_) then (cache,{},DAEUtil.emptyDae);
  end matchcontinue;
end elabArraydimOpt;
...
algorithm
  ...
  matchcontinue
    ...
    // variables here.
    case (cache, env, cref, path, ad, _, impl, st, doVect, true,pre)
      equation
        (cache, dim, dae) = elabArraydimDecl(cache, env, cref, ad, true, st, doVect,pre);
      then
        (cache, dim, dae);
        
    case (cache,env,cref,path,ad,NONE,impl,st,doVect, _,pre) /* impl */
      equation
        (cache,dim,dae) = elabArraydimDecl(cache,env, cref, ad, impl, st,doVect,pre);
      then
        (cache,dim,dae);
    case (cache,env,cref,path,ad,SOME(DAE.TYPED(e,_,prop,_)),impl,st,doVect, _ ,pre) /* Untyped expressions must be elaborated. */
      equation
    ...
    case (cache,env,cref,path,ad,SOME(DAE.UNTYPED(e)),impl,st,doVect, _,pre)
      local Absyn.Exp e;
      equation
        (cache,e_1,prop,_,dae1) = Static.elabExp(cache,env, e, impl, st,doVect,pre);
    ...
    case (cache,env,cref,path,ad,SOME(DAE.TYPED(e,_,DAE.PROP(t,_),_)),impl,st,doVect, _,pre)
      ...
      then
        fail();
    // print some failures
    case (_,_,cref,path,ad,eq,_,_,_,_,_)
...
algorithm
  ...
  matchcontinue (inCache,inEnv,inComponentRef,inArrayDim,inBoolean,inInteractiveInteractiveSymbolTableOption,performVectorization,inPrefix)
    ...
    // empty case
    case (cache,_,_,{},_,_,_,_) then (cache,{},DAEUtil.emptyDae);
    // no subs
    case (cache,env,cref,(Absyn.NOSUB() :: ds),impl,st,doVect,pre)
      equation
        (cache,l,dae) = elabArraydimDecl(cache,env, cref, ds, impl, st,doVect,pre);
      then
        (cache,DAE.DIM_UNKNOWN :: l,dae);
    ...
    case (cache,env,cref,(Absyn.SUBSCRIPT(subScript = d) :: ds),impl,st,doVect,pre)
      equation
        ...
        (cache,e,DAE.PROP((DAE.T_INTEGER(_),_),cnst),_,dae1) = Static.elabExp(cache,env, d, impl, st,doVect,pre);
    ...
    case (cache,env,cref,(Absyn.SUBSCRIPT(subScript = d) :: ds),(impl as false),st,doVect,pre)
      equation
        //Debug.fprintln("insttr", "elab_arraydim_decl5");
        (cache,e,DAE.PROP((DAE.T_INTEGER(_),_),DAE.C_VAR()),_,_) = Static.elabExp(cache,env, d, impl, st,doVect,pre);
        str = Dump.printExpStr(d);
        Error.addMessage(Error.DIMENSION_NOT_KNOWN, {str});
      then
        fail();
    // Non-constant dimension creates DIMEXP
    case (cache,env,cref,(Absyn.SUBSCRIPT(subScript = d) :: ds),(impl as true),st,doVect,pre)
      equation
        // Debug.fprintln("insttr", "elab_arraydim_decl6");
        (cache,e,prop as DAE.PROP((DAE.T_INTEGER(_),_),cnst),_,dae1) = Static.elabExp(cache,env, d, impl, st,doVect,pre);
        (cache, e, prop) = Ceval.cevalIfConstant(cache, env, e, prop, impl);
        (cache,l,dae2) = elabArraydimDecl(cache,env, cref, ds, impl, st,doVect,pre);
        dae = DAEUtil.joinDaes(dae1,dae2);
      then
        (cache, DAE.DIM_EXP(e) :: l, dae);

    /* Size(x,1) in e.g. functions => Unknown dimension */
    case (cache,env,cref,(Absyn.SUBSCRIPT(subScript = d) :: ds),impl,st,doVect,pre)
      equation
        (cache, e, prop,_,dae1) = Static.elabExp(cache,env, d, impl, st,doVect,pre);
  ...
  (outCache,outEnv,outIH,outDae):= matchcontinue (inCache,inEnv,inIH,inMod,inPrefix,inSets,inClass,inInstDims)
    ...
    case (cache,env,ih,mod,pre,csets,(c as SCode.CLASS(classDef=cd,partialPrefix = partialPrefix, name = n,restriction = SCode.R_FUNCTION(),info = info)),inst_dims)
      ...
      equation
        ...
        derFuncs = getDeriveAnnotation(cd,fpath,cache,cenv,ih,pre);
    ...
    case (cache,env,ih,mod,pre,csets,(c as SCode.CLASS(partialPrefix=partialPrefix,name = n,restriction = (restr as SCode.R_EXT_FUNCTION()),
      ...
      equation
        ...
        derFuncs = getDeriveAnnotation(parts,fpath,cache,env,ih,pre);
...
algorithm
  element := matchcontinue(cd,baseFunc,inCache,inEnv,inIH,inPrefix)
  local
...
helper function for getDeriveAnnotation"
  ...
  output list<DAE.FunctionDefinition> element;
algorithm
  (element) := matchcontinue(anns,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix)
  local
  ...
  case(SCode.ANNOTATION(SCode.MOD(_,_,smlst,_)) :: anns,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix)
     then getDeriveAnnotation3(smlst,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix);

  case(_::anns,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix)
     then getDeriveAnnotation2(anns,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix);
end matchcontinue;
...
Author: bjozac
  ...
  input Prefix.Prefix inPrefix;
  output list<DAE.FunctionDefinition> element;
algorithm element := matchcontinue(subs,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix)
  local
    Absyn.Exp ae;
    Exp.Exp exp;
    Absyn.ComponentRef acr;
  ...
  case(SCode.NAMEMOD("derivative",(m as SCode.MOD(subModLst = subs2,absynExpOption=SOME(((ae as Absyn.CREF(acr)),_)))))::subs,
       elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix)
    equation
      ...
      conditionRefs = getDeriveCondition(subs2,elemDecl,inCache,inEnv,inIH,inPrefix);
  ...
  case(_ :: subs,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix)
  then getDeriveAnnotation3(subs,elemDecl,baseFunc,inCache,inEnv,inIH,inPrefix);
end matchcontinue;
...
algorithm 
  outconds := matchcontinue(subs,elemDecl,inCache,inEnv,inIH,inPrefix)
  local
    Absyn.Exp ae;
    SCode.Mod m;
    DAE.Mod elabedMod;
    ...
    case(SCode.NAMEMOD("noDerivative",(m as SCode.MOD(absynExpOption = SOME(((Absyn.CREF(acr)),_)))))::subs,elemDecl,inCache,inEnv,inIH,inPrefix)
    equation
      name = Absyn.printComponentRefStr(acr);
        outconds = getDeriveCondition(subs,elemDecl,inCache,inEnv,inIH,inPrefix);
      varPos = setFunctionInputIndex(elemDecl,name,1);
    then
      (varPos,DAE.NO_DERIVATIVE(DAE.ICONST(99)))::outconds;

    case(SCode.NAMEMOD("zeroDerivative",(m as SCode.MOD(absynExpOption =  SOME(((Absyn.CREF(acr)),_)) )))::subs,elemDecl,inCache,inEnv,inIH,inPrefix)
    equation
      name = Absyn.printComponentRefStr(acr);
        outconds = getDeriveCondition(subs,elemDecl,inCache,inEnv,inIH,inPrefix);
      varPos = setFunctionInputIndex(elemDecl,name,1);
    ...
    case(SCode.NAMEMOD("noDerivative",(m as SCode.MOD(absynExpOption=_)))::subs,elemDecl,inCache,inEnv,inIH,inPrefix)
    equation
        (inCache,(elabedMod as DAE.MOD(subModLst={sub})),_) = Mod.elabMod(inCache, inEnv, inIH, inPrefix, m, false);
    ...
    case(_::subs,elemDecl,inCache,inEnv,inIH,inPrefix) 
    then getDeriveCondition(subs,elemDecl,inCache,inEnv,inIH,inPrefix);
end matchcontinue;
  ...
  (outCache,outEnv,outIH,outDae) := matchcontinue (inCache,inEnv,inIH,inClass)
    ...
    case (cache,env,ih,SCode.CLASS(name = id,partialPrefix = p,encapsulatedPrefix = e,restriction = r,
      ...
      equation 
        ...
        (cache,mod2,_) = Mod.elabMod(cache, env, ih, Prefix.NOPRE(), mod1, false); 
...
algorithm 
  (outCache,outIH,outExternalDecl) := matchcontinue (inCache,inEnv,inIH,inIdent,inClassDef,inBoolean,inPrefix)
    local
      String fname,lang,n;
    ...
    case (cache,env,ih,n,SCode.PARTS(elementLst=els,externalDecl = SOME(extdecl)),impl,pre) /* impl */
      equation 
        isExtExplicitCall(extdecl);
        fname = instExtGetFname(extdecl, n);
        (cache,fargs) = instExtGetFargs(cache,env, extdecl, impl,pre);
        (cache,rettype) = instExtGetRettype(cache,env, extdecl, impl,pre);
    ...
    case (cache,env,ih,n,SCode.PARTS(elementLst = els,externalDecl = SOME(orgextdecl)),impl,pre)
      equation 
...
algorithm 
  ...
  matchcontinue (inCache,inEnv,inAbsynExpLst,inBoolean,inInteractiveInteractiveSymbolTableOption,inPrefix)
    local
      Boolean impl;
      ...
      Env.Cache cache;
      Prefix pre;
    case (cache,_,{},impl,st,_) then (cache,{},{},st); 
    case (cache,env,(e :: rest),impl,st,pre)
      equation 
        (cache,exp,p,st_1) = elabExpExt(cache,env, e, impl, st,pre);
        (cache,exps,props,st_2) = elabExpListExt(cache,env, rest, impl, st_1,pre);
      then
...
algorithm 
  ...
  matchcontinue (inCache,inEnv,inExp,inBoolean,inInteractiveInteractiveSymbolTableOption,inPrefix)
    local
    ...
    case (cache,env,(call as Absyn.CALL(function_ = Absyn.CREF_IDENT(name = "size"),
          functionArgs = Absyn.FUNCTIONARGS(args = (args as {arraycr,dim}),argNames = nargs))),impl,st,pre) 
      equation         
        (cache,dimp,prop as DAE.PROP(dimty,_),_,_) = Static.elabExp(cache, env, dim, impl, NONE,false,pre);
        (cache, dimp, prop) = Ceval.cevalIfConstant(cache, env, dimp, prop, impl);
        (cache,arraycrefe,arraycrprop,_,_) = Static.elabExp(cache, env, arraycr, impl, NONE,false,pre);
    ...
    case (cache,env,absynExp,impl,st,pre) 
      equation 
        (cache,e,prop,st,_) = Static.elabExp(cache, env, absynExp, impl, st,false,pre);
        (cache, e, prop) = Ceval.cevalIfConstant(cache, env, e, prop, impl);
      then
        (cache,e,prop,st);
    case (cache,env,absynExp,impl,st,pre)
...
algorithm 
  ...
  matchcontinue (inCache,inEnv,inExternalDecl,inBoolean,inPrefix)
    local
      ...
      Env.Cache cache;
      Prefix pre;
    case (cache,env,Absyn.EXTERNALDECL(funcName = id,lang = lang,output_ = retcr,args = absexps),impl,pre) /* impl */ 
      equation 
        (cache,exps,props,_) = elabExpListExt(cache,env, absexps, impl, NONE,pre);
...
algorithm 
  (outCache,outExtArg) := matchcontinue (inCache,inEnv,inExternalDecl,inBoolean,inPrefix)
    ...
    case (cache,_,Absyn.EXTERNALDECL(output_ = NONE),_,_) then (cache,DAE.NOEXTARG());  /* impl */ 

    case (cache,env,Absyn.EXTERNALDECL(funcName = n,lang = lang,output_ = SOME(cref),args = args),impl,pre)
      equation 
        (cache,exp,prop,acc,_) = Static.elabCref(cache,env, cref, impl,true,pre);
...
algorithm 
  ...
  matchcontinue (inCache,inEnv,inIH,inMod,inPrefix,inSets,inState,inEEquation,inInitial,inBoolean,inGraph)
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_IF(condition = conditions,thenBranch = tb,elseBranch = fb),SCode.NON_INITIAL(),impl,graph)
      equation 
        (cache, expl1,props,_,fdae1) = Static.elabExpList(cache,env, conditions, impl, NONE,true,pre);
        ...
        (cache,env_1,ih,dae,csets_1,ci_state_1,graph) = instList(cache,env,ih, mod, pre, csets, ci_state, instEEquation, b, impl, alwaysUnroll, graph);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_IF(condition = conditions,thenBranch = tb,elseBranch = fb),SCode.INITIAL(),impl,graph) 
      equation 
        ...
        blist = Util.listMap(valList,ValuesUtil.valueBool);
        b = selectList(blist, tb, fb);
        (cache,env_1,ih,dae,csets_1,ci_state_1,graph) = instList(cache,env,ih, mod, pre, csets, ci_state, instEInitialEquation, b, impl, alwaysUnroll, graph);
        dae = DAEUtil.joinDaes(dae,fdae1);
      then
        (cache,env_1,ih,dae,csets_1,ci_state_1,graph);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_WHEN(condition = e,eEquationLst = el,tplAbsynExpEEquationLstLst = ((ee,eel) :: eex),info=info),(initial_ as SCode.NON_INITIAL()),impl,graph) 
      ...
      equation 
        ...
        (cache,env_1,ih,DAE.DAE(daeElts1,_),_,_,graph) = instList(cache,env,ih, mod, pre, csets, ci_state, instEEquation, el, impl, alwaysUnroll, graph);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_WHEN(condition = e,eEquationLst = el,tplAbsynExpEEquationLstLst = {}, info = info),(initial_ as SCode.NON_INITIAL()),impl,graph)
      ...
      equation 
        ...
        (cache,env_1,ih,DAE.DAE(daeElts1,funcs),_,_,graph) = instList(cache,env,ih, mod, pre, csets, ci_state, instEEquation, el, impl, alwaysUnroll, graph);
        lhsCrefs = DAEUtil.verifyWhenEquation(daeElts1);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_ASSERT(condition = e1,message = e2,info = info),initial_,impl,graph)
      equation 
        (cache,e1_1,prop1 as DAE.PROP((DAE.T_BOOL(_),_),_),_,fdae1) = Static.elabExp(cache,env, e1, impl, NONE,true,pre) "assert statement" ;
        (cache, e1_1, prop1) = Ceval.cevalIfConstant(cache, env, e1_1, prop1, impl);
        (cache,e2_1,prop2 as DAE.PROP((DAE.T_STRING(_),_),_),_,fdae2) = Static.elabExp(cache,env, e2, impl, NONE,true,pre);
        (cache, e2_1, prop2) = Ceval.cevalIfConstant(cache, env, e2_1, prop2, impl);
        (cache,e1_2) = PrefixUtil.prefixExp(cache, env, ih, e1_1, pre);                
        (cache,e2_2) = PrefixUtil.prefixExp(cache, env, ih, e2_1, pre); 
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_TERMINATE(message= e1, info=info),initial_,impl,graph)
      equation 
        (cache,e1_1,prop1 as DAE.PROP((DAE.T_STRING(_),_),_),_,fdae1) = Static.elabExp(cache,env, e1, impl, NONE,true,pre);
        (cache, e1_1, prop1) = Ceval.cevalIfConstant(cache, env, e1_1, prop1, impl);
        (cache,e1_2) = PrefixUtil.prefixExp(cache, env, ih, e1_1, pre);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_REINIT(cref = cr,expReinit = e2,info = info),initial_,impl,graph)
      local  DAE.DAElist trDae; list<DAE.Element> daeElts; 
        ...
        DAE.FunctionTree funcs;
      equation 
        (cache,e1_1 as DAE.CREF(cr_1,t),tprop1,_,fdae1) = Static.elabCref(cache,env, cr, impl,false,pre) "reinit statement" ;
        (cache, e1_1, tprop1) = Ceval.cevalIfConstant(cache, env, e1_1, tprop1, impl);
        (cache,e2_1,tprop2,_,fdae2) = Static.elabExp(cache,env, e2, impl, NONE,true,pre);
        (cache, e2_1, tprop2) = Ceval.cevalIfConstant(cache, env, e2_1, tprop2, impl);
        (e2_1,_) = Types.matchProp(e2_1,tprop2,tprop1,true);
        (cache,e1_1,e2_1,tprop1,fdae3) = condenseArrayEquation(cache,env,Absyn.CREF(cr),e2,e1_1,e2_1,tprop1,tprop2,impl,pre);
        (cache,e2_2) = PrefixUtil.prefixExp(cache, env, ih, e2_1, pre);
        (cache,e1_2) = PrefixUtil.prefixExp(cache, env, ih, e1_1, pre);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_NORETCALL(
      ...
      equation 
        (cache,DAE.CREF(cr_,t),_,_,fdae) = Static.elabCref(cache,env, cr, false /* ??? */,false,pre);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_NORETCALL(
      ...
      equation 
        (cache,DAE.CREF(cr1_,t),_,_,fdae1) = Static.elabCref(cache,env, cr1, false /* ??? */,false,pre);
        (cache,DAE.CREF(cr2_,t),_,_,fdae2) = Static.elabCref(cache,env, cr2, false /* ??? */,false,pre);
    ...
    case (cache,env,ih,mod,pre,csets,ci_state,SCode.EQ_NORETCALL(functionName = cr, functionArgs = fargs, info = info),initial_,impl,graph)
      local DAE.ComponentRef cr_2; DAE.ExpType t; Absyn.Path path; list<DAE.Exp> expl; Absyn.FunctionArgs fargs;
        DAE.Exp exp;
      equation 
        (cache,exp,prop1,_,fdae1) = Static.elabExp(cache,env,Absyn.CALL(cr,fargs),impl,NONE,false,pre);
...
This function detect this case and elaborates expressions without vectorization."
  ...
  output DAE.DAElist outDae "contain functions";
algorithm
  (outCache,outE1,outE2,oprop,outDae) := matchcontinue(inCache,env,e1,e2,elabedE1,elabedE2,prop,prop2,impl,inPrefix)
    local Env.Cache cache;
      ...
      DAE.Properties prop1, prop2;
      Prefix pre;
    case(cache,env,e1,e2,elabedE1,elabedE2,prop,prop2,impl,pre) equation
      ...
      (cache,elabedE1_2,prop1,_,fdae1) = Static.elabExp(cache,env, e1, impl, NONE,false,pre);
      (cache, elabedE1_2, prop1) = Ceval.cevalIfConstant(cache, env, elabedE1_2, prop1, impl);
      (cache,elabedE2_2,prop2,_,fdae2) = Static.elabExp(cache,env, e2, impl, NONE,false,pre);
    ...
    case(cache,env,e1,e2,elabedE1,elabedE2,prop,prop2,impl,_)
  ...
  matchcontinue (inCache,inEnv,inIH,inMod,inPrefix,inSets,inState,inAlgorithm,inBoolean,unrollForLoops,inGraph)
    ...
    case (cache,env,ih,_,pre,csets,ci_state,SCode.ALGORITHM(statements = statements),impl,unrollForLoops,graph) /* impl */ 
      equation 
        ...
        (cache,statements_1,fdae) = instStatements(cache, env, ih, pre, statements, source, SCode.NON_INITIAL(), impl, unrollForLoops);        
  ...
  matchcontinue (inCache,inEnv,inIH,inMod,inPrefix,inSets,inState,inAlgorithm,inBoolean,unrollForLoops,inGraph)
    ...
    case (cache,env,ih,_,pre,csets,ci_state,SCode.ALGORITHM(statements = statements),impl,unrollForLoops,graph)
      equation 
        ...
        (cache,statements_1,fdae) = instStatements(cache, env, ih, pre, statements, source, SCode.INITIAL(), impl, unrollForLoops);
...
"function: instStatements 
  ...
  output DAE.DAElist outDae "contain functions";
algorithm 
  (outCache,outAlgorithmStatementLst,outDae) := matchcontinue (inCache,inEnv,inIH,inPre,inAbsynAlgorithmLst,source,initial_,inBoolean,unrollForLoops)
    local
      list<Env.Frame> env;
      Boolean impl;
    ...
    // empty case 
    case (cache,env,ih,pre,{},source,initial_,impl,unrollForLoops) then (cache,{},DAEUtil.emptyDae);

    // general case       
    case (cache,env,ih,pre,(x :: xs),source,initial_,impl,unrollForLoops)
      equation 
        (cache,stmts1,dae1) = instStatement(cache, env, ih, pre, x, source, initial_, impl, unrollForLoops);
        (cache,stmts2,dae2) = instStatements(cache, env, ih, pre, xs, source, initial_, impl, unrollForLoops);
        dae = DAEUtil.joinDaes(dae1,dae2);
...
function: instStatement 
  ...
  output DAE.DAElist outDae "contains functions";
algorithm 
  (outCache,outStatements,outDae) := matchcontinue (inCache,inEnv,inIH,inPre,inAlgorithm,source,initial_,inBoolean,unrollForLoops)
    local
    ...
    case (cache,env,ih,pre,SCode.ALG_ASSIGN(assignComponent = Absyn.CREF(cr),value = Absyn.ARRAY(expList),info = info),source,initial_,impl,unrollForLoops)
      ...
      equation
        ...
        (cache,cre,cprop,acc,_) = Static.elabCref(cache,env, cr, impl,false,pre);
        true = MetaUtil.isList(cprop);
        ...
        (cache,e_1,eprop,_) = Static.elabListExp(cache,env, expList, cprop, impl, NONE,true,pre);
    ...
    case (cache,env,ih,pre,SCode.ALG_ASSIGN(assignComponent = Absyn.CREF(c),
      ...
      equation
        ...
        (cache,vb2,_,_,dae2) = Static.elabExp(cache,env,vb,impl,NONE,true,pre);
    ...
    case (cache,env,ih,pre,SCode.ALG_ASSIGN(assignComponent = Absyn.CREF(c1),
      ...
      equation
        ...
        (cache,declList,dae1) = createForIteratorArray(cache,env,e1,rangeList,impl,pre);
        ...
        (cache,stmts,dae3) = instStatement(cache,env,ih,pre,absynStmt,source,initial_,impl,unrollForLoops);
        dae = DAEUtil.joinDaeLst({dae1,dae2,dae3});
      then
        (cache,stmts,dae);
    ...
    case (cache,env,ih,pre,SCode.ALG_ASSIGN(assignComponent = Absyn.CREF(cr),value = e,info = info),source,initial_,impl,unrollForLoops) 
      equation     
        (cache,cre,cprop,acc,dae1) = Static.elabCref(cache, env, cr, impl, false,pre);
        (cache,DAE.CREF(ce,t)) = PrefixUtil.prefixExp(cache, env, ih, cre, pre);
        (cache,ce_1) = Static.canonCref(cache, env, ce, impl);
        (cache,e_1,eprop,_,dae2) = Static.elabExp(cache, env, e, impl, NONE,true,pre);
        (cache, e_1, eprop) = Ceval.cevalIfConstant(cache, env, e_1, eprop, impl);
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);
        source = DAEUtil.addElementSourceFileInfo(source, info);
    ...
    case (cache,env,ih,pre,SCode.ALG_ASSIGN(assignComponent = 
      ...
      local
        ...
        DAE.Exp e2_2,e2_2_2; 
      equation 
        (cache,_,cprop,acc,dae) = Static.elabCref(cache,env, cr, impl,false,pre);
        (cache,(e2_2 as DAE.CALL(path=_)),_,_,dae1) = Static.elabExp(cache,env, e2, impl, NONE,true,pre);
    ...
    case (cache,env,ih,pre,SCode.ALG_ASSIGN(assignComponent = Absyn.TUPLE(expressions = expl),value = e,info = info),source,initial_,impl,unrollForLoops)
      equation 
        ...
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);
        (cache,expl_1,cprops,_,dae2) = Static.elabExpList(cache, env, expl, impl, NONE,false,pre);
    ...
    case (cache,env,ih,pre,SCode.ALG_ASSIGN(assignComponent = Absyn.TUPLE(expressions = expl),value = e,info=info),source,initial_,impl,unrollForLoops)
      ...
      equation 
        ...
        (cache,expl_2,cprops,_,dae2) = Static.elabExpList(cache,env, expl, impl, NONE,false,pre);
    ...
    case (cache,env,ih,pre,SCode.ALG_IF(boolExpr = e,trueBranch = tb,elseIfBranch = eib,elseBranch = fb,info = info),source,initial_,impl,unrollForLoops)
      equation 
        (cache,e_1,prop,_,dae1) = Static.elabExp(cache,env, e, impl, NONE,true,pre);
        (cache, e_1, prop) = Ceval.cevalIfConstant(cache, env, e_1, prop, impl);
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);        
        (cache,tb_1 ,dae2)= instStatements(cache,env,ih,pre, tb, source, initial_,impl,unrollForLoops);
        (cache,eib_1,dae3) = instElseIfs(cache,env,ih,pre, eib, source, initial_,impl,unrollForLoops);
        (cache,fb_1,dae4) = instStatements(cache,env,ih,pre, fb, source, initial_,impl,unrollForLoops);
        source = DAEUtil.addElementSourceFileInfo(source, info);
...
//        stmt = Algorithm.makeFor(i, e_2, prop, sl_1);
    ...
    case (cache,env,ih,pre,SCode.ALG_WHILE(boolExpr = e,whileBody = sl, info = info),source,initial_,impl,unrollForLoops)
      equation 
        ...
        (cache, e_1, prop) = Ceval.cevalIfConstant(cache, env, e_1, prop, impl);
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);        
        (cache,sl_1,dae2) = instStatements(cache,env,ih,pre,sl,source,initial_,impl,unrollForLoops);
        source = DAEUtil.addElementSourceFileInfo(source, info);
    ...
    case (cache,env,ih,pre,SCode.ALG_WHEN_A(branches = (e,sl)::(elseWhenRest as _::_), comment = comment, info = info),source,initial_,impl,unrollForLoops)
      equation 
        false = containsWhenStatements(sl);
        (cache,{stmt1},dae1) = instStatement(cache,env,ih,pre,SCode.ALG_WHEN_A(elseWhenRest,comment,info),source,initial_,impl,unrollForLoops);
        (cache,e_1,prop,_,dae2) = Static.elabExp(cache, env, e, impl, NONE, true,pre);
        (cache, e_1, prop) = Ceval.cevalIfConstant(cache, env, e_1, prop, impl);
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);        
        (cache,sl_1,dae3) = instStatements(cache, env, ih, pre, sl, source, initial_, impl, unrollForLoops);
        source = DAEUtil.addElementSourceFileInfo(source, info);
    ...
    case (cache,env,ih,pre,SCode.ALG_NORETCALL(functionCall = Absyn.CREF_IDENT(name = "assert"),
      ...
      equation 
        (cache,cond_1,cprop,_,dae1) = Static.elabExp(cache, env, cond, impl, NONE, true,pre);
        ...
        (cache,msg_1,msgprop,_,dae2) = Static.elabExp(cache, env, msg, impl, NONE, true,pre);
    ...
    case (cache,env,ih,pre,SCode.ALG_NORETCALL(functionCall = Absyn.CREF_IDENT(name = "terminate"),
      ...
      equation 
        (cache,msg_1,msgprop,_,dae) = Static.elabExp(cache, env, msg, impl, NONE, true,pre);
        (cache, msg_1, msgprop) = Ceval.cevalIfConstant(cache, env, msg_1, msgprop, impl);
        (cache,msg_2) = PrefixUtil.prefixExp(cache, env, ih, msg_1, pre);
        source = DAEUtil.addElementSourceFileInfo(source, info);
    ...
    case (cache,env,ih,pre,SCode.ALG_NORETCALL(functionCall = Absyn.CREF_IDENT(name = "reinit"),
      ...
      equation 
        (cache,var_1,varprop,_,dae1) = Static.elabExp(cache, env, var, impl, NONE, true,pre);
        ...
        (cache,value_1,valprop,_,dae2) = Static.elabExp(cache, env, value, impl, NONE, true,pre);
    ...
    case (cache,env,ih,pre,(SCode.ALG_NORETCALL(functionCall = callFunc, functionArgs = callArgs, info = info)),source,initial_,impl,unrollForLoops)
      local 
        ...
        DAE.ExpType tp;
      equation
        (cache, DAE.CALL(ap, eexpl, tuple_, builtin, tp, inline), varprop, _, dae) = 
          Static.elabExp(cache, env, Absyn.CALL(callFunc, callArgs), impl, NONE, true,pre); 
    ...
    case (cache,env,ih,pre,SCode.ALG_TRY(tryBody = sl, comment = comment, info = info),source,initial_,impl,unrollForLoops)
      equation
        true = RTOpts.acceptMetaModelicaGrammar();
        (cache,sl_1,dae) = instStatements(cache, env, ih, pre, sl, source, initial_, impl, unrollForLoops);
        source = DAEUtil.addElementSourceFileInfo(source, info);
...
algorithm 
  ...
  matchcontinue (inCache,inEnv,inIH,inPrefix,inIdent,inValue,inAlgItmLst,source,inInitial,inBoolean,unrollForLoops)
    ...
    case (_,_,_,_,_,v,_,_,_,_,_)
      equation 
        true = RTOpts.debugFlag("failtrace");
        Debug.fprintln("failtrace", "- Inst.loopOverRange failed to loop over range: " +& ValuesUtil.valString(v));
      then
        fail();
  end matchcontinue;
end loopOverRange;
...
"@author: adrpo
 unroll for loops that contains when statements"
  ...
  output DAE.DAElist outDae; 
algorithm
  (outCache,outStatement,outDae) := matchcontinue(inCache,inEnv,inIH,inPrefix,inIterators,inForBody,info,source,inInitial,inBool,unrollForLoops)
    local
	    Env.Cache cache;
	    list<Env.Frame> env,env_1;
	    Prefix pre;
  ...
  (outCache,outStatement,outDae) := matchcontinue(inCache,inEnv,inIH,inPrefix,inIterators,inForBody,info,source,inInitial,inBool,unrollForLoops)
    ...
    case (cache,env,ih,pre,inIterators,sl,info,source,initial_,impl,unrollForLoops)
      equation
        ...
        true = containsWhenStatements(sl);
        (cache,stmts,dae) = unrollForLoop(cache,env,ih,pre,inIterators,sl,info,source,initial_,impl,unrollForLoops);
      then
        (cache,stmts,dae);
    ...
    case (cache,env,ih,pre,inIterators,sl,info,source,initial_,impl,unrollForLoops)
      equation
        ...
        false = containsWhenStatements(sl);
        (cache,stmts,dae) = instForStatement_dispatch(cache,env,ih,pre,inIterators,sl,info,source,initial_,impl,unrollForLoops);
...
algorithm
  (outCache,outStatement,outDae) := matchcontinue(inCache,inEnv,inIH,inPrefix,inIterators,inForBody,info,source,inInitial,inBool,unrollForLoops)
    ...
    case (cache,env,ih,pre,{(i,SOME(e))},sl,info,source,initial_,impl,unrollForLoops)
      equation
        (cache,e_1,(prop as DAE.PROP((DAE.T_ARRAY(_,t),_),cnst)),_,dae1) = Static.elabExp(cache, env, e, impl, NONE, true,pre);
        (cache, e_1) = Ceval.cevalRangeIfConstant(cache, env, e_1, prop, impl);
        (cache,e_2) = PrefixUtil.prefixExp(cache,env, ih, e_1, pre);
        env_1 = addForLoopScope(env, i, t, SCode.VAR(), SOME(cnst));
        (cache,sl_1,dae2) = instStatements(cache, env_1, ih, pre, sl, source, initial_, impl, unrollForLoops);
        source = DAEUtil.addElementSourceFileInfo(source,info);
    ...
    case (cache,env,ih,pre,(i,SOME(e))::restIterators,sl,info,source,initial_,impl,unrollForLoops)
      equation        
        ...
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);
        env_1 = addForLoopScope(env, i, t, SCode.VAR(), SOME(cnst));
        (cache,stmts,dae2) = instForStatement_dispatch(cache,env_1,ih,pre,restIterators,sl,info,source,initial_,impl,unrollForLoops);
        source = DAEUtil.addElementSourceFileInfo(source,info);
    ...
    case (cache,env,ih,pre,(i,NONE)::restIterators,sl,info,source,initial_,impl,unrollForLoops) //The verison w/o assertions
      equation
        ...
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);
        env_1 = addForLoopScope(env, i, t, SCode.VAR(), SOME(cnst));
        (cache,sl_1,dae2) = instForStatement_dispatch(cache,env_1,ih,pre,restIterators,sl,info,source,initial_,impl,unrollForLoops);
        source = DAEUtil.addElementSourceFileInfo(source,info);
        stmt = Algorithm.makeFor(i, e_2, prop, sl_1, source);
        dae = DAEUtil.joinDaes(dae1,dae2);
      then
...
algorithm
  ...
  matchcontinue (inCache,inEnv,inIH,inPre,inTplAbsynExpAbsynAlgorithmItemLstLst,source,initial_,inBoolean,unrollForLoops)
    local
      list<Env.Frame> env;
      Boolean impl;
      DAE.Exp e_1,e_2;
    ...
    case (cache,env,ih,pre,((e,l) :: tail),source,initial_,impl,unrollForLoops)
      equation
        (cache,e_1,prop,_,dae1) = Static.elabExp(cache, env, e, impl, NONE, true,pre);
        (cache, e_1, prop) = Ceval.cevalIfConstant(cache, env, e_1, prop, impl);
        (cache,e_2) = PrefixUtil.prefixExp(cache, env, ih, e_1, pre);
        (cache,stmts,dae2) = instStatements(cache, env, ih, pre, l, source, initial_, impl, unrollForLoops);
        (cache,tail_1,dae3) = instElseIfs(cache,env,ih,pre,tail, source, initial_, impl, unrollForLoops);
        dae = DAEUtil.joinDaeLst({dae1,dae2,dae3});
      then
  ...
  matchcontinue (inCache,inEnv,inIH,inSets,inPrefix,inComponentRefLeft,inComponentRefRight,inBoolean,inGraph,info)
    ...
    case (cache,env,ih,sets,pre,c1,c2,impl,graph,info)
      equation
        ...
        (cache,DAE.CREF(c2_1,t2),prop2,acc,_) = Static.elabCref(cache,env, c2, impl, false,pre);
    ...
    case (cache,env,ih,sets,pre,c1,c2,impl,graph,info)
      ...
      equation
        ...
        s1 = "connect("+&s1+&", "+&s2+&")";
        checkConstantVariability(crefs1,cache,env,s1,pre);
        checkConstantVariability(crefs2,cache,env,s1,pre);
      then
        fail();

    case (cache,env,ih,sets,pre,c1,c2,impl,_,_)
      equation
        Debug.fprintln("failtrace", "- Inst.instConnect failed for: connect(" +& 
...
Author BZ, 2009-09
  ...
  input Prefix inPrefix;
algorithm props := matchcontinue(inrefs,cache,env,affectedConnector,inPrefix)
  local
    Absyn.ComponentRef cr;
    Boolean b2;
    DAE.Properties prop;
    ...
    Prefix pre;
  case({},_,_,_,_) then ();
  case(cr::inrefs,cache,env,affectedConnector,pre)
    equation
      (_,_,prop,_,_) = Static.elabCref(cache,env,cr,false,false,pre);
      const = Types.elabTypePropToConst({prop});
      true = Types.isParameterOrConstant(const);
      checkConstantVariability(inrefs,cache,env,affectedConnector,pre);
    then
      ();
  case(cr::inrefs,cache,env,affectedConnector,pre)
    local String s1;
  ...
  matchcontinue (inCache,inEnv,inIH,inElement,outerMod,inBoolean)
    ...
    case (cache,env,ih,
      ...
      equation
        ...
        (cache,mod_1,_) = Mod.elabMod(cache, env, ih, Prefix.NOPRE(), mod, impl);
...
"function: createForIteratorArray
  ...
  output DAE.DAElist outDae "contain functions";
algorithm
  (outCache,outDecls,outDae) := matchcontinue (cache,env,iterExp,rangeIdList,b,inPrefix)
    case (localCache,localEnv,localIterExp,localRangeIdList,impl,pre)
      local
      ...
      equation
        (localCache,subscriptList,ld,dae1) = deriveArrayDimAndTempVars(localCache,localEnv,localRangeIdList,impl,{},{},pre);
...
"function: deriveArrayDimAndTempVars.
  ...
  output DAE.DAElist outDae "contain functions";
algorithm
  (cache,outList1,outList2,outDae) := matchcontinue (cache,env,rangeList,impl,accList,accTempVars,inPrefix)
    local
      list<Absyn.Subscript> localAccList;
      ...
      Env.Cache localCache;
      Prefix pre;
    case (localCache,_,{},_,localAccList,localAccTempVars,_) then (localCache,localAccList,localAccTempVars,DAEUtil.emptyDae);
    case (localCache,localEnv,(id,SOME(e)) :: restList,localImpl,localAccList,localAccTempVars,pre)
      local
        Absyn.Exp e;
      ...
      equation
        ...
        deriveArrayDimAndTempVars(localCache,localEnv,restList,localImpl,localAccList,localAccTempVars,pre);
        dae = DAEUtil.joinDaes(dae1,dae2);
...
algorithm
  (outCache,outDae,outSets,outGraph,outDae) := matchcontinue(cache,env,cond,compName,dae,sets,pre,inGraphOld,inGraphNew)
    ...
    case(cache,env,SOME(condExp),compName,dae,sets,pre,graphOld,graphNew) equation
      (cache,e,DAE.PROP(t,c ),_,dae1) = Static.elabExp(cache, env, condExp, false, NONE, false,pre);
    ...
    case(cache,env,SOME(condExp),compName,dae,sets,pre,graphOld,graphNew) equation
      (cache,e,DAE.PROP(t,c ),_,_) = Static.elabExp(cache, env, condExp, false, NONE, false,pre);
  ...
  matchcontinue (inCache,inEnv,inIH,inSets,inPrefix,inComponentRefLeft,inComponentRefRight,inBoolean,inGraph,info)
    ...
    case (cache,env,ih,sets,pre,c1,c2,impl,graph,info)
      equation
        ...
        (cache,DAE.CREF(c1_1,t1),prop1,_,_) = Static.elabCref(cache, env, c1_prefix, impl, false,pre);
        ...
        (cache,DAE.CREF(c1_1,t1),prop1,_,_) = Static.elabCref(cache, env, c1, impl, false,pre);
        (cache,c1_2) = Static.canonCref(cache,env, c1_1, impl);
        (cache,attr1,ty1) = Lookup.lookupConnectorVar(cache,env,c1_2);
        // bind the attributes
