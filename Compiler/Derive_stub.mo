...
" file:	 Derive.mo
  package:      Derive
  description: Differentiation of equations from BackendDAE
...
algorithm
  ...
  matchcontinue (inExp,inComponentRef,differentiateIfExp)
    ...
    case (e,cr,differentiateIfExp)
      equation
        false = Expression.expContains(e, DAE.CREF(cr,DAE.ET_REAL())) "If the expression does not contain the variable,
