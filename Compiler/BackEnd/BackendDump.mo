...
algorithm
  ...
  match (inBackendDAE)
    ...
    case (BackendDAE.DAE(BackendDAE.EQSYSTEM(vars1,eqns,_,_)::{},BackendDAE.SHARED(vars2,vars3,av,ieqns,reqns,ae,algs,BackendDAE.EVENT_INFO(zeroCrossingLst = zc,whenClauseLst=wc),extObjCls)))
      equation
        print("Variables (");
