...
algorithm
  ...
  matchcontinue (inComp,inEqnLst,inVarVarindxLst,inDAE,inIncidenceMatrix,inIncidenceMatrixT,inAss1,inAss2)
    ...
    case (comp,eqn_lst,var_varindx_lst,inDAE as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars=vars,orderedEqs=eqns),arrayEqs=ae,algorithms=al),m,mt,ass1,ass2)
      equation
    ...
    case (comp,eqn_lst,var_varindx_lst,inDAE as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars=vars,orderedEqs=eqns),arrayEqs=ae,algorithms=al),m,mt,ass1,ass2)
      equation
        ...
        subsystem_dae = BackendDAE.DAE(BackendDAE.EQSYSTEM(vars_1,eqns_1,eeqns),evars,evars,av,eeqns,ae1,al,BackendDAE.EVENT_INFO({},{}),{});
...
algorithm
  ...
  match (inOrgEqns,inDAE)
    ...
    case ({},_) then BackendDAEUtil.emptyVars();
    case (inOrgEqns,inDAE)
      equation
        orgeqn_indxs = Util.listMap(inOrgEqns,Util.tuple32);
        orgeqn = BackendEquation.getEqns(orgeqn_indxs,BackendEquation.daeEqns(inDAE));
        vars = BackendDAEUtil.emptyVars();
        vars1 = BackendEquation.equationsLstVars(orgeqn,BackendVariable.daeVars(inDAE),vars);
      then
        vars1;
  end match;
...
algorithm
  ...
  matchcontinue (inIntegerLst,inBackendDAE,inStateOrd)
    ...
    case ((e :: es),(dae as BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie),kv,ev,av,seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zc),eoc)),inStateOrd)
      equation
        e_1 = e - 1;
        eqn = BackendDAEUtil.equationNth(eqns, e_1);
        ...
        dae = replaceStateOrder(es,BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns_1,ie),kv,ev,av,seqns,ae1,al1,BackendDAE.EVENT_INFO(wclst1,zc),eoc),inStateOrd);
      then
        (dae);
    case (_,_,_)
      equation
  ...
  matchcontinue (inJop,inBackendDAE1,inIncidenceMatrix2,inIncidenceMatrixT3,inFunctions,inAssignments1,inAssignments2,inDerivedAlgs,inDerivedMultiEqn,inArg)
    ...
    case (BackendDAE.ENDSTEP(),dae as BackendDAE.DAE(arrayEqs=ae),m,mt,inFunctions,ass1,ass2,derivedAlgs,derivedMultiEqn,(so,orgEqnsLst))
      equation
        ...
        (dae,m,mt,ass1,ass2) = processOrgEnqs(orgEqnsLst_1,so,dae,m,mt,inFunctions,ass1,ass2);  
         vec1 = assignmentsVector(ass1);
         vec2 = assignmentsVector(ass2);
...
algorithm
  ...
  matchcontinue (inOrgEqns,inBackendDAE,inArrayListeqns)
    ...
    case ({},inBackendDAE,arrayListeqns) 
      then arrayListeqns;
    case ((e,_,_)::rest,dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedEqs=eqnsarr),arrayEqs=ae),arrayListeqns)
      equation
        e_1 = e - 1;
...
algorithm
  ...
  matchcontinue (inBackendDAE1,inIntegerLst6,inFunctions,inDerivedAlgs,inDerivedMultiEqn,inStateOrd,inM,inMT,inOrgEqnsLst)
    ...
    case ((dae as BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie),kv,ev,av,seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zc),eoc)),(e :: es),inFunctions,inDerivedAlgs,inDerivedMultiEqn,inStateOrd,m,mt,inOrgEqnsLst)
      equation
        e_1 = e - 1;
        eqn = BackendDAEUtil.equationNth(eqns, e_1);
        ...
        eqns_1 = BackendEquation.equationSetnth(eqns,e_1,eqn_1);
        dae1 = BackendDAE.DAE(BackendDAE.EQSYSTEM(v1,eqns_1,ie),kv,ev,av,seqns,ae1,al1,BackendDAE.EVENT_INFO(wclst1,zc),eoc);
...
algorithm
  ...
  matchcontinue (inOrgEqns,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inStateOrd,inFunctions,e)
    ...
    case ((orgeqn,false)::rest,dae as BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqnsarr,ie),kv,ev,av,seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zc),eoc),m,mt,so,inFunctions,e)
      equation
        ...
        ep = arrayLength(m)+1;
        dae1 = BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqnsarr,ie),kv,ev,av,seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zc),eoc);
...
algorithm
  ...
  matchcontinue (inOrgEqns,inStateOrd,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inFunctionTree,inAssignments1,inAssignments2)
    ...
    case (orgEqns,inStateOrd,dae as BackendDAE.DAE(arrayEqs=ae),m,mt,inFunctionTree,ass1,ass2)
      equation
        ...
        (dae2,m,mt,ass1,ass2) = processOrgEnqs(orgEqns1,so,dae1,m,mt,inFunctionTree,ass1,ass2);
      then
        (dae2,m,mt,ass1,ass2);
  end matchcontinue;
end processOrgEnqs;
...
algorithm
  ...
  matchcontinue (inStates,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT)
    ...
    case (inStates,BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars=vars,orderedEqs = eqns),knownVars=knvars),m,mt)
      equation
...
algorithm
  (outBackendDAE,outIncidenceMatrix,outIncidenceMatrixT,outAssignments1,outAssignments2,outStateOrd,outStates,outOrgEqns,outOrgEqnsLst,outReplaced):=
  matchcontinue (inOrgEqns,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inAssignments1,inAssignments2,inStateOrd,inStates,inOrgEqns1,inOrgEqnsLst)
    local
    ...
    case ((e,ep,l)::rest,dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars=v,orderedEqs=eqns)),m,mt,ass1,ass2,so,cstates,orgEqnslst,inOrgEqnsLst)
      equation
        ...
        (dae2,m2,mt2,ass1,ass2,so2,cstates,orgEqnslst,orgeqns,r) = processAlliasStates(rest,dae1,m,mt,ass1,ass2,so,cstates1,orgEqnslst,orgeqns);
      then
        (dae2,m2,mt2,ass1,ass2,so2,cstates,orgEqnslst,orgeqns,r+1);
    case ((e,ep,l)::rest,dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars=v,orderedEqs=eqns)),m,mt,ass1,ass2,so,cstates,orgEqnslst,inOrgEqnsLst)
      equation
        // next 
        (dae2,m2,mt2,ass1,ass2,so1,cstates,orgEqnslst,orgeqns,r) = processAlliasStates(rest,dae,m,mt,ass1,ass2,so,cstates,(e,ep,l)::orgEqnslst,inOrgEqnsLst);
      then
        (dae2,m2,mt2,ass1,ass2,so1,cstates,orgEqnslst,orgeqns,r); 
    else
      equation
...
"function: processEqnsLevel
  ...
  output list<tuple<DAE.ComponentRef,Integer>> outStates; 
algorithm
  (outBackendDAE,outIncidenceMatrix,outIncidenceMatrixT,outAssignments1,outAssignments2,outStates):=
  matchcontinue (inOrgEqns,inSysjac,inStateOrd,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inAssignments1,inAssignments2,inFunctionTree,inStates)
    ...
    case ({},inSysjac,inStateOrd,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inAssignments1,inAssignments2,inFunctionTree,inStates)
      then (inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inAssignments1,inAssignments2,inStates);
    case (inOrgEqns,inSysjac,inStateOrd,inBackendDAE,m,mt,ass1,ass2,inFunctionTree,inStates)
      equation
        (orgeqns,sysjac,dae,m,mt,ass1,ass2,states1,rs) = processOneStateEqns(inOrgEqns,inSysjac,inStateOrd,inBackendDAE,m,mt,ass1,ass2,inFunctionTree,inStates);
        true = intGt(listLength(rs),0);
        (sysjac1,orgeqns) = removeVarsfromSysJac(rs,sysjac,orgeqns);
        (dae1,m,mt,ass1,ass2,states2) = processEqnsLevel(orgeqns,sysjac1,inStateOrd,dae,m,mt,ass1,ass2,inFunctionTree,states1);
      then
...
algorithm
  ...
  matchcontinue (inOrgEqns,inSysjac,inStateOrd,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inAssignments1,inAssignments2,inFunctionTree,inStates)
    ...
    case ((e,ep,l)::rest,((stateno,_)::{})::sysjac,inStateOrd,dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars=v)),m,mt,ass1,ass2,inFunctionTree,inStates)
      equation
        ...
        (ass1,ass2) = assignWithExpand(ev, ast, ass1, ass2);   
        // next 
        (orgeqns,sysjac1,dae1,m,mt,ass1,ass2,states,rs) = processOneStateEqns(rest,sysjac,inStateOrd,dae1,m,mt,ass1,ass2,inFunctionTree,inStates);
     ...
     case ((e,ep,l)::rest,eqnjac::sysjac,inStateOrd,dae,m,mt,ass1,ass2,inFunctionTree,inStates)
      equation
        (orgeqns,sysjac1,dae1,m,mt,ass1,ass2,states,rs) = processOneStateEqns(rest,sysjac,inStateOrd,dae,m,mt,ass1,ass2,inFunctionTree,inStates);
      then
...
algorithm
  ...
  matchcontinue (inOrgEqns,repl,inBackendDAE)
    ...
    case ({},_,inBackendDAE) 
      then (inBackendDAE,{});
    case ((ep,l,b)::rest,repl,BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqnsarr,ie),kv,ev,av,seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zc),eoc))
      equation
        e_1 = ep - 1;
...
algorithm
  ...
  matchcontinue (inOrgEqns,repl,inBackendDAE)
    ...
    case ({},_,inBackendDAE) 
      then (inBackendDAE,{});
    case ((e,ep,l)::rest,repl,BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqnsarr,ie),kv,ev,av,seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zc),eoc))
      equation
        e_1 = ep - 1;
        (orgeqn as BackendDAE.ARRAY_EQUATION(index=i)) = BackendDAEUtil.equationNth(eqnsarr, e_1);        
        BackendDAE.MULTIDIM_EQUATION(dims,exp1,exp2,source) = ae[i+1];
...
algorithm
  ...
  matchcontinue (inOrgEqns,inBackendDAE,inStates)
    ...
    case ({},inBackendDAE,inStates)
      then ({},{});
    case ((e,ep,_)::rest,dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedEqs=eqns),knownVars=knvars,arrayEqs=ae,algorithms=al),inStates)
      equation
        e_1 = ep - 1;
        orgeqn = BackendDAEUtil.equationNth(eqns, e_1); 
...
algorithm
  ...
  matchcontinue (inOrgEqns,inStateOrd,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inFunctionTree,inStates,inDummyStates)
    ...
    case ({},inStateOrd,inBackendDAE,m,mt,inFunctionTree,inStates,dummystates)
      ...
      then dummystates;
    case ((e,ep,_)::rest,inStateOrd,dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedEqs=eqns),knownVars=knvars,arrayEqs=ae,algorithms=al),m,mt,inFunctionTree,inStates,dummystates)
      equation
        e_1 = ep - 1;
        orgeqn = BackendDAEUtil.equationNth(eqns, e_1); 
   ...
   matchcontinue (inDynDummyDer,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inFunctionTree,inStates,inStateOrd,inOrgEqns,inDummyStates,ep)
    ...
    case ((dyndummyder as (_::{}))::rest,dae,m,mt,inFunctionTree,states,inStateOrd,inOrgEqns,inDummyStates,ep)
      equation
        ...
        ((_,_,dse1)) = Util.listGetMemberOnTrue(stateno,dyndummyder,getDummyExp);
        accdummystate = {(dummystate,dse1,stateno,ep)};
        accdummystates = selectDummyStates(inOrgEqns,inStateOrd,dae,m,mt,inFunctionTree,states,inDummyStates);
      then
  ...
  outDummyStates := 
   matchcontinue (stateNo,accdummystate,inDummyDer,inDynDummyDer,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inFunctionTree,inStates,inStateOrd,inOrgEqns,inDummyStates,ep)
    ...
    case (stateNo,accdummystate,dummydercand,dyndummydercand,inBackendDAE,m,mt,inFunctionTree,inStates,inStateOrd,inOrgEqns,inDummyStates,ep)
      equation
        dummystates = selectDummyStates(inOrgEqns,inStateOrd,inBackendDAE,m,mt,inFunctionTree,inStates,inDummyStates);
      then
...
algorithm
  (outBackendDAE,outIncidenceMatrix,outIncidenceMatrixT,outAssignments1,outAssignments2,outStates) := 
   matchcontinue (inDummyDers,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT,inAssignments1,inAssignments2,inStates)
    local
    ...
    case ({},dae,m,mt,ass1,ass2,inStates) 
      then 
       (dae,m,mt,ass1,ass2,inStates);
    case (((dummystate,dse1,stateno,ep)::{})::rest,dae,m,mt,ass1,ass2,inStates)
      equation
        ...
        (dae2,m,mt,ass1,ass2,states1) =  makeDummyStates(rest,dae1,m,mt,ass1,ass2,states);  
      then
        (dae2,m,mt,ass1,ass2,states1);
    case (((dummystate,dse1,stateno,ep)::((dummystate1,dse2,stateno1,_)::{}))::rest,dae,m,mt,ass1,ass2,inStates)
      equation
        ...
        (dae,m,mt,ass1,ass2,states1) =  makeDummyStates(rest,dae,m,mt,ass1,ass2,states);
      then
        (dae,m,mt,ass1,ass2,states1);
    else
      equation
...
algorithm
  ...
  matchcontinue (orgEqns,dae)
    local
      ...
      Integer i,e,l,e_1;
    case ({},_) then ();
    case ((e,l,_)::rest,dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedEqs=eqns),arrayEqs=ae))
      equation
        e_1 = e - 1;
...
algorithm
  ...
  matchcontinue (orgEqns,dae)
    ...
    case ((e,ep,l),dae as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedEqs=eqns),arrayEqs=ae))
      equation
        e_1 = ep - 1;
        (orgeqn as BackendDAE.ARRAY_EQUATION(index=i)) = BackendDAEUtil.equationNth(eqns, e_1); 
        BackendDAE.MULTIDIM_EQUATION(left=exp1,right=exp2) = ae[i+1];
...
algorithm
  ...
  matchcontinue (inBackendDAE,inComponentRef)
    ...
    case (BackendDAE.DAE(BackendDAE.EQSYSTEM(vars,e,ie),kv,ev,av,se,ae,al,wc,eoc),cr)
      equation
      ...
      then
        BackendDAE.DAE(BackendDAE.EQSYSTEM(vars_1,e,ie),kv,ev,av,se,ae,al,wc,eoc);
...
algorithm
  outBackendDAE := matchcontinue (inBackendDAE,inIntegerLst,inComponentRef,inInteger)
   ...
   /* eqns dummy state */
    case ((dae as BackendDAE.DAE(BackendDAE.EQSYSTEM(vars,e,ie),kv,ev,av,se,ae,al,ei,eoc)),eqns,dummy,dummy_no)
      equation
      ...
      then
        BackendDAE.DAE(BackendDAE.EQSYSTEM(vars_1,e,ie),kv,ev,av,se,ae,al,ei,eoc);
...
algorithm
  ...
  matchcontinue (inExp1,inExp2,inBackendDAE3,inIncidenceMatrix4,inIncidenceMatrixT5,inIntegerLst6)
    ...
    case (stateexpcall,dummyderexp,BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie),kv,ev,av as BackendDAE.ALIASVARS(aliasVars = aliasVars),seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zeroCrossingLst),eoc),m,mt,{})
      equation
       ...
       then (BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie1),kv,ev,av,seqns1,ae2,al2,BackendDAE.EVENT_INFO(wclst2,zeroCrossingLst),eoc),m,mt);

    case (stateexpcall,dummyderexp,BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie),kv,ev,av,seqns,ae,al,BackendDAE.EVENT_INFO(wclst,zeroCrossingLst),eoc),m,mt,(e :: rest))
      equation
        e_1 = e - 1;
        eqn = BackendDAEUtil.equationNth(eqns, e_1);
        ...
        (dae,m,mt) = replaceDummyDer(stateexpcall, dummyderexp, BackendDAE.DAE(BackendDAE.EQSYSTEM(v_1,eqns_1,ie),kv,ev,av,seqns,ae2,al2,BackendDAE.EVENT_INFO(wclst2,zeroCrossingLst),eoc), m, mt, rest);
      then
        (dae,m,mt);
...
algorithm
  ...
  matchcontinue (inComponentRef,inBackendDAE,op)
    ...
    case (var,BackendDAE.DAE(BackendDAE.EQSYSTEM(vars,eqns,ie), kv, ev, av, seqns, ae, al, wc,eoc),op)
      equation
      ...
      then
        (dummyvar_cr,BackendDAE.DAE(BackendDAE.EQSYSTEM(vars_1,eqns,ie),kv,ev,av,seqns,ae,al,wc,eoc));
...
algorithm
  ...
  matchcontinue (varCrefs,varIndices,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT)
    ...
    case (varCrefs,varIndices,BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars=vars,orderedEqs = eqns),knownVars=knvars),m,mt)
      equation
        prioTuples = calculateVarPriorities(varCrefs,varIndices,vars,knvars,eqns,m,mt);
...
algorithm
  ...
  matchcontinue (inIntegerLst,inBackendDAE,inIncidenceMatrix,inIncidenceMatrixT)
    ...
    case ({},_,_,_) then ({},{});
    case ((e :: rest),daelow as BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedVars = vars,orderedEqs = eqns)),m,mt)
      equation
      ...
      then
        (res1_1,res2_1);
    case ((e :: rest),BackendDAE.DAE(eqs=BackendDAE.EQSYSTEM(orderedEqs = eqns)),_,_)
      equation
        se = intString(e);
...
algorithm
  ...
  matchcontinue (inBackendDAE1,inIncidenceMatrix2,inIncidenceMatrixT3,inIntegerLst6,inFunctions,inDerivedAlgs,inDerivedMultiEqn)
    ...
    case ((dae as BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie),kv,ev,av,seqns,ae,al,wc,eoc)),m,mt,(e :: es),inFunctions,inDerivedAlgs,inDerivedMultiEqn)
      equation
        e_1 = e - 1;
        eqn = BackendDAEUtil.equationNth(eqns, e_1);
        ...
        (dae,m,mt,reqns,derivedAlgs1,derivedMultiEqn1) = differentiateEqns(BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns_1,ie),kv,ev,av,seqns,ae1,al1,wc,eoc), m, mt, es, inFunctions,derivedAlgs,derivedMultiEqn);
      then
    ...
    case ((dae as BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie),kv,ev,av,seqns,ae,al,wc,eoc)),m,mt,(e :: es),inFunctions,inDerivedAlgs,inDerivedMultiEqn)
      equation
        ...
        Debug.fcall("bltdump", debugdifferentiateEqns,(eqn,eqn_1));
        BackendDAEEXT.markDifferentiated(e) "length gives index of new equation Mark equation as differentiated so it won\'t be differentiated again" ;
        (dae,m,mt,reqns,derivedAlgs1,derivedMultiEqn1) = differentiateEqns(BackendDAE.DAE(BackendDAE.EQSYSTEM(v,eqns,ie),kv,ev,av,seqns,ae1,al1,wc,eoc), m, mt, es, inFunctions,derivedAlgs,derivedMultiEqn);
      then
