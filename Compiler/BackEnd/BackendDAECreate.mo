...
algorithm
  (outVariables,outKnownVariables,outExternalVariables,outEquationLst3,outEquationLst4,outEquationLst5,
   ...
   matchcontinue (inElements,functionTree,inStatesBinTree,inVariables,inKnownVariables,inExternalVariables,inWhenClauseLst)
    ...
    case ((daeEl as DAE.VAR(componentRef = _)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
    ...
    case (DAE.EXTOBJECTCLASS(path,constr,destr,source) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
        {extObjCl} = Inline.inlineExtObjClasses({BackendDAE.EXTOBJCLASS(path,constr,destr,source)},(SOME(functionTree),{DAE.NORM_INLINE()}));
      then
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,
    ...
    case (((daeEl as DAE.EQUATION(exp = e1,scalar = e2)) :: daeLstRest),functionTree,states,vars,knvars,extVars,whenclauses)
      equation
    ...
    case ((DAE.EQUATION(DAE.TUPLE(targets), DAE.TUPLE(sources), source = eq_source) :: daeLstRest),
    ...
    case ((daeEl as DAE.EQUEQUATION(cr1 = _)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
        backendEq1 = lowerEqn(daeEl);
    ...
    // a solved equation 
    case ((daeEl as DAE.DEFINE(componentRef = _)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
        backendEq1 = lowerEqn(daeEl);
    ...
    // complex equations
    case ((daeEl as DAE.COMPLEX_EQUATION(lhs = e1,rhs = e2)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
    ...
    case ((daeEl as DAE.INITIAL_COMPLEX_EQUATION(lhs = e1,rhs = e2)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
    ...
    // array equations
    case ((daeEl as DAE.ARRAY_EQUATION(dimension = _,exp = e1,array = e2)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
    ...
    case ((daeEl as DAE.INITIAL_ARRAY_EQUATION(dimension = _,exp = e1,array = e2)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
        BackendDAE.MULTIDIM_EQUATION(left=e_11 as DAE.ARRAY(scalar=true,array=ea1),
    ...
    // initial array equations
    case ((daeEl as DAE.INITIAL_ARRAY_EQUATION(dimension = _, exp = e1, array = e2)) :: daeLstRest, 
        functionTree, states, vars, knvars, extVars, whenclauses)
      equation
        (vars, knvars, extVars, eqns, reqns, ieqns, aeqns,iaeqns, algs,ialgs, whenclauses_1, extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
    ...
    // initial equations
    case ((daeEl as DAE.INITIALEQUATION(exp1 = e1,exp2 = e2)) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
        backendEq1 = lowerEqn(daeEl);
    ...
    // algorithm
    case ((DAE.ALGORITHM(algorithm_ = a) :: daeLstRest),functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
        a1 = Inline.inlineAlgorithm(a,(SOME(functionTree),{DAE.NORM_INLINE()})); 
    ...
    case (DAE.COMP(dAElist = daeElts) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        ...
        (vars2,knvars2,extVars2,eqns2,reqns2,ieqns2,aeqns2,iaeqns2,algs2,ialgs2,whenclauses_2,extObjCls2,states) = lower2(daeLstRest, functionTree, states, vars1, knvars1, extVars1, whenclauses_1);
        ...
        ialgs = listAppend(ialgs1, ialgs2);
        extObjCls = listAppend(extObjCls1,extObjCls2);
      then
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_2,extObjCls,states);
    
    // assert in equation section is converted to ALGORITHM
    case (DAE.ASSERT(cond,msg,source) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        checkAssertCondition(cond,msg);
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states) = lower2(daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses);
    ...
    case (DAE.TERMINATE(message = msg, source = source) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states) = lower2(daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses);
    ...
    case (DAE.NORETCALL(functionName = func_name, functionArgs = args, source = source) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
    ...
    // initial algorithm
    case ((daeEl as DAE.INITIALALGORITHM(algorithm_ = a, source = DAE.SOURCE(info=info))) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states)
        = lower2(daeLstRest, functionTree, states, vars, knvars, extVars, whenclauses);
       a1 = Inline.inlineAlgorithm(a,(SOME(functionTree),{DAE.NORM_INLINE()})); 
    ...
    case ((daeEl as DAE.IF_EQUATION(condition1 = {DAE.CALL(path=Absyn.IDENT("initial"))}, source = DAE.SOURCE(info = info))) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
    ...
    case ((daeEl as DAE.INITIAL_IF_EQUATION(condition1 = _, source = DAE.SOURCE(info = info))) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        true = OptManager.getOption("checkModel");
        (vars,knvars,extVars,eqns,reqns,ieqns,aeqns,iaeqns,algs,ialgs,whenclauses_1,extObjCls,states) = lower2(daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses);        
      then
    ...
    case ((daeEl as DAE.IF_EQUATION(condition1 = _, source = DAE.SOURCE(info = info))) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
    ...
    case ((daeEl as DAE.NORETCALL(functionName = Absyn.IDENT(name = "constrain"), source = DAE.SOURCE(info=info))) :: daeLstRest,functionTree,states,vars,knvars,extVars,whenclauses)
      equation
        str = DAEDump.dumpElementsStr({daeEl});
    ...
    case (daeEl::daeLstRest,functionTree,_,vars,knvars,extVars,_)
      equation
  ...
  matchcontinue (inVariables1,knvars,inEquationLst2,inMultiDimEqs,inInteger3,inWhenClauseLst4,inInteger5,algs)
    ...
    case (v,knvars,((e as BackendDAE.ALGORITHM(index = ind)) :: xs),mdeqs,eq_count,{},_,algs)
      equation
        ...
        rellst1 = traverseAlgStmts(stmts,v,knvars);
    ...
    case (v,knvars,(e :: xs),mdeqs,eq_count,{},_,algs)
      ...
      then
        res;
    case (v,knvars,el,mdeqs,eq_count,((wc as BackendDAE.WHEN_CLAUSE(condition = daeExp)) :: xsWhen),wc_count,algs)
      equation
        wc_count_1 = wc_count + 1;
        (res1) = findZeroCrossings2(v, knvars,el,mdeqs,eq_count, xsWhen, wc_count_1,algs);
        rel = findZeroCrossings3(daeExp, v,knvars);
...
public function traverseAlgStmts "function: traverseAlgStmts
  Author: Frenkel TUD, 2010-12
  Helper function to collectZeroCrossings,
...
algorithm
  zeroCrossings := matchcontinue(inStmts,vars,knvars)
    ...
    case ((DAE.STMT_ASSIGN(type_ = tp,exp1 = e2,exp = e, source = source) :: xs),vars,knvars)
      equation
        zcl1 = findZeroCrossings3(e, vars,knvars);
        zcl2 = findZeroCrossings3(e2, vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);
        zcl = listAppend(zcl,zcl3);        
      then zcl;
        
    case ((DAE.STMT_TUPLE_ASSIGN(type_ = tp,expExpLst = expl1, exp = e, source = source) :: xs),vars,knvars)
      equation
        zcl1 = findZeroCrossings3(e, vars,knvars);
        zcl2 = Util.listFlatten(Util.listMap2(expl1,findZeroCrossings3,vars,knvars));
        zcl3 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);
        zcl = listAppend(zcl,zcl3);          
      then zcl;
        
    case ((DAE.STMT_ASSIGN_ARR(type_ = tp,componentRef = cr, exp = e, source = source) :: xs),vars,knvars)
      equation
        zcl1 = findZeroCrossings3(e, vars,knvars);
        zcl2 = findZeroCrossings3(Expression.crefExp(cr), vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);
        zcl = listAppend(zcl,zcl3);        
      then zcl;
    ...
    case (((x as DAE.STMT_IF(exp=e,statementLst=stmts,else_ = algElse, source = source)) :: xs),vars,knvars)
      equation
        ...
        zcl2 = traverseAlgStmts(stmts,vars,knvars);
        zcl3 = findZeroCrossings3(e, vars,knvars);
        zcl4 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);
        zcl = listAppend(zcl,zcl3);        
        zcl = listAppend(zcl,zcl4);        
      then zcl;
        
    case (((x as DAE.STMT_FOR(type_=tp,iterIsArray=b1,iter=id1,range=e,statementLst=stmts, source = source)) :: xs),vars,knvars)
      equation
        /* use the range for the componentreferences */
        cr = ComponentReference.makeCrefIdent(id1, tp, {});
        iteratorExp = Expression.crefExp(cr);   
        iteratorexps = extendRange(e,knvars); 
        zcl1 = traverseAlgStmtsFor(iteratorExp,iteratorexps,stmts,vars,knvars);
        zcl2 = findZeroCrossings3(e, vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);
        zcl = listAppend(zcl,zcl3);          
      then zcl;
        
    case (((x as DAE.STMT_WHILE(exp = e,statementLst=stmts, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = traverseAlgStmts(stmts,vars,knvars);
        zcl2 = findZeroCrossings3(e, vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);
        zcl = listAppend(zcl,zcl3);          
    ...
    case (((x as DAE.STMT_WHEN(exp = e,statementLst=stmts,elseWhen=NONE(),helpVarIndices=li, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = traverseAlgStmts(stmts,vars,knvars);
        zcl2 = findZeroCrossings3(e, vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
    ...
    case (((x as DAE.STMT_WHEN(exp = e,statementLst=stmts,elseWhen=SOME(ew),helpVarIndices=li, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = traverseAlgStmts(ew::stmts,vars,knvars);
        zcl2 = findZeroCrossings3(e, vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);
        zcl = listAppend(zcl,zcl3);          
    ...
    case (((x as DAE.STMT_ASSERT(cond = e, msg=e2, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = findZeroCrossings3(e, vars,knvars);
        zcl2 = findZeroCrossings3(e2, vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
    ...
    case (((x as DAE.STMT_TERMINATE(msg = e, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = findZeroCrossings3(e, vars,knvars);
        zcl2 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);       
    ...
    case (((x as DAE.STMT_REINIT(var = e,value=e2, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = findZeroCrossings3(e, vars,knvars);
        zcl2 = findZeroCrossings3(e2, vars,knvars);
        zcl3 = traverseAlgStmts(xs, vars,knvars);
    ...
    case (((x as DAE.STMT_NORETCALL(exp = e, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = findZeroCrossings3(e, vars,knvars);
        zcl2 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);       
    ...
    case (((x as DAE.STMT_RETURN(source = source)) :: xs),vars,knvars)
      equation
        zcl = traverseAlgStmts(xs, vars,knvars);
      then zcl;
        
    case (((x as DAE.STMT_BREAK(source = source)) :: xs),vars,knvars)
      equation
        zcl = traverseAlgStmts(xs, vars,knvars);
      then zcl;
        
    // MetaModelica extension. KS
    case (((x as DAE.STMT_FAILURE(body=stmts, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = traverseAlgStmts(stmts,vars,knvars);
        zcl2 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);         
    ...
    case (((x as DAE.STMT_TRY(tryBody=stmts, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = traverseAlgStmts(stmts,vars,knvars);
        zcl2 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);         
    ...
    case (((x as DAE.STMT_CATCH(catchBody=stmts, source = source)) :: xs),vars,knvars)
      equation
        zcl1 = traverseAlgStmts(stmts,vars,knvars);
        zcl2 = traverseAlgStmts(xs, vars,knvars);
        zcl = listAppend(zcl1,zcl2);         
    ...
    case (((x as DAE.STMT_THROW(source = source)) :: xs),vars,knvars)
      equation
        zcl = traverseAlgStmts(xs, vars,knvars);
      then zcl;
        
    case ((x :: xs),vars,knvars)
      equation
        str = DAEDump.ppStatementStr(x);
        str = "BackendDAECreate.traverseAlgStmts not implemented correctly: " +& str;
        Error.addMessage(Error.INTERNAL_ERROR, {str});
      then fail();
  end matchcontinue;
end traverseAlgStmts;

protected function traverseAlgStmtElse "
Author: Frenkel TUD, 2010-12
Helper function for traverseAlgStmts
"
...
algorithm
  ...
  case(DAE.NOELSE(),vars,knvars) then {};
  case(DAE.ELSEIF(e,st,el),vars,knvars)
    equation
      zcl1 = traverseAlgStmtElse(el,vars,knvars);
      zcl2 = traverseAlgStmts(st,vars,knvars);
      zcl3 = findZeroCrossings3(e, vars,knvars);
      zcl = listAppend(zcl1,zcl2);
      zcl = listAppend(zcl,zcl3);
    then zcl;
  case(DAE.ELSE(st),vars,knvars)
    equation
...
"function: traverseAlgStmtsFor
  ...
  output list<DAE.Exp> zeroCrossings;
algorithm
  zeroCrossings := matchcontinue (inIteratorExp,inExplst,inStmts,vars,knvars)
    local
      list<DAE.Statement> statementLst,statementLst1;
      DAE.Exp e,ie;
      list<DAE.Exp> rest,zcl,zcl1,zcl2;
    case (_,{},_,_,_) then {};
    case (ie,e::rest,statementLst,vars,knvars)
      equation
        (statementLst1,_) = DAEUtil.traverseDAEEquationsStmts(statementLst,replaceExp,((ie,e)));
        zcl1 = traverseAlgStmts(statementLst1, vars,knvars);
        zcl2 = traverseAlgStmtsFor(ie,rest,statementLst,vars,knvars);
        zcl = listAppend(zcl1,zcl2);
      then
        zcl;
    case (_,_,_,_,_)
