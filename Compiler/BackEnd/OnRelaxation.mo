...
algorithm
  (outVars,outEqns,outExp,outTpl) := matchcontinue(inTpl,e,inVars,inEqns)
    ...
    case((a,b),_,_,_)
      ...
      v = BackendDAE.VAR(cr,BackendDAE.VARIABLE(),DAE.BIDIR(),DAE.NON_PARALLEL(),DAE.T_REAL_DEFAULT,NONE(),NONE(),{},DAE.emptyElementSource,NONE(),NONE(),NONE(),DAE.NON_CONNECTOR(), DAE.NOT_INNER_OUTER());
