  ...
  matchcontinue (inInteractiveStmts,inInteractiveSymbolTable)
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      (st as SYMBOLTABLE(
        ...
        loadedFiles = lf)))
      equation 
        (newp, newCF) = updateProgram(
          Absyn.PROGRAM(
          {
          Absyn.CLASS(name,false,false,false,Absyn.R_MODEL(),
          Absyn.PARTS({Absyn.PUBLIC({})},NONE),Absyn.INFO("",false,0,0,0,0))},Absyn.TOP()), p, cf);
        newst = SYMBOLTABLE(newp,s,ic,iv,newCF,lf);
      then
        ("true",newst);
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      equation 
        ...
        (newp, newCF) = updateProgram(
          ...
          {
          Absyn.CLASS(name,false,false,false,Absyn.R_MODEL(),
          Absyn.PARTS({Absyn.PUBLIC({})},NONE),Absyn.INFO("",false,0,0,0,0))},Absyn.WITHIN(wpath)), p, cf);
        newst = SYMBOLTABLE(newp,s,ic,iv,newCF,lf);
      then
        ("true",newst);
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      equation 
        ...
        (newp, newCF) = updateProgram(
          ...
          {
          Absyn.CLASS(name,false,false,false,Absyn.R_MODEL(),
          Absyn.PARTS({Absyn.PUBLIC({})},NONE),Absyn.INFO("",false,0,0,0,0))},Absyn.WITHIN(path)), p, cf);
        newst = SYMBOLTABLE(newp,s,ic,iv,newCF,lf);
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      equation 
        ...
        (newp, newCF_1) = updateProgram(p1, p, newCF);
        top_names_str = getTopClassnames(p1);
      then
        (top_names_str,SYMBOLTABLE(newp,s,ic,iv,newCF_1,lf));
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      (st as SYMBOLTABLE(
        ...
        loadedFiles = lf)))
      equation 
        (resstr,newp,newCF) = deleteClass(cr, p, cf);
      then
        (resstr,SYMBOLTABLE(newp,s,ic,iv,newCF,lf));
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      (st as SYMBOLTABLE(
        ...
        loadedFiles = lf)))
      equation 
        (newp,newCF,res) = updateComponent(name, tp, model_, nargs, p, cf) "delete_component(name,model,p) => (newp,resstr) &
	 add_component(name,tp,model,nargs,newp) => (newp2,resstr)" ;
      then
        (res,SYMBOLTABLE(newp,s,ic,iv,newCF,lf));
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      (st as SYMBOLTABLE(
        ...
        loadedFiles = lf)))
      equation 
        (newp,newCF,resstr) = deleteComponent(name, model_, p, cf);
        str = Print.getString();
        resstr_1 = stringAppend(resstr, str);
      then
        ("true",SYMBOLTABLE(newp,s,ic,iv,newCF,lf));
    ...
    case (ISTMTS(interactiveStmtLst = 
      ...
      (st as SYMBOLTABLE(
        ...
        loadedFiles = lf)))
      equation 
        (newp, newCF) = addClassAnnotation(cr, nargs, p, cf);
        newst = SYMBOLTABLE(newp,s,ic,iv,newCF,lf);
      then
        ("true",newst);
...
*/
    case (ISTMTS(interactiveStmtLst = 
      ...
      equation 
        ...
        (p, cf) = updateProgram(Absyn.PROGRAM({refactoredClass}, Absyn.TOP), p, cf);
...
algorithm 
  ...
  matchcontinue (inTplAbsynClassAbsynPathOptionComponentReplacement)
    ...
    case (((class_ as Absyn.CLASS(name = id,partial_ = a,final_ = b,encapsulated_ = c,restriction = d,body = e,info = file_info)),SOME(pa),COMPONENTREPLACEMENT(which1 = class_id,the2 = old_comp,the3 = new_comp)))
      equation 
    ...
    case (((class_ as Absyn.CLASS(name = id,partial_ = a,final_ = b,encapsulated_ = c,restriction = d,body = e,info = file_info)),NONE,COMPONENTREPLACEMENT(which1 = class_id,the2 = old_comp,the3 = new_comp)))
      equation 
...
algorithm 
  ...
  matchcontinue (inClass1,inComponentRef2,inComponentRef3)
    local
      ...
      Absyn.Class class_;
    case (Absyn.CLASS(name = id,partial_ = partial_,final_ = final_,encapsulated_ = encapsulated_,restriction = restriction,body = Absyn.PARTS(classParts = parts,comment = a),info = file_info),old_comp,new_comp) /* the class with the component the old name for the component */ 
      equation 
    ...
    case (Absyn.CLASS(name = id,partial_ = partial_,final_ = final_,encapsulated_ = encapsulated_,restriction = restriction,body = Absyn.CLASS_EXTENDS(name = a,arguments = b,comment = c,parts = parts),info = file_info),old_comp,new_comp)
      local String a;
      equation 
        parts_1 = renameComponentInParts(parts, old_comp, new_comp);
      then
...
algorithm 
  ...
  matchcontinue (inTplAbsynClassAbsynPathOptionTplComponentsAbsynProgramEnvEnv)
    ...
    case (((class_ as Absyn.CLASS(name = id,partial_ = a,final_ = b,encapsulated_ = c,restriction = d,body = e,info = file_info)),NONE,(comps,p,env)))
      equation 
        false = isReadOnly(file_info);
        path_1 = Absyn.IDENT(id);
...
algorithm 
  ...
  matchcontinue (inClass,inPath,inComponentRef,inModification,inEnv)
    local
      ...
      Absyn.Modification mod;
      list<Env.Frame> env;
    case (Absyn.CLASS(name = id,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),inherit_name,submod,mod,env)
      equation 
...
algorithm 
  ...
  matchcontinue (inClass,inIdent,inComponentRef,inModification)
    local
      ...
      Absyn.Modification mod;
    case (Absyn.CLASS(name = id,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),varname,submodident,mod)
      equation 
...
algorithm 
  ...
  matchcontinue (inClass,inIdent,inExp)
    local
      ...
      Absyn.Info file_info;
      Absyn.Exp exp;
    case (Absyn.CLASS(name = id,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),id2,exp)
      equation 
...
algorithm 
  ...
  matchcontinue (inElement,inIdent,inExp)
    local
      ...
      Absyn.Exp exp;
      Absyn.Element elt;
    case (Absyn.ELEMENT(final_ = f,redeclareKeywords = r,innerOuter = i,name = n,specification = Absyn.COMPONENTS(attributes = attr,typeSpec = tp,components = compitems),info = info,constrainClass = constr),id,exp)
      equation 
    ...
    case ((Absyn.CLASS(name = id,partial_ = a,final_ = b,encapsulated_ = c,restriction = d,body = e,info = file_info),SOME(pa),(old_class_path,new_class_path,p,path_str_lst,env)))
      ...
      then
        ((Absyn.CLASS(new_name,a,b,c,d,e,file_info),SOME(pa),
          ...
          env)));
    case ((Absyn.CLASS(name = id,partial_ = a,final_ = b,encapsulated_ = c,restriction = d,body = e,info = file_info),NONE,(old_class_path,new_class_path,p,path_str_lst,env)))
      equation 
        path_1 = Absyn.IDENT(id);
        true = ModUtil.pathEqual(old_class_path, path_1);
        new_name = Absyn.pathLastIdent(new_class_path);
      ...
      then
        ((Absyn.CLASS(new_name,a,b,c,d,e,file_info),NONE,
          (old_class_path,new_class_path,p,(path_str :: path_str_lst),
          env)));
    case (((class_ as Absyn.CLASS(name = id,partial_ = a,final_ = b,encapsulated_ = c,restriction = d,body = e,info = file_info)),SOME(pa),(old_class_path,new_class_path,p,path_str_lst,env)))
      equation 
        path_1 = Absyn.joinPaths(pa, Absyn.IDENT(id));
      ...
      then
        ((class_1,SOME(pa),
          (old_class_path,new_class_path,p,(path_str :: path_str_lst),
          env)));
    case (((class_ as Absyn.CLASS(name = id,partial_ = a,final_ = b,encapsulated_ = c,restriction = d,body = e,info = file_info)),NONE,(old_class_path,new_class_path,p,path_str_lst,env)))
      equation 
        path_1 = Absyn.IDENT(id);
        cenv = getClassEnvNoElaboration(p, path_1, env) "get_class_env(p,path\') => cenv &" ;
        (class_1,changed) = renameClassInClass(class_, old_class_path, new_class_path, cenv);
...
algorithm 
  ...
  matchcontinue (inClass1,inPath2,inPath3,inEnv4)
    local
      ...
      Absyn.Class class_;
    case (Absyn.CLASS(name = id,partial_ = partial_,final_ = final_,encapsulated_ = encapsulated_,restriction = restriction,body = Absyn.PARTS(classParts = parts,comment = a),info = file_info),old_comp,new_comp,env) /* the class with the component the old name for the component signal if something in class have been changed */ 
      equation 
        (parts_1,changed) = renameClassInParts(parts, old_comp, new_comp, env);
      then
        (Absyn.CLASS(id,partial_,final_,encapsulated_,restriction,
          Absyn.PARTS(parts_1,a),file_info),changed);
    case (Absyn.CLASS(name = id,partial_ = partial_,final_ = final_,encapsulated_ = encapsulated_,restriction = restriction,body = Absyn.CLASS_EXTENDS(name = a,arguments = b,comment = c,parts = parts),info = file_info),old_comp,new_comp,env)
      local String a;
      equation 
        (parts_1,changed) = renameClassInParts(parts, old_comp, new_comp, env);
      then
    ...
    case (Absyn.CLASS(name = id,partial_ = partial_,final_ = final_,encapsulated_ = encapsulated_,restriction = restriction,body = Absyn.DERIVED(typeSpec=Absyn.TPATH(path_1,a),attributes = b,arguments = elementarg,comment = co),info = file_info),old_comp,new_comp,env)
      local
      ...
      then
        (Absyn.CLASS(id,partial_,final_,encapsulated_,restriction,
          Absyn.DERIVED(Absyn.TPATH(new_path,a),b,elementarg,co),file_info),true);
...
algorithm 
  ...
  matchcontinue (inClass,inAbsynPathOption,inFuncTypeTplAbsynClassAbsynPathOptionTypeAToTplAbsynClassAbsynPathOptionTypeA,inTypeA,inBoolean)
    local
      ...
      FuncTypeTplAbsyn_ClassAbsyn_PathOptionType_aToTplAbsyn_ClassAbsyn_PathOptionType_a visitor;
      Absyn.Class cl;
    case (Absyn.CLASS(name = name,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = str_opt),info = file_info),SOME(pa),visitor,args,visit_prot)
      equation 
    ...
    case (Absyn.CLASS(name = name,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = str_opt),info = file_info),NONE,visitor,args,visit_prot)
      equation 
        ((parts_1,pa_1,args_1)) = traverseInnerClassParts(parts, SOME(Absyn.IDENT(name)), visitor, args, visit_prot);
      then
        ((
          Absyn.CLASS(name,p,f,e,r,Absyn.PARTS(parts_1,str_opt),file_info),pa_1,args_1));
    case (Absyn.CLASS(name = name,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = str_opt),info = file_info),pa,visitor,args,visit_prot)
      local Option<Absyn.Path> pa;
      equation 
...
algorithm 
  (outString,outProgram,outCompiledFunctions):=
  matchcontinue (inComponentRef,inProgram,inCompiledFunctions)
    local
      ...
      list<CompiledCFunction> cf, newCF, newCF_1;
      Absyn.Within w;
    case (class_,(p as Absyn.PROGRAM(classes = clist,within_ = w)),cf)
      equation 
        ...
        newCF = removeAnySubFunctions(cpath,cdef,cf);
        (newp,newCF_1) = updateProgram(
          Absyn.PROGRAM({parentcdef_1},Absyn.WITHIN(parentparentcpath)), p, newCF);
      then
        ("true",newp,newCF_1);
    case (class_,(p as Absyn.PROGRAM(classes = clist,within_ = w)),cf)
      equation 
        ...
        parentcdef_1 = removeInnerClass(cdef, parentcdef);
        newCF = removeAnySubFunctions(cpath,cdef,cf);
        (newp, newCF_1) = updateProgram(Absyn.PROGRAM({parentcdef_1},Absyn.TOP()), p, newCF);
      then
        ("true",newp,newCF_1);
    case (class_,(p as Absyn.PROGRAM(classes = clist,within_ = w)),cf)
      equation 
        ...
        newCF = removeAnySubFunctions(cpath,cdef,cf);
      then
        ("true",Absyn.PROGRAM(clist_1,w),newCF);
    case (_,p,cf) then ("false",p,cf); 
  end matchcontinue;
end deleteClass;
...
algorithm 
  ...
  matchcontinue (inClass,inString)
    local
      ...
      Absyn.Restriction r;
      Absyn.Info info;
    case (Absyn.CLASS(name = id,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = cdef,info = info),cmt)
      equation 
...
algorithm 
  ...
  matchcontinue (inProgram1,inProgram2,inCompiledFunctions)
    local
      ...
      Absyn.ElementSpec elt;
      list<CompiledCFunction> cf, newCF, newCF_1;
    case (Absyn.PROGRAM(classes = {}),prg,cf) then (prg,cf); 
    case (Absyn.BEGIN_DEFINITION(path = Absyn.IDENT(name = name),restriction = restr,partial_ = p,encapsulated_ = e),oldp,cf)
      equation 
        ...
        (newp, newCF) = updateProgram(Absyn.PROGRAM({newclass},Absyn.TOP()), oldp, cf);
      then
        (newp, newCF);
    case (Absyn.BEGIN_DEFINITION(path = (path as Absyn.QUALIFIED(name = _)),restriction = restr,partial_ = p,encapsulated_ = e),oldp,cf)
      equation 
        ...
        (newp, newCF) = updateProgram(Absyn.PROGRAM({newclass},Absyn.WITHIN(w)), oldp, cf);
      then
        (newp, newCF);
    case (p1 as Absyn.PROGRAM(classes = ((c1 as Absyn.CLASS(name = name)) :: c2),within_ = (w as Absyn.TOP())),(p2 as Absyn.PROGRAM(classes = c3,within_ = w2)),cf)
      local Absyn.Within w;
      equation        
        //debug_print("name", name); 
        //Dump.dump(p1);        
        false = classInProgram(name, p2);
        (newp, newCF)  = updateProgram(Absyn.PROGRAM(c2,w), Absyn.PROGRAM((c1 :: c3),w2),cf);
      then
        (newp, newCF);
    case (p1 as Absyn.PROGRAM(classes = ((c1 as Absyn.CLASS(name = name)) :: c2),within_ = (w as Absyn.TOP())),p2,cf)
      local Absyn.Within w;
      equation 
        //debug_print("name", name);         
        //Dump.dump(p1);
        true = classInProgram(name, p2);
        (newp, newCF) = updateProgram(Absyn.PROGRAM(c2,w), p2, cf);
        (newp_1, newCF_1) = replaceClassInProgram(c1, newp, newCF);
      then
        (newp_1, newCF_1);
    case (Absyn.PROGRAM(classes = (c1 :: c2),within_ = (w as Absyn.WITHIN(path = path))),p2,cf)
      local Absyn.Within w;
      equation 
        newp = insertClassInProgram(c1, w, p2);
        (newp_1, newCF) = updateProgram(Absyn.PROGRAM(c2,w), newp, cf);
      then
        (newp_1, newCF);
    case (Absyn.COMP_DEFINITION(element = elt,insertInto = SOME((path as Absyn.QUALIFIED(_,_)))),p,cf)
      ...
      equation 
        ...
        (newp, newCF) = updateProgram(Absyn.PROGRAM({newcdef},Absyn.WITHIN(modelwithin)), p, cf);
      then
        (newp, newCF);
    case (Absyn.COMP_DEFINITION(element = elt,insertInto = SOME((path as Absyn.IDENT(_)))),p, cf)
      local Absyn.Program p;
      equation 
        ...
        newcdef = addToPublic(cdef, 
          ...
          Absyn.ELEMENT(false,NONE,Absyn.UNSPECIFIED(),"",elt,
          Absyn.INFO("",false,0,0,0,0),NONE)));
        (newp, newCF) = updateProgram(Absyn.PROGRAM({newcdef},Absyn.TOP()), p, cf);
      then
        (newp, newCF);
    case (Absyn.IMPORT_DEFINITION(importElementFor = elt,insertInto = SOME((path as Absyn.QUALIFIED(_,_)))),p,cf)
      local Absyn.Program p;
      equation 
      ...
      then
        (newp, newCF);
    case (Absyn.IMPORT_DEFINITION(importElementFor = elt,insertInto = SOME((path as Absyn.IDENT(_)))),p,cf)
      local Absyn.Program p;
      equation 
...
algorithm 
  (outProgram,outString):=
  matchcontinue (inString,inComponentRef,inProgram,inCompiledFunctions)
    local
      ...
      Absyn.Within w;
      list<CompiledCFunction> cf, newCF, newCF_1;
    case (name,model_,p,cf)
      equation 
        modelpath = Absyn.crefToPath(model_);
        failure(_ = getPathedClassInProgram(modelpath, p));
      then
        (p,cf,"false\n");
    case (name,(model_ as Absyn.CREF_QUAL(name = _)),(p as Absyn.PROGRAM(within_ = w)),cf)
      equation 
        modelpath = Absyn.crefToPath(model_);
        modelwithin = Absyn.stripLast(modelpath);
        cdef = getPathedClassInProgram(modelpath, p);
        (newcdef, newCF) = deleteComponentFromClass(name, cdef, cf);
        (newp, newCF_1) = updateProgram(Absyn.PROGRAM({newcdef},Absyn.WITHIN(modelwithin)), p, newCF);
      then
        (newp,newCF_1,"true\n");
    case (name,(model_ as Absyn.CREF_IDENT(name = _)),(p as Absyn.PROGRAM(within_ = w)),cf)
      equation 
        modelpath = Absyn.crefToPath(model_);
        cdef = getPathedClassInProgram(modelpath, p);
        (newcdef, newCF) = deleteComponentFromClass(name, cdef, cf);
        (newp, newCF_1) = updateProgram(Absyn.PROGRAM({newcdef},Absyn.TOP()), p, newCF);
      then
        (newp,newCF_1,"true\n");
    case (_,_,p,cf) then (p,cf,"false\n"); 
  end matchcontinue;
end deleteComponent;
...
"
  ...
  output list<CompiledCFunction> outCompiledFunctions;
algorithm 
  (outClass,outCompiledFunctions):=
  matchcontinue (inString,inClass,inCompiledFunctions)
    local
      ...
      Absyn.Info file_info;
      list<CompiledCFunction> cf, newCF;
    case (name,Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = Absyn.R_FUNCTION(),body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),cf)
      equation 
        publst = getPublicList(parts) "Search in public list" ;
        publst2 = deleteComponentFromElementitems(name, publst);
        newCF = removeCf(Absyn.IDENT(i), cf);
      ...
      then
        (Absyn.CLASS(i,p,f,e,Absyn.R_FUNCTION(),Absyn.PARTS(parts2,cmt),file_info),newCF);
    case (name,Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),cf)
      equation 
        publst = getPublicList(parts) "Search in public list" ;
        publst2 = deleteComponentFromElementitems(name, publst);
        l2 = listLength(publst2);
        ...
        parts2 = replacePublicList(parts, publst2);
      then
        (Absyn.CLASS(i,p,f,e,r,Absyn.PARTS(parts2,cmt),file_info),cf);
    case (name,Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = Absyn.R_FUNCTION(),body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),cf) /* Search in protected list */ 
      equation 
        protlst = getProtectedList(parts);
      ...
      then
        (Absyn.CLASS(i,p,f,e,Absyn.R_FUNCTION(),Absyn.PARTS(parts2,cmt),file_info),newCF);
    case (name,Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),cf) /* Search in protected list */ 
      equation 
        protlst = getProtectedList(parts);
        protlst2 = deleteComponentFromElementitems(name, protlst);
        l2 = listLength(protlst2);
  ...
  matchcontinue (inString1,inComponentRef2,inComponentRef3,inAbsynNamedArgLst4,inProgram5)
    ...
    case (name,tp,(model_ as Absyn.CREF_QUAL(name = _)),nargs,(p as Absyn.PROGRAM(within_ = w))) /* Adding component to model that resides inside package */ 
      equation 
        ...
        (newp,_) = updateProgram(Absyn.PROGRAM({newcdef},Absyn.WITHIN(modelwithin)), p, {});
      then
        (newp,"Ok\n");
    case (name,tp,(model_ as Absyn.CREF_IDENT(name = _)),nargs,(p as Absyn.PROGRAM(within_ = w))) /* Adding component to model that resides on top level */ 
      equation 
        ...
        newcdef = addToPublic(cdef, 
          ...
          {
          Absyn.COMPONENTITEM(Absyn.COMPONENT(name,{},modification),NONE,annotation_)}),Absyn.INFO("",false,0,0,0,0),NONE)));
        (newp,_) = updateProgram(Absyn.PROGRAM({newcdef},Absyn.TOP()), p, {});
      then
        (newp,"Ok\n");
    case (_,_,_,_,p) then (p,"Error"); 
  end matchcontinue;
...
"
  ...
  output String outString;
algorithm 
  (outProgram,outCompiledFunctions,outString):=
  matchcontinue (inString1,inComponentRef2,inComponentRef3,inAbsynNamedArgLst4,inProgram5,inCompiledFunctions)
    local
      ...
      Absyn.Within w;
      list<CompiledCFunction> cf, newCF, newCF_1;
    case (name,tp,(model_ as Absyn.CREF_QUAL(name = _)),nargs,(p as Absyn.PROGRAM(within_ = w)),cf)
      equation 
        modelpath = Absyn.crefToPath(model_) "Updating a public component to model that resides inside package" ;
        modelwithin = Absyn.stripLast(modelpath);
        (p_1,newCF,_) = deleteComponent(name, model_, p, cf);
        ...
        publst = getPublicList(parts);
        Absyn.ELEMENT(final_,repl,inout,id,Absyn.COMPONENTS(attr,Absyn.TPATH(tp,x),items),info,constr) = getElementContainsName(Absyn.CREF_IDENT(name,{}), publst);
    ...
    case (name,tp,(model_ as Absyn.CREF_QUAL(name = _)),nargs,(p as Absyn.PROGRAM(within_ = w)),cf)
      equation 
        ...
        cdef = getPathedClassInProgram(modelpath, p_1);
        protlst = getProtectedList(parts);
        Absyn.ELEMENT(final_,repl,inout,id,Absyn.COMPONENTS(attr,Absyn.TPATH(tp,x),items),info,constr) = getElementContainsName(Absyn.CREF_IDENT(name,{}), protlst);
        Absyn.COMPONENTITEM(Absyn.COMPONENT(_,_,mod),cond,ann) = getCompitemNamed(Absyn.CREF_IDENT(name,{}), items);
        annotation_ = annotationListToAbsynComment(nargs, ann);
        modification = modificationToAbsyn(nargs, mod);
      ...
      then
        (newp,newCF_1,"true");
    case (name,tp,(model_ as Absyn.CREF_IDENT(name = _)),nargs,(p as Absyn.PROGRAM(within_ = w)),cf)
      equation 
...
algorithm 
  (outProgram,outCompiledFunctions):=
  matchcontinue (inComponentRef,inAbsynNamedArgLst,inProgram,inCompiledFunctions)
    local
      Absyn.Path modelpath,modelwithin;
      Absyn.Class cdef,cdef_1;
      Absyn.Program newp,p;
      ...
      list<Absyn.NamedArg> nargs;
      list<CompiledCFunction> cf, newCF;
    case ((model_ as Absyn.CREF_QUAL(name = _)),nargs,p,cf)
      equation 
        modelpath = Absyn.crefToPath(model_) "Class inside other class" ;
        modelwithin = Absyn.stripLast(modelpath);
        cdef = getPathedClassInProgram(modelpath, p);
        cdef_1 = addClassAnnotationToClass(cdef, nargs);
        (newp,newCF) = updateProgram(Absyn.PROGRAM({cdef_1},Absyn.WITHIN(modelwithin)), p, cf);
      then
        (newp, newCF);
    case ((model_ as Absyn.CREF_IDENT(name = _)),nargs,p,cf)
      equation 
        modelpath = Absyn.crefToPath(model_) "Class on top level" ;
        cdef = getPathedClassInProgram(modelpath, p);
        cdef_1 = addClassAnnotationToClass(cdef, nargs);
        (newp, newCF) = updateProgram(Absyn.PROGRAM({cdef_1},Absyn.TOP()), p, cf);
      then
        (newp, newCF);
  end matchcontinue;
...
algorithm 
  ...
  matchcontinue (inClass,inAbsynNamedArgLst)
    ...
    case ((cdef as Absyn.CLASS(body = Absyn.PARTS(classParts = parts))),nargs)
      ...
      then
        cdef_1;
    case ((cdef as Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info)),nargs)
      equation 
        publst = getPublicList(parts);
...
algorithm 
  ...
  matchcontinue (inClass1,inClass2,inInteger3,inEnv4)
    ...
    case ((c as SCode.CLASS(name = _)),cdef,n,env)
      ...
      then
        str;
    case ((c as SCode.CLASS(name = id,encapsulated_ = encflag,restriction = restr)),cdef,n,env)
      equation 
...
algorithm 
  ...
  matchcontinue (inClass)
    local
      ...
      Option<String> cmt;
      Absyn.Info file_info;
    case Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PUBLIC(contents = elt) :: lst),comment = cmt),info = file_info)
      equation 
        c1 = countComponents(Absyn.CLASS(a,b,c,d,e,Absyn.PARTS(lst,cmt),file_info));
        c2 = countComponentsInElts(elt);
      then
        c1 + c2;
    case Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PROTECTED(contents = elt) :: lst),comment = cmt),info = file_info)
      equation 
        c1 = countComponents(Absyn.CLASS(a,b,c,d,e,Absyn.PARTS(lst,cmt),file_info));
        c2 = countComponentsInElts(elt);
      then
        c1 + c2;
    case Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (_ :: lst),comment = cmt),info = file_info)
      equation 
        res = countComponents(Absyn.CLASS(a,b,c,d,e,Absyn.PARTS(lst,cmt),file_info));
      then
        res;
    case Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = {})) then 0; 
    case Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.DERIVED(typeSpec = _)) then -1; 
  end matchcontinue;
end countComponents;
  ...
  matchcontinue (inComponentRef1,inComponentRef2,inComponentRef3,inAbsynNamedArgLst4,inProgram5)
    ...
    case ((model_ as Absyn.CREF_IDENT(name = _)),c1,c2,{},(p as Absyn.PROGRAM(within_ = w)))
      equation 
        ...
        (newp,_) = updateProgram(Absyn.PROGRAM({newcdef},w), p, {});
      then
        ("Ok",newp);
    case ((model_ as Absyn.CREF_QUAL(name = _)),c1,c2,{},(p as Absyn.PROGRAM(within_ = w)))
      equation 
        ...
        newcdef = addToEquation(cdef, Absyn.EQUATIONITEM(Absyn.EQ_CONNECT(c1,c2),NONE));
        (newp,_) = updateProgram(Absyn.PROGRAM({newcdef},Absyn.WITHIN(package_)), p, {});
      then
        ("Ok",newp);
...
algorithm 
  ...
  matchcontinue (inClass1,inComponentRef2,inComponentRef3)
    ...
    case (Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),c1,c2)
      equation 
...
algorithm 
  ...
  matchcontinue (inClass,inComponentRef,inString)
    ...
    case (Absyn.CLASS(name = name,partial_ = p,final_ = f,encapsulated_ = e,restriction = restr,body = Absyn.PARTS(classParts = parts,comment = pcmt),info = info),cr1,cmt)
      equation 
...
algorithm 
  ...
  matchcontinue (inClass1,inComponentRef2,inComponentRef3,inString4)
    local
      ...
      Absyn.Info info;
      Absyn.ComponentRef cr1,cr2;
    case (Absyn.CLASS(name = name,partial_ = p,final_ = f,encapsulated_ = e,restriction = restr,body = Absyn.PARTS(classParts = parts,comment = pcmt),info = info),cr1,cr2,cmt)
      equation 
...
algorithm 
  ...
  matchcontinue (inPath,inClass,inProgram,inInteger)
    local
      ...
      Option<String> cmt;
      Absyn.Info file_info;
    case (modelpath,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PUBLIC(contents = elt) :: lst))),p,n)
      equation 
        (str,tp) = getNthConnectorStr(p, modelpath, elt, n);
      then
        (str,tp);
    case (modelpath,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PUBLIC(contents = elt) :: lst),comment = cmt),info = file_info),p,n) /* The rule above failed, count the number of connectors in the first public list, subtract the number 
      ...
      then
        (str,tp);
    case (modelpath,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (_ :: lst),comment = cmt),info = file_info),p,n)
      equation 
        (str,tp) = getNthPublicConnectorStr(modelpath, 
...
algorithm 
  ...
  matchcontinue (inPath,inProgram,inClass)
    local
      ...
      Absyn.Info file_info;
      Absyn.Class cdef;
    case (modelpath,p,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PUBLIC(contents = elt) :: lst),comment = cmt),info = file_info))
      equation 
        c1 = countPublicConnectors(modelpath, p, 
      ...
      then
        c1 + c2;
    case (modelpath,p,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (_ :: lst),comment = cmt),info = file_info))
      equation 
        res = countPublicConnectors(modelpath, p, 
          Absyn.CLASS(a,b,c,d,e,Absyn.PARTS(lst,cmt),file_info));
      then
        res;
    case (modelpath,p,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = {},comment = cmt),info = file_info)) then 0; 
    case (modelpath,p,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.DERIVED(typeSpec = Absyn.TPATH(cname, _))))
      equation 
...
algorithm 
  ...
  matchcontinue (inPath,inProgram,inAbsynElementItemLst)
    ...
    case (modelpath,p,(Absyn.ELEMENTITEM(element = Absyn.ELEMENT(specification = Absyn.EXTENDS(path = tp),constrainClass = NONE)) :: lst))
      ...
      then
        c1 + c2;
    case (modelpath,p,(Absyn.ELEMENTITEM(element = Absyn.ELEMENT(specification = Absyn.COMPONENTS(typeSpec = Absyn.TPATH(tp, _),components = complst),constrainClass = NONE)) :: lst))
      equation 
        (Absyn.CLASS(_,_,_,_,Absyn.R_CONNECTOR(),_,_),newmodelpath) = lookupClassdef(tp, modelpath, p);
        c1 = listLength(complst);
        c2 = countConnectors(modelpath, p, lst);
...
algorithm 
  ...
  matchcontinue (inClass)
    local
      ...
      list<Absyn.ClassPart> lst;
      Absyn.Info file_info;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = {},comment = cmt))) then {}; 
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PUBLIC(contents = elts) :: lst),comment = cmt),info = file_info)) /* Search in public list */ 
      equation 
      ...
      then
        res;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PROTECTED(contents = elts) :: lst),comment = cmt),info = file_info)) /* Search in protected list */ 
      equation 
        lst1 = getComponentsInClass(Absyn.CLASS(a,b,c,d,e,Absyn.PARTS(lst,cmt),file_info));
        lst2 = getComponentsInElementitems(elts);
        res = listAppend(lst2, lst1);
...
algorithm 
  ...
  matchcontinue (inClass,inInteger)
    local
      ...
      Option<String> cmt;
      Absyn.Info file_info;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PUBLIC(contents = elt) :: lst),comment = cmt),info = file_info),n)
      equation 
      ...
      then
        res;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PUBLIC(contents = elt) :: rest),comment = cmt),info = file_info),n) /* The rule above failed, i.e the nth number is larger than # elements in first public list subtract and try next public list */ 
      equation 
      ...
      then
        res;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PROTECTED(contents = elt) :: lst),comment = cmt),info = file_info),n)
      equation 
        res = getNthComponentInElementitems(elt, n);
      then
        res;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (Absyn.PROTECTED(contents = elt) :: rest),comment = cmt),info = file_info),n) /* The rule above failed, i.e the nth number is larger than # elements in first public list subtract and try next public list */ 
      equation 
        c1 = countComponentsInElts(elt);
        newn = n - c1;
        (newn > 0) = true;
      ...
      then
        res;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = (_ :: lst),comment = cmt),info = file_info),n)
      equation 
        res = getNthComponentInClass(Absyn.CLASS(a,b,c,d,e,Absyn.PARTS(lst,cmt),file_info), n);
      then
        res;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = {},comment = cmt),info = file_info),_) then fail(); 
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.DERIVED(typeSpec = _),info = file_info),_) then fail(); 
  end matchcontinue;
...
algorithm 
  ...
  matchcontinue (inAbsynElementItemLst,inInteger)
    local
      ...
      list<Absyn.ComponentItem> lst;
      list<Absyn.ElementItem> rest;
    case ((Absyn.ELEMENTITEM(element = Absyn.ELEMENT(final_ = a,redeclareKeywords = b,innerOuter = c,name = d,specification = Absyn.COMPONENTS(attributes = e,typeSpec = f,components = (elt :: _)),info = info,constrainClass = i)) :: _),1) then Absyn.ELEMENT(a,b,c,d,Absyn.COMPONENTS(e,f,{elt}),info,i); 
    case ((Absyn.ELEMENTITEM(element = Absyn.ELEMENT(specification = Absyn.COMPONENTS(components = lst))) :: rest),n)
      ...
      then
        res;
    case ((Absyn.ELEMENTITEM(element = (elt as Absyn.ELEMENT(final_ = a,redeclareKeywords = b,innerOuter = c,name = d,specification = Absyn.COMPONENTS(attributes = e,typeSpec = f,components = lst),info = info,constrainClass = i))) :: rest),n)
      equation 
        numcomps = listLength(lst);
        (n <= numcomps) = true;
        n_1 = n - 1;
...
algorithm 
  ...
  matchcontinue (inElement,inEnv)
    local
      ...
      Absyn.InnerOuter inout;
      Absyn.ElementAttributes attr;
    case (Absyn.ELEMENT(final_ = f,redeclareKeywords = r,innerOuter = inout,specification = Absyn.COMPONENTS(attributes = attr,typeSpec = Absyn.TPATH(p, _),components = lst)),env)
      equation 
        (_,c,env_1) = Lookup.lookupClass(Env.emptyCache,env, p, true);
        SOME(envpath) = Env.getEnvPath(env_1);
        tpname = Absyn.pathLastIdent(p);
...
algorithm 
  ...
  matchcontinue (inClass,inElementItem)
    ...
    case (Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),eitem)
      equation 
        publst = getPublicList(parts);
      ...
      then
        Absyn.CLASS(i,p,f,e,r,Absyn.PARTS(parts2,cmt),file_info);
    case (Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.DERIVED(typeSpec = _),info = file_info),eitem) then fail(); 
    case (Absyn.CLASS(name = i,partial_ = p,final_ = f,encapsulated_ = e,restriction = r,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info),eitem) then Absyn.CLASS(i,p,f,e,r,
...
algorithm
  ...
  matchcontinue (inWithin,inPath)
    ...
    case (Absyn.WITHIN(path = p),p1)
      equation
        p2 = Absyn.joinPaths(p, p1);
      then
        p2;       
  end matchcontinue;    
end buildPath;
...
algorithm 
  (outProgram, outCompiledFunctions) :=
  matchcontinue (inClass,inProgram,inCompiledFunctions)
    local
      Absyn.Class c,c1;
      Absyn.Within w;
      String name1,name2;
      ...
      list<CompiledCFunction> cf, newCF;
      Absyn.Path cp; 
    case (c,Absyn.PROGRAM(classes = {},within_ = w),cf) then (Absyn.PROGRAM({c},w),cf);
    case ((c as Absyn.CLASS(name = name1)),Absyn.PROGRAM(classes = (Absyn.CLASS(name = name2, restriction = Absyn.R_FUNCTION()) :: clst),within_ = w),cf)
      equation 
        equality(name1 = name2);
        cp = buildPath(w, Absyn.IDENT(name2));
        newCF = removeCf(cp, cf);
      then
        (Absyn.PROGRAM((c :: clst),w),newCF);
    case ((c as Absyn.CLASS(name = name1)),Absyn.PROGRAM(classes = ((c1 as Absyn.CLASS(name = name2)) :: clst),within_ = w),cf)
      equation 
        equality(name1 = name2);        
        cp = buildPath(w, Absyn.IDENT(name2));
        newCF = removeAnySubFunctions(cp, c1, cf);
      then
        (Absyn.PROGRAM((c :: clst),w),newCF);
    case ((c as Absyn.CLASS(name = name1)),Absyn.PROGRAM(classes = ((c1 as Absyn.CLASS(name = name2)) :: clst),within_ = w),cf)
      equation 
        failure(equality(name1 = name2));
        (Absyn.PROGRAM(newclst,w),newCF) = replaceClassInProgram(c, Absyn.PROGRAM(clst,w), cf);
      then
        (Absyn.PROGRAM((c1 :: newclst),w),newCF);
    case (c,p,_)
      equation 
  ...
  matchcontinue (inClass,inWithin,inProgram)
    ...
    case (c1,(w as Absyn.WITHIN(path = Absyn.QUALIFIED(name = n1))),p)
      equation 
        ...
        (pnew,_) = updateProgram(Absyn.PROGRAM({c3},Absyn.TOP()), p, {});
      then
        pnew;
...
algorithm 
  ...
  matchcontinue (inClass1,inClass2)
    local
      ...
      Option<String> cmt;
      Absyn.Info file_info;
    case (c1,Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = parts,comment = cmt),info = file_info))
      equation 
        publst = getPublicList(parts);
...
algorithm 
  ...
  matchcontinue (inClass)
    local
      ...
      Option<String> cmt;
      Absyn.Info file_info;
    case (Absyn.CLASS(name = a,partial_ = b,final_ = c,encapsulated_ = d,restriction = e,body = Absyn.PARTS(classParts = parts,comment = cmt),info = (file_info as Absyn.INFO(fileName = file))))
      equation 
        publst = getPublicList(parts);
...
algorithm
  outElementItems := matchcontinue(inPublicElItems, inProtectedElItems)
    ...
    then 
      Absyn.PUBLIC(publicElements)::{Absyn.PROTECTED(protectedElements)};
  end matchcontinue;
...
"@author adrpo
 ...
 - if not, load it, add the info to cache"
  input String fileName                   "Filename to load";
  input list<LoadedFile> loadedFiles      "The already loaded files";
  input list<CompiledCFunction> compiledFunctions "Compiled functions from the symboltable";
  ...
  output list<CompiledCFunction> newCompiledFunctions "The new compiled functions to put in the symboltable";
  output Absyn.Program newAst             "The new program to put it in the symboltable"; 
algorithm
  (topClassNamesQualified, newLoadedFiles, newCompiledFunctions, newAst) := 
  matchcontinue (fileName, loadedFiles, compiledFunctions, ast, shouldUpdateProgram)
    local
      String f;
      String topNamesStr;
    ...
    case (f, lf, cf, pAst, _)
      ...
      then
        (topNamesStr, lf, cf, pAst); // not worth loading 
        
    case (f, lf, cf, pAst, true)
      equation 
        ...
        (newP, newCF) = updateProgram(parsed, pAst, cf);
      ...
      then
        (topNamesStr, newLF, newCF, newP); // loading
        
    case (f, lf, cf, pAst, false)
      equation 
        // it seems the file was not loaded yet or the one on the disk is newer
        NONE = getLoadedFileInfo(f, lf);
        // fall back to basis :)
        ...
        newLF = updateLoadedFiles(f, lf, topNamesStr, {});
      then
        (topNamesStr, newLF, cf, pAst); // loading
        
    case (f, lf, cf, pAst, _)
      equation          
        failure(p1 = Parser.parse(f)); // failed to parse!
      then
        ("error",lf,cf,pAst); // return error    
  end matchcontinue;
...
algorithm
  (topClassNamesQualified, newst) := matchcontinue (fileName, st)
    ...
    case (file, s as SYMBOLTABLE(pAst,eAst,ic,iv,cf,lf))
      equation
        (topNamesStr,newLF,newCF,newP) = checkLoadedFiles(file, lf, cf, pAst, true);
      then
        (topNamesStr, SYMBOLTABLE(newP,eAst,ic,iv,newCF,lf));        
  end matchcontinue;
...
algorithm
  (topClassNamesQualified, newst) := matchcontinue (fileName, st)
    ...
    case (file, s as SYMBOLTABLE(pAst,eAst,ic,iv,cf,lf))
      equation
        (topNamesStr,newLF,newCF,newP) = checkLoadedFiles(file, lf, cf, pAst, false);
      then
