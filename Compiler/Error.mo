...
protected constant list<tuple<Integer, MessageType, Severity, String>> errorTable={(SYNTAX_ERROR,SYNTAX(),ERROR(),"Syntax error near: %s"),
          ...
          "Attempt to assign to a constant component in %s := %s."),
          (ASSIGN_PARAM_ERROR,TRANSLATION(),ERROR(),
          "Attempt to assign to a parameter component in %s := %s."),
          (ASSIGN_READONLY_ERROR,TRANSLATION(),ERROR(),
          "Attempt to assign to a read-only component in %s := %s."),
          (ASSIGN_TYPE_MISMATCH_ERROR,TRANSLATION(),ERROR(),
          "Type mismatch in assignment %s := %s of %s := %s."),
          ...
          "'end' cannot be used outside array subscripts."),
          ...
          "Failed reading simulation result."),
          (SCRIPT_READ_SIM_RES_SIZE_ERROR,SCRIPTING(),ERROR(),
          "Failed reading simulation result size."),
          ...
          "In type %s: Types can only extend predefined types or classes extending from types."),
          (EQUATION_IN_RECORD,TRANSLATION(),ERROR(),
          "In class %s: Equations not allowed within records."),
          (EQUATION_IN_CONNECTOR,TRANSLATION(),ERROR(),
          "In class %s: Equations not allowed within connectors."),
          ...
          "Different number of equations in branches of if equation: %s"),
          (UNSUPPORTED_LANGUAGE_FEATURE,TRANSLATION(),ERROR(),
          "Language feature %s not supported. Suggested workaround: %s"),
          ...
          "Model structurally singular, the following connectors are not connected from the outside: %s."),
          (NON_EXISTING_DERIVATIVE,SYMBOLIC(),ERROR(),
          "Derivative of expression %s non-existent."),
          ...
          "Attempt to redeclare class %s as a variable."),
          (REDECLARE_NON_REPLACEABLE,TRANSLATION(),ERROR(),
          "Attempt to redeclare class %s but class not declared as repleacable."),
          (COMPONENT_INPUT_OUTPUT_MISMATCH,TRANSLATION(),ERROR(),
          "Component declared as %s but variable %s declared as input."),
          ...
          "Array dimension must be integer expressions in %s which has type %s."),
          ...
          "Array equation of unknown size in %s."),
          ...
          "Incorrect type on %s, expected %s."),
          ...
          "%s is not a package. Imports are only allowed for packages."),
          ...
          "Variable %s in package %s not a constant."),
          ...
          "Function \"sum\" has a scalar as argument in sum(%s)."),
          (BUILTIN_FUNCTION_PRODUCT_HAS_SCALAR_PARAMETER,TRANSLATION(),WARNING(),
          "Function \"product\" has a scalar as argument in sum(%s)."),
          ...
          "The same variables must be solved in the elsewhen clause as in the when clause."),
          ...
          "Using non-standardized function %s. For full conformance with language specification, use appropriate function from the Modelica standard library."),
...
*/
          ...
          "Attempt to override final variable in class %s."),
          ...
          (INCOMPLETE_UNITS, TRANSLATION(),NOTIFICATION(),"The system of units is incomplete. Please provide unit information to the class, for instance by using types from the Modelica.SIunits package."),
          (IF_EQUATION_NO_ELSE, TRANSLATION(),ERROR(),"In equation %s: If-equation with conditions that are not parameter expressions must have an else branch."),
