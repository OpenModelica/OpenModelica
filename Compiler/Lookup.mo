  ...
  matchcontinue (inCache,inBinTree1,inBinTree2,inEnv3,inIdent4)
    ...
    case (cache,ht,httypes,env,id) local SCode.Restriction restr;
      equation 
        ...
        (cache,env_1,_) = 
        Inst.implicitFunctionTypeInstantiation(cache,cenv,InstanceHierarchy.emptyInstanceHierarchy,cdef);
  ...
  matchcontinue (inCache,inSCodeElementLst,mods,inEnv)
    ...
    case (cache,((comp as SCode.COMPONENT(component = n)) :: rest),mods,env)
      equation 
        ...
        (cache,_,var) = 
        Inst.instRecordConstructorElt(cache,env,InstanceHierarchy.emptyInstanceHierarchy, comp,compMod, true) 
