...
encapsulated package GraphMLNew
" file:        GraphMLNew
  package:     GraphMLNew
  description: GraphMLNew contains functions to generate a gaphML file for yED. The implementation is based on the GraphML-Package of Jens Frenkel.


  RCS: $Id: GraphMLNew 2014-02-04 mwalther $
"
