...
encapsulated package HashTableUnitToString "
  ...
  RCS: $Id: HashTableUnitToString.mo 15213 2013-02-18 10:17:07Z petar $
...
"
  ...
  output HashTable hashTable;
algorithm
  hashTable := BaseHashTable.emptyHashTableWork(size,(Unit.hashUnitMod,Unit.unitEqual,Unit.unit2string,id));
end emptyHashTableSized;

annotation(__OpenModelica_Interface="backend");
end HashTableUnitToString;
