...
constant ConfigFlag PRE_OPT_MODULES = CONFIG_FLAG(12, "preOptModules",
  ...
  SOME(STRING_DESC_OPTION({
    ("removeSimpleEquations", "DESCRIBE ME"),
    ("inlineArrayEqn", "DESCRIBE ME"),
    ("removeFinalParameters", "DESCRIBE ME"),
    ...
    ("partitionIndependentBlocks", "DESCRIBE ME"),
    ("collapseIndependentBlocks", "DESCRIBE ME"),
    ("expandDerOperator", "DESCRIBE ME"),
    ("residualForm", "DESCRIBE ME")})),
...
constant ConfigFlag POST_OPT_MODULES = CONFIG_FLAG(14, "postOptModules",
  ...
  SOME(STRING_DESC_OPTION({
    ...
    ("inlineArrayEqn", "DESCRIBE ME"),
    ("removeUnusedParameter", "DESCRIBE ME"),
    ("constantLinearSystem", "DESCRIBE ME"),
