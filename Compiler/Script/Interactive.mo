...
algorithm
  ...
  matchcontinue (inValue,inExp,inAbsynAlgorithmItemLst,inTplAbsynExpAbsynAlgorithmItemLstLst,inSymbolTable,info)
    ...
    case (Values.BOOL(boolean = false),_,algitemlst,algrest,st,_)
      equation
...
algorithm
  ...
  (_, sexp, prop) := CevalScript.cevalIfConstant(Env.emptyCache(), env, sexp, prop, true, Absyn.dummyInfo, 0);
...
algorithm
  ...
  matchcontinue (inClass1,inComponentRef2,inComponentRef3)
    ...
    case (Absyn.CLASS(name = name,partialPrefix = partialPrefix,finalPrefix = finalPrefix,encapsulatedPrefix = encapsulatedPrefix,restriction = restriction,
          body = Absyn.PARTS(typeVars = typeVars,classAttrs = classAttrs,classParts = parts,comment = a),info = file_info),old_comp,new_comp)
      equation
        parts_1 = renameComponentInParts(parts, old_comp, new_comp);
      then
        Absyn.CLASS(name,partialPrefix,finalPrefix,encapsulatedPrefix,restriction,Absyn.PARTS(typeVars,classAttrs,parts_1,a),file_info);
...
algorithm
  ...
  match (inClass1,inString2,inFinal,inFlow,inStream,inProtected,inReplaceable,inString6,inString7,inBooleanLst8,inString9)
    ...
    case (Absyn.CLASS(name = id,
      ...
      then
        Absyn.CLASS(id,p,f,e,r,Absyn.PARTS(typeVars,classAttrs,parts_1,cmt),file_info);
...
algorithm
  ...
  match (inClass,inPath,inComponentRef,inModification,inEnv)
    ...
    case (Absyn.CLASS(name = id,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
                      body = Absyn.PARTS(typeVars = typeVars,classAttrs = classAttrs,classParts = parts,comment = cmt),info = file_info),
...
algorithm
  outAbsynComponentItemLst := matchcontinue (inAbsynComponentItemLst,inIdent,inPath,inModification)
    ...
    // remove modifier.
    case ((Absyn.COMPONENTITEM(component = Absyn.COMPONENT(name = id,arrayDim = dim,modification = SOME(Absyn.CLASSMOD(args,_))),condition = cond,comment = cmt) :: rest),varname,Absyn.IDENT(""),mod)
      equation
    ...
    // remove modifier.
    case ((Absyn.COMPONENTITEM(component = Absyn.COMPONENT(name = id,arrayDim = dim,modification = NONE()),condition = cond,comment = cmt) :: rest),varname,Absyn.IDENT(""),mod)
      equation
        true = stringEq(varname, id);
      then
...
algorithm
  ...
  matchcontinue (inAbsynElementArgLst,inPath,inModification)
    ...
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = (p as Absyn.IDENT(name = name)),comment = cmt,modification=SOME(Absyn.CLASSMOD((submods as _::_),_)), info = info) :: rest),Absyn.IDENT(name = submodident),(mod as Absyn.CLASSMOD( {},Absyn.NOMOD())))
      equation
    ...
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = Absyn.IDENT(name = name),comment = cmt,modification=SOME(Absyn.CLASSMOD({},_)), info = info) :: rest),Absyn.IDENT(name = submodident),(mod as Absyn.CLASSMOD( {},Absyn.NOMOD())))
      equation
        true = stringEq(name, submodident);
      then
        rest;
    ...
    // modfication, m=e
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = Absyn.IDENT(name = name),modification=SOME(Absyn.CLASSMOD(submods,_)),comment = cmt, info = info) :: rest),Absyn.IDENT(name = submodident),(mod as Absyn.CLASSMOD({},eqMod as Absyn.EQMOD(exp=_)))) /* update modification */
      equation
        true = stringEq(name, submodident);
      then
    ...
    // modfication, m(...)=e
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = Absyn.IDENT(name = name),modification=mod2,comment = cmt, info = info) :: rest),Absyn.IDENT(name = submodident),mod) /* update modification */
      equation
        true = stringEq(name, submodident);
      then
    ...
    // Clear modification, m.n
     case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = (p1 as Absyn.QUALIFIED(name = _)),comment = cmt) :: rest),p2,Absyn.CLASSMOD({},Absyn.NOMOD()))
      equation
    ...
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = Absyn.QUALIFIED(name = name1),comment = cmt) :: rest),p as Absyn.IDENT(name = name2),Absyn.CLASSMOD({},Absyn.NOMOD()))
      equation
...
algorithm
  ...
  matchcontinue (inAbsynElementArgLst)
    ...
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = Absyn.IDENT(name = name),modification = NONE(),comment = cmt) :: rest))
      ...
      then
        (name :: names);
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = p,modification = SOME(Absyn.CLASSMOD({},_)),comment = cmt) :: rest))
      equation
    ...
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = p,modification = SOME(Absyn.CLASSMOD(args,Absyn.EQMOD(exp=_))),comment = cmt) :: rest))
      equation
        name = Absyn.pathString(p);
    ...
    case ((Absyn.MODIFICATION(finalPrefix = f,eachPrefix = each_,path = p,modification = SOME(Absyn.CLASSMOD(args,_)),comment = cmt) :: rest))
      equation
        name = Absyn.pathString(p);
        names2 = getModificationNames(args);
        names2_1 = List.map1r(names2, stringAppend, ".");
...
algorithm
  (outClass, outChangeMade) := match (inClass,inIdent,inExp)
    ...
    case (Absyn.CLASS(name = id,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
      ...
      then
        (Absyn.CLASS(id,p,f,e,r,Absyn.PARTS(typeVars,classAttrs,parts_1,cmt),file_info), b);
...
algorithm
  ...
  matchcontinue (inClass1,inPath2,inPath3,inEnv4)
    ...
    case (Absyn.CLASS(name = name,partialPrefix = partialPrefix,finalPrefix = finalPrefix,encapsulatedPrefix = encapsulatedPrefix,restriction = restriction,
                      body = Absyn.PARTS(typeVars = typeVars,classAttrs = classAttrs,classParts = parts,comment = comment),info = file_info),old_comp,new_comp,env)
      equation
        (parts_1,changed) = renameClassInParts(parts, old_comp, new_comp, env);
      then
        (Absyn.CLASS(name,partialPrefix,finalPrefix,encapsulatedPrefix,restriction,Absyn.PARTS(typeVars,classAttrs,parts_1,comment),file_info),changed);
...
algorithm
  ...
  matchcontinue (inClass,inAbsynPathOption,inFuncTypeTplAbsynClassAbsynPathOptionTypeAToTplAbsynClassAbsynPathOptionTypeA,inTypeA,inBoolean)
    ...
    case (Absyn.CLASS(name = name,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
                      body = Absyn.PARTS(typeVars = typeVars, classAttrs = classAttrs, classParts = parts,comment = str_opt),info = file_info),
      ...
      then
        ((Absyn.CLASS(name,p,f,e,r,Absyn.PARTS(typeVars,classAttrs,parts_1,str_opt),file_info),pa_1,args_1));
...
algorithm
  ...
  matchcontinue (inClassDef,inString)
    local
      ...
      list<String> typeVars;
      list<Absyn.NamedArg> classAttrs;
    case (Absyn.PARTS(typeVars=typeVars,classAttrs=classAttrs,classParts = p),"") then Absyn.PARTS(typeVars,classAttrs,p,NONE());
    case (Absyn.PARTS(typeVars=typeVars,classAttrs=classAttrs,classParts = p),strcmt) then Absyn.PARTS(typeVars,classAttrs,p,SOME(strcmt));
...
algorithm
  outAbsynElementArgLst := matchcontinue (inAbsynElementArgLst,inPath)
    ...
    case ({Absyn.MODIFICATION(path = Absyn.IDENT(name = id1))},Absyn.IDENT(name = id2))
      equation
        true = stringEq(id1, id2);
      then
        {};

    case ({(m as Absyn.MODIFICATION(path = Absyn.IDENT(name = id1)))},Absyn.IDENT(name = id2))
      equation
        false = stringEq(id1, id2);
      then
        fail();

    case ((Absyn.MODIFICATION(path = Absyn.IDENT(name = id1)) :: xs),Absyn.IDENT(name = id2))
      equation
        true = stringEq(id1, id2);
    ...
    case (((m as Absyn.MODIFICATION(path = Absyn.IDENT(name = id1))) :: xs),Absyn.IDENT(name = id2))
      equation
        false = stringEq(id1, id2);
        res = removeModificationInElementargs(xs, inPath);
      then
...
algorithm
  (outString, annotationOpt) := matchcontinue (inModelPath,inInteger,inClass,inProgram)
    ...
    */
    ...
    case (modelpath,n,_,p) /* if above fails, baseclass not defined. return its name */
      equation
        cdef = inClass;
        extends_ = getExtendsInClass(cdef);
        n_1 = n - 1;
...
algorithm
  outString := matchcontinue (inAbsynElementArgLst, inMapType, inClass, inFullProgram, inModelPath)
    ...
    case ((ann as Absyn.MODIFICATION(path = Absyn.IDENT(name = mapType),modification = mod)) :: _,_,
          _, _, _)
      equation
...
algorithm
  ...
  match (inClass1,inComponentRef2,inComponentRef3)
    ...
    case (Absyn.CLASS(name = i,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
                      body = Absyn.PARTS(typeVars = typeVars,classAttrs = classAttrs,classParts = parts,comment = cmt),info = file_info),c1,c2)
      equation
...
algorithm
  outClass := match (inClass,inComponentRef,inString)
    ...
    case (Absyn.CLASS(name = name,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = restr,
                      body = Absyn.PARTS(typeVars = typeVars,classAttrs = classAttrs,classParts = parts,comment = pcmt),info = info),cr1,cmt)
      equation
        parts_1 = setComponentCommentInParts(parts, cr1, cmt);
      then
        Absyn.CLASS(name,p,f,e,restr,Absyn.PARTS(typeVars,classAttrs,parts_1,pcmt),info);
    /* an extended class with parts: model extends M end M; */
    case (Absyn.CLASS(name = name,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = restr,
...
algorithm
  ...
  match (inClass1,inComponentRef2,inComponentRef3,inString4)
    ...
    /* a class with parts */
    case (Absyn.CLASS(name = name,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = restr,
                      body = Absyn.PARTS(typeVars = typeVars,classAttrs = classAttrs,classParts = parts,comment = pcmt),info = info),cr1,cr2,cmt)
      equation
...
algorithm
  outString := matchcontinue (inAbsynElementArgLst, annotationType, inClass, inProgram, inModelPath)
    ...
    case (((ann as Absyn.MODIFICATION(path = Absyn.IDENT(name = ann_name),modification = mod)) :: _), _, c, fullProgram, p)
      equation
        isAnnotationType(ann_name, annotationType);
...
algorithm
  outString := matchcontinue (inClass,id,f)
    ...
    case (Absyn.CLASS(body = Absyn.PARTS(classParts = parts)),_,_)
      equation
        SOME(str) = getNamedAnnotationInParts(parts,id,f);
      then
        SOME(str);

    case (Absyn.CLASS(body = Absyn.CLASS_EXTENDS(parts = parts)),_,_)
      equation
        SOME(str) = getNamedAnnotationInParts(parts,id,f);
      then
        SOME(str);
...
algorithm
  outString := matchcontinue (inAbsynClassPartsLst,id,f)
    ...
    // search in public
    case (Absyn.PUBLIC(contents)::rest, _, _)
      equation
    ...
    // search in protected
    case (Absyn.PROTECTED(contents)::rest, _, _)
      equation
        SOME(str) = getNamedAnnotationInElItems(contents,id,f);
      then
        SOME(str);
    ...
    // search in equations
    case (Absyn.EQUATIONS(eqItems)::rest, _, _)
      equation
    ...
    case (Absyn.INITIALEQUATIONS(eqItems)::rest, _, _)
      equation
        SOME(str) = getNamedAnnotationInEquItems(eqItems,id,f);
      then
        SOME(str);
    ...
    case (Absyn.ALGORITHMS(alItems)::rest, _, _)
      equation
    ...
    case (Absyn.INITIALALGORITHMS(alItems)::rest, _, _)
      equation
        SOME(str) = getNamedAnnotationInAlgItems(alItems,id,f);
      then
        SOME(str);
    ...
    case (Absyn.EXTERNAL(annotation_ = SOME(Absyn.ANNOTATION(elArgs)))::rest, _, _)
      equation
...
algorithm
  outString := matchcontinue (inAbsynElementItemLst,id,f)
    ...
    case ((Absyn.ANNOTATIONITEM(annotation_ = Absyn.ANNOTATION(elementArgs = annlst)) :: _),_,_)
      equation
...
algorithm
  outString := matchcontinue (inAbsynEquItemLst,id,f)
    ...
    case (Absyn.EQUATIONITEMANN(annotation_ = Absyn.ANNOTATION(elementArgs = annlst)) :: _, _, _)
      equation
        SOME(s1) = getNamedAnnotationStr(annlst,id,f);
      then
        SOME(s1);
...
algorithm
  outString := matchcontinue (inAbsynAlgItemLst,id,f)
    ...
    case (Absyn.ALGORITHMITEMANN(annotation_ = Absyn.ANNOTATION(elementArgs = annlst)) :: _, _, _)
      equation
        SOME(s1) = getNamedAnnotationStr(annlst,id,f);
      then
        SOME(s1);
  ...
  outStringLst := matchcontinue (inElArgLst,info,inClass,inFullProgram,inModelPath)
    ...
    case (Absyn.MODIFICATION(path = Absyn.IDENT(annName), modification = SOME(Absyn.CLASSMOD(mod,_))) :: rest,_,_, _, _)
      equation
        ...
        (cache, newexp, prop) = CevalScript.cevalIfConstant(cache, env, newexp, prop, false, info, 0);
      ...
      then
        (gexpstr :: res);
    case (Absyn.MODIFICATION(path = Absyn.IDENT(annName), modification = SOME(Absyn.CLASSMOD(mod,Absyn.NOMOD()))) :: rest,_,_,_,_)
      equation
...
algorithm
  outStringLst := matchcontinue (inElArgLst,inEnv,inClass,inFullProgram,inModelPath)
    ...
    case (Absyn.MODIFICATION(path = Absyn.IDENT(annName),
        modification = SOME(Absyn.CLASSMOD(mod,Absyn.NOMOD()))) :: rest,env,_,_,_)
      equation
        gexpstr_1 = stringAppendList({annName,"(error)"});
        res = getComponentitemsAnnotationsElArgs(rest, env, inClass,inFullProgram,inModelPath);
      then
...
algorithm
  outStringLst := match (inAbsynComponentItemLst,inEnv,inClass,inFullProgram,inModelPath)
    ...
    case ({Absyn.COMPONENTITEM(comment = NONE())},env,_,_,_)
      then
        {"{}"};
  ...
  outString := matchcontinue (inAnnotation,inClass,inFullProgram,inModelPath)
    ...
    case (Absyn.ANNOTATION(elementArgs = {Absyn.MODIFICATION(path = Absyn.IDENT(name = "Icon"),modification = SOME(Absyn.CLASSMOD(mod,_)), info = info)}),
      ...
      equation
        ...
        (cache, graphicexp2, prop) = CevalScript.cevalIfConstant(cache, env, graphicexp2, prop, false, Absyn.dummyInfo, 0);
...
algorithm
  (outAbsynElementArgLst1,outAbsynElementArgLst2) := matchcontinue (inAbsynElementArgLst)
    ...
    case (((mod as Absyn.MODIFICATION(modification = _, path = Absyn.IDENT(name = "interaction"))) :: rest))
      equation
    ...
    case (((mod as Absyn.MODIFICATION(modification = NONE(), path = Absyn.IDENT(name = "graphics"))) :: rest))
      equation
         (l1,l2) = stripGraphicsAndInteractionModification(rest);
      then
        (l1,l2);
...
algorithm
  ...
  matchcontinue (inClass,inElementItem)
    ...
    case (Absyn.CLASS(name = i,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
                      ...
                      info = file_info),eitem)
      then
        Absyn.CLASS(i,p,f,e,r,Absyn.PARTS(typeVars,classAttrs,(Absyn.PUBLIC({eitem}) :: parts),cmt),file_info);
    /* adrpo: handle also the case model extends X end X; */
    case (Absyn.CLASS(name = i,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
...
algorithm
  ...
  matchcontinue (inClass,inElementItem)
    ...
    case (Absyn.CLASS(name = i,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
                      body = Absyn.PARTS(typeVars = typeVars,classAttrs = classAttrs,classParts = parts,comment = cmt),
                      info = file_info),eitem)
      then Absyn.CLASS(i,p,f,e,r,Absyn.PARTS(typeVars,classAttrs,(Absyn.PROTECTED({eitem}) :: parts),cmt),file_info);
...
algorithm
  ...
  matchcontinue (inClass,inEquationItem)
    ...
    case (Absyn.CLASS(name = i,partialPrefix = p,finalPrefix = f,encapsulatedPrefix = e,restriction = r,
      ...
      then
        Absyn.CLASS(i,p,f,e,r,Absyn.PARTS(typeVars,classAttrs,newparts,cmt),file_info);
  ...
  matchcontinue (inClass1,inClass2)
    ...
    case (c1,Absyn.CLASS(name = a,partialPrefix = b,finalPrefix = c,encapsulatedPrefix = d,restriction = e,
      ...
      equation
        ...
        parts2 = replacePublicList(parts, publst2);
      then
        Absyn.CLASS(a,b,c,d,e,Absyn.PARTS(typeVars,classAttrs,parts2,cmt),file_info);
    /* an extended class with parts: model extends M end M; */
    case (c1,Absyn.CLASS(name = a,partialPrefix = b,finalPrefix = c,encapsulatedPrefix = d,restriction = e,
                         body = Absyn.CLASS_EXTENDS(baseClassName=bcname,modifications=modif,parts = parts,comment = cmt),info = file_info))
      equation
...
algorithm
  outCdef := matchcontinue(cdef)
    ...
    case(Absyn.PARTS(typeVars,classAttrs,parts,cmt))
      ...
      then
        Absyn.PARTS(typeVars,classAttrs,partsTransformed,cmt);
    /*
