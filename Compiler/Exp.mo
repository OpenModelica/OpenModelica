...
algorithm
  ...
  matchcontinue (inExp)
    ...
    case e
      equation
        Debug.fprintln("failtrace", "- Exp.typeof failed for " +& ExpressionDump.printExpStr(e));
      then fail();
  end matchcontinue;
end typeof;
...
algorithm
  ...
  matchcontinue (inExp,inFn)
   ...
   case (DAE.META_OPTION(SOME(e1)), fn)
    ...
    case (e,_)
      equation
        Debug.fprintln("failtrace", "- Exp.getMatchingExps failed: " +& ExpressionDump.printExpStr(e));
      then fail();
