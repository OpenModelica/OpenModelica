...
#define LDFLAGS_RT " -static-libgcc -luuid -lole32 -lws2_32 -lsundials_kinsol -lsundials_nvecserial -llapack-mingw"
...
#define CONFIG_VERSION "1.9.0 beta4+dev (r" CONFIG_REVISION ")"
#else
#define CONFIG_VERSION "1.9.0 beta4+dev"
#endif
