  ...
  matchcontinue (inDAElist1,inDAELow2,inIntegerArray3,inIntegerArray4)
    ...
    case (dae,dlow,ass1,ass2)
      equation
        ...
        deriveddlow1 = DAELow.generateSymbolicJacobian(dlow, dae, comref_states, ass1,ass2);
        ...
        deriveddlow1 = DAELow.generateSymbolicJacobian(dlow, dae, comref_inputvars, ass1,ass2);
