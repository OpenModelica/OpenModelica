...
algorithm
  outCrefs := match(inCr, inSubscripts, inAccumSubs, inAccumCrefs)
    ...
    case (_, (sub :: subs) :: rest_subs, acc_subs, crefs)
      equation
        crefs = expandArrayCref1(inCr, subs :: rest_subs, acc_subs, crefs);
        crefs = expandArrayCref1(inCr, rest_subs, sub :: acc_subs, crefs);
      then
        crefs;
