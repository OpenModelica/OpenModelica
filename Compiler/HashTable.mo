...
algorithm
  hashTable := BaseHashTable.emptyHashTableWork(1000,100,(HashTable2.hashFunc,ComponentReference.crefEqual,ComponentReference.printComponentRefStr,intString));
end emptyHashTable;
