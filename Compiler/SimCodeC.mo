  ...
  matchcontinue(in_txt, in_i_helpVarIndices, in_i_when_exp, in_i_varDecls, in_i_when_elseWhen)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_530(emptyTxt, i_when_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_529(emptyTxt, i_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_operator, in_i_context, in_i_exp, in_i_e2, in_i_e1, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_typeShort = fun_570(emptyTxt, i_ty);
  ...
  matchcontinue(in_txt, in_i_call, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_retVar, i_varDecls) = tempDecl(emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_cast = fun_588(emptyTxt, i_arg_ty);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_scalar)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_597(emptyTxt, i_scalar, i_e);
        txt = Tpl.writeText(txt, i_prefix);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_scalarPrefix = fun_595(emptyTxt, i_scalar);
        i_scalarRef = fun_596(emptyTxt, i_scalar);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varLstStr, in_i_arrayTypeStr, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_scalarStr = fun_602(emptyTxt, i_b);
        i_scalarRefStr = fun_603(emptyTxt, i_b);
  ...
  matchcontinue(in_txt, in_items, in_i_done, in_i_res, in_i_context, in_i_onPatternFail, in_i_prefix)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_caseRes, i_varDeclsCaseInner, i_preRes) = fun_631(emptyTxt, i_c_result, i_varDeclsCaseInner, i_preRes, i_context);
        ret_8 = SimCode.elementVars(i_c_localDecls);
        (i_0__, i_preExpCaseInner, i_varDeclsCaseInner) = lm_632(emptyTxt, ret_8, i_preExpCaseInner, i_varDeclsCaseInner);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("case "));
        txt = Tpl.writeStr(txt, intString(i_i0));
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(": {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_ignore2, i_preExpInner, i_varDeclsInner) = lm_623(emptyTxt, ret_6, i_preExpInner, i_varDeclsInner);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_argsStr, i_varDecls, i_preExp) = fun_647(emptyTxt, i_args, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_i_type, in_i_varname, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_args, i_varDecls, i_preExp) = fun_651(emptyTxt, i_varLst, i_varDecls, i_preExp, i_varname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("mmc_mk_box"));
...
algorithm
  ...
  matchcontinue(in_txt, in_i_pat, in_i_rhs, in_i_onPatternFail, in_i_varDecls, in_i_assignments)
    ...
    case ( txt,
      ...
      equation
        i_unboxBuf = emptyTxt;
        (i_urhs, i_varDecls, i_unboxBuf) = fun_691(emptyTxt, i_p_ty, i_varDecls, i_unboxBuf, i_rhs);
        txt = Tpl.writeText(txt, i_unboxBuf);
