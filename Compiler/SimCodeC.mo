...
algorithm
  ...
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_184(out_txt, i_functions);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       "#ifdef __cplusplus\n",
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        i_funArgsStr = lm_188(i_funArgsStr, i_funArgs);
        i_funArgsStr = Tpl.popIter(i_funArgsStr);
        ret_3 = RTOpts.acceptMetaModelicaGrammar();
        i_funArgsBoxedStr = fun_190(emptyTxt, ret_3, i_funArgs);
        ret_5 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedHeader = fun_191(emptyTxt, ret_5, i_funArgsBoxedStr, i_fname);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_192(txt, i_recordDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("#define "));
        txt = Tpl.writeText(txt, i_fname);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_194(out_txt, i_functions);
  out_txt := Tpl.popIter(out_txt);
end functionHeaders;
  ...
  matchcontinue(in_txt, in_i_recDecl)
    ...
    case ( txt,
      ...
      equation
        ...
        txt_2 = lm_197(txt_2, i_variables);
        txt_2 = Tpl.popIter(txt_2);
    ...
    case ( txt,
      ...
      equation
        ...
        txt_2 = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(",")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt_2 = lm_198(txt_2, i_fieldNames);
        txt_2 = Tpl.popIter(txt_2);
        txt = recordDefinition(txt, Tpl.textString(txt_0), Tpl.textString(txt_1), Tpl.textString(txt_2));
      then txt;
...
algorithm
  ...
  out_txt := fun_202(txt, ret_0, i_fname, i_fargs, i_outVars);
  ...
  matchcontinue(in_txt, in_items, in_i_boxStr, in_i_fname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeStr(txt, intString(i_i1));
        txt = Tpl.nextIter(txt);
        txt = lm_210(txt, rest, i_boxStr, i_fname);
      then txt;
  ...
  matchcontinue(in_txt, in_i_ty)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("["));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_212(txt, i_arrayDimensions);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("]"));
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_boxed)
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        i_dimStr = fun_213(emptyTxt, i_ty);
        i_typeStr = fun_214(emptyTxt, i_boxed, i_var);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_outVars, in_i_inFnStr, in_i_boxed, in_i_boxStr, in_i_fargsStr, in_i_fname, in_i_boxPtrStr)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_210(txt, i_outVars, i_boxStr, i_fname);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_215(txt, i_outVars, i_boxed);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("} "));
...
protected
  ...
  Tpl.Text i_fargsStr;
algorithm
  i_fargsStr := fun_206(emptyTxt, i_boxed, i_fargs);
  i_boxStr := fun_207(emptyTxt, i_boxed);
  i_boxPtrStr := fun_208(emptyTxt, i_boxed);
  i_inFnStr := fun_209(emptyTxt, i_boxed, i_fname);
  out_txt := fun_216(txt, i_outVars, i_inFnStr, i_boxed, i_boxStr, i_fargsStr, i_fname, i_boxPtrStr);
...
public function extFunctionName
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_222(txt, i_language, i_name);
end extFunctionName;
...
public function extFunDefArgs
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_226(txt, i_language, i_args);
end extFunDefArgs;
  ...
  matchcontinue(in_txt, in_i_extArg)
    ...
    case ( txt,
      ...
      equation
        ...
        i_typeStr = fun_232(emptyTxt, i_ii, i_ia, i_t);
        txt = Tpl.writeText(txt, i_typeStr);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" "));
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_236(out_txt, i_functions);
  out_txt := Tpl.popIter(out_txt);
end functionBodies;
  ...
  matchcontinue(in_txt, in_items, in_i_varInits, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varInits, i_varDecls) = lm_241(txt, rest, i_varInits, i_varDecls);
      then (txt, i_varInits, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_outVarInits, in_i_varDecls, in_i_retVar)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_outVarInits, i_varDecls) = lm_244(txt, rest, i_outVarInits, i_varDecls, i_retVar);
      then (txt, i_outVarInits, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        i_fname = underscorePath(emptyTxt, i_name);
        i_retType = fun_239(emptyTxt, i_outVars, i_fname);
        i_varDecls = emptyTxt;
        i_varInits = emptyTxt;
        (i_retVar, i_varDecls) = fun_240(emptyTxt, i_outVars, i_varDecls, i_retType);
        ...
        (i_0__, i_varInits, i_varDecls) = lm_241(i_0__, i_variableDeclarations, i_varInits, i_varDecls);
        ...
        (i_funArgs, i_varDecls) = lm_242(i_funArgs, i_functionArguments, i_varDecls);
        ...
        (i_bodyPart, i_varDecls) = lm_243(i_bodyPart, i_body, i_varDecls);
        ...
        (i_outVarsStr, i_outVarInits, i_varDecls) = lm_244(i_outVarsStr, i_outVars, i_outVarInits, i_varDecls, i_retVar);
        i_outVarsStr = Tpl.popIter(i_outVarsStr);
        ret_12 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedFn = fun_245(emptyTxt, ret_12, i_fn);
        txt = Tpl.writeText(txt, i_retType);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" _"));
        txt = Tpl.writeText(txt, i_fname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_246(txt, i_functionArguments);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    ")\n",
                                    "{\n"
        ...
        txt = fun_247(txt, i_outVars, i_retVar);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(";\n"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "}\n",
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_248(txt, i_functionArguments);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_249(txt, i_outVars, i_retType);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_250(txt, i_functionArguments);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_251(txt, i_outVars);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("_"));
        txt = Tpl.writeText(txt, i_fname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_252(txt, i_functionArguments);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = fun_254(txt, i_outVars);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("return 0;\n"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
  ...
  matchcontinue(in_txt, in_items, in_i_outputAlloc, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_outputAlloc, i_varDecls) = lm_256(txt, rest, i_outputAlloc, i_varDecls);
      then (txt, i_outputAlloc, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        i_0__ = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, NONE, 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_0__, i_outputAlloc, i_varDecls) = lm_256(i_0__, i_outVars, i_outputAlloc, i_varDecls);
        i_0__ = Tpl.popIter(i_0__);
        ret_9 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedFn = fun_257(emptyTxt, ret_9, i_fn);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_260(txt, i_funArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_261(txt, i_outVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("return 0;\n"));
        txt = Tpl.popBlock(txt);
  ...
  matchcontinue(in_txt, in_items, in_i_structVar)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        txt = lm_266(txt, rest, i_structVar);
      then txt;
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        i_boxedFn = fun_264(emptyTxt, ret_7, i_fn);
        txt = Tpl.writeText(txt, i_retType);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" _"));
        txt = Tpl.writeText(txt, i_fname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        ...
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_266(txt, i_funArgs, i_structVar);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_retVar);
  ...
  matchcontinue(in_txt, in_items, in_i_varBox, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varBox, i_varDecls) = lm_273(txt, rest, i_varBox, i_varDecls);
      then (txt, i_varBox, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_varUnbox, in_i_retTypeBoxed, in_i_retVar, in_i_retType, in_i_funRetVar)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_varUnbox) = lm_274(txt, rest, i_varDecls, i_varUnbox, i_retTypeBoxed, i_retVar, i_retType, i_funRetVar);
      then (txt, i_varDecls, i_varUnbox);
...
algorithm
  System.tmpTickReset(1);
  i_fname := underscorePath(emptyTxt, i_name);
  i_retType := fun_269(emptyTxt, i_outvars, i_fname);
  i_retTypeBoxed := fun_270(emptyTxt, i_outvars, i_retType);
  i_varDecls := emptyTxt;
  (i_retVar, i_varDecls) := fun_271(emptyTxt, i_outvars, i_varDecls, i_retTypeBoxed);
  (i_funRetVar, i_varDecls) := fun_272(emptyTxt, i_outvars, i_varDecls, i_retType);
  (i_stateVar, i_varDecls) := tempDecl(emptyTxt, "state", i_varDecls);
  i_varBox := emptyTxt;
  i_varUnbox := emptyTxt;
  i_args := Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_args, i_varBox, i_varDecls) := lm_273(i_args, i_funargs, i_varBox, i_varDecls);
  ...
  (i_retStr, i_varDecls, i_varUnbox) := lm_274(i_retStr, i_outvars, i_varDecls, i_varUnbox, i_retTypeBoxed, i_retVar, i_retType, i_funRetVar);
  ...
  out_txt := lm_275(out_txt, i_funargs);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       ")\n",
                                       "{\n"
  ...
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := fun_276(out_txt, i_outvars, i_funRetVar);
...
public function unboxVariable
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) := fun_282(txt, i_varType, i_varName, i_preExp, i_varDecls);
end unboxVariable;
  ...
  matchcontinue(in_txt, in_items, in_i_tmpVar, in_i_recordVar, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_284(txt, rest, i_tmpVar, i_recordVar, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_ty, in_i_recordVar, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_preExp, i_varDecls) = lm_284(i_preExp, i_vars, i_tmpVar, i_recordVar, i_varDecls);
...
public function unboxRecord
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) := fun_285(txt, i_ty, i_recordVar, i_preExp, i_varDecls);
end unboxRecord;
...
algorithm
  ...
  (out_txt, out_i_varDecls, out_i_varUnbox) := fun_287(txt, str_1, i_constructorType, i_varDecls, i_varUnbox, i_ty, i_varName);
end funArgBox;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_varName)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_290(txt, rest, i_varDecls, i_preExp, i_varName);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_type, in_i_varName, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_varsStr, i_varDecls, i_preExp) = lm_290(i_varsStr, i_vars, i_varDecls, i_preExp, i_varName);
  ...
  matchcontinue(in_txt, in_items, in_i_prefix)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpVar i_subvar;
      equation
        txt = fun_293(txt, i_tp, i_subvar_name, i_prefix);
        txt = Tpl.nextIter(txt);
        txt = lm_294(txt, rest, i_prefix);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_index, in_i_prefix)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpVar i_subvar;
      equation
        txt = fun_297(txt, i_tp, i_index, i_subvar_name, i_prefix);
        txt = Tpl.nextIter(txt);
        txt = lm_298(txt, rest, i_index, i_prefix);
      then txt;
  ...
  matchcontinue(in_txt, in_i_type, in_i_index, in_i_prefix)
    ...
    case ( txt,
      ...
      equation
        ...
        i_args = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_args = lm_298(i_args, i_vl, i_index, i_prefix);
        i_args = Tpl.popIter(i_args);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("&"));
        txt = Tpl.writeText(txt, i_basename);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("__desc"));
        str_2 = Tpl.textString(i_args);
        txt = fun_299(txt, str_2, i_args);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_varInits) = lm_303(txt, rest, i_varDecls, i_varInits);
      then (txt, i_varDecls, i_varInits);
  ...
  matchcontinue(in_txt, in_i_var, in_i_outStruct, in_i_i, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_varName;
      equation
        i_varDecls = fun_301(i_varDecls, i_outStruct, i_var_name, i_var);
        i_varName = fun_302(emptyTxt, i_outStruct, i_i, i_var_name);
        i_instDimsInit = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_instDimsInit, i_varDecls, i_varInits) = lm_303(i_instDimsInit, i_instDims, i_varDecls, i_varInits);
        i_instDimsInit = Tpl.popIter(i_instDimsInit);
        (txt, i_varInits) = fun_304(txt, i_instDims, i_i, i_outStruct, i_var, i_instDimsInit, i_varName, i_var_ty, i_varInits);
      then (txt, i_varDecls, i_varInits);
  ...
  matchcontinue(in_txt, in_i_var, in_i_outStruct, in_i_i)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Variable i_var;
      equation
        txt = fun_306(txt, i_value, i_i, i_outStruct, i_var_ty);
      then txt;
  ...
  matchcontinue(in_txt, in_i_var)
    ...
    case ( txt,
      ...
      equation
        ...
        i_typelist = lm_308(i_typelist, i_args);
        i_typelist = Tpl.popIter(i_typelist);
        i_rettype = Tpl.writeStr(emptyTxt, i_name);
        i_rettype = Tpl.writeTok(i_rettype, Tpl.ST_STRING("_rettype"));
        txt = fun_310(txt, i_ty, i_args, i_rettype, i_typelist, i_name);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varInits, i_varDecls) = daeExp(txt, i_exp, SimCode.contextFunction, i_varInits, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_varInits) = lm_313(txt, rest, i_varDecls, i_varInits);
      then (txt, i_varDecls, i_varInits);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_var, in_i_dest, in_i_i, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        i_instDimsInit = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_instDimsInit, i_varDecls, i_varInits) = lm_313(i_instDimsInit, i_instDims, i_varDecls, i_varInits);
        i_instDimsInit = Tpl.popIter(i_instDimsInit);
        (txt, i_varInits) = fun_314(txt, i_instDims, i_instDimsInit, i_var_ty, i_var_name, i_i, i_dest, i_var, i_varInits);
      then (txt, i_varDecls, i_varInits);
  ...
  matchcontinue(in_txt, in_items, in_i_varName)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varName) = lm_316(txt, rest, i_varName);
      then (txt, i_varName);
  ...
  matchcontinue(in_txt, in_i_var)
    ...
    case ( txt,
      ...
      equation
        i_varName = crefStr(emptyTxt, i_name);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varName) = lm_316(txt, i_ty_varLst, i_varName);
        txt = Tpl.popIter(txt);
      then txt;
  ...
  matchcontinue(in_txt, in_i_v, in_i_varName)
    ...
    case ( txt,
      ...
      equation
        ...
        i_dims = lm_319(i_dims, i_tp_arrayDimensions);
...
public function recordMemberInit
  ...
  output Tpl.Text out_i_varName;
algorithm
  out_txt := fun_320(txt, i_v, i_varName);
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Function i_fun;
      equation
        (txt, i_varDecls, i_preExp) = fun_323(txt, i_language, i_varDecls, i_preExp, i_fun);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_325(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_args = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_325(i_args, i_extArgs, i_varDecls, i_preExp);
        i_args = Tpl.popIter(i_args);
        i_returnAssign = fun_326(emptyTxt, i_extReturn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_327(txt, i_extArgs, i_varDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        (txt, i_varDecls) = fun_328(txt, i_extReturn, i_varDecls);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_329(txt, i_extArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_330(txt, i_extReturn);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_336(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_336(txt, i_biVars, i_varDecls, i_preExp);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_returnAssign);
        txt = Tpl.writeStr(txt, i_extName);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_337(txt, i_extArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_338(txt, i_extReturn);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_arg, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpType i_ty;
      equation
        (txt, i_varDecls) = fun_340(txt, i_ty, i_c, i_varDecls);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_oi;
      equation
        (txt, i_varDecls) = fun_341(txt, i_oi, i_c, i_ty, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_oi, in_i_ia, in_i_c, in_i_ty, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_STRING(";"));
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_NEW_LINE());
        txt = fun_343(txt, i_ia, i_c, i_oi, i_ty);
      then (txt, i_varDecls);
  end matchcontinue;
end fun_344;
  ...
  matchcontinue(in_txt, in_i_arg, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_oi;
      equation
        (txt, i_varDecls) = fun_344(txt, i_oi, i_ia, i_c, i_ty, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, SimCode.contextFunction, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_347(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_var, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_STRING(";"));
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_NEW_LINE());
        (i_defaultValue, i_varDecls, i_preExp) = fun_346(emptyTxt, i_value, i_varDecls, i_preExp, i_var__name);
        i_preExp = Tpl.writeText(i_preExp, i_defaultValue);
        i_instDimsInit = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_instDimsInit, i_varDecls, i_preExp) = lm_347(i_instDimsInit, i_instDims, i_varDecls, i_preExp);
        i_instDimsInit = Tpl.popIter(i_instDimsInit);
        (txt, i_preExp) = fun_348(txt, i_instDims, i_name, i_instDimsInit, i_var__name, i_preExp, i_var_ty);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_oi, in_i_ty, in_i_ai, in_i_c)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_352(txt, i_ai, i_ext__name, i_ty, i_outarg);
      then txt;
  end matchcontinue;
end fun_353;
  ...
  matchcontinue(in_txt, in_i_arg)
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_oi;
      equation
        txt = fun_353(txt, i_oi, i_ty, i_ai, i_c);
      then txt;
  ...
  matchcontinue(in_txt, in_i_extArg, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_name;
      equation
        i_name = fun_355(emptyTxt, i_oi, i_c);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_356(emptyTxt, i_oi);
        i_suffix = fun_358(emptyTxt, i_oi, i_t);
    ...
    case ( txt,
      ...
      equation
        ...
        i_name = fun_359(emptyTxt, i_outputIndex, i_c);
  ...
  matchcontinue(in_txt, in_i_extArg, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_suffix;
      equation
        i_suffix = fun_362(emptyTxt, i_oi, i_ia);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("&"));
        txt = crefStr(txt, i_c);
        txt = Tpl.writeText(txt, i_suffix);
      then (txt, i_preExp, i_varDecls);
...
public function tempSizeVarName
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_364(txt, i_indices, i_c);
end tempSizeVarName;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_366(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_366(txt, i_statementLst, i_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls);
...
algorithm
  out_txt :=
  matchcontinue(in_txt, in_it, in_i_ispec, in_i_cr, in_i_expPart, in_i_t, in_i_preExp)
    local
      Tpl.Text txt;
      Tpl.Text i_ispec;
      DAE.ComponentRef i_cr;
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_370(txt, str_3, i_ispec, i_cr, i_expPart, i_t, i_preExp);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_retStruct)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_372(txt, rest, i_varDecls, i_preExp, i_context, i_retStruct);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_372(txt, i_expExpLst, i_varDecls, i_preExp, i_context, i_retStruct);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_rhsStr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_374(txt, i_context, i_lhsStr, i_rhsStr, i_t);
      then (txt, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_375(txt, i_context, i_lhsStr, i_rhsStr, i_t);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_377(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_380(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_stmtStr, i_varDecls) = lm_380(i_stmtStr, i_statementLst, i_varDecls, i_context);
  ...
  matchcontinue(in_txt, in_i_range, in_i_iterator, in_i_type, in_i_shortType, in_i_body, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_stepValue, i_varDecls, i_preExp) = fun_382(emptyTxt, i_expOption, i_varDecls, i_preExp, i_context);
...
public function algStmtForRange_impl
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varDecls) := fun_383(txt, i_range, i_iterator, i_type, i_shortType, i_body, i_context, i_varDecls);
  out_i_body := i_body;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_385(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_stmtStr = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmtStr, i_varDecls) = lm_385(i_stmtStr, i_statementLst, i_varDecls, i_context);
        i_stmtStr = Tpl.popIter(i_stmtStr);
...
algorithm
  ...
  i_stmtStuff := fun_387(emptyTxt, i_iterIsArray, i_ivar, i_type, i_tvar, i_evar, i_arrayType, i_iterName);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_389(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_389(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
  ...
  matchcontinue(in_txt, in_items, in_i_doneVar, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("};"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_392(txt, rest, i_doneVar, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_392(txt, i_caseStmt, i_doneVar, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_body = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_body, i_varDecls) = lm_394(i_body, i_tryBody, i_varDecls, i_context);
        i_body = Tpl.popIter(i_body);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_body = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_body, i_varDecls) = lm_396(i_body, i_catchBody, i_varDecls, i_context);
        i_body = Tpl.popIter(i_body);
  ...
  matchcontinue(in_txt, in_i_when, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_statements, i_varDecls) = lm_399(i_statements, i_statementLst, i_varDecls, i_context);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if ("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(" || ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_400(txt, i_helpVarIndices);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(") {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
  ...
  matchcontinue(in_txt, in_i_context, in_i_when, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        SimCode.Context i_context;
      equation
        (txt, i_varDecls) = fun_401(txt, i_when, i_context, i_varDecls);
      then (txt, i_varDecls);
...
public function algStmtWhen
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varDecls) := fun_402(txt, i_context, i_when, i_varDecls);
end algStmtWhen;
  ...
  matchcontinue(in_txt, in_i_helpVarIndices, in_i_when_exp, in_i_varDecls, in_i_when_elseWhen)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_405(emptyTxt, i_when_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_404(emptyTxt, i_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Statement i_when;
      equation
        (txt, i_varDecls) = fun_406(txt, i_helpVarIndices, i_when_exp, i_varDecls, i_when_elseWhen);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_408(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_statements = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_statements, i_varDecls) = lm_408(i_statements, i_when_statementLst, i_varDecls);
        i_statements = Tpl.popIter(i_statements);
        ...
        i_elseCondStr = lm_409(i_elseCondStr, i_when_helpVarIndices);
  ...
  matchcontinue(in_txt, in_i_exps, in_i_ints, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_firstExp;
      equation
        (txt, i_varDecls, i_preExp) = fun_411(txt, i_ints, i_firstExp, i_varDecls, i_preExp, i_restExps);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_414(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_415(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_else__, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_414(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_415(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
  ...
  matchcontinue(in_txt, in_i_ecr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls, i_preExp) = fun_417(txt, ret_0, i_ecr_componentRef, i_varDecls, i_preExp, i_context, i_ecr);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_exp;
      equation
        (txt, i_varDecls, i_preExp) = fun_424(txt, i_context, i_cr, i_t, i_varDecls, i_preExp, i_exp);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_cref)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_426(txt, i_identType);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" slist "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_429(txt, i_subscriptLst);
        txt = Tpl.popIter(txt);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_431(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_varDecls, in_i_ty, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_dimsValuesStr, i_varDecls, i_preExp) = lm_431(i_dimsValuesStr, ret_7, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_varDecls, in_i_ty, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_432(txt, ret_0, i_preExp, i_varDecls, i_ty, i_context, i_cr);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_it, in_i_box, in_i_preExp, in_i_varDecls, in_i_ty, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_434(txt, ret_0, i_preExp, i_varDecls, i_ty, i_context, i_cr);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_ecr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_435(txt, str_1, i_box, i_preExp, i_varDecls, i_ty, i_context, i_cr);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Subscript i_sub;
      equation
        (txt, i_varDecls, i_preExp) = fun_437(txt, i_sub, i_varDecls, i_preExp, i_context);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_438(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  (i_idx__str, out_i_varDecls, out_i_preExp) := lm_438(i_idx__str, i_subs, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_i_context, in_i_ecr_componentRef, in_i_preExp, in_i_dims, in_i_varDecls, in_i_aty)
    ...
    case ( txt,
      ...
      equation
        ...
        i_dimsValuesStr = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_dimsValuesStr = lm_440(i_dimsValuesStr, i_dims);
        i_dimsValuesStr = Tpl.popIter(i_dimsValuesStr);
    ...
    case ( txt,
      ...
      equation
        ...
        i_dimsLenStr = Tpl.writeStr(emptyTxt, intString(ret_3));
        i_dimsValuesStr = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_dimsValuesStr = lm_441(i_dimsValuesStr, i_dims);
        i_dimsValuesStr = Tpl.popIter(i_dimsValuesStr);
        i_preExp = expTypeShort(i_preExp, i_aty);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("_array_create(&"));
        i_preExp = Tpl.writeText(i_preExp, i_tmpArr);
  ...
  matchcontinue(in_txt, in_i_ecr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_ecr;
      equation
        (txt, i_preExp, i_varDecls) = fun_442(txt, i_context, i_ecr_componentRef, i_preExp, i_dims, i_varDecls, i_aty);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_444(txt, rest, i_varDecls, i_preExp, i_context, i_cr);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_ty, in_i_cr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_vars, i_varDecls, i_preExp) = lm_444(i_vars, i_var__lst, i_varDecls, i_preExp, i_context, i_cr);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_operator, in_i_context, in_i_exp, in_i_e2, in_i_e1, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_typeShort = fun_451(emptyTxt, i_ty);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_453(txt, i_operator, i_context, i_exp, i_e2, i_e1, i_preExp, i_varDecls);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp) = fun_455(txt, i_operator, i_preExp, i_e);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_e2, i_preExp, i_varDecls) = daeExp(emptyTxt, i_exp2, i_context, i_preExp, i_varDecls);
        txt = fun_457(txt, i_operator, i_e2, i_e1);
      then (txt, i_preExp, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (i_e, i_preExp, i_varDecls) = daeExp(emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = fun_459(txt, i_operator, i_e);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_it, in_i_simRel, in_i_rel_operator, in_i_rel_exp2, in_i_varDecls, in_i_preExp, in_i_context, in_i_rel_exp1)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_461(txt, i_rel_operator, i_e2, i_e1);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls, i_preExp) = fun_462(txt, str_1, i_simRel, i_rel_operator, i_rel_exp2, i_varDecls, i_preExp, i_context, i_rel_exp1);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_context, in_i_rel_operator, in_i_rel_exp2, in_i_varDecls, in_i_preExp, in_i_rel_exp1)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp) = fun_464(txt, i_rel_operator, i_e2, i_e1, i_res, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_rel;
      equation
        (txt, i_varDecls, i_preExp) = fun_465(txt, i_context, i_rel_operator, i_rel_exp2, i_varDecls, i_preExp, i_rel_exp1);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_470(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_471(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_473(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_call, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_retVar, i_varDecls) = tempDecl(emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_cast = fun_469(emptyTxt, i_arg_ty);
    ...
    case ( txt,
      ...
      equation
        ...
        (i_argStr, i_varDecls, i_preExp) = lm_470(i_argStr, i_expLst, i_varDecls, i_preExp, i_context);
    ...
    case ( txt,
      ...
      equation
        i_argStr = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_argStr, i_varDecls, i_preExp) = lm_471(i_argStr, i_expLst, i_varDecls, i_preExp, i_context);
        i_argStr = Tpl.popIter(i_argStr);
        i_funName = underscorePath(emptyTxt, i_path);
        ...
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(");"));
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_NEW_LINE());
        txt = fun_472(txt, i_builtin, i_retType, i_retVar);
      then (txt, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        i_argStr = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_argStr, i_varDecls, i_preExp) = lm_473(i_argStr, i_expLst, i_varDecls, i_preExp, i_context);
        i_argStr = Tpl.popIter(i_argStr);
        i_funName = underscorePath(emptyTxt, i_path);
        i_retType = Tpl.writeText(emptyTxt, i_funName);
        i_retType = Tpl.writeTok(i_retType, Tpl.ST_STRING("_rettype"));
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_scalar)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_478(emptyTxt, i_scalar, i_e);
        txt = Tpl.writeText(txt, i_prefix);
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_e, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_479(txt, rest, i_varDecls, i_preExp, i_context, i_scalar);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_scalarPrefix = fun_476(emptyTxt, i_scalar);
        i_scalarRef = fun_477(emptyTxt, i_scalar);
        i_params = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_params, i_varDecls, i_preExp) = lm_479(i_params, i_array, i_varDecls, i_preExp, i_context, i_scalar);
  ...
  matchcontinue(in_txt, in_items, in_i_vars2, in_i_promote, in_i_context, in_i_varDecls, in_i_arrayTypeStr)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_vars2, i_promote, i_varDecls) = lm_481(txt, rest, i_vars2, i_promote, i_context, i_varDecls, i_arrayTypeStr);
      then (txt, i_vars2, i_promote, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_catAlloc, i_vars2, i_promote, i_varDecls) = lm_481(i_catAlloc, i_m_scalar, i_vars2, i_promote, i_context, i_varDecls, i_arrayTypeStr);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varLstStr, in_i_arrayTypeStr, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_scalarStr = fun_483(emptyTxt, i_b);
        i_scalarRefStr = fun_484(emptyTxt, i_b);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_varLstStr, i_varDecls, i_preExp) = lm_485(txt, rest, i_varLstStr, i_arrayTypeStr, i_varDecls, i_preExp, i_context);
      then (txt, i_varLstStr, i_varDecls, i_preExp);
...
algorithm
  ...
  (i_preExp2, i_varLstStr, out_i_varDecls, out_i_preExp) := lm_485(i_preExp2, i_row, i_varLstStr, i_arrayTypeStr, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_487(txt, i_ty, i_preExp, i_exp, i_varDecls, i_expVar);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls, i_preExp) = fun_489(txt, i_context, i_varDecls, i_preExp, i_arrName, i_subs, i_ecr_ty);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_preExpInner, in_i_varDeclsInner)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExpInner, i_varDeclsInner) = lm_501(txt, rest, i_preExpInner, i_varDeclsInner);
      then (txt, i_preExpInner, i_varDeclsInner);
  ...
  matchcontinue(in_txt, in_items, in_i_varDeclsInner, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDeclsInner) = lm_502(txt, rest, i_varDeclsInner, i_context);
      then (txt, i_varDeclsInner);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_0__, i_preExpInner, i_varDeclsInner) = lm_501(emptyTxt, ret_4, i_preExpInner, i_varDeclsInner);
        ...
        (i_stmts, i_varDeclsInner) = lm_502(i_stmts, i_body, i_varDeclsInner, i_context);
...
public function daeExpValueblock
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp) := fun_503(txt, i_exp, i_context, i_preExp);
  out_i_varDecls := i_varDecls;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_505(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  i_dimsValuesStr := Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_dimsValuesStr, out_i_varDecls, out_i_preExp) := lm_505(i_dimsValuesStr, i_subs, i_varDecls, i_preExp, i_context);
  i_dimsValuesStr := Tpl.popIter(i_dimsValuesStr);
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING("(*"));
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_510(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_args = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_510(i_args, i_listExp, i_varDecls, i_preExp, i_context);
        i_args = Tpl.popIter(i_args);
        (i_tmp, i_varDecls) = tempDecl(emptyTxt, "modelica_metatype", i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tmp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_513(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_args, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_513(txt, i_args, i_varDecls, i_preExp, i_context);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls, i_preExp);
  end matchcontinue;
end fun_514;
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_argsStr, i_varDecls, i_preExp) = fun_514(emptyTxt, i_args, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_varname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_517(txt, rest, i_varDecls, i_preExp, i_varname);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_varLst, in_i_varDecls, in_i_preExp, in_i_varname)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_517(txt, i_varLst, i_varDecls, i_preExp, i_varname);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls, i_preExp);
  end matchcontinue;
end fun_518;
  ...
  matchcontinue(in_txt, in_i_type, in_i_varname, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_args, i_varDecls, i_preExp) = fun_518(emptyTxt, i_varLst, i_varDecls, i_preExp, i_varname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("mmc_mk_box"));
...
public function daeExpMetaHelperConstantNameType
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) := fun_519(txt, i_type, i_varname, i_preExp, i_varDecls);
  out_i_varname := i_varname;
  ...
  matchcontinue(in_txt, in_i_var)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Variable i_var;
      equation
        txt = fun_523(txt, i_instDims, i_var_ty);
      then txt;
...
public function expType
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_530(txt, i_array, i_ty);
end expType;
...
public function expTypeFlag
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_542(txt, i_flag, i_ty);
end expTypeFlag;
