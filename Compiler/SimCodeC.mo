  ...
  matchcontinue(in_txt, in_i_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        Tpl.textFile(txt_0, Tpl.textString(txt_1));
        txt_2 = simulationFunctionsHeaderFile(emptyTxt, i_fileNamePrefix, i_functions, i_externalFunctionIncludes);
        ...
        txt_4 = simulationFunctionsFile(emptyTxt, i_fileNamePrefix, i_functions, i_externalFunctionIncludes);
        ...
        txt_6 = simulationMakefile(emptyTxt, i_simCode);
        txt_7 = Tpl.writeStr(emptyTxt, i_fileNamePrefix);
  ...
  matchcontinue(in_txt, in_i_functionCode)
    ...
    case ( txt,
      ...
      equation
        ...
        txt_1 = functionsHeaderFile(emptyTxt, Tpl.textString(i_filePrefix), i_mainFunction, i_functions, i_extraRecordDecls, i_externalFunctionIncludes);
        txt_2 = Tpl.writeText(emptyTxt, i_filePrefix);
        txt_2 = Tpl.writeTok(txt_2, Tpl.ST_STRING(".h"));
        Tpl.textFile(txt_1, Tpl.textString(txt_2));
        txt_3 = functionsFile(emptyTxt, Tpl.textString(i_filePrefix), i_mainFunction, i_functions, i_extraRecordDecls, i_externalFunctionIncludes);
        txt_4 = Tpl.writeText(emptyTxt, i_filePrefix);
        txt_4 = Tpl.writeTok(txt_4, Tpl.ST_STRING(".c"));
        Tpl.textFile(txt_3, Tpl.textString(txt_4));
        txt_5 = functionsMakefile(emptyTxt, i_functionCode);
...
algorithm
  i_varDecls := emptyTxt;
  (i_storePart, i_varDecls) := fun_121(emptyTxt, i_delayed, i_varDecls);
...
algorithm
  ...
  i_Vars__ := Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  i_Vars__ := lm_142(i_Vars__, i_JacVars);
  i_Vars__ := Tpl.popIter(i_Vars__);
  i_writeJac__ := Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
...
protected
  Tpl.Text i_jacMats;
algorithm
  i_jacMats := lm_159(emptyTxt, i_JacobianMatrixes);
  ...
  matchcontinue(in_txt, in_i_eq, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_mixedPostfix = fun_205(emptyTxt, i_partOfMixed);
  ...
  matchcontinue(in_txt, in_i_fn, in_i_inFunc)
    ...
    case ( txt,
      ...
      equation
        ...
        i_funArgsBoxedStr = fun_281(emptyTxt, ret_3, i_funArgs);
        ret_5 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedHeader = fun_282(emptyTxt, ret_5, i_funArgsBoxedStr, i_fname);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_boxed)
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        i_dimStr = fun_304(emptyTxt, i_ty);
        i_typeStr = fun_305(emptyTxt, i_boxed, i_var);
...
protected
  ...
  Tpl.Text i_fargsStr;
algorithm
  i_fargsStr := fun_297(emptyTxt, i_boxed, i_fargs);
  i_boxStr := fun_298(emptyTxt, i_boxed);
  i_boxPtrStr := fun_299(emptyTxt, i_boxed);
  i_inFnStr := fun_301(emptyTxt, i_boxed, i_fname, i_inFunc);
  ...
  matchcontinue(in_txt, in_i_extArg)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_name;
      equation
        i_name = contextCref(emptyTxt, i_c, SimCode.contextFunction);
        i_typeStr = fun_323(emptyTxt, i_ii, i_ia, i_t);
        txt = Tpl.writeText(txt, i_typeStr);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" "));
  ...
  matchcontinue(in_txt, in_i_fn, in_i_inFunc)
    ...
    case ( txt,
      ...
      equation
        ...
        i_fname = underscorePath(emptyTxt, i_name);
        i_retType = fun_330(emptyTxt, i_outVars, i_fname);
        i_varDecls = emptyTxt;
        i_varInits = emptyTxt;
        (i_retVar, i_varDecls) = fun_331(emptyTxt, i_outVars, i_varDecls, i_retType);
        ret_6 = RTOpts.acceptMetaModelicaGrammar();
        (i_stateVar, i_varDecls) = fun_332(emptyTxt, ret_6, i_varDecls);
        ...
        i_boxedFn = fun_337(emptyTxt, ret_13, i_fn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  ...
  matchcontinue(in_txt, in_i_fn, in_i_inFunc)
    ...
    case ( txt,
      ...
      equation
        System.tmpTickReset(1);
        i_fname = underscorePath(emptyTxt, i_name);
        i_retType = fun_352(emptyTxt, i_outVars, i_fname);
        i_preExp = emptyTxt;
        i_varDecls = emptyTxt;
        (i_retVar, i_varDecls) = fun_353(emptyTxt, i_outVars, i_varDecls, i_retType);
        i_outputAlloc = emptyTxt;
        ret_7 = RTOpts.acceptMetaModelicaGrammar();
        (i_stateVar, i_varDecls) = fun_354(emptyTxt, ret_7, i_varDecls);
        ...
        i_boxedFn = fun_356(emptyTxt, ret_11, i_fn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        ret_7 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedFn = fun_368(emptyTxt, ret_7, i_fn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
...
algorithm
  System.tmpTickReset(1);
  i_fname := underscorePath(emptyTxt, i_name);
  i_retType := fun_374(emptyTxt, i_outvars, i_fname);
  i_retTypeBoxed := fun_375(emptyTxt, i_outvars, i_retType);
  i_varDecls := emptyTxt;
  (i_retVar, i_varDecls) := fun_376(emptyTxt, i_outvars, i_varDecls, i_retTypeBoxed);
  (i_funRetVar, i_varDecls) := fun_377(emptyTxt, i_outvars, i_varDecls, i_retType);
  ret_7 := RTOpts.acceptMetaModelicaGrammar();
  (i_stateVar, i_varDecls) := fun_378(emptyTxt, ret_7, i_varDecls);
  i_varBox := emptyTxt;
  i_varUnbox := emptyTxt;
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        i_preExp = emptyTxt;
        ret_3 = RTOpts.acceptMetaModelicaGrammar();
        (i_stateVar, i_varDecls) = fun_386(emptyTxt, ret_3, i_varDecls);
        i_fname = underscorePath(emptyTxt, i_name);
        i_retType = Tpl.writeText(emptyTxt, i_fname);
        ...
        i_funArgCount = Tpl.writeStr(emptyTxt, intString(ret_11));
        txt = Tpl.writeText(txt, i_retType);
  ...
  matchcontinue(in_txt, in_i_var, in_i_varDecls, in_i_varBox)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_varName;
      equation
        i_varName = contextCref(emptyTxt, i_name, SimCode.contextFunction);
  ...
  matchcontinue(in_txt, in_i_var)
    ...
    case ( txt,
      ...
      equation
        ...
        txt_0 = contextCref(emptyTxt, i_cr, SimCode.contextFunction);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_var_value, in_i_varDecls, in_i_varInits, in_i_var_name)
    ...
    case ( txt,
      ...
      equation
        i_defaultValue = contextCref(emptyTxt, i_var_name, SimCode.contextFunction);
  ...
  matchcontinue(in_txt, in_i_var, in_i_outStruct, in_i_i, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        ...
        i_varName = fun_413(emptyTxt, i_outStruct, i_i, i_var_name);
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_args = Tpl.popIter(i_args);
        i_returnAssign = fun_436(emptyTxt, i_extReturn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_args = Tpl.popIter(i_args);
        i_returnAssign = fun_443(emptyTxt, i_extReturn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  ...
  matchcontinue(in_txt, in_i_var, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_var__name;
      equation
        i_var__name = contextCref(emptyTxt, i_name, SimCode.contextFunction);
        ...
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_STRING(";"));
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_NEW_LINE());
        (i_defaultValue, i_varDecls, i_preExp) = fun_456(emptyTxt, i_value, i_varDecls, i_preExp, i_var__name);
  ...
  matchcontinue(in_txt, in_i_oi, in_i_ty, in_i_ai, in_i_c)
    ...
    case ( txt,
      ...
      equation
        ...
        i_ext__name = contextCref(emptyTxt, i_c, SimCode.contextFunction);
  ...
  matchcontinue(in_txt, in_i_extArg, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_name;
      equation
        i_name = fun_465(emptyTxt, i_oi, i_c);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_466(emptyTxt, i_oi);
        i_suffix = fun_468(emptyTxt, i_oi, i_t);
    ...
    case ( txt,
      ...
      equation
        ...
        i_name = fun_469(emptyTxt, i_outputIndex, i_c);
  ...
  matchcontinue(in_txt, in_i_extArg, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_suffix;
      equation
        i_suffix = fun_472(emptyTxt, i_oi, i_ia);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("&"));
        txt = contextCref(txt, i_c, SimCode.contextFunction);
        txt = Tpl.writeText(txt, i_suffix);
      then (txt, i_preExp, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_val, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_preExp = emptyTxt;
        (i_arr1, i_preExp, i_varDecls) = daeExp(emptyTxt, i_arr, i_context, i_preExp, i_varDecls);
        (i_idx1, i_preExp, i_varDecls) = daeExp(emptyTxt, i_idx, i_context, i_preExp, i_varDecls);
        (i_val1, i_preExp, i_varDecls) = daeExp(emptyTxt, i_val, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_it, in_i_exp1, in_i_val, in_i_varDecls, in_i_context, in_i_exp)
    ...
    case ( txt,
      ...
      equation
        i_preExp = emptyTxt;
        (i_varPart, i_preExp, i_varDecls) = daeExpAsub(emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_expPart, i_preExp, i_varDecls) = daeExp(emptyTxt, i_val, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text txt_0;
      equation
        txt_0 = expTypeFromExpShort(emptyTxt, i_exp);
        str_1 = Tpl.textString(txt_0);
  ...
  matchcontinue(in_txt, in_i_range, in_i_iterator, in_i_type, in_i_shortType, in_i_body, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_stateVar, i_varDecls) = fun_498(emptyTxt, ret_2, i_varDecls);
        ...
        (i_stepValue, i_varDecls, i_preExp) = fun_499(emptyTxt, i_expOption, i_varDecls, i_preExp, i_context);
...
algorithm
  i_iterName := contextIteratorName(emptyTxt, i_iterator, i_context);
  ret_2 := RTOpts.acceptMetaModelicaGrammar();
  (i_stateVar, out_i_varDecls) := fun_506(emptyTxt, ret_2, i_varDecls);
  ...
  i_stmtStuff := fun_507(emptyTxt, i_iterIsArray, i_ivar, i_type, i_tvar, i_evar, i_arrayType, i_iterName);
  ...
  matchcontinue(in_txt, in_items, in_i_doneVar, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("};"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_518(txt, rest, i_doneVar, i_varDecls, i_context);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
           DAE.STMT_MATCHCASES(inputExps = i_inputExps, caseStmt = i_caseStmt, matchType = i_matchType),
           i_context,
           i_varDecls )
      local
        Absyn.MatchType i_matchType;
        list<DAE.Exp> i_caseStmt;
        list<DAE.Exp> i_inputExps;
        Integer ret_7;
        Tpl.Text i_numCases;
        Tpl.Text i_inVarAssignLoop;
        Tpl.Text i_inVarPreExp;
        Tpl.Text i_inVarAssign;
        Tpl.Text i_inVarDecl;
        Tpl.Text i_doneVar;
        Tpl.Text i_loopVar;
      equation
        ...
        i_inVarDecl = emptyTxt;
        i_inVarAssign = emptyTxt;
        i_inVarPreExp = emptyTxt;
        (i_inVarAssignLoop, i_inVarDecl, i_inVarAssign, i_inVarPreExp) = algStmtMatchcasesVarDeclsAndAssign(emptyTxt, i_inputExps, i_context, i_inVarDecl, i_inVarAssign, i_inVarPreExp);
        ret_7 = listLength(i_caseStmt);
        i_numCases = Tpl.writeStr(emptyTxt, intString(ret_7));
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.writeText(txt, i_doneVar);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(" = 0;\n"));
        txt = Tpl.writeText(txt, i_inVarDecl);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_inVarPreExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_inVarAssign);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("for ("));
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("++) {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.writeText(txt, i_inVarAssignLoop);
        txt = Tpl.softNewLine(txt);
        txt = fun_517(txt, i_matchType);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_518(txt, i_caseStmt, i_doneVar, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("} /* end match switch */\n"));
        txt = Tpl.popBlock(txt);
        txt = fun_519(txt, i_matchType);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "} /* end match for */\n",
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tmp;
      equation
        (i_tmp, i_varDecls) = tempDecl(emptyTxt, "modelica_boolean", i_varDecls);
        i_stmtBody = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmtBody, i_varDecls) = lm_521(i_stmtBody, i_body, i_varDecls, i_context);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_525(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_528(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_when, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_statements, i_varDecls) = lm_528(i_statements, i_statementLst, i_varDecls, i_context);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if ("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(" || ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_529(txt, i_helpVarIndices);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(") {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
  ...
  matchcontinue(in_txt, in_i_context, in_i_when, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        SimCode.Context i_context;
      equation
        (txt, i_varDecls) = fun_530(txt, i_when, i_context, i_varDecls);
      then (txt, i_varDecls);
...
public function algStmtWhen
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varDecls) := fun_531(txt, i_context, i_when, i_varDecls);
end algStmtWhen;
  ...
  matchcontinue(in_txt, in_i_helpVarIndices, in_i_when_exp, in_i_varDecls, in_i_when_elseWhen)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_534(emptyTxt, i_when_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_533(emptyTxt, i_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Statement i_when;
      equation
        (txt, i_varDecls) = fun_535(txt, i_helpVarIndices, i_when_exp, i_varDecls, i_when_elseWhen);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_537(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_statements = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_statements, i_varDecls) = lm_537(i_statements, i_when_statementLst, i_varDecls);
        i_statements = Tpl.popIter(i_statements);
        ...
        i_elseCondStr = lm_538(i_elseCondStr, i_when_helpVarIndices);
  ...
  matchcontinue(in_txt, in_i_exps, in_i_ints, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_firstExp;
      equation
        (txt, i_varDecls, i_preExp) = fun_540(txt, i_ints, i_firstExp, i_varDecls, i_preExp, i_restExps);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_544(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_else__, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_544(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
  ...
  matchcontinue(in_txt, in_i_ecr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls, i_preExp) = fun_546(txt, ret_0, i_ecr_componentRef, i_varDecls, i_preExp, i_context, i_ecr);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_exp;
      equation
        (txt, i_varDecls, i_preExp) = fun_553(txt, i_context, i_cr, i_t, i_varDecls, i_preExp, i_exp);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_varDecls, in_i_ty, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_dimsValuesStr, i_varDecls, i_preExp) = lm_555(i_dimsValuesStr, ret_7, i_varDecls, i_preExp, i_context);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_operator, in_i_context, in_i_exp, in_i_e2, in_i_e1, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_typeShort = fun_574(emptyTxt, i_ty);
  ...
  matchcontinue(in_txt, in_i_call, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_retVar, i_varDecls) = tempDecl(emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_cast = fun_592(emptyTxt, i_arg_ty);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_scalar)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_601(emptyTxt, i_scalar, i_e);
        txt = Tpl.writeText(txt, i_prefix);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_scalarPrefix = fun_599(emptyTxt, i_scalar);
        i_scalarRef = fun_600(emptyTxt, i_scalar);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varLstStr, in_i_arrayTypeStr, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_scalarStr = fun_606(emptyTxt, i_b);
        i_scalarRefStr = fun_607(emptyTxt, i_b);
  ...
  matchcontinue(in_txt, in_items, in_i_varDeclsInner, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDeclsInner) = lm_628(txt, rest, i_varDeclsInner, i_context);
      then (txt, i_varDeclsInner);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp)
    ...
    case ( txt,
           (i_exp as DAE.VALUEBLOCK(localDecls = i_localDecls, ty = i_ty, body = i_body, result = i_result)),
           i_context,
           i_preExp )
      local
        DAE.Exp i_result;
      ...
      equation
        ...
        i_ignore = emptyTxt;
        ret_5 = SimCode.elementVars(i_localDecls);
        (i_0__, i_preExpInner, i_varDeclsInner) = lm_627(emptyTxt, ret_5, i_preExpInner, i_varDeclsInner);
        i_resType = expTypeModelica(emptyTxt, i_ty);
        txt_8 = expTypeModelica(emptyTxt, i_ty);
        (i_res, i_preExp) = tempDecl(emptyTxt, Tpl.textString(txt_8), i_preExp);
        i_stmts = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmts, i_varDeclsInner) = lm_628(i_stmts, i_body, i_varDeclsInner, i_context);
...
public function daeExpValueblock
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp) := fun_629(txt, i_exp, i_context, i_preExp);
  out_i_varDecls := i_varDecls;
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_preExpInner, in_i_varDeclsInner)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDeclsInner, i_preExpInner) = varInit(txt, i_var, "", 0, i_varDeclsInner, i_preExpInner);
        (txt, i_preExpInner, i_varDeclsInner) = lm_631(txt, rest, i_preExpInner, i_varDeclsInner);
      then (txt, i_preExpInner, i_varDeclsInner);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_preExpInput, in_i_context, in_i_expInput, in_i_varDeclsInput, in_i_prefix)
    ...
    case ( txt,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        i_decl = Tpl.writeText(emptyTxt, i_prefix);
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_preExpInput, i_expInput, i_varDeclsInput) = lm_632(txt, rest, i_preExpInput, i_context, i_expInput, i_varDeclsInput, i_prefix);
      then (txt, i_preExpInput, i_expInput, i_varDeclsInput);
  ...
  matchcontinue(in_txt, in_i_et, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text txt_0;
      equation
        txt_0 = expTypeModelica(emptyTxt, i_et);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_varDeclsCaseInner, in_i_onPatternFail, in_i_prefix)
    ...
    case ( txt,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        txt_0 = Tpl.writeText(emptyTxt, i_prefix);
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_assignments, i_varDeclsCaseInner, i_onPatternFail) = lm_637(txt, rest, i_assignments, i_varDeclsCaseInner, i_onPatternFail, i_prefix);
      then (txt, i_assignments, i_varDeclsCaseInner, i_onPatternFail);
  ...
  matchcontinue(in_txt, in_items, in_i_varDeclsCaseInner, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDeclsCaseInner) = lm_638(txt, rest, i_varDeclsCaseInner, i_context);
      then (txt, i_varDeclsCaseInner);
  ...
  matchcontinue(in_txt, in_items, in_i_preExpCaseInner, in_i_varDeclsCaseInner)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExpCaseInner, i_varDeclsCaseInner) = lm_640(txt, rest, i_preExpCaseInner, i_varDeclsCaseInner);
      then (txt, i_preExpCaseInner, i_varDeclsCaseInner);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_done, in_i_res, in_i_context, in_i_onPatternFail, in_i_prefix)
    ...
    case ( txt,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        i_varDeclsCaseInner = emptyTxt;
        i_preExpCaseInner = emptyTxt;
        i_assignments = emptyTxt;
        i_preRes = emptyTxt;
        i_patternMatching = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, SOME(Tpl.ST_STRING("")), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_patternMatching, i_assignments, i_varDeclsCaseInner, i_onPatternFail) = lm_637(i_patternMatching, i_c_patterns, i_assignments, i_varDeclsCaseInner, i_onPatternFail, i_prefix);
        i_patternMatching = Tpl.popIter(i_patternMatching);
        i_stmts = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmts, i_varDeclsCaseInner) = lm_638(i_stmts, i_c_body, i_varDeclsCaseInner, i_context);
        i_stmts = Tpl.popIter(i_stmts);
        (i_caseRes, i_varDeclsCaseInner, i_preRes) = fun_639(emptyTxt, i_c_result, i_varDeclsCaseInner, i_preRes, i_context);
        ret_8 = SimCode.elementVars(i_c_localDecls);
        (i_0__, i_preExpCaseInner, i_varDeclsCaseInner) = lm_640(emptyTxt, ret_8, i_preExpCaseInner, i_varDeclsCaseInner);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("case "));
        txt = Tpl.writeStr(txt, intString(i_i0));
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(": {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        ...
        txt = Tpl.softNewLine(txt);
        txt = fun_641(txt, i_c_result, i_caseRes, i_res, i_preRes);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.nextIter(txt);
        (txt, i_onPatternFail) = lm_642(txt, rest, i_done, i_res, i_context, i_onPatternFail, i_prefix);
      then (txt, i_onPatternFail);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExpInner = emptyTxt;
        i_preExpRes = emptyTxt;
        i_varDeclsInput = emptyTxt;
        i_varDeclsInner = emptyTxt;
        i_ignore = emptyTxt;
        ret_6 = SimCode.elementVars(i_localDecls);
        (i_ignore2, i_preExpInner, i_varDeclsInner) = lm_631(emptyTxt, ret_6, i_preExpInner, i_varDeclsInner);
        i_prefix = Tpl.writeTok(emptyTxt, Tpl.ST_STRING("tmp"));
        ret_8 = System.tmpTick();
        i_prefix = Tpl.writeStr(i_prefix, intString(ret_8));
        i_preExpInput = emptyTxt;
        i_expInput = emptyTxt;
        i_ignore3 = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, SOME(Tpl.ST_STRING("")), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_ignore3, i_preExpInput, i_expInput, i_varDeclsInput) = lm_632(i_ignore3, i_inputs, i_preExpInput, i_context, i_expInput, i_varDeclsInput, i_prefix);
        i_ignore3 = Tpl.popIter(i_ignore3);
        (i_res, i_varDecls) = fun_633(emptyTxt, i_et, i_varDecls);
        (i_ix, i_varDeclsInner) = tempDecl(emptyTxt, "int", i_varDeclsInner);
        (i_done, i_varDeclsInner) = tempDecl(emptyTxt, "int", i_varDeclsInner);
        i_onPatternFail = fun_634(emptyTxt, i_exp_matchType);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("{ /* "));
        ...
        (i_preExp, i_onPatternFail) = lm_642(i_preExp, i_cases, i_done, i_res, i_context, i_onPatternFail, i_prefix);
        i_preExp = Tpl.popIter(i_preExp);
        i_preExp = Tpl.softNewLine(i_preExp);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_LINE("}\n"));
        i_preExp = Tpl.popBlock(i_preExp);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("}"));
        i_preExp = fun_643(i_preExp, i_exp_matchType);
        i_preExp = Tpl.softNewLine(i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_645(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  i_dimsValuesStr := Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_dimsValuesStr, out_i_varDecls, out_i_preExp) := lm_645(i_dimsValuesStr, i_subs, i_varDecls, i_preExp, i_context);
  i_dimsValuesStr := Tpl.popIter(i_dimsValuesStr);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_args = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_650(i_args, i_listExp, i_varDecls, i_preExp, i_context);
        i_args = Tpl.popIter(i_args);
        (i_tmp, i_varDecls) = tempDecl(emptyTxt, "modelica_metatype", i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tmp);
        ...
        i_preExp = fun_651(i_preExp, str_4);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_654(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_args, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_654(txt, i_args, i_varDecls, i_preExp, i_context);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls, i_preExp);
  end matchcontinue;
end fun_655;
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_argsStr, i_varDecls, i_preExp) = fun_655(emptyTxt, i_args, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_varname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_658(txt, rest, i_varDecls, i_preExp, i_varname);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_varLst, in_i_varDecls, in_i_preExp, in_i_varname)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_658(txt, i_varLst, i_varDecls, i_preExp, i_varname);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls, i_preExp);
  end matchcontinue;
end fun_659;
  ...
  matchcontinue(in_txt, in_i_type, in_i_varname, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_args, i_varDecls, i_preExp) = fun_659(emptyTxt, i_varLst, i_varDecls, i_preExp, i_varname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("mmc_mk_box"));
...
public function daeExpMetaHelperConstantNameType
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) := fun_660(txt, i_type, i_varname, i_preExp, i_varDecls);
  out_i_varname := i_varname;
  ...
  matchcontinue(in_txt, in_i_var)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Variable i_var;
      equation
        txt = fun_666(txt, i_instDims, i_var_ty);
      then txt;
...
public function expType
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_673(txt, i_array, i_ty);
end expType;
...
public function expTypeFlag
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_685(txt, i_flag, i_ty);
end expTypeFlag;
  ...
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_varDecls, in_i_onPatternFail, in_i_rhs)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_assignments, i_varDecls, i_onPatternFail) = lm_702(txt, rest, i_assignments, i_varDecls, i_onPatternFail, i_rhs);
      then (txt, i_assignments, i_varDecls, i_onPatternFail);
  ...
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_onPatternFail, in_i_rhs, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tvar;
      equation
        txt_1 = expTypeModelica(emptyTxt, i_t);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(";\n"));
        (txt, i_tvar, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p, i_tvar, i_onPatternFail, i_varDecls, i_assignments);
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_703(txt, rest, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
      then (txt, i_assignments, i_onPatternFail, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_onPatternFail, in_i_rhs, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_tvar, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p, i_tvar, i_onPatternFail, i_varDecls, i_assignments);
        txt = Tpl.nextIter(txt);
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_704(txt, rest, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
      then (txt, i_assignments, i_onPatternFail, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_pat, in_i_rhs, in_i_onPatternFail, in_i_varDecls, in_i_assignments)
    ...
    case ( txt,
      ...
      equation
        i_unboxBuf = emptyTxt;
        (i_urhs, i_varDecls, i_unboxBuf) = fun_699(emptyTxt, i_p_ty, i_varDecls, i_unboxBuf, i_rhs);
        txt = Tpl.writeText(txt, i_unboxBuf);
        txt = fun_700(txt, i_p_exp, i_onPatternFail, i_urhs);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, SOME(Tpl.ST_STRING("")), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_assignments, i_varDecls, i_onPatternFail) = lm_702(txt, i_patterns, i_assignments, i_varDecls, i_onPatternFail, i_rhs);
        txt = Tpl.popIter(txt);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_703(txt, i_patterns, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_704(txt, i_patterns, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.popBlock(txt);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
