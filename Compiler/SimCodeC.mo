  ...
  matchcontinue(in_txt, in_items, in_i_outputAlloc, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_outputAlloc, i_varDecls) = lm_180(txt, rest, i_outputAlloc, i_varDecls);
      then (txt, i_outputAlloc, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        i_0__ = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, NONE, 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_0__, i_outputAlloc, i_varDecls) = lm_180(i_0__, i_outVars, i_outputAlloc, i_varDecls);
        i_0__ = Tpl.popIter(i_0__);
  ...
  matchcontinue(in_txt, in_items, in_i_prefix)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpVar i_subvar;
      equation
        txt = fun_188(txt, i_tp, i_subvar_name, i_prefix);
        txt = Tpl.nextIter(txt);
        txt = lm_189(txt, rest, i_prefix);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_index, in_i_prefix)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpVar i_subvar;
      equation
        txt = fun_192(txt, i_tp, i_index, i_subvar_name, i_prefix);
        txt = Tpl.nextIter(txt);
        txt = lm_193(txt, rest, i_index, i_prefix);
      then txt;
  ...
  matchcontinue(in_txt, in_i_type, in_i_index, in_i_prefix)
    ...
    case ( txt,
      ...
      equation
        ...
        i_args = lm_193(i_args, i_vl, i_index, i_prefix);
  ...
  matchcontinue(in_txt, in_i_it, in_i_outStruct, in_i_i, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_varName;
      equation
        i_varDecls = fun_196(i_varDecls, i_outStruct, i_var_name, i_var);
        i_varName = fun_197(emptyTxt, i_outStruct, i_i, i_var_name);
        ...
        (txt, i_varInits) = fun_199(txt, i_instDims, i_instDimsInit, i_varName, i_var_ty, i_varInits);
      then (txt, i_varDecls, i_varInits);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varInits, i_varDecls) = daeExp(txt, i_exp, SimCode.contextOther, i_varInits, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_varInits) = lm_201(txt, rest, i_varDecls, i_varInits);
      then (txt, i_varDecls, i_varInits);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_source, in_i_dest, in_i_i, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        i_instDimsInit = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_instDimsInit, i_varDecls, i_varInits) = lm_201(i_instDimsInit, i_instDims, i_varDecls, i_varInits);
        i_instDimsInit = Tpl.popIter(i_instDimsInit);
        (txt, i_varInits) = fun_202(txt, i_instDims, i_instDimsInit, i_var_ty, i_varInits, i_var_name, i_i, i_dest);
      then (txt, i_varDecls, i_varInits);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_204(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_206(txt, rest, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_fname = underscorePath(emptyTxt, i_name);
        i_args = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_204(i_args, i_extArgs, i_varDecls, i_preExp);
        i_args = Tpl.popIter(i_args);
        i_returnAssign = fun_205(emptyTxt, i_extReturn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_206(txt, i_extArgs, i_varDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        (txt, i_varDecls) = fun_207(txt, i_extReturn, i_varDecls);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_208(txt, i_extArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_209(txt, i_extReturn);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_arg, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpType i_ty;
      equation
        (txt, i_varDecls) = fun_211(txt, i_ty, i_c, i_varDecls);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_oi;
      equation
        (txt, i_varDecls) = fun_212(txt, i_oi, i_c, i_ty, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_it, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_name;
      equation
        i_name = fun_216(emptyTxt, i_oi, i_c);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_217(emptyTxt, i_oi);
        i_suffix = fun_219(emptyTxt, i_oi, i_t);
    ...
    case ( txt,
      ...
      equation
        ...
        i_name = fun_220(emptyTxt, i_outputIndex, i_c);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = funStatement(txt, i_stmt, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_222(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  i_varDecls := emptyTxt;
  i_bodyPart := Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_bodyPart, i_varDecls) := lm_222(i_bodyPart, i_body, i_varDecls);
  i_bodyPart := Tpl.popIter(i_bodyPart);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_it, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_224(txt, i_statementLst, i_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_retStruct, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_227(txt, rest, i_retStruct, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_doneVar, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("};"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_235(txt, rest, i_doneVar, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_it, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_226(txt, str_3, i_cref, i_expPart, i_t, i_preExp);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_227(txt, i_expExpLst, i_retStruct, i_varDecls, i_preExp, i_context);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        (i_er2, i_varDecls, i_preExp) = fun_229(emptyTxt, i_rng_expOption, i_varDecls, i_preExp, i_context);
    ...
    case ( txt,
      ...
      equation
        ...
        i_stmtStuff = fun_232(emptyTxt, i_boolean, i_ivar, i_identType, i_tvar, i_evar, i_arrayType, i_id);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("{\n"));
        txt = Tpl.writeText(txt, i_identType);
    ...
    case ( txt,
      ...
      local
        DAE.Statement i_when;
      equation
        (txt, i_varDecls) = fun_234(txt, i_context, i_varDecls, i_when);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_235(txt, i_caseStmt, i_doneVar, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
  ...
  matchcontinue(in_txt, in_i_it, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if ("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(" || ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_238(txt, i_helpVarIndices);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(") {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.writeText(txt, i_statements);
  ...
  matchcontinue(in_txt, in_i_helpVarIndices, in_i_when_exp, in_i_varDecls, in_i_when_elseWhen)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_241(emptyTxt, i_when_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
  ...
  matchcontinue(in_txt, in_i_it, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_240(emptyTxt, i_elseWhen, i_varDecls);
        i_preExp = emptyTxt;
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Statement i_when;
      equation
        (txt, i_varDecls) = fun_242(txt, i_helpVarIndices, i_when_exp, i_varDecls, i_when_elseWhen);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exps, in_i_ints, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_firstExp;
      equation
        (txt, i_varDecls, i_preExp) = fun_247(txt, i_ints, i_firstExp, i_varDecls, i_preExp, i_restExps);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_cref, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls, i_preExp) = fun_252(txt, ret_0, i_cref_componentRef, i_varDecls, i_preExp, i_context, i_cref);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_context, in_i_subs, in_i_varDecls, in_i_cref_ty, in_i_cref_componentRef)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_dimsValuesStr, i_varDecls, i_preExp) = lm_259(i_dimsValuesStr, i_subs, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_context, in_i_subs, in_i_varDecls, in_i_cref_ty, in_i_cref_componentRef)
    ...
    case ( txt,
      ...
      local
        Tpl.Text i_cast;
      equation
        i_cast = fun_261(emptyTxt, i_cref_ty);
...
algorithm
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_context, in_i_subs, in_i_varDecls, in_i_cref_ty, in_i_cref_componentRef)
    ...
    case ( txt,
      ...
      equation
        ret_0 = SimCode.crefNoSub(i_cref_componentRef);
        (txt, i_preExp, i_varDecls) = fun_262(txt, ret_0, i_preExp, i_context, i_subs, i_varDecls, i_cref_ty, i_cref_componentRef);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        str_1 = Tpl.textString(txt_0);
        (txt, i_preExp, i_varDecls) = fun_263(txt, str_1, i_preExp, i_context, i_subs, i_varDecls, i_cref_ty, i_cref_componentRef);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Subscript i_sub;
      equation
        (txt, i_varDecls, i_preExp) = fun_265(txt, i_sub, i_varDecls, i_preExp, i_context);
        txt = Tpl.nextIter(txt);
...
algorithm
  ...
  (i_idx__str, out_i_varDecls, out_i_preExp) := lm_266(i_idx__str, i_subs, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_i_context, in_i_cref_componentRef, in_i_preExp, in_i_dims, in_i_varDecls, in_i_aty)
    ...
    case ( txt,
      ...
      equation
        ...
        i_dimsLenStr = Tpl.writeStr(emptyTxt, intString(ret_3));
        i_dimsValuesStr = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_dimsValuesStr = lm_268(i_dimsValuesStr, i_dims);
        i_dimsValuesStr = Tpl.popIter(i_dimsValuesStr);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_cref;
      equation
        (txt, i_preExp, i_varDecls) = fun_269(txt, i_context, i_cref_componentRef, i_preExp, i_dims, i_varDecls, i_aty);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_275(txt, i_operator, i_e2, i_e1, i_preExp, i_varDecls);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_e2, i_preExp, i_varDecls) = daeExp(emptyTxt, i_exp2, i_context, i_preExp, i_varDecls);
        txt = fun_279(txt, i_operator, i_e2, i_e1);
      then (txt, i_preExp, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (i_e, i_preExp, i_varDecls) = daeExp(emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = fun_281(txt, i_operator, i_e);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_it, in_i_rel_operator, in_i_rel_exp2, in_i_varDecls, in_i_preExp, in_i_context, in_i_rel_exp1)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_283(txt, i_rel_operator, i_e2, i_e1);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        str_1 = Tpl.textString(txt_0);
        (txt, i_varDecls, i_preExp) = fun_284(txt, str_1, i_rel_operator, i_rel_exp2, i_varDecls, i_preExp, i_context, i_rel_exp1);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_context, in_i_rel_operator, in_i_rel_exp2, in_i_varDecls, in_i_preExp, in_i_rel_exp1)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp) = fun_286(txt, i_rel_operator, i_e2, i_e1, i_res, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_rel;
      equation
        (txt, i_varDecls, i_preExp) = fun_287(txt, i_context, i_rel_operator, i_rel_exp2, i_varDecls, i_preExp, i_rel_exp1);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_call, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_retVar, i_varDecls) = tempDecl(emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_cast = fun_290(emptyTxt, i_arg_ty);
    ...
    case ( txt,
      ...
      equation
        ...
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(");"));
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_NEW_LINE());
        txt = fun_293(txt, i_builtin, i_retType, i_retVar);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_scalarPrefix = fun_297(emptyTxt, i_scalar);
        i_scalarRef = fun_298(emptyTxt, i_scalar);
        i_params = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_params, i_varDecls, i_preExp) = lm_299(i_params, i_array, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_items, in_i_vars2, in_i_promote, in_i_context, in_i_varDecls, in_i_arrayTypeStr)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_vars2, i_promote, i_varDecls) = lm_301(txt, rest, i_vars2, i_promote, i_context, i_varDecls, i_arrayTypeStr);
      then (txt, i_vars2, i_promote, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_catAlloc, i_vars2, i_promote, i_varDecls) = lm_301(i_catAlloc, i_m_scalar, i_vars2, i_promote, i_context, i_varDecls, i_arrayTypeStr);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varLstStr, in_i_arrayTypeStr, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_scalarStr = fun_303(emptyTxt, i_b);
        i_scalarRefStr = fun_304(emptyTxt, i_b);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_varLstStr, i_varDecls, i_preExp) = lm_305(txt, rest, i_varLstStr, i_arrayTypeStr, i_varDecls, i_preExp, i_context);
      then (txt, i_varLstStr, i_varDecls, i_preExp);
...
algorithm
  ...
  (i_preExp2, i_varLstStr, out_i_varDecls, out_i_preExp) := lm_305(i_preExp2, i_row, i_varLstStr, i_arrayTypeStr, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_307(txt, i_ty, i_preExp, i_exp, i_varDecls, i_expVar);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls, i_preExp) = fun_309(txt, i_context, i_varDecls, i_preExp, i_arrName, i_subs, i_cref_ty);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_cast = fun_313(emptyTxt, str_8, i_accFun);
        (i_r1, i_varDecls) = tempDecl(emptyTxt, Tpl.textString(i_identType), i_varDecls);
        (i_r2, i_varDecls) = tempDecl(emptyTxt, Tpl.textString(i_identType), i_varDecls);
        (i_r3, i_varDecls) = tempDecl(emptyTxt, Tpl.textString(i_identType), i_varDecls);
        (i_er1, i_preExp, i_varDecls) = daeExp(emptyTxt, i_range_exp, i_context, i_preExp, i_varDecls);
        (i_er2, i_varDecls, i_preExp) = fun_314(emptyTxt, i_range_expOption, i_varDecls, i_preExp, i_context);
  ...
  matchcontinue(in_txt, in_items, in_i_preExpInner, in_i_varDeclsInner)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_preExpInner, i_varDeclsInner) = lm_322(txt, rest, i_preExpInner, i_varDeclsInner);
      then (txt, i_preExpInner, i_varDeclsInner);
  ...
  matchcontinue(in_txt, in_items, in_i_varDeclsInner, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDeclsInner) = lm_323(txt, rest, i_varDeclsInner, i_context);
      then (txt, i_varDeclsInner);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_0__, i_preExpInner, i_varDeclsInner) = lm_322(i_0__, ret_4, i_preExpInner, i_varDeclsInner);
        i_0__ = Tpl.popIter(i_0__);
        ...
        i_stmts = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmts, i_varDeclsInner) = lm_323(i_stmts, i_body, i_varDeclsInner, i_context);
        i_stmts = Tpl.popIter(i_stmts);
...
public function daeExpValueblock
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp) := fun_324(txt, i_exp, i_context, i_preExp);
...
algorithm
  ...
  i_dimsValuesStr := Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_dimsValuesStr, out_i_varDecls, out_i_preExp) := lm_326(i_dimsValuesStr, i_subs, i_varDecls, i_preExp, i_context);
  i_dimsValuesStr := Tpl.popIter(i_dimsValuesStr);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_args = Tpl.pushIter(emptyTxt, Tpl.ITER_OPTIONS(0, NONE, SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_331(i_args, i_listExp, i_varDecls, i_preExp, i_context);
        i_args = Tpl.popIter(i_args);
        (i_tmp, i_varDecls) = tempDecl(emptyTxt, "modelica_metatype", i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tmp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_argsStr, i_varDecls, i_preExp) = lm_334(i_argsStr, i_args, i_varDecls, i_preExp, i_context);
...
algorithm
  ...
  out_txt := fun_336(txt, ret_1, i_expPart);
  ...
  matchcontinue(in_txt, in_i_it)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Variable i_var;
      equation
        txt = fun_340(txt, i_instDims, i_var_ty);
      then txt;
...
public function expType
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_344(txt, i_array, i_ty);
end expType;
...
public function expTypeFlag
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_356(txt, i_flag, i_ty);
end expTypeFlag;
