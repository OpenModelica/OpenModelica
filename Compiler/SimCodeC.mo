  ...
  matchcontinue(in_txt, in_a_exp, in_a_rhsStr, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_496(txt, a_context, l_lhsStr, a_rhsStr, i_t);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_stmt, a_context, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_498(txt, rest, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_498(txt, i_statementLst, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_stmtStr, a_varDecls) = lm_501(l_stmtStr, i_statementLst, a_varDecls, a_context);
  ...
  matchcontinue(in_txt, in_a_range, in_a_iterator, in_a_type, in_a_shortType, in_a_body, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_stateVar, a_varDecls) = fun_503(Tpl.emptyTxt, ret_2, a_varDecls);
        ...
        (l_stepValue, a_varDecls, l_preExp) = fun_504(Tpl.emptyTxt, i_expOption, a_varDecls, l_preExp, a_context);
        ...
        txt = fun_505(txt, ret_10, l_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, a_body);
        txt = Tpl.softNewLine(txt);
        ret_11 = RTOpts.acceptMetaModelicaGrammar();
        txt = fun_506(txt, ret_11, l_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
        txt = Tpl.popBlock(txt);
...
public function algStmtForRange_impl
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_507(txt, a_range, a_iterator, a_type, a_shortType, a_body, a_context, a_varDecls);
  out_a_body := a_body;
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_stmt, a_context, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_509(txt, rest, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        l_stmtStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_stmtStr, a_varDecls) = lm_509(l_stmtStr, i_statementLst, a_varDecls, a_context);
        l_stmtStr = Tpl.popIter(l_stmtStr);
...
algorithm
  l_iterName := contextIteratorName(Tpl.emptyTxt, a_iterator, a_context);
  ret_2 := RTOpts.acceptMetaModelicaGrammar();
  (l_stateVar, out_a_varDecls) := fun_511(Tpl.emptyTxt, ret_2, a_varDecls);
  ...
  l_stmtStuff := fun_512(Tpl.emptyTxt, a_iterIsArray, l_ivar, a_type, l_tvar, l_evar, a_arrayType, l_iterName);
  ...
  out_txt := fun_513(out_txt, ret_8, l_stateVar);
  out_txt := Tpl.softNewLine(out_txt);
  ...
  out_txt := Tpl.softNewLine(out_txt);
  ret_9 := RTOpts.acceptMetaModelicaGrammar();
  out_txt := fun_514(out_txt, ret_9, l_stateVar);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.popBlock(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_LINE("}\n"));
  out_txt := Tpl.popBlock(out_txt);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_stmt, a_context, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_516(txt, rest, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_516(txt, i_statementLst, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
  ...
  matchcontinue(in_txt, in_items, in_a_varAssign, in_a_preExp, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, a_varAssign, a_preExp, a_varDecls) = lm_520(txt, rest, a_varAssign, a_preExp, a_context, a_varDecls);
      then (txt, a_varAssign, a_preExp, a_varDecls);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_a_varAssign, out_a_preExp, out_a_varDecls) := lm_520(out_txt, a_expList, a_varAssign, a_preExp, a_context, a_varDecls);
  out_txt := Tpl.popIter(out_txt);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_stmt, a_context, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_522(txt, rest, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_stmtBody, a_varDecls) = lm_522(l_stmtBody, i_body, a_varDecls, a_context);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        l_body = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_body, a_varDecls) = lm_524(l_body, i_tryBody, a_varDecls, a_context);
        l_body = Tpl.popIter(l_body);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
...
algorithm
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        l_body = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_body, a_varDecls) = lm_526(l_body, i_catchBody, a_varDecls, a_context);
        l_body = Tpl.popIter(l_body);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
  ...
  matchcontinue(in_txt, in_a_when, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_statements, a_varDecls) = lm_529(l_statements, i_statementLst, a_varDecls, a_context);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if ("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(" || ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_530(txt, i_helpVarIndices);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(") {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
...
algorithm
  ...
  matchcontinue(in_txt, in_a_context, in_a_when, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls) = fun_531(txt, a_when, i_context, a_varDecls);
      then (txt, a_varDecls);
...
public function algStmtWhen
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_varDecls) := fun_532(txt, a_context, a_when, a_varDecls);
end algStmtWhen;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_helpVarIndices, in_a_when_exp, in_a_varDecls, in_a_when_elseWhen)
    ...
    case ( txt,
           ...
           a_when_elseWhen )
      equation
        (l_restPre, a_varDecls) = fun_535(Tpl.emptyTxt, a_when_elseWhen, a_varDecls);
        l_preExp = Tpl.emptyTxt;
...
algorithm
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (l_restPre, a_varDecls) = fun_534(Tpl.emptyTxt, i_elseWhen, a_varDecls);
        l_preExp = Tpl.emptyTxt;
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls) = fun_536(txt, i_helpVarIndices, i_when_exp, a_varDecls, i_when_elseWhen);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_538(txt, rest, a_varDecls);
      then (txt, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_stmt, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        l_statements = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_statements, a_varDecls) = lm_538(l_statements, i_when_statementLst, a_varDecls);
        l_statements = Tpl.popIter(l_statements);
        ...
        l_elseCondStr = lm_539(l_elseCondStr, i_when_helpVarIndices);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_exps, in_a_ints, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls, a_preExp) = fun_541(txt, a_ints, i_firstExp, a_varDecls, a_preExp, i_restExps);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_varDecls) = algStatement(txt, i_stmt, a_context, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls) = lm_545(txt, rest, a_varDecls, a_context);
      then (txt, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_else__, in_a_context, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls) = lm_545(txt, i_statementLst, a_varDecls, a_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
  ...
  matchcontinue(in_txt, in_a_ecr, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_varDecls, a_preExp) = fun_547(txt, ret_0, i_ecr_componentRef, a_varDecls, a_preExp, a_context, i_ecr);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls, a_preExp) = fun_554(txt, a_context, i_cr, i_t, a_varDecls, a_preExp, i_exp);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_556(txt, rest, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_mArg, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_dimsValuesStr, a_varDecls, a_preExp) = lm_556(l_dimsValuesStr, ret_10, a_varDecls, a_preExp, a_context);
        l_dimsValuesStr = Tpl.popIter(l_dimsValuesStr);
        str_11 = Tpl.textString(l_arrayType);
        txt = fun_557(txt, str_11, l_dimsLenStr, l_arrayType, l_dimsValuesStr, l_arrName);
      then (txt, a_preExp, a_varDecls);
  end matchcontinue;
end fun_558;
  ...
  matchcontinue(in_txt, in_mArg, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_558(txt, ret_0, a_preExp, a_varDecls, a_ty, a_context, a_cr);
      then (txt, a_preExp, a_varDecls);
    ...
    case ( txt,
           ...
           a_cr )
      equation
        l_cast = fun_559(Tpl.emptyTxt, a_ty);
  ...
  matchcontinue(in_txt, in_a_ecr, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_561(txt, l_box, a_preExp, a_varDecls, i_ty, a_context, i_cr);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
           ...
           a_context )
      equation
        (txt, a_varDecls, a_preExp) = fun_563(txt, i_sub, a_varDecls, a_preExp, a_context);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_564(txt, rest, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  (l_idx__str, out_a_varDecls, out_a_preExp) := lm_564(l_idx__str, a_subs, a_varDecls, a_preExp, a_context);
  ...
  matchcontinue(in_txt, in_a_context, in_a_ecr_componentRef, in_a_preExp, in_a_dims, in_a_varDecls, in_a_aty)
    ...
    case ( txt,
      ...
      equation
        ...
        l_dimsValuesStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        l_dimsValuesStr = lm_566(l_dimsValuesStr, a_dims);
        l_dimsValuesStr = Tpl.popIter(l_dimsValuesStr);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_ecr, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_preExp, a_varDecls) = fun_567(txt, a_context, i_ecr_componentRef, a_preExp, i_dims, a_varDecls, i_aty);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context, in_a_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_569(txt, rest, a_varDecls, a_preExp, a_context, a_cr);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_ty, in_a_cr, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_vars, a_varDecls, a_preExp) = lm_569(l_vars, i_var__lst, a_varDecls, a_preExp, a_context, a_cr);
  ...
  matchcontinue(in_txt, in_a_operator, in_a_context, in_a_exp, in_a_e2, in_a_e1, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        a_preExp = fun_571(a_preExp, ret_1, a_e2, a_e1, l_tmpStr);
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        l_typeShort = fun_577(Tpl.emptyTxt, i_ty);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_579(txt, i_operator, a_context, i_exp, l_e2, l_e1, a_preExp, a_varDecls);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp) = fun_581(txt, i_operator, a_preExp, l_e);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        (l_e1, a_preExp, a_varDecls) = daeExp(Tpl.emptyTxt, i_exp1, a_context, a_preExp, a_varDecls);
        (l_e2, a_preExp, a_varDecls) = daeExp(Tpl.emptyTxt, i_exp2, a_context, a_preExp, a_varDecls);
        txt = fun_583(txt, i_operator, l_e2, l_e1);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        (l_e, a_preExp, a_varDecls) = daeExp(Tpl.emptyTxt, i_exp, a_context, a_preExp, a_varDecls);
        txt = fun_585(txt, i_operator, l_e);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_simRel, in_a_rel_operator, in_a_rel_exp2, in_a_varDecls, in_a_preExp, in_a_context, in_a_rel_exp1)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = fun_587(txt, a_rel_operator, l_e2, l_e1);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_varDecls, a_preExp) = fun_588(txt, l_simRel, i_rel_operator, i_rel_exp2, a_varDecls, a_preExp, a_context, i_rel_exp1);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_context, in_a_rel_operator, in_a_rel_exp2, in_a_varDecls, in_a_preExp, in_a_rel_exp1)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp) = fun_590(txt, a_rel_operator, l_e2, l_e1, l_res, a_preExp);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls, a_preExp) = fun_591(txt, a_context, i_rel_operator, i_rel_exp2, a_varDecls, a_preExp, i_rel_exp1);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_exp, a_context, a_preExp, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_597(txt, rest, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_call, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        l_type = fun_594(Tpl.emptyTxt, i_ty);
        (l_var, a_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(l_type), a_varDecls);
        (l_var1, a_preExp, a_varDecls) = daeExp(Tpl.emptyTxt, i_e1, a_context, a_preExp, a_varDecls);
        (l_var2, a_preExp, a_varDecls) = daeExp(Tpl.emptyTxt, i_e2, a_context, a_preExp, a_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        l_cast = fun_595(Tpl.emptyTxt, i_arg_ty);
    ...
    case ( txt,
      ...
      equation
        l_argStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_argStr, a_varDecls, a_preExp) = lm_597(l_argStr, i_expLst, a_varDecls, a_preExp, a_context);
        l_argStr = Tpl.popIter(l_argStr);
        l_funName = underscorePath(Tpl.emptyTxt, i_path);
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING(");"));
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_NEW_LINE());
        txt = fun_598(txt, i_builtin, l_retType, l_retVar);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context, in_a_scalar)
    ...
    case ( txt,
           ...
           a_scalar )
      equation
        l_prefix = fun_604(Tpl.emptyTxt, a_scalar, i_e);
        txt = Tpl.writeText(txt, l_prefix);
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_e, a_context, a_preExp, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_605(txt, rest, a_varDecls, a_preExp, a_context, a_scalar);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        l_scalarPrefix = fun_602(Tpl.emptyTxt, i_scalar);
        l_scalarRef = fun_603(Tpl.emptyTxt, i_scalar);
        l_params = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_params, a_varDecls, a_preExp) = lm_605(l_params, i_array, a_varDecls, a_preExp, a_context, i_scalar);
  ...
  matchcontinue(in_txt, in_items, in_a_vars2, in_a_promote, in_a_context, in_a_varDecls, in_a_arrayTypeStr)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, a_vars2, a_promote, a_varDecls) = lm_607(txt, rest, a_vars2, a_promote, a_context, a_varDecls, a_arrayTypeStr);
      then (txt, a_vars2, a_promote, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_catAlloc, l_vars2, l_promote, a_varDecls) = lm_607(l_catAlloc, i_m_scalar, l_vars2, l_promote, a_context, a_varDecls, l_arrayTypeStr);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_a_varLstStr, in_a_arrayTypeStr, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
           ...
           a_context )
      equation
        l_scalarStr = fun_609(Tpl.emptyTxt, i_b);
        l_scalarRefStr = fun_610(Tpl.emptyTxt, i_b);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, a_varLstStr, a_varDecls, a_preExp) = lm_611(txt, rest, a_varLstStr, a_arrayTypeStr, a_varDecls, a_preExp, a_context);
      then (txt, a_varLstStr, a_varDecls, a_preExp);
...
algorithm
  ...
  (l_preExp2, l_varLstStr, out_a_varDecls, out_a_preExp) := lm_611(l_preExp2, a_row, l_varLstStr, a_arrayTypeStr, a_varDecls, a_preExp, a_context);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExp, a_varDecls) = fun_613(txt, i_ty, a_preExp, i_exp, a_varDecls, l_expVar);
      then (txt, a_preExp, a_varDecls);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_varDecls, a_preExp) = fun_616(txt, a_context, a_varDecls, a_preExp, i_subs, i_ecr_ty, l_arrName);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_mArg, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
           ...
           a_varDecls )
      equation
        (txt, a_varDecls, a_preExp) = fun_615(txt, a_exp, a_varDecls, a_preExp, a_context);
      then (txt, a_preExp, a_varDecls);
...
algorithm
  ...
  str_1 := Tpl.textString(txt_0);
  (out_txt, out_a_preExp, out_a_varDecls) := fun_618(txt, str_1, a_exp, a_context, a_preExp, a_varDecls);
end daeExpAsub;
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        l_cast = fun_621(Tpl.emptyTxt, str_7);
  ...
  matchcontinue(in_txt, in_items, in_a_preExpInner, in_a_varDeclsInner)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExpInner, a_varDeclsInner) = lm_630(txt, rest, a_preExpInner, a_varDeclsInner);
      then (txt, a_preExpInner, a_varDeclsInner);
  ...
  matchcontinue(in_txt, in_items, in_a_preExpInput, in_a_context, in_a_expInput, in_a_varDeclsInput, in_a_prefix)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_preExpInput, a_expInput, a_varDeclsInput) = lm_631(txt, rest, a_preExpInput, a_context, a_expInput, a_varDeclsInput, a_prefix);
      then (txt, a_preExpInput, a_expInput, a_varDeclsInput);
  ...
  matchcontinue(in_txt, in_items, in_a_assignments, in_a_varDeclsCaseInner, in_a_onPatternFail, in_a_prefix)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_assignments, a_varDeclsCaseInner, a_onPatternFail) = lm_636(txt, rest, a_assignments, a_varDeclsCaseInner, a_onPatternFail, a_prefix);
      then (txt, a_assignments, a_varDeclsCaseInner, a_onPatternFail);
  ...
  matchcontinue(in_txt, in_items, in_a_varDeclsCaseInner, in_a_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDeclsCaseInner) = lm_637(txt, rest, a_varDeclsCaseInner, a_context);
      then (txt, a_varDeclsCaseInner);
  ...
  matchcontinue(in_txt, in_items, in_a_preExpCaseInner, in_a_varDeclsCaseInner)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_preExpCaseInner, a_varDeclsCaseInner) = lm_639(txt, rest, a_preExpCaseInner, a_varDeclsCaseInner);
      then (txt, a_preExpCaseInner, a_varDeclsCaseInner);
  ...
  matchcontinue(in_txt, in_items, in_a_done, in_a_res, in_a_context, in_a_onPatternFail, in_a_prefix)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_patternMatching, l_assignments, l_varDeclsCaseInner, a_onPatternFail) = lm_636(l_patternMatching, i_c_patterns, l_assignments, l_varDeclsCaseInner, a_onPatternFail, a_prefix);
        ...
        (l_stmts, l_varDeclsCaseInner) = lm_637(l_stmts, i_c_body, l_varDeclsCaseInner, a_context);
        l_stmts = Tpl.popIter(l_stmts);
        (l_caseRes, l_varDeclsCaseInner, l_preRes) = fun_638(Tpl.emptyTxt, i_c_result, l_varDeclsCaseInner, l_preRes, a_context);
        ret_8 = SimCode.elementVars(i_c_localDecls);
        (l_0__, l_preExpCaseInner, l_varDeclsCaseInner) = lm_639(Tpl.emptyTxt, ret_8, l_preExpCaseInner, l_varDeclsCaseInner);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("case "));
        txt = Tpl.writeStr(txt, intString(x_i0));
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(": {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        ...
        txt = Tpl.softNewLine(txt);
        txt = fun_640(txt, i_c_result, l_caseRes, a_res, l_preRes);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.nextIter(txt);
        (txt, a_onPatternFail) = lm_641(txt, rest, a_done, a_res, a_context, a_onPatternFail, a_prefix);
      then (txt, a_onPatternFail);
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_ignore2, l_preExpInner, l_varDeclsInner) = lm_630(Tpl.emptyTxt, ret_6, l_preExpInner, l_varDeclsInner);
        ...
        (l_ignore3, l_preExpInput, l_expInput, l_varDeclsInput) = lm_631(l_ignore3, i_inputs, l_preExpInput, a_context, l_expInput, l_varDeclsInput, l_prefix);
        l_ignore3 = Tpl.popIter(l_ignore3);
        (l_res, a_varDecls) = fun_632(Tpl.emptyTxt, i_et, a_varDecls);
        ...
        l_onPatternFail = fun_633(Tpl.emptyTxt, i_exp_matchType);
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING("{ /* "));
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_LINE("++) {\n"));
        a_preExp = Tpl.pushBlock(a_preExp, Tpl.BT_INDENT(2));
        a_preExp = fun_635(a_preExp, i_exp_matchType);
        a_preExp = Tpl.softNewLine(a_preExp);
        ...
        (a_preExp, l_onPatternFail) = lm_641(a_preExp, i_cases, l_done, l_res, a_context, l_onPatternFail, l_prefix);
        a_preExp = Tpl.popIter(a_preExp);
        a_preExp = Tpl.softNewLine(a_preExp);
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_LINE("}\n"));
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        (txt, a_preExp, a_varDecls) = daeExp(txt, i_exp, a_context, a_preExp, a_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_644(txt, rest, a_varDecls, a_preExp, a_context);
      then (txt, a_varDecls, a_preExp);
...
algorithm
  ...
  l_dimsValuesStr := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (l_dimsValuesStr, out_a_varDecls, out_a_preExp) := lm_644(l_dimsValuesStr, a_subs, a_varDecls, a_preExp, a_context);
  l_dimsValuesStr := Tpl.popIter(l_dimsValuesStr);
  str_4 := Tpl.textString(l_arrayType);
  out_txt := fun_645(txt, str_4, l_dimsLenStr, l_arrayType, l_dimsValuesStr, a_arrName);
end arrayScalarRhs;
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        l_args = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (l_args, a_varDecls, a_preExp) = lm_650(l_args, i_listExp, a_varDecls, a_preExp, a_context);
        l_args = Tpl.popIter(l_args);
        (l_tmp, a_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", a_varDecls);
        a_preExp = Tpl.writeText(a_preExp, l_tmp);
        ...
        a_preExp = Tpl.writeTok(a_preExp, Tpl.ST_STRING("0"));
        a_preExp = fun_651(a_preExp, l_args);
  ...
  matchcontinue(in_txt, in_a_args, in_a_varDecls, in_a_preExp, in_a_context)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls, a_preExp) = lm_654(txt, i_args, a_varDecls, a_preExp, a_context);
        txt = Tpl.popIter(txt);
      then (txt, a_varDecls, a_preExp);
  end matchcontinue;
end fun_655;
  ...
  matchcontinue(in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_argsStr, a_varDecls, a_preExp) = fun_655(Tpl.emptyTxt, i_args, a_varDecls, a_preExp, a_context);
  ...
  matchcontinue(in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_varname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_varDecls, a_preExp) = lm_658(txt, rest, a_varDecls, a_preExp, a_varname);
      then (txt, a_varDecls, a_preExp);
  ...
  matchcontinue(in_txt, in_a_varLst, in_a_varDecls, in_a_preExp, in_a_varname)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_varDecls, a_preExp) = lm_658(txt, i_varLst, a_varDecls, a_preExp, a_varname);
        txt = Tpl.popIter(txt);
      then (txt, a_varDecls, a_preExp);
  end matchcontinue;
end fun_659;
  ...
  matchcontinue(in_txt, in_a_type, in_a_varname, in_a_preExp, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (l_args, a_varDecls, a_preExp) = fun_659(Tpl.emptyTxt, i_varLst, a_varDecls, a_preExp, a_varname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("mmc_mk_box"));
...
public function daeExpMetaHelperConstantNameType
  ...
  output Tpl.Text out_a_varDecls;
algorithm
  (out_txt, out_a_preExp, out_a_varDecls) := fun_660(txt, a_type, a_varname, a_preExp, a_varDecls);
  out_a_varname := a_varname;
...
public function expType
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_673(txt, a_array, a_ty);
end expType;
...
public function expTypeFlag
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_685(txt, a_flag, a_ty);
end expTypeFlag;
  ...
  matchcontinue(in_txt, in_items, in_a_assignments, in_a_onPatternFail, in_a_rhs, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_assignments, a_onPatternFail, a_varDecls) = lm_701(txt, rest, a_assignments, a_onPatternFail, a_rhs, a_varDecls);
      then (txt, a_assignments, a_onPatternFail, a_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_a_assignments, in_a_varDecls, in_a_onPatternFail, in_a_rhs)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, a_assignments, a_varDecls, a_onPatternFail) = lm_702(txt, rest, a_assignments, a_varDecls, a_onPatternFail, a_rhs);
      then (txt, a_assignments, a_varDecls, a_onPatternFail);
  ...
  matchcontinue(in_txt, in_items, in_a_assignments, in_a_onPatternFail, in_a_rhs, in_a_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, l_tvar, a_onPatternFail, a_varDecls, a_assignments) = patternMatch(txt, i_p, l_tvar, a_onPatternFail, a_varDecls, a_assignments);
        txt = Tpl.nextIter(txt);
        (txt, a_assignments, a_onPatternFail, a_varDecls) = lm_704(txt, rest, a_assignments, a_onPatternFail, a_rhs, a_varDecls);
      then (txt, a_assignments, a_onPatternFail, a_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_a_pat, in_a_rhs, in_a_onPatternFail, in_a_varDecls, in_a_assignments)
    ...
    case ( txt,
      ...
      equation
        l_unboxBuf = Tpl.emptyTxt;
        (l_urhs, a_varDecls, l_unboxBuf) = fun_699(Tpl.emptyTxt, i_p_ty, a_varDecls, l_unboxBuf, a_rhs);
        txt = Tpl.writeText(txt, l_unboxBuf);
        txt = fun_700(txt, i_p_exp, a_onPatternFail, l_urhs);
      then (txt, a_rhs, a_onPatternFail, a_varDecls, a_assignments);
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_assignments, a_onPatternFail, a_varDecls) = lm_701(txt, i_patterns, a_assignments, a_onPatternFail, a_rhs, a_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, a_rhs, a_onPatternFail, a_varDecls, a_assignments);
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(1, SOME(Tpl.ST_STRING("")), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, a_assignments, a_varDecls, a_onPatternFail) = lm_702(txt, i_patterns, a_assignments, a_varDecls, a_onPatternFail, a_rhs);
        txt = Tpl.popIter(txt);
      then (txt, a_rhs, a_onPatternFail, a_varDecls, a_assignments);
    ...
    case ( txt,
           ...
           a_assignments )
      equation
        (txt, a_assignments, a_onPatternFail, a_varDecls) = lm_703(txt, i_patterns_1, a_assignments, a_onPatternFail, a_rhs, a_varDecls);
      then (txt, a_rhs, a_onPatternFail, a_varDecls, a_assignments);
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, a_assignments, a_onPatternFail, a_varDecls) = lm_704(txt, i_patterns, a_assignments, a_onPatternFail, a_rhs, a_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, a_rhs, a_onPatternFail, a_varDecls, a_assignments);
