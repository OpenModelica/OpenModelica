  ...
  matchcontinue(in_txt, in_i_simulationSettingsOpt, in_i_fileNamePrefix, in_i_simCode)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text txt_0;
      equation
        txt_0 = simulationInitFile(Tpl.emptyTxt, i_simCode);
  ...
  matchcontinue(in_txt, in_i_simCode)
    ...
    case ( txt,
      ...
      equation
        ...
        Tpl.textFile(txt_0, Tpl.textString(txt_1));
        txt_2 = simulationFunctionsHeaderFile(Tpl.emptyTxt, i_fileNamePrefix, i_functions, i_externalFunctionIncludes);
        ...
        txt_4 = simulationFunctionsFile(Tpl.emptyTxt, i_fileNamePrefix, i_functions, i_externalFunctionIncludes);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_functionCode)
    ...
    case ( txt,
      ...
      equation
        i_filePrefix = Tpl.writeStr(Tpl.emptyTxt, i_name);
        txt_1 = functionsHeaderFile(Tpl.emptyTxt, Tpl.textString(i_filePrefix), i_mainFunction, i_functions, i_extraRecordDecls, i_externalFunctionIncludes);
  ...
  matchcontinue(in_txt, in_i_modelInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = lm_18(txt, i_vars_stateVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_19(txt, i_vars_derivativeVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_20(txt, i_vars_algVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_21(txt, i_vars_paramVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_22(txt, i_vars_extObjVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_23(txt, i_vars_intAlgVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_24(txt, i_vars_intParamVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_25(txt, i_vars_boolAlgVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_26(txt, i_vars_boolParamVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_27(txt, i_vars_stringAlgVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_28(txt, i_vars_stringParamVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "\n",
  ...
  matchcontinue(in_txt, in_i_items, in_i_name)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_itemsStr;
      equation
        i_itemsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_itemsStr = lm_64(i_itemsStr, i_items);
...
public function globalDataVarNamesArray
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_65(txt, i_items, i_name);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_items, in_i_name)
    ...
    case ( txt,
      ...
      equation
        i_itemsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_itemsStr = lm_67(i_itemsStr, i_items);
        i_itemsStr = Tpl.popIter(i_itemsStr);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("const char* "));
        txt = Tpl.writeStr(txt, i_name);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("["));
...
public function globalDataVarCommentsArray
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_68(txt, i_items, i_name);
  ...
  matchcontinue(in_txt, in_i_modelInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_74(txt, i_vars_stateVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_75(txt, i_vars_derivativeVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_76(txt, i_vars_algVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_77(txt, i_vars_paramVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_78(txt, i_vars_intAlgVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_79(txt, i_vars_intParamVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("return \"\";\n"));
        txt = Tpl.popBlock(txt);
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_80(txt, i_vars_boolAlgVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_81(txt, i_vars_boolParamVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("return \"\";\n"));
        txt = Tpl.popBlock(txt);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_argsStr;
      equation
        i_argsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_argsStr, i_varDecls, i_preExp) = lm_86(i_argsStr, i_args, i_varDecls, i_preExp);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_87(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_extObjInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        i_ctorCalls = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_ctorCalls, i_varDecls, i_preExp) = lm_87(i_ctorCalls, i_constructors, i_varDecls, i_preExp);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_nonStateContPart := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_nonStateContPart, i_varDecls) := lm_92(i_nonStateContPart, i_nonStateContEquations, i_varDecls);
  i_nonStateContPart := Tpl.popIter(i_nonStateContPart);
  i_algAndEqAssertsPart := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_algAndEqAssertsPart, i_varDecls) := lm_93(i_algAndEqAssertsPart, i_algorithmAndEquationAsserts, i_varDecls);
  i_algAndEqAssertsPart := Tpl.popIter(i_algAndEqAssertsPart);
  i_removedPart := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_removedPart, i_varDecls) := lm_94(i_removedPart, i_removedEquations, i_varDecls);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_nonSateDiscPart := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_nonSateDiscPart, i_varDecls) := lm_96(i_nonSateDiscPart, i_nonStateDiscEquations, i_varDecls);
  i_nonSateDiscPart := Tpl.popIter(i_nonSateDiscPart);
  i_removedPart := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_removedPart, i_varDecls) := lm_97(i_removedPart, i_removedEquations, i_varDecls);
  i_removedPart := Tpl.popIter(i_removedPart);
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
  ...
  matchcontinue(in_txt, in_i_modelInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_99(txt, i_vars_inputVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
  ...
  matchcontinue(in_txt, in_i_modelInfo)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_101(txt, i_vars_outputVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("return 0;\n"));
        txt = Tpl.popBlock(txt);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  (i_zeroCrossingsCode, i_varDecls) := zeroCrossingsTpl(Tpl.emptyTxt, i_zeroCrossings, i_varDecls);
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
...
algorithm
  ...
  out_txt := lm_106(out_txt, i_zeroCrossingsNeedSave);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  (i_timeEventCode, i_varDecls) := timeEventsTpl(Tpl.emptyTxt, i_zeroCrossings, i_varDecls);
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, SimCode.contextSimulationDiscrete, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_eqs := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_eqs, i_varDecls) := lm_109(i_eqs, i_allEquations, i_varDecls);
  i_eqs := Tpl.popIter(i_eqs);
  i_hvars := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_hvars, i_varDecls) := lm_110(i_hvars, i_helpVarInfo, i_varDecls);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_eqs := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_eqs, i_varDecls) := lm_112(i_eqs, i_allEquationsPlusWhen, i_varDecls);
  i_eqs := Tpl.popIter(i_eqs);
  i_reinit := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_reinit, i_varDecls) := lm_113(i_reinit, i_whenClauses, i_varDecls);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_hvars := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_hvars, i_varDecls) := lm_116(i_hvars, i_helpVarInfo, i_varDecls);
  i_hvars := Tpl.popIter(i_hvars);
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
...
algorithm
  ...
  out_txt := Tpl.pushBlock(out_txt, Tpl.BT_INDENT(2));
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_118(out_txt, i_discreteModelVars);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       "\n",
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_eRes, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, SimCode.contextSimulationNonDiscrete, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_delayed, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = lm_120(txt, i_delayedExps, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  (i_storePart, i_varDecls) := fun_121(Tpl.emptyTxt, i_delayed, i_varDecls);
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING("extern int const numDelayExpressionIndex = "));
  out_txt := fun_122(out_txt, i_delayed);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       ";\n",
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_body;
      equation
        (i_body, i_varDecls) = functionWhenReinitStatement(Tpl.emptyTxt, i_reinit, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_124(txt, i_reinits, i_varDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("break;"));
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.popBlock(txt);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_125(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_cases := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_cases, i_varDecls) := lm_125(i_cases, i_whenClauses, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_when, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_weq_right, SimCode.contextSimulationDiscrete, i_preExp, i_varDecls);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("save("));
...
algorithm
  ...
  matchcontinue(in_txt, in_i_reinit, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_val, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_value, SimCode.contextSimulationDiscrete, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("  "));
  ...
  matchcontinue(in_txt, in_items, in_i_helpInits, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_helpInit;
      equation
        (i_helpInit, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, SimCode.contextSimulationDiscrete, i_preExp, i_varDecls);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("])"));
        txt = Tpl.nextIter(txt);
        (txt, i_helpInits, i_varDecls, i_preExp) = lm_129(txt, rest, i_helpInits, i_varDecls, i_preExp);
      then (txt, i_helpInits, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_whenClauses, in_i_varDecls, in_i_int)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_ifthen, i_varDecls) = functionWhenReinitStatementThen(Tpl.emptyTxt, i_reinits, i_varDecls);
...
algorithm
  i_body := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_body, out_i_varDecls, out_i_preExp) := lm_136(i_body, i_reinits, i_varDecls, i_preExp);
  i_body := Tpl.popIter(i_body);
  out_txt := Tpl.pushBlock(txt, Tpl.BT_INDENT(1));
  out_txt := Tpl.writeText(out_txt, i_body);
  out_txt := Tpl.popBlock(out_txt);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = equation_(txt, i_eq, SimCode.contextSimulationNonDiscrete, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_138(txt, rest, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls2)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls2) = lm_139(txt, rest, i_varDecls2);
      then (txt, i_varDecls2);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_stateContPart := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_stateContPart, i_varDecls) := lm_138(i_stateContPart, i_stateContEquations, i_varDecls);
  i_stateContPart := Tpl.popIter(i_stateContPart);
  i_varDecls2 := Tpl.emptyTxt;
  i_stateContPartInline := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_stateContPartInline, i_varDecls2) := lm_139(i_stateContPartInline, i_stateContEquations, i_varDecls2);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_Equations__ := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_Equations__, i_varDecls) := lm_141(i_Equations__, i_JacEquations, i_varDecls);
  i_Equations__ := Tpl.popIter(i_Equations__);
  i_Vars__ := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  i_Vars__ := lm_142(i_Vars__, i_JacVars);
  i_Vars__ := Tpl.popIter(i_Vars__);
  i_writeJac__ := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  i_writeJac__ := lm_143(i_writeJac__, i_JacVars);
  i_writeJac__ := Tpl.popIter(i_writeJac__);
  ...
  matchcontinue(in_txt, in_i_item)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ComponentRef i_name;
      equation
        txt = fun_146(txt, i_index, i_name);
      then txt;
  ...
  matchcontinue(in_txt, in_i_modelInfo)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_matrixA;
      equation
        i_matrixA = genMatrix(Tpl.emptyTxt, "A", i_varInfo_numStateVars, i_varInfo_numStateVars);
        i_matrixB = genMatrix(Tpl.emptyTxt, "B", i_varInfo_numStateVars, i_varInfo_numInVars);
        i_matrixC = genMatrix(Tpl.emptyTxt, "C", i_varInfo_numOutVars, i_varInfo_numStateVars);
        i_matrixD = genMatrix(Tpl.emptyTxt, "D", i_varInfo_numOutVars, i_varInfo_numInVars);
        i_vectorX = genVector(Tpl.emptyTxt, "x", i_varInfo_numStateVars, 0);
        i_vectorU = genVector(Tpl.emptyTxt, "u", i_varInfo_numInVars, 1);
        i_vectorY = genVector(Tpl.emptyTxt, "y", i_varInfo_numOutVars, 2);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
  ...
  matchcontinue(in_txt, in_i_simVars, in_i_arrayName, in_i_arraySize)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_rest;
      equation
        i_rest = getVarName(Tpl.emptyTxt, i_restVars, i_arrayName, i_arraySize);
        ret_2 = listLength(i_restVars);
        ret_3 = SimCode.decrementInt(i_arraySize, ret_2);
        i_arrindex = Tpl.writeStr(Tpl.emptyTxt, intString(ret_3));
        txt = fun_149(txt, i_var, i_rest, i_arrindex, i_arrayName);
      then txt;
  ...
  matchcontinue(in_txt, in_i_row, in_i_name, in_i_col)
    ...
    case ( txt,
      ...
      local
        Integer i_row;
      equation
        txt = fun_151(txt, i_col, i_row, i_name);
      then txt;
  end matchcontinue;
end fun_152;
...
public function genMatrix
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_152(txt, i_row, i_name, i_col);
end genMatrix;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_flag, in_i_name, in_i_numIn)
    ...
    case ( txt,
           ...
           i_numIn )
      equation
        txt = fun_154(txt, i_numIn, i_name);
      then txt;
...
public function genVector
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_157(txt, i_flag, i_name, i_numIn);
end genVector;
...
protected
  Tpl.Text i_jacMats;
algorithm
  i_jacMats := lm_159(Tpl.emptyTxt, i_JacobianMatrixes);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_161(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  (i_eqPart, i_varDecls) := lm_161(i_eqPart, i_initialEquations, i_varDecls);
  ...
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_NEW_LINE());
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_162(out_txt, i_initialEquations);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       "\n",
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, SimCode.contextOther, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_exp;
      equation
        (txt, i_varDecls) = fun_164(txt, i_exp, i_varDecls);
        txt = Tpl.nextIter(txt);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_body := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_body, i_varDecls) := lm_165(i_body, i_residualEquations, i_varDecls);
  i_body := Tpl.popIter(i_body);
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_eq2_exp, SimCode.contextSimulationDiscrete, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
      ...
      equation
        i_varDecls = Tpl.emptyTxt;
        i_prebody = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_prebody, i_varDecls) = lm_167(i_prebody, i_eq_eqs, i_varDecls);
        i_prebody = Tpl.popIter(i_prebody);
        i_body = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_body, i_varDecls) = lm_168(i_body, i_eq_eqs, i_varDecls);
        i_body = Tpl.popIter(i_body);
...
algorithm
  ...
  out_txt := lm_169(out_txt, i_allEquations);
  out_txt := Tpl.popIter(out_txt);
...
algorithm
  i_varDecls := Tpl.emptyTxt;
  i_body := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_body, i_varDecls) := lm_171(i_body, i_parameterEquations, i_varDecls);
  i_body := Tpl.popIter(i_body);
  i_divbody := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_divbody, i_varDecls) := lm_172(i_divbody, i_parameterEquations, i_varDecls);
  ...
  matchcontinue(in_txt, in_items)
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_hindex;
      equation
        txt = fun_174(txt, i_windex, i_hindex);
        txt = Tpl.nextIter(txt);
        txt = lm_175(txt, rest);
      then txt;
...
algorithm
  ...
  out_txt := Tpl.pushBlock(out_txt, Tpl.BT_INDENT(2));
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_175(out_txt, i_helpVarInfo);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_NEW_LINE());
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_176(out_txt, i_discreteModelVars);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       "\n",
...
algorithm
  ...
  (out_txt, out_i_varDecls) := lm_178(out_txt, i_zeroCrossings, i_varDecls);
  out_txt := Tpl.popIter(out_txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_relation, in_i_index, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp1, SimCode.contextOther, i_preExp, i_varDecls);
        i_op = zeroCrossingOpFunc(Tpl.emptyTxt, i_operator);
        (i_e2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp2, SimCode.contextOther, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_start, SimCode.contextOther, i_preExp, i_varDecls);
        (i_e2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_interval, SimCode.contextOther, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("ZEROCROSSING("));
        txt = Tpl.writeStr(txt, intString(i_index));
...
public function zeroCrossingTpl
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varDecls) := fun_180(txt, i_relation, i_index, i_varDecls);
end zeroCrossingTpl;
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_i_varDecls) := lm_182(out_txt, i_zeroCrossings, i_varDecls);
  out_txt := Tpl.popIter(out_txt);
end timeEventsTpl;
...
public function timeEventTpl
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varDecls) := fun_184(txt, i_relation, i_index, i_varDecls);
end timeEventTpl;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_eq, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = cref(txt, i_cref);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" = "));
  ...
  matchcontinue(in_txt, in_it, in_i_context, in_i_eqn_componentRef, in_i_expPart, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        Tpl.Text i_tvar;
      equation
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, "boolean_array", i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
    ...
    case ( txt,
      ...
      local
        Tpl.Text i_tvar;
      equation
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, "integer_array", i_varDecls);
  ...
  matchcontinue(in_txt, in_i_eq, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_201(txt, str_3, i_context, i_eqn_componentRef, i_expPart, i_preExp, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_eq, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_203(txt, i_statements, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_size, in_i_aname, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_eq_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_206(txt, rest, i_size, i_aname, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_bname, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_207(txt, rest, i_bname, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_eq, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_mixedPostfix = fun_205(Tpl.emptyTxt, i_partOfMixed);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_206(txt, i_simJac, i_size, i_aname, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_207(txt, i_beqs, i_bname, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preDisc, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        (i_expPart, i_preDisc, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preDisc, i_varDecls);
        txt = cref(txt, i_cref);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" = "));
        txt = Tpl.writeText(txt, i_expPart);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preDisc) = lm_210(txt, rest, i_varDecls, i_preDisc, i_context);
      then (txt, i_varDecls, i_preDisc);
  ...
  matchcontinue(in_txt, in_i_eq, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_contEqs;
      equation
        (i_contEqs, i_varDecls) = equation_(Tpl.emptyTxt, i_cont, i_context, i_varDecls);
        ret_2 = listLength(i_discVars);
        i_numDiscVarsStr = Tpl.writeStr(Tpl.emptyTxt, intString(ret_2));
        ret_4 = listLength(i_values);
        i_valuesLenStr = Tpl.writeStr(Tpl.emptyTxt, intString(ret_4));
        ...
        (i_discLoc2, i_varDecls, i_preDisc) = lm_210(i_discLoc2, i_discEqs, i_varDecls, i_preDisc, i_context);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("] = {"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_212(txt, i_value__dims);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("};\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_213(txt, i_discVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("{\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
...
public function equationNonlinear
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  out_txt := fun_218(txt, i_eq, i_context);
  ...
  matchcontinue(in_txt, in_items, in_i_helpInits, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_helpInit;
      equation
        (i_helpInit, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        i_helpInits = Tpl.writeTok(i_helpInits, Tpl.ST_STRING("localData->helpVars["));
        i_helpInits = Tpl.writeStr(i_helpInits, intString(i_hidx));
        i_helpInits = Tpl.writeTok(i_helpInits, Tpl.ST_STRING("] = "));
        i_helpInits = Tpl.writeText(i_helpInits, i_helpInit);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("])"));
        txt = Tpl.nextIter(txt);
        (txt, i_helpInits, i_varDecls, i_preExp) = lm_220(txt, rest, i_helpInits, i_varDecls, i_preExp, i_context);
      then (txt, i_helpInits, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_eq, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_helpInits = Tpl.emptyTxt;
        i_helpIf = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(" || ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_helpIf, i_helpInits, i_varDecls, i_preExp) = lm_220(i_helpIf, i_conditions, i_helpInits, i_varDecls, i_preExp, i_context);
        i_helpIf = Tpl.popIter(i_helpIf);
        i_preExp2 = Tpl.emptyTxt;
        (i_exp, i_preExp2, i_varDecls) = daeExp(Tpl.emptyTxt, i_right, i_context, i_preExp2, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_helpInits);
        txt = Tpl.softNewLine(txt);
  ...
  matchcontinue(in_txt, in_i_simCode)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_dirExtra;
      equation
        i_dirExtra = fun_224(Tpl.emptyTxt, i_modelInfo_directory);
        ...
        i_libsPos1 = fun_226(Tpl.emptyTxt, str_3, i_libsStr);
        str_5 = Tpl.textString(i_dirExtra);
        i_libsPos2 = fun_227(Tpl.emptyTxt, str_5, i_libsStr);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
...
algorithm
  ...
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_236(out_txt, i_extraRecordDecls);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       "}\n",
...
algorithm
  ...
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.pushIter(out_txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_238(out_txt, i_extraRecordDecls);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       "\n",
...
algorithm
  ...
  matchcontinue(in_txt, in_i_fnCode)
    ...
    case ( txt,
      ...
      equation
        i_libsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(" ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_libsStr = lm_240(i_libsStr, i_makefileParams_libs);
        i_libsStr = Tpl.popIter(i_libsStr);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "# Makefile generated by OpenModelica\n",
                                    "\n",
...
public function contextCref
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_242(txt, i_context, i_cr);
end contextCref;
...
public function contextIteratorName
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_244(txt, i_context, i_name);
...
algorithm
  i_preExp := Tpl.emptyTxt;
  i_varDecls := Tpl.emptyTxt;
  (out_txt, i_varDecls, i_preExp) := fun_250(txt, i_subscript, i_varDecls, i_preExp);
end subscriptToCStr;
...
public function contextArrayCref
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_259(txt, i_context, i_cr);
...
algorithm
  i_preExp := Tpl.emptyTxt;
  i_varDecls := Tpl.emptyTxt;
  (out_txt, i_varDecls, i_preExp) := fun_266(txt, i_subscript, i_varDecls, i_preExp);
end subscriptStr;
  ...
  matchcontinue(in_txt, in_i_str)
    ...
    case ( txt,
      ...
      equation
        ...
        i_str__dots = Tpl.writeStr(Tpl.emptyTxt, ret_1);
        ret_3 = System.stringReplace(Tpl.textString(i_str__dots), "_", "__");
        i_str__underscores = Tpl.writeStr(Tpl.emptyTxt, ret_3);
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_275(out_txt, i_functions);
  out_txt := Tpl.popIter(out_txt);
end functionHeaders;
  ...
  matchcontinue(in_txt, in_i_fn, in_i_inFunc)
    ...
    case ( txt,
      ...
      equation
        ...
        i_funArgsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_funArgsStr = lm_279(i_funArgsStr, i_funArgs);
        i_funArgsStr = Tpl.popIter(i_funArgsStr);
        ret_3 = RTOpts.acceptMetaModelicaGrammar();
        i_funArgsBoxedStr = fun_281(Tpl.emptyTxt, ret_3, i_funArgs);
        ret_5 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedHeader = fun_282(Tpl.emptyTxt, ret_5, i_funArgsBoxedStr, i_fname);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_283(txt, i_recordDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("#define "));
        txt = Tpl.writeText(txt, i_fname);
  ...
  matchcontinue(in_txt, in_i_recDecl)
    ...
    case ( txt,
      ...
      equation
        ...
        txt_2 = lm_285(txt_2, i_variables);
        txt_2 = Tpl.popIter(txt_2);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text txt_0;
      equation
        txt_0 = dotPath(Tpl.emptyTxt, i_path);
        txt_1 = underscorePath(Tpl.emptyTxt, i_path);
        txt_2 = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(",")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt_2 = lm_286(txt_2, i_fieldNames);
        txt_2 = Tpl.popIter(txt_2);
        ret_3 = listLength(i_fieldNames);
        txt = recordDefinition(txt, Tpl.textString(txt_0), Tpl.textString(txt_1), Tpl.textString(txt_2), ret_3);
      then txt;
...
public function recordDefinitionHeader
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := Tpl.writeTok(txt, Tpl.ST_STRING("extern const char* "));
  out_txt := Tpl.writeStr(out_txt, i_encName);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING("__desc__fields["));
  out_txt := Tpl.writeStr(out_txt, intString(i_numFields));
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
...
algorithm
  ...
  out_txt := fun_293(txt, ret_0, i_fname, i_fargs, i_outVars);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_boxed, in_i_fname, in_i_inFunc)
    ...
    case ( txt,
           ...
           i_inFunc )
      equation
        txt = fun_300(txt, i_inFunc, i_fname);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_boxStr, in_i_fname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeStr(txt, intString(i_i1));
        txt = Tpl.nextIter(txt);
        txt = lm_302(txt, rest, i_boxStr, i_fname);
      then txt;
  ...
  matchcontinue(in_txt, in_i_ty)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("["));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_303(txt, i_arrayDimensions);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("]"));
      then txt;
...
protected function fun_306
  input Tpl.Text in_txt;
  input SimCode.Variable in_i_var;
  input Integer in_i_i1;
  input Boolean in_i_boxed;

  output Tpl.Text out_txt;
algorithm
  out_txt :=
  matchcontinue(in_txt, in_i_var, in_i_i1, in_i_boxed)
    local
      Tpl.Text txt;
      Integer i_i1;
      Boolean i_boxed;
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_dimStr;
      equation
        i_dimStr = fun_304(Tpl.emptyTxt, i_ty);
        i_typeStr = fun_305(Tpl.emptyTxt, i_boxed, i_var);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_boxed)
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        txt = fun_306(txt, i_var, i_i1, i_boxed);
        txt = Tpl.nextIter(txt);
        txt = lm_307(txt, rest, i_boxed);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_outVars, in_i_inFnStr, in_i_boxed, in_i_boxStr, in_i_fargsStr, in_i_fname, in_i_boxPtrStr)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_302(txt, i_outVars, i_boxStr, i_fname);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_307(txt, i_outVars, i_boxed);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("} "));
...
protected
  ...
  Tpl.Text i_fargsStr;
algorithm
  i_fargsStr := fun_297(Tpl.emptyTxt, i_boxed, i_fargs);
  i_boxStr := fun_298(Tpl.emptyTxt, i_boxed);
  i_boxPtrStr := fun_299(Tpl.emptyTxt, i_boxed);
  i_inFnStr := fun_301(Tpl.emptyTxt, i_boxed, i_fname, i_inFunc);
  out_txt := fun_308(txt, i_outVars, i_inFnStr, i_boxed, i_boxStr, i_fargsStr, i_fname, i_boxPtrStr);
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_fn__name;
      equation
        i_fn__name = extFunctionName(Tpl.emptyTxt, i_extName, i_language);
        i_fargsStr = extFunDefArgs(Tpl.emptyTxt, i_extArgs, i_language);
...
public function extFunctionName
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_314(txt, i_language, i_name);
end extFunctionName;
...
public function extFunDefArgs
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_318(txt, i_language, i_args);
end extFunDefArgs;
  ...
  matchcontinue(in_txt, in_i_ia, in_i_t)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text txt_0;
      equation
        txt_0 = extType(Tpl.emptyTxt, i_t);
        str_1 = Tpl.textString(txt_0);
        txt = fun_322(txt, str_1, i_t);
      then txt;
  end matchcontinue;
end fun_323;
  ...
  matchcontinue(in_txt, in_i_extArg)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_name;
      equation
        i_name = contextCref(Tpl.emptyTxt, i_c, SimCode.contextFunction);
        i_typeStr = fun_324(Tpl.emptyTxt, i_ii, i_ia, i_t);
        txt = Tpl.writeText(txt, i_typeStr);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" "));
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_typeStr;
      equation
        i_typeStr = extType(Tpl.emptyTxt, i_type__);
        txt = Tpl.writeText(txt, i_typeStr);
      then txt;
    ...
    case ( txt,
      ...
      equation
        i_name = contextCref(Tpl.emptyTxt, i_c, SimCode.contextFunction);
        i_eStr = daeExpToString(Tpl.emptyTxt, i_exp);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_extArg)
    ...
    case ( txt,
      ...
      equation
        i_name = contextCref(Tpl.emptyTxt, i_c, SimCode.contextFunction);
        i_typeStr = Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("const "));
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  out_txt := lm_328(out_txt, i_functions);
  out_txt := Tpl.popIter(out_txt);
end functionBodies;
...
algorithm
  (out_txt, out_i_varDecls) :=
  matchcontinue(in_txt, in_it, in_i_varDecls)
    local
      Tpl.Text txt;
      Tpl.Text i_varDecls;
    ...
    case ( txt,
           ...
           i_varDecls )
      equation
        (txt, i_varDecls) = tempDecl(txt, "state", i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varInits, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varInits, i_varDecls) = lm_334(txt, rest, i_varInits, i_varDecls);
      then (txt, i_varInits, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varInits) = lm_335(txt, rest, i_varInits);
      then (txt, i_varInits);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_336(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
protected function lm_337
  input Tpl.Text in_txt;
  input list<SimCode.Variable> in_items;
  input Tpl.Text in_i_outVarAssign;
  input Tpl.Text in_i_outVarCopy;
  input Tpl.Text in_i_outVarInits;
  input Tpl.Text in_i_varDecls;
  input Tpl.Text in_i_retVar;

  output Tpl.Text out_txt;
  output Tpl.Text out_i_outVarAssign;
  output Tpl.Text out_i_outVarCopy;
  output Tpl.Text out_i_outVarInits;
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_outVarAssign, out_i_outVarCopy, out_i_outVarInits, out_i_varDecls) :=
  matchcontinue(in_txt, in_items, in_i_outVarAssign, in_i_outVarCopy, in_i_outVarInits, in_i_varDecls, in_i_retVar)
    local
      Tpl.Text txt;
      Tpl.Text i_outVarAssign;
      Tpl.Text i_outVarCopy;
    ...
    case ( txt,
           ...
           i_varDecls,
           _ )
      then (txt, i_outVarAssign, i_outVarCopy, i_outVarInits, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        (txt, i_varDecls, i_outVarInits, i_outVarCopy, i_outVarAssign) = varOutput(txt, i_var, Tpl.textString(i_retVar), i_i1, i_varDecls, i_outVarInits, i_outVarCopy, i_outVarAssign);
        txt = Tpl.nextIter(txt);
        (txt, i_outVarAssign, i_outVarCopy, i_outVarInits, i_varDecls) = lm_337(txt, rest, i_outVarAssign, i_outVarCopy, i_outVarInits, i_varDecls, i_retVar);
      then (txt, i_outVarAssign, i_outVarCopy, i_outVarInits, i_varDecls);
...
protected function fun_341
  input Tpl.Text in_txt;
  input Boolean in_it;
  input Tpl.Text in_i_stateVar;

  output Tpl.Text out_txt;
algorithm
  out_txt :=
  matchcontinue(in_txt, in_it, in_i_stateVar)
    local
      Tpl.Text txt;
      Tpl.Text i_stateVar;
  ...
  matchcontinue(in_txt, in_i_inFunc, in_i_retType, in_i_outVars, in_i_functionArguments, in_i_fname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_345(txt, i_outVars, i_retType);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_346(txt, i_functionArguments);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_347(txt, i_outVars);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("_"));
        txt = Tpl.writeText(txt, i_fname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_348(txt, i_functionArguments);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
...
algorithm
  ...
  matchcontinue(in_txt, in_i_fn, in_i_inFunc)
    ...
    case ( txt,
           (i_fn as SimCode.FUNCTION(name = i_name, outVars = i_outVars, variableDeclarations = i_variableDeclarations, functionArguments = i_functionArguments, body = i_body, recordDecls = i_recordDecls)),
           i_inFunc )
      local
        list<SimCode.RecordDeclaration> i_recordDecls;
      ...
      equation
        ...
        i_fname = underscorePath(Tpl.emptyTxt, i_name);
        i_retType = fun_331(Tpl.emptyTxt, i_outVars, i_fname);
        i_varDecls = Tpl.emptyTxt;
        i_varInits = Tpl.emptyTxt;
        (i_retVar, i_varDecls) = fun_332(Tpl.emptyTxt, i_outVars, i_varDecls, i_retType);
        ret_6 = RTOpts.acceptMetaModelicaGrammar();
        (i_stateVar, i_varDecls) = fun_333(Tpl.emptyTxt, ret_6, i_varDecls);
        i_0__ = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_0__, i_varInits, i_varDecls) = lm_334(i_0__, i_variableDeclarations, i_varInits, i_varDecls);
        i_0__ = Tpl.popIter(i_0__);
        i_funArgs = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_funArgs, i_varInits) = lm_335(i_funArgs, i_functionArguments, i_varInits);
        ...
        (i_bodyPart, i_varDecls) = lm_336(i_bodyPart, i_body, i_varDecls);
        i_bodyPart = Tpl.popIter(i_bodyPart);
        i_outVarInits = Tpl.emptyTxt;
        i_outVarCopy = Tpl.emptyTxt;
        i_outVarAssign = Tpl.emptyTxt;
        i_0__1 = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, SOME(Tpl.ST_STRING("")), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_0__1, i_outVarAssign, i_outVarCopy, i_outVarInits, i_varDecls) = lm_337(i_0__1, i_outVars, i_outVarAssign, i_outVarCopy, i_outVarInits, i_varDecls, i_retVar);
        i_0__1 = Tpl.popIter(i_0__1);
        ret_15 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedFn = fun_338(Tpl.emptyTxt, ret_15, i_fn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_339(txt, i_recordDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_retType);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" _"));
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_340(txt, i_functionArguments);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    ")\n",
                                    "{\n"
        ...
        txt = fun_341(txt, ret_16, i_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        ...
        txt = Tpl.writeText(txt, i_outVarCopy);
        txt = Tpl.softNewLine(txt);
        ret_17 = RTOpts.acceptMetaModelicaGrammar();
        txt = fun_342(txt, ret_17, i_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_outVarAssign);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("return"));
        txt = fun_343(txt, i_outVars, i_retVar);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(";\n"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "}\n",
        ...
        txt = fun_351(txt, i_inFunc, i_retType, i_outVars, i_functionArguments, i_fname);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
  ...
  matchcontinue(in_txt, in_items, in_i_outputAlloc, in_i_varDecls, in_i_retVar)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_outputAlloc, i_varDecls) = lm_356(txt, rest, i_outputAlloc, i_varDecls, i_retVar);
      then (txt, i_outputAlloc, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_inFunc, in_i_outVars, in_i_retType, in_i_funArgs, in_i_fname)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_365(txt, i_funArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_366(txt, i_outVars);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("return 0;\n"));
        txt = Tpl.popBlock(txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_fn, in_i_inFunc)
    ...
    case ( txt,
           (i_fn as SimCode.EXTERNAL_FUNCTION(name = i_name, outVars = i_outVars, recordDecls = i_recordDecls, funArgs = i_funArgs)),
           i_inFunc )
      local
        list<SimCode.Variable> i_funArgs;
        list<SimCode.RecordDeclaration> i_recordDecls;
      ...
      equation
        System.tmpTickReset(1);
        i_fname = underscorePath(Tpl.emptyTxt, i_name);
        i_retType = fun_353(Tpl.emptyTxt, i_outVars, i_fname);
        i_preExp = Tpl.emptyTxt;
        i_varDecls = Tpl.emptyTxt;
        (i_retVar, i_varDecls) = fun_354(Tpl.emptyTxt, i_outVars, i_varDecls, i_retType);
        i_outputAlloc = Tpl.emptyTxt;
        ret_7 = RTOpts.acceptMetaModelicaGrammar();
        (i_stateVar, i_varDecls) = fun_355(Tpl.emptyTxt, ret_7, i_varDecls);
        (i_callPart, i_preExp, i_varDecls) = extFunCall(Tpl.emptyTxt, i_fn, i_preExp, i_varDecls);
        i_0__ = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_0__, i_outputAlloc, i_varDecls) = lm_356(i_0__, i_outVars, i_outputAlloc, i_varDecls, i_retVar);
        i_0__ = Tpl.popIter(i_0__);
        ret_11 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedFn = fun_357(Tpl.emptyTxt, ret_11, i_fn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_358(txt, i_recordDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_retType);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" _"));
        ...
        txt = fun_360(txt, ret_12, i_stateVar);
        txt = Tpl.softNewLine(txt);
        ...
        txt = fun_361(txt, ret_13, i_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("return "));
        txt = fun_362(txt, i_outVars, i_retVar);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(";\n"));
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    "}\n",
        ...
        txt = fun_367(txt, i_inFunc, i_outVars, i_retType, i_funArgs, i_fname);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.writeText(txt, i_boxedFn);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_structVar)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        txt = lm_372(txt, rest, i_structVar);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
           (i_fn as SimCode.RECORD_CONSTRUCTOR(name = i_name, recordDecls = i_recordDecls, funArgs = i_funArgs)) )
      local
        list<SimCode.Variable> i_funArgs;
        list<SimCode.RecordDeclaration> i_recordDecls;
        Absyn.Path i_name;
      ...
      equation
        ...
        i_varDecls = Tpl.emptyTxt;
        i_fname = underscorePath(Tpl.emptyTxt, i_name);
        i_retType = Tpl.writeText(Tpl.emptyTxt, i_fname);
        i_retType = Tpl.writeTok(i_retType, Tpl.ST_STRING("_rettype"));
        (i_retVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_structType = Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("struct "));
        i_structType = Tpl.writeText(i_structType, i_fname);
        (i_structVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_structType), i_varDecls);
        ret_7 = RTOpts.acceptMetaModelicaGrammar();
        i_boxedFn = fun_369(Tpl.emptyTxt, ret_7, i_fn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_370(txt, i_recordDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_retType);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" _"));
        ...
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_372(txt, i_funArgs, i_structVar);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_retVar);
  ...
  matchcontinue(in_txt, in_items, in_i_varBox, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varBox, i_varDecls) = lm_380(txt, rest, i_varBox, i_varDecls);
      then (txt, i_varBox, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_varUnbox, in_i_retTypeBoxed, in_i_retVar, in_i_retType, in_i_funRetVar)
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        i_arg = Tpl.writeText(Tpl.emptyTxt, i_funRetVar);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_varUnbox) = lm_381(txt, rest, i_varDecls, i_varUnbox, i_retTypeBoxed, i_retVar, i_retType, i_funRetVar);
      then (txt, i_varDecls, i_varUnbox);
...
algorithm
  System.tmpTickReset(1);
  i_fname := underscorePath(Tpl.emptyTxt, i_name);
  i_retType := fun_375(Tpl.emptyTxt, i_outvars, i_fname);
  i_retTypeBoxed := fun_376(Tpl.emptyTxt, i_outvars, i_retType);
  i_varDecls := Tpl.emptyTxt;
  (i_retVar, i_varDecls) := fun_377(Tpl.emptyTxt, i_outvars, i_varDecls, i_retTypeBoxed);
  (i_funRetVar, i_varDecls) := fun_378(Tpl.emptyTxt, i_outvars, i_varDecls, i_retType);
  ret_7 := RTOpts.acceptMetaModelicaGrammar();
  (i_stateVar, i_varDecls) := fun_379(Tpl.emptyTxt, ret_7, i_varDecls);
  i_varBox := Tpl.emptyTxt;
  i_varUnbox := Tpl.emptyTxt;
  i_args := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_args, i_varBox, i_varDecls) := lm_380(i_args, i_funargs, i_varBox, i_varDecls);
  i_args := Tpl.popIter(i_args);
  i_retStr := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_retStr, i_varDecls, i_varUnbox) := lm_381(i_retStr, i_outvars, i_varDecls, i_varUnbox, i_retTypeBoxed, i_retVar, i_retType, i_funRetVar);
  ...
  out_txt := lm_382(out_txt, i_funargs);
  out_txt := Tpl.popIter(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_STRING_LIST({
                                       ")\n",
                                       "{\n"
  ...
  out_txt := Tpl.softNewLine(out_txt);
  ret_12 := RTOpts.acceptMetaModelicaGrammar();
  out_txt := fun_383(out_txt, ret_12, i_stateVar);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.writeText(out_txt, i_varBox);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := fun_384(out_txt, i_outvars, i_funRetVar);
  ...
  out_txt := Tpl.softNewLine(out_txt);
  ret_13 := RTOpts.acceptMetaModelicaGrammar();
  out_txt := fun_385(out_txt, ret_13, i_stateVar);
  out_txt := Tpl.softNewLine(out_txt);
  ...
  matchcontinue(in_txt, in_i_fn)
    ...
    case ( txt,
      ...
      equation
        ...
        i_preExp = Tpl.emptyTxt;
        ret_3 = RTOpts.acceptMetaModelicaGrammar();
        (i_stateVar, i_varDecls) = fun_387(Tpl.emptyTxt, ret_3, i_varDecls);
        i_fname = underscorePath(Tpl.emptyTxt, i_name);
        i_retType = Tpl.writeText(Tpl.emptyTxt, i_fname);
        i_retType = Tpl.writeTok(i_retType, Tpl.ST_STRING("_rettypeboxed"));
        (i_retVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_funArgsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_funArgsStr = lm_388(i_funArgsStr, i_funArgs);
        i_funArgsStr = Tpl.popIter(i_funArgsStr);
        (i_boxRetVar, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        ret_10 = listLength(i_funArgs);
        ret_11 = SimCode.incrementInt(ret_10, 1);
        i_funArgCount = Tpl.writeStr(Tpl.emptyTxt, intString(ret_11));
        txt = Tpl.writeText(txt, i_retType);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" boxptr_"));
        txt = Tpl.writeText(txt, i_fname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_389(txt, i_funArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    ")\n",
                                    "{\n"
        ...
        txt = Tpl.softNewLine(txt);
        ret_12 = RTOpts.acceptMetaModelicaGrammar();
        txt = fun_390(txt, ret_12, i_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        ...
        ret_13 = RTOpts.acceptMetaModelicaGrammar();
        txt = fun_391(txt, ret_13, i_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("return "));
        txt = Tpl.writeText(txt, i_retVar);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(";\n"));
  ...
  matchcontinue(in_txt, in_i_var, in_i_varDecls, in_i_varBox)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_varName;
      equation
        i_varName = contextCref(Tpl.emptyTxt, i_name, SimCode.contextFunction);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_varType, in_i_varName, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_shortType = mmcExpTypeShort(Tpl.emptyTxt, i_varType);
        i_type = Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("mmc__unbox__"));
        ...
        (i_tmpVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(txt_3), i_varDecls);
...
public function unboxVariable
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) := fun_394(txt, i_varType, i_varName, i_preExp, i_varDecls);
end unboxVariable;
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_tmpVar, in_i_recordVar, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        i_varType = mmcExpTypeShort(Tpl.emptyTxt, i_tp);
        (i_untagTmp, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        ret_3 = SimCode.incrementInt(i_i1, 1);
        i_offsetStr = Tpl.writeStr(Tpl.emptyTxt, intString(ret_3));
        i_unboxBuf = Tpl.emptyTxt;
        (i_unboxStr, i_unboxBuf, i_varDecls) = unboxVariable(Tpl.emptyTxt, Tpl.textString(i_untagTmp), i_tp, i_unboxBuf, i_varDecls);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_396(txt, rest, i_tmpVar, i_recordVar, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_ty, in_i_recordVar, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_tmpVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(txt_1), i_varDecls);
        i_preExp = Tpl.pushIter(i_preExp, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_preExp, i_varDecls) = lm_396(i_preExp, i_vars, i_tmpVar, i_recordVar, i_varDecls);
...
public function unboxRecord
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) := fun_397(txt, i_ty, i_recordVar, i_preExp, i_varDecls);
end unboxRecord;
...
algorithm
  ...
  matchcontinue(in_txt, in_it, in_i_constructorType, in_i_varDecls, in_i_varUnbox, in_i_ty, in_i_varName)
    ...
    case ( txt,
      ...
      equation
        (i_constructor, i_varUnbox, i_varDecls) = mmcConstructor(Tpl.emptyTxt, i_ty, i_varName, i_varUnbox, i_varDecls);
        (i_tmpVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_constructorType), i_varDecls);
...
protected
  ...
  Tpl.Text i_constructorType;
algorithm
  i_constructorType := mmcConstructorType(Tpl.emptyTxt, i_ty);
  str_1 := Tpl.textString(i_constructorType);
  (out_txt, out_i_varDecls, out_i_varUnbox) := fun_399(txt, str_1, i_constructorType, i_varDecls, i_varUnbox, i_ty, i_varName);
end funArgBox;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_varName)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_varname;
      equation
        i_varname = Tpl.writeStr(Tpl.emptyTxt, i_varName);
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_402(txt, rest, i_varDecls, i_preExp, i_varName);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_type, in_i_varName, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_varCount = Tpl.writeStr(Tpl.emptyTxt, intString(ret_2));
        i_varsStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_varsStr, i_varDecls, i_preExp) = lm_402(i_varsStr, i_vars, i_varDecls, i_preExp, i_varName);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_tp, in_i_subvar_name, in_i_prefix)
    ...
    case ( txt,
      ...
      equation
        i_newPrefix = Tpl.writeStr(Tpl.emptyTxt, i_prefix);
  ...
  matchcontinue(in_txt, in_items, in_i_prefix)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpVar i_subvar;
      equation
        txt = fun_405(txt, i_tp, i_subvar_name, i_prefix);
        txt = Tpl.nextIter(txt);
        txt = lm_406(txt, rest, i_prefix);
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_index, in_i_prefix)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpVar i_subvar;
      equation
        txt = fun_409(txt, i_tp, i_index, i_subvar_name, i_prefix);
        txt = Tpl.nextIter(txt);
        txt = lm_410(txt, rest, i_index, i_prefix);
      then txt;
  ...
  matchcontinue(in_txt, in_i_type, in_i_index, in_i_prefix)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_basename;
      equation
        i_basename = underscorePath(Tpl.emptyTxt, i_n);
        i_args = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_args = lm_410(i_args, i_vl, i_index, i_prefix);
        i_args = Tpl.popIter(i_args);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("&"));
        txt = Tpl.writeText(txt, i_basename);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("__desc"));
        str_2 = Tpl.textString(i_args);
        txt = fun_411(txt, str_2, i_args);
  ...
  matchcontinue(in_txt, in_i_outStruct, in_i_var_name, in_i_var)
    ...
    case ( txt,
      ...
      equation
        txt = varType(txt, i_var);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" "));
        txt = contextCref(txt, i_var_name, SimCode.contextFunction);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
      then txt;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_varInits) = lm_415(txt, rest, i_varDecls, i_varInits);
      then (txt, i_varDecls, i_varInits);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_var_value, in_i_varDecls, in_i_varInits, in_i_var_name)
    ...
    case ( txt,
      ...
      equation
        i_defaultValue = contextCref(Tpl.emptyTxt, i_var_name, SimCode.contextFunction);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_instDims, in_i_i, in_i_outStruct, in_i_var, in_i_instDimsInit, in_i_varName, in_i_var_ty, in_i_varDecls, in_i_varInits, in_i_var_name, in_i_var_value)
    ...
    case ( txt,
           ...
           i_var_value )
      equation
        (txt, i_varDecls, i_varInits) = fun_416(txt, i_var_value, i_varDecls, i_varInits, i_var_name);
      then (txt, i_varDecls, i_varInits);
    ...
    case ( txt,
      ...
      equation
        ...
        (i_defaultValue, i_varDecls, i_varInits) = varDefaultValue(Tpl.emptyTxt, i_var, i_outStruct, i_i, Tpl.textString(i_varName), i_varDecls, i_varInits);
        i_varInits = Tpl.writeText(i_varInits, i_defaultValue);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" "));
      then (txt, i_varDecls, i_varInits);
  end matchcontinue;
  ...
  matchcontinue(in_txt, in_i_var, in_i_outStruct, in_i_i, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_varName;
      equation
        i_varDecls = fun_413(i_varDecls, i_outStruct, i_var_name, i_var);
        i_varName = fun_414(Tpl.emptyTxt, i_outStruct, i_i, i_var_name);
        ...
        (i_instDimsInit, i_varDecls, i_varInits) = lm_415(i_instDimsInit, i_instDims, i_varDecls, i_varInits);
        i_instDimsInit = Tpl.popIter(i_instDimsInit);
        (txt, i_varDecls, i_varInits) = fun_417(txt, i_instDims, i_i, i_outStruct, i_var, i_instDimsInit, i_varName, i_var_ty, i_varDecls, i_varInits, i_var_name, i_var_value);
      then (txt, i_varDecls, i_varInits);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_ignore;
      equation
        i_ignore = Tpl.emptyTxt;
        (i_varDecls, i_ignore) = functionArg(i_varDecls, i_var, i_ignore);
      then (txt, i_varDecls, i_varInits);
    ...
    case ( txt,
           ...
           i_varInits )
      equation
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_STRING("#error Unknown local variable type"));
  ...
  matchcontinue(in_txt, in_i_value, in_i_lhsVarName, in_i_varDecls, in_i_varInits, in_i_i, in_i_outStruct, in_i_var_ty)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_arrayExp;
      equation
        (i_arrayExp, i_varInits, i_varDecls) = daeExp(Tpl.emptyTxt, i_arr, SimCode.contextFunction, i_varInits, i_varDecls);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("copy_"));
        txt = expTypeShort(txt, i_var_ty);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("_array_data(&"));
  ...
  matchcontinue(in_txt, in_i_var, in_i_outStruct, in_i_i, in_i_lhsVarName, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Variable i_var;
      equation
        (txt, i_varDecls, i_varInits) = fun_419(txt, i_value, i_lhsVarName, i_varDecls, i_varInits, i_i, i_outStruct, i_var_ty);
      then (txt, i_varDecls, i_varInits);
...
algorithm
  out_txt :=
  matchcontinue(in_txt, in_items, in_i_rettype)
    local
      Tpl.Text txt;
      Tpl.Text i_rettype;
...
protected function fun_424
  input Tpl.Text in_txt;
  input list<DAE.ExpType> in_i_tys;
  input Tpl.Text in_i_rettype;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_tys, in_i_rettype, in_i_typelist, in_i_name, in_i_varInit)
    local
      Tpl.Text txt;
      Tpl.Text i_rettype;
      Tpl.Text i_typelist;
    ...
    case ( txt,
      ...
      equation
        ...
        i_varInit = Tpl.writeTok(i_varInit, Tpl.ST_NEW_LINE());
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_422(txt, i_tys, i_rettype);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("typedef struct "));
        txt = Tpl.writeText(txt, i_rettype);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_var, in_i_varInit)
    ...
    case ( txt,
           (i_var as SimCode.FUNCTION_PTR(args = i_args, name = i_name, tys = i_tys)),
           i_varInit )
      local
        list<DAE.ExpType> i_tys;
        String i_name;
        ...
        Tpl.Text i_typelist;
      equation
        i_typelist = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_typelist = lm_421(i_typelist, i_args);
        i_typelist = Tpl.popIter(i_typelist);
        i_rettype = Tpl.writeStr(Tpl.emptyTxt, i_name);
        i_rettype = Tpl.writeTok(i_rettype, Tpl.ST_STRING("_rettype"));
        (txt, i_varInit) = fun_424(txt, i_tys, i_rettype, i_typelist, i_name, i_varInit);
      then (txt, i_varInit);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_varInits)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varInits, i_varDecls) = daeExp(txt, i_exp, SimCode.contextFunction, i_varInits, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_varInits) = lm_426(txt, rest, i_varDecls, i_varInits);
      then (txt, i_varDecls, i_varInits);
...
protected function fun_427
  ...
  input DAE.ExpType in_i_var_ty;
  input DAE.ComponentRef in_i_var_name;
  input Integer in_i_ix;
  input String in_i_dest;
  input Tpl.Text in_i_varAssign;
  input SimCode.Variable in_i_var;
  input Tpl.Text in_i_varInits;

  output Tpl.Text out_txt;
  output Tpl.Text out_i_varAssign;
  output Tpl.Text out_i_varInits;
algorithm
  (out_txt, out_i_varAssign, out_i_varInits) :=
  matchcontinue(in_txt, in_i_instDims, in_i_instDimsInit, in_i_var_ty, in_i_var_name, in_i_ix, in_i_dest, in_i_varAssign, in_i_var, in_i_varInits)
    local
      Tpl.Text txt;
      Tpl.Text i_instDimsInit;
      DAE.ExpType i_var_ty;
    ...
    case ( txt,
      ...
      equation
        ...
        i_varAssign = contextCref(i_varAssign, i_var_name, SimCode.contextFunction);
        i_varAssign = Tpl.writeTok(i_varAssign, Tpl.ST_STRING(";"));
        i_varAssign = Tpl.writeTok(i_varAssign, Tpl.ST_NEW_LINE());
      then (txt, i_varAssign, i_varInits);
    ...
    case ( txt,
      ...
      equation
        ...
        i_varInits = Tpl.writeStr(i_varInits, intString(i_ix));
        i_varInits = Tpl.writeTok(i_varInits, Tpl.ST_STRING(", "));
        ret_0 = listLength(i_instDims);
        i_varInits = Tpl.writeStr(i_varInits, intString(ret_0));
        i_varInits = Tpl.writeTok(i_varInits, Tpl.ST_STRING(", "));
        ...
        i_varInits = Tpl.writeTok(i_varInits, Tpl.ST_STRING(");"));
        i_varInits = Tpl.writeTok(i_varInits, Tpl.ST_NEW_LINE());
        i_varAssign = Tpl.writeTok(i_varAssign, Tpl.ST_STRING("copy_"));
        i_varAssign = expTypeShort(i_varAssign, i_var_ty);
        i_varAssign = Tpl.writeTok(i_varAssign, Tpl.ST_STRING("_array_data(&"));
        i_varAssign = contextCref(i_varAssign, i_var_name, SimCode.contextFunction);
        i_varAssign = Tpl.writeTok(i_varAssign, Tpl.ST_STRING(", &"));
        i_varAssign = Tpl.writeStr(i_varAssign, i_dest);
        i_varAssign = Tpl.writeTok(i_varAssign, Tpl.ST_STRING(".targ"));
...
public function varOutput
  ...
  input Tpl.Text in_i_varDecls;
  input Tpl.Text in_i_varInits;
  input Tpl.Text in_i_varCopy;
  input Tpl.Text in_i_varAssign;

  output Tpl.Text out_txt;
  output Tpl.Text out_i_varDecls;
  output Tpl.Text out_i_varInits;
  output Tpl.Text out_i_varCopy;
  output Tpl.Text out_i_varAssign;
algorithm
  (out_txt, out_i_varDecls, out_i_varInits, out_i_varCopy, out_i_varAssign) :=
  matchcontinue(in_txt, in_i_var, in_i_dest, in_i_ix, in_i_varDecls, in_i_varInits, in_i_varCopy, in_i_varAssign)
    local
      Tpl.Text txt;
      String i_dest;
      Integer i_ix;
    ...
    case ( txt,
           (i_var as SimCode.VARIABLE(ty = DAE.ET_STRING(), name = i_var_name)),
           i_dest,
           i_ix,
           i_varDecls,
           i_varInits,
    ...
    case ( txt,
      ...
      equation
        i_instDimsInit = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_instDimsInit, i_varDecls, i_varInits) = lm_426(i_instDimsInit, i_instDims, i_varDecls, i_varInits);
        i_instDimsInit = Tpl.popIter(i_instDimsInit);
        (txt, i_varAssign, i_varInits) = fun_427(txt, i_instDims, i_instDimsInit, i_var_ty, i_var_name, i_ix, i_dest, i_varAssign, i_var, i_varInits);
      then (txt, i_varDecls, i_varInits, i_varCopy, i_varAssign);
  ...
  matchcontinue(in_txt, in_items, in_i_varName)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varName) = lm_429(txt, rest, i_varName);
      then (txt, i_varName);
  ...
  matchcontinue(in_txt, in_i_var)
    ...
    case ( txt,
      ...
      equation
        i_varName = contextCref(Tpl.emptyTxt, i_name, SimCode.contextFunction);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varName) = lm_429(txt, i_ty_varLst, i_varName);
        txt = Tpl.popIter(txt);
      then txt;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_v, in_i_varName)
    ...
    case ( txt,
      ...
      equation
        i_arrayType = expType(Tpl.emptyTxt, i_tp, true);
        i_dims = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_dims = lm_431(i_dims, i_tp_arrayDimensions);
...
public function recordMemberInit
  ...
  output Tpl.Text out_i_varName;
algorithm
  out_txt := fun_432(txt, i_v, i_varName);
...
public function extVarName
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := contextCref(txt, i_cr, SimCode.contextFunction);
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Function i_fun;
      equation
        (txt, i_varDecls, i_preExp) = fun_435(txt, i_language, i_varDecls, i_preExp, i_fun);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_437(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_439(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_args = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_437(i_args, i_extArgs, i_varDecls, i_preExp);
        i_args = Tpl.popIter(i_args);
        i_returnAssign = fun_438(Tpl.emptyTxt, i_extReturn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_439(txt, i_extArgs, i_varDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        (txt, i_varDecls) = fun_440(txt, i_extReturn, i_varDecls);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_441(txt, i_extArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_442(txt, i_extReturn);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_444(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_446(txt, rest, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_448(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_fun, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_args = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_444(i_args, i_extArgs, i_varDecls, i_preExp);
        i_args = Tpl.popIter(i_args);
        i_returnAssign = fun_445(Tpl.emptyTxt, i_extReturn);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_446(txt, i_extArgs, i_varDecls);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        (txt, i_varDecls) = fun_447(txt, i_extReturn, i_varDecls);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_448(txt, i_biVars, i_varDecls, i_preExp);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_returnAssign);
        txt = Tpl.writeStr(txt, i_extName);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_449(txt, i_extArgs);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = fun_450(txt, i_extReturn);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_ty, in_i_c, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_varDecls = contextCref(i_varDecls, i_c, SimCode.contextFunction);
  ...
  matchcontinue(in_txt, in_i_arg, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.ExpType i_ty;
      equation
        (txt, i_varDecls) = fun_452(txt, i_ty, i_c, i_varDecls);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_oi;
      equation
        (txt, i_varDecls) = fun_453(txt, i_oi, i_c, i_ty, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_oi, in_i_ia, in_i_c, in_i_ty, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_STRING(";"));
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_NEW_LINE());
        txt = fun_455(txt, i_ia, i_c, i_oi, i_ty);
      then (txt, i_varDecls);
  end matchcontinue;
end fun_456;
  ...
  matchcontinue(in_txt, in_i_arg, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_oi;
      equation
        (txt, i_varDecls) = fun_456(txt, i_oi, i_ia, i_c, i_ty, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, SimCode.contextFunction, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_459(txt, rest, i_varDecls, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_instDims, in_i_name, in_i_instDimsInit, in_i_var__name, in_i_preExp, in_i_var_ty)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = expTypeArray(Tpl.emptyTxt, i_var_ty);
  ...
  matchcontinue(in_txt, in_i_var, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_var__name;
      equation
        i_var__name = contextCref(Tpl.emptyTxt, i_name, SimCode.contextFunction);
        ...
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_STRING(";"));
        i_varDecls = Tpl.writeTok(i_varDecls, Tpl.ST_NEW_LINE());
        (i_defaultValue, i_varDecls, i_preExp) = fun_458(Tpl.emptyTxt, i_value, i_varDecls, i_preExp, i_var__name);
        i_preExp = Tpl.writeText(i_preExp, i_defaultValue);
        i_instDimsInit = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_instDimsInit, i_varDecls, i_preExp) = lm_459(i_instDimsInit, i_instDims, i_varDecls, i_preExp);
        i_instDimsInit = Tpl.popIter(i_instDimsInit);
        (txt, i_preExp) = fun_460(txt, i_instDims, i_name, i_instDimsInit, i_var__name, i_preExp, i_var_ty);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_oi, in_i_ty, in_i_ai, in_i_c)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_outarg;
      equation
        i_outarg = Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("out.targ"));
        i_outarg = Tpl.writeStr(i_outarg, intString(i_oi));
        i_ext__name = contextCref(Tpl.emptyTxt, i_c, SimCode.contextFunction);
        i_ext__name = Tpl.writeTok(i_ext__name, Tpl.ST_STRING("_ext"));
        txt = fun_464(txt, i_ai, i_ext__name, i_ty, i_outarg);
      then txt;
  end matchcontinue;
end fun_465;
  ...
  matchcontinue(in_txt, in_i_arg)
    ...
    case ( txt,
      ...
      local
        ...
        Integer i_oi;
      equation
        txt = fun_465(txt, i_oi, i_ty, i_ai, i_c);
      then txt;
  ...
  matchcontinue(in_txt, in_i_extArg, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_name;
      equation
        i_name = fun_467(Tpl.emptyTxt, i_oi, i_c);
        i_shortTypeStr = expTypeShort(Tpl.emptyTxt, i_t);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_468(Tpl.emptyTxt, i_oi);
        i_suffix = fun_470(Tpl.emptyTxt, i_oi, i_t);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_typeStr;
      equation
        i_typeStr = expTypeShort(Tpl.emptyTxt, i_type__);
        i_name = fun_471(Tpl.emptyTxt, i_outputIndex, i_c);
        (i_dim, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, SimCode.contextFunction, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_extArg, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_suffix;
      equation
        i_suffix = fun_474(Tpl.emptyTxt, i_oi, i_ia);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("&"));
        txt = contextCref(txt, i_c, SimCode.contextFunction);
        txt = Tpl.writeText(txt, i_suffix);
      then (txt, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        i_sizeVarName = tempSizeVarName(Tpl.emptyTxt, i_c, i_exp);
        (i_sizeVar, i_varDecls) = tempDecl(Tpl.emptyTxt, "int", i_varDecls);
        (i_dim, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, SimCode.contextFunction, i_preExp, i_varDecls);
        i_size__call = Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("size_of_dimension_"));
        ...
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("("));
        i_preExp = contextCref(i_preExp, i_c, SimCode.contextFunction);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(", "));
...
public function tempSizeVarName
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_476(txt, i_indices, i_c);
end tempSizeVarName;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_478(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_478(txt, i_statementLst, i_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        DAE.Statement i_s;
      equation
        (txt, i_varDecls) = algStmtTerminate(txt, i_s, i_context, i_varDecls);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      local
        DAE.Statement i_s;
      equation
        (txt, i_varDecls) = algStmtFailure(txt, i_s, i_context, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  (out_txt, out_i_varDecls) :=
  matchcontinue(in_txt, in_i_exp, in_i_val, in_i_varDecls, in_i_context)
    local
      Tpl.Text txt;
      DAE.Exp i_val;
      Tpl.Text i_varDecls;
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_arr1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_arr, i_context, i_preExp, i_varDecls);
        (i_idx1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_idx, i_context, i_preExp, i_varDecls);
        (i_val1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_val, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("arrayUpdate("));
        txt = Tpl.writeText(txt, i_arr1);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(","));
        txt = Tpl.writeText(txt, i_idx1);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(","));
        txt = Tpl.writeText(txt, i_val1);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
      then (txt, i_varDecls);
...
algorithm
  (out_txt, out_i_varDecls) :=
  matchcontinue(in_txt, in_it, in_i_exp1, in_i_val, in_i_varDecls, in_i_context, in_i_exp)
    local
      Tpl.Text txt;
      DAE.Exp i_exp1;
      DAE.Exp i_val;
    ...
    case ( txt,
           ...
           i_exp )
      equation
        (txt, i_varDecls) = fun_481(txt, i_exp, i_val, i_varDecls, i_context);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_varPart, i_preExp, i_varDecls) = daeExpAsub(Tpl.emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_val, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_varPart, i_preExp, i_varDecls) = scalarLhsCref(Tpl.emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_varPart);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text txt_0;
      equation
        txt_0 = expTypeFromExpShort(Tpl.emptyTxt, i_exp);
        str_1 = Tpl.textString(txt_0);
        (txt, i_varDecls) = fun_482(txt, str_1, i_exp1, i_val, i_varDecls, i_context, i_exp);
      then (txt, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_expPart2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        (i_ispec, i_preExp, i_varDecls) = indexSpecFromCref(Tpl.emptyTxt, i_cr, i_context, i_preExp, i_varDecls);
        str_3 = Tpl.textString(i_ispec);
        (txt, i_varDecls) = fun_484(txt, str_3, i_varDecls, i_ispec, i_context, i_cr, i_expPart, i_t, i_preExp);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_context, in_i_varDecls, in_i_ispec, in_i_cref, in_i_exp, in_i_type)
    ...
    case ( txt,
      ...
      local
        Tpl.Text i_tmp;
      equation
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, "real_array", i_varDecls);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("indexed_assign_"));
        txt = Tpl.writeText(txt, i_type);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("(&"));
        txt = Tpl.writeStr(txt, i_exp);
...
protected
  ...
  Tpl.Text i_type;
algorithm
  i_type := expTypeArray(Tpl.emptyTxt, i_ty);
  i_cref := contextArrayCref(Tpl.emptyTxt, i_cr, i_context);
  (out_txt, out_i_varDecls) := fun_486(txt, i_context, i_varDecls, i_ispec, i_cref, i_exp, i_type);
end indexedAssign;
...
algorithm
  i_type := expTypeArray(Tpl.emptyTxt, i_ty);
  i_cref := contextArrayCref(Tpl.emptyTxt, i_cr, i_context);
  out_txt := fun_488(txt, i_context, i_cref, i_exp, i_type);
end copyArrayData;
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_retStruct)
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        i_rhsStr = Tpl.writeText(Tpl.emptyTxt, i_retStruct);
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_490(txt, rest, i_varDecls, i_preExp, i_context, i_retStruct);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_retStruct, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_490(txt, i_expExpLst, i_varDecls, i_preExp, i_context, i_retStruct);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_rhsStr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_lhsStr;
      equation
        (i_lhsStr, i_preExp, i_varDecls) = scalarLhsCref(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = fun_492(txt, i_context, i_lhsStr, i_rhsStr, i_t);
      then (txt, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_lhsStr;
      equation
        (i_lhsStr, i_preExp, i_varDecls) = scalarLhsCref(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        txt = fun_493(txt, i_context, i_lhsStr, i_rhsStr, i_t);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_495(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_condExp, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if ("));
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_495(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
           (i_s as DAE.STMT_FOR(range = (i_rng as DAE.RANGE(ty = _)))),
           i_context,
           i_varDecls )
      local
        DAE.Exp i_rng;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_498(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_stmtStr, i_varDecls) = lm_498(i_stmtStr, i_statementLst, i_varDecls, i_context);
        i_stmtStr = Tpl.popIter(i_stmtStr);
        (txt, i_stmtStr, i_varDecls) = algStmtForRange_impl(txt, i_rng, i_iter, Tpl.textString(i_identType), Tpl.textString(i_identTypeShort), i_stmtStr, i_context, i_varDecls);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_range, in_i_iterator, in_i_type, in_i_shortType, in_i_body, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_iterName;
      equation
        i_iterName = contextIteratorName(Tpl.emptyTxt, i_iterator, i_context);
        ret_2 = RTOpts.acceptMetaModelicaGrammar();
        (i_stateVar, i_varDecls) = fun_500(Tpl.emptyTxt, ret_2, i_varDecls);
        (i_startVar, i_varDecls) = tempDecl(Tpl.emptyTxt, i_type, i_varDecls);
        (i_stepVar, i_varDecls) = tempDecl(Tpl.emptyTxt, i_type, i_varDecls);
        (i_stopVar, i_varDecls) = tempDecl(Tpl.emptyTxt, i_type, i_varDecls);
        i_preExp = Tpl.emptyTxt;
        (i_startValue, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        (i_stepValue, i_varDecls, i_preExp) = fun_501(Tpl.emptyTxt, i_expOption, i_varDecls, i_preExp, i_context);
        (i_stopValue, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_range, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        ...
        txt = fun_502(txt, ret_10, i_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_body);
        txt = Tpl.softNewLine(txt);
        ret_11 = RTOpts.acceptMetaModelicaGrammar();
        txt = fun_503(txt, ret_11, i_stateVar);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
        txt = Tpl.popBlock(txt);
...
public function algStmtForRange_impl
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varDecls) := fun_504(txt, i_range, i_iterator, i_type, i_shortType, i_body, i_context, i_varDecls);
  out_i_body := i_body;
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_506(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_iterType;
      equation
        i_iterType = expType(Tpl.emptyTxt, i_type__, i_iterIsArray);
        i_arrayType = expTypeArray(Tpl.emptyTxt, i_type__);
        i_stmtStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmtStr, i_varDecls) = lm_506(i_stmtStr, i_statementLst, i_varDecls, i_context);
        i_stmtStr = Tpl.popIter(i_stmtStr);
        (txt, i_stmtStr, i_varDecls) = algStmtForGeneric_impl(txt, i_range, i_iter, Tpl.textString(i_iterType), Tpl.textString(i_arrayType), i_iterIsArray, i_stmtStr, i_context, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  i_iterName := contextIteratorName(Tpl.emptyTxt, i_iterator, i_context);
  ret_2 := RTOpts.acceptMetaModelicaGrammar();
  (i_stateVar, out_i_varDecls) := fun_508(Tpl.emptyTxt, ret_2, i_varDecls);
  (i_tvar, out_i_varDecls) := tempDecl(Tpl.emptyTxt, "int", out_i_varDecls);
  (i_ivar, out_i_varDecls) := tempDecl(Tpl.emptyTxt, i_type, out_i_varDecls);
  i_preExp := Tpl.emptyTxt;
  (i_evar, i_preExp, out_i_varDecls) := daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, out_i_varDecls);
  i_stmtStuff := fun_509(Tpl.emptyTxt, i_iterIsArray, i_ivar, i_type, i_tvar, i_evar, i_arrayType, i_iterName);
  ...
  out_txt := fun_510(out_txt, ret_8, i_stateVar);
  out_txt := Tpl.softNewLine(out_txt);
  ...
  out_txt := fun_511(out_txt, ret_9, i_stateVar);
  out_txt := Tpl.softNewLine(out_txt);
  out_txt := Tpl.popBlock(out_txt);
  out_txt := Tpl.writeTok(out_txt, Tpl.ST_LINE("}\n"));
  out_txt := Tpl.popBlock(out_txt);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_513(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_preExp = Tpl.emptyTxt;
        (i_var, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        ...
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_513(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
...
protected function lm_517
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varAssign, out_i_preExp, out_i_varDecls) :=
  matchcontinue(in_txt, in_items, in_i_varAssign, in_i_preExp, in_i_context, in_i_varDecls)
    local
      Tpl.Text txt;
      Tpl.Text i_varAssign;
      Tpl.Text i_preExp;
    ...
    case ( txt,
           ...
           _,
           i_varDecls )
      then (txt, i_varAssign, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        (i_decl, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(txt_1), i_varDecls);
        (i_lhs, i_preExp, i_varDecls) = scalarLhsCref(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.nextIter(txt);
        (txt, i_varAssign, i_preExp, i_varDecls) = lm_517(txt, rest, i_varAssign, i_preExp, i_context, i_varDecls);
      then (txt, i_varAssign, i_preExp, i_varDecls);
...
public function algStmtMatchcasesVarDeclsAndAssign
  input Tpl.Text txt;
  input list<DAE.Exp> i_expList;
  input SimCode.Context i_context;
  input Tpl.Text i_varDecls;
  input Tpl.Text i_varAssign;
  input Tpl.Text i_preExp;
...
algorithm
  out_txt := Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (out_txt, out_i_varAssign, out_i_preExp, out_i_varDecls) := lm_517(out_txt, i_expList, i_varAssign, i_preExp, i_context, i_varDecls);
  out_txt := Tpl.popIter(out_txt);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_519(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tmp;
      equation
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_boolean", i_varDecls);
        i_stmtBody = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmtBody, i_varDecls) = lm_519(i_stmtBody, i_body, i_varDecls, i_context);
        i_stmtBody = Tpl.popIter(i_stmtBody);
        txt = Tpl.writeText(txt, i_tmp);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    " = 0; /* begin failure */\n",
                                    "try {\n"
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_521(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_body = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_body, i_varDecls) = lm_521(i_body, i_tryBody, i_varDecls, i_context);
        i_body = Tpl.popIter(i_body);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_523(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_body = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_body, i_varDecls) = lm_523(i_body, i_catchBody, i_varDecls, i_context);
        i_body = Tpl.popIter(i_body);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_526(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_when, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_preIf;
      equation
        (i_preIf, i_varDecls) = algStatementWhenPre(Tpl.emptyTxt, i_when, i_varDecls);
        i_statements = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_statements, i_varDecls) = lm_526(i_statements, i_statementLst, i_varDecls, i_context);
        i_statements = Tpl.popIter(i_statements);
        (i_else, i_varDecls) = algStatementWhenElse(Tpl.emptyTxt, i_elseWhen, i_varDecls);
        txt = Tpl.writeText(txt, i_preIf);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if ("));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(" || ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        txt = lm_527(txt, i_helpVarIndices);
        txt = Tpl.popIter(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(") {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
  ...
  matchcontinue(in_txt, in_i_context, in_i_when, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        SimCode.Context i_context;
      equation
        (txt, i_varDecls) = fun_528(txt, i_when, i_context, i_varDecls);
      then (txt, i_varDecls);
...
public function algStmtWhen
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_varDecls) := fun_529(txt, i_context, i_when, i_varDecls);
end algStmtWhen;
  ...
  matchcontinue(in_txt, in_i_helpVarIndices, in_i_when_exp, in_i_varDecls, in_i_when_elseWhen)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_532(Tpl.emptyTxt, i_when_elseWhen, i_varDecls);
        i_preExp = Tpl.emptyTxt;
        (i_res, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_when_exp, SimCode.contextSimulationDiscrete, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("localData->helpVars["));
        txt = Tpl.writeStr(txt, intString(i_i));
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_restPre;
      equation
        (i_restPre, i_varDecls) = fun_531(Tpl.emptyTxt, i_elseWhen, i_varDecls);
        i_preExp = Tpl.emptyTxt;
        (i_assignments, i_preExp, i_varDecls) = algStatementWhenPreAssigns(Tpl.emptyTxt, i_el, i_helpVarIndices, i_preExp, i_varDecls);
        txt = Tpl.writeText(txt, i_preExp);
        txt = Tpl.softNewLine(txt);
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Statement i_when;
      equation
        (txt, i_varDecls) = fun_533(txt, i_helpVarIndices, i_when_exp, i_varDecls, i_when_elseWhen);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_535(txt, rest, i_varDecls);
      then (txt, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_stmt, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_statements = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_statements, i_varDecls) = lm_535(i_statements, i_when_statementLst, i_varDecls);
        i_statements = Tpl.popIter(i_statements);
        (i_else, i_varDecls) = algStatementWhenElse(Tpl.emptyTxt, i_when_elseWhen, i_varDecls);
        i_elseCondStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(" || ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_elseCondStr = lm_536(i_elseCondStr, i_when_helpVarIndices);
  ...
  matchcontinue(in_txt, in_i_ints, in_i_firstExp, in_i_varDecls, in_i_preExp, in_i_restExps)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_rest;
      equation
        (i_rest, i_preExp, i_varDecls) = algStatementWhenPreAssigns(Tpl.emptyTxt, i_restExps, i_restInts, i_preExp, i_varDecls);
        (i_firstExpPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_firstExp, SimCode.contextSimulationDiscrete, i_preExp, i_varDecls);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("localData->helpVars["));
  ...
  matchcontinue(in_txt, in_i_exps, in_i_ints, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_firstExp;
      equation
        (txt, i_varDecls, i_preExp) = fun_538(txt, i_ints, i_firstExp, i_varDecls, i_preExp, i_restExps);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_541(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_varDecls) = algStatement(txt, i_stmt, i_context, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls) = lm_542(txt, rest, i_varDecls, i_context);
      then (txt, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_else__, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_541(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("}\n"));
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls) = lm_542(txt, i_statementLst, i_varDecls, i_context);
        txt = Tpl.popIter(txt);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.popBlock(txt);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("}"));
  ...
  matchcontinue(in_txt, in_i_ecr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls, i_preExp) = fun_544(txt, ret_0, i_ecr_componentRef, i_varDecls, i_preExp, i_context, i_ecr);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        DAE.Exp i_e;
      equation
        (txt, i_preExp, i_varDecls) = daeExpMatch(txt, i_e, i_context, i_preExp, i_varDecls);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_exp;
      equation
        (txt, i_varDecls, i_preExp) = fun_551(txt, i_context, i_cr, i_t, i_varDecls, i_preExp, i_exp);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_553(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
...
protected function fun_554
  input Tpl.Text in_txt;
  input String in_it;
  input Tpl.Text in_i_dimsLenStr;
...
algorithm
  out_txt :=
  matchcontinue(in_txt, in_it, in_i_dimsLenStr, in_i_arrayType, in_i_dimsValuesStr, in_i_arrName)
    local
      Tpl.Text txt;
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_varDecls, in_i_ty, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_arrName;
      equation
        i_arrName = contextArrayCref(Tpl.emptyTxt, i_cr, i_context);
        i_arrayType = expTypeArray(Tpl.emptyTxt, i_ty);
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_arrayType), i_varDecls);
        ret_4 = ComponentReference.crefSubs(i_cr);
        (i_spec1, i_preExp, i_varDecls) = daeExpCrefRhsIndexSpec(Tpl.emptyTxt, ret_4, i_context, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        i_arrName = contextCref(Tpl.emptyTxt, ret_1, i_context);
        i_arrayType = expTypeArray(Tpl.emptyTxt, i_ty);
        ret_4 = ComponentReference.crefSubs(i_cr);
        ret_5 = listLength(ret_4);
        i_dimsLenStr = Tpl.writeStr(Tpl.emptyTxt, intString(ret_5));
        ...
        (i_dimsValuesStr, i_varDecls, i_preExp) = lm_553(i_dimsValuesStr, ret_7, i_varDecls, i_preExp, i_context);
        i_dimsValuesStr = Tpl.popIter(i_dimsValuesStr);
        str_8 = Tpl.textString(i_arrayType);
        txt = fun_554(txt, str_8, i_dimsLenStr, i_arrayType, i_dimsValuesStr, i_arrName);
      then (txt, i_preExp, i_varDecls);
  end matchcontinue;
end fun_555;
  ...
  matchcontinue(in_txt, in_it, in_i_preExp, in_i_varDecls, in_i_ty, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_555(txt, ret_0, i_preExp, i_varDecls, i_ty, i_context, i_cr);
      then (txt, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      local
        Tpl.Text i_cast;
      equation
        i_cast = fun_556(Tpl.emptyTxt, i_ty);
  ...
  matchcontinue(in_txt, in_it, in_i_box, in_i_preExp, in_i_varDecls, in_i_ty, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExp, i_varDecls) = fun_557(txt, ret_0, i_preExp, i_varDecls, i_ty, i_context, i_cr);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_ecr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_box;
      equation
        (i_box, i_preExp, i_varDecls) = daeExpCrefRhsArrayBox(Tpl.emptyTxt, i_ecr, i_context, i_preExp, i_varDecls);
        str_1 = Tpl.textString(i_box);
        (txt, i_preExp, i_varDecls) = fun_558(txt, str_1, i_box, i_preExp, i_varDecls, i_ty, i_context, i_cr);
      then (txt, i_preExp, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_sub, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_integer", i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tmp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Subscript i_sub;
      equation
        (txt, i_varDecls, i_preExp) = fun_560(txt, i_sub, i_varDecls, i_preExp, i_context);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_561(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  i_nridx__str := Tpl.writeStr(Tpl.emptyTxt, intString(ret_1));
  i_idx__str := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_idx__str, out_i_varDecls, out_i_preExp) := lm_561(i_idx__str, i_subs, i_varDecls, i_preExp, i_context);
  i_idx__str := Tpl.popIter(i_idx__str);
  (i_tmp, out_i_varDecls) := tempDecl(Tpl.emptyTxt, "index_spec_t", out_i_varDecls);
  ...
  matchcontinue(in_txt, in_i_context, in_i_ecr_componentRef, in_i_preExp, in_i_dims, in_i_varDecls, in_i_aty)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tmpArr;
      equation
        txt_1 = expTypeArray(Tpl.emptyTxt, i_aty);
        (i_tmpArr, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(txt_1), i_varDecls);
        ret_3 = listLength(i_dims);
        i_dimsLenStr = Tpl.writeStr(Tpl.emptyTxt, intString(ret_3));
        i_dimsValuesStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        i_dimsValuesStr = lm_563(i_dimsValuesStr, i_dims);
        i_dimsValuesStr = Tpl.popIter(i_dimsValuesStr);
  ...
  matchcontinue(in_txt, in_i_ecr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_ecr;
      equation
        (txt, i_preExp, i_varDecls) = fun_564(txt, i_context, i_ecr_componentRef, i_preExp, i_dims, i_varDecls, i_aty);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_cr)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_566(txt, rest, i_varDecls, i_preExp, i_context, i_cr);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_ty, in_i_cr, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_vars;
      equation
        i_vars = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_vars, i_varDecls, i_preExp) = lm_566(i_vars, i_var__lst, i_varDecls, i_preExp, i_context, i_cr);
        i_vars = Tpl.popIter(i_vars);
        i_record__type__name = underscorePath(Tpl.emptyTxt, i_record__path);
        i_ret__type = Tpl.writeText(Tpl.emptyTxt, i_record__type__name);
        i_ret__type = Tpl.writeTok(i_ret__type, Tpl.ST_STRING("_rettype"));
        (i_ret__var, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_ret__type), i_varDecls);
...
protected function fun_568
  ...
  input Tpl.Text in_i_tmpStr;

  output Tpl.Text out_txt;
algorithm
  out_txt :=
  matchcontinue(in_txt, in_it, in_i_e2, in_i_e1, in_i_tmpStr)
    local
      Tpl.Text txt;
      Tpl.Text i_e2;
      Tpl.Text i_e1;
  ...
  matchcontinue(in_txt, in_i_operator, in_i_context, in_i_exp, in_i_e2, in_i_e1, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tmpStr;
      equation
        (i_tmpStr, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_string", i_varDecls);
        ret_1 = RTOpts.acceptMetaModelicaGrammar();
        i_preExp = fun_568(i_preExp, ret_1, i_e2, i_e1, i_tmpStr);
        txt = Tpl.writeText(txt, i_tmpStr);
      then (txt, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = fun_569(Tpl.emptyTxt, i_ty);
        (i_var, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_type), i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = fun_570(Tpl.emptyTxt, i_ty);
        (i_var, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_type), i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = fun_571(Tpl.emptyTxt, i_ty);
        (i_var, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_type), i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = fun_572(Tpl.emptyTxt, i_ty);
        (i_var, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_type), i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = fun_573(Tpl.emptyTxt, i_ty);
    ...
    case ( txt,
      ...
      equation
        i_typeShort = fun_574(Tpl.emptyTxt, i_ty);
        i_type = Tpl.writeText(Tpl.emptyTxt, i_typeShort);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = fun_575(Tpl.emptyTxt, i_ty);
        (i_var, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_type), i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_e1;
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_e2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp2, i_context, i_preExp, i_varDecls);
        (txt, i_preExp, i_varDecls) = fun_576(txt, i_operator, i_context, i_exp, i_e2, i_e1, i_preExp, i_varDecls);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_e;
      equation
        (i_e, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        (txt, i_preExp) = fun_578(txt, i_operator, i_preExp, i_e);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp1, i_context, i_preExp, i_varDecls);
        (i_e2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp2, i_context, i_preExp, i_varDecls);
        txt = fun_580(txt, i_operator, i_e2, i_e1);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_it, in_i_simRel, in_i_rel_operator, in_i_rel_exp2, in_i_varDecls, in_i_preExp, in_i_context, in_i_rel_exp1)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_e1;
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_rel_exp1, i_context, i_preExp, i_varDecls);
        (i_e2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_rel_exp2, i_context, i_preExp, i_varDecls);
        txt = fun_584(txt, i_rel_operator, i_e2, i_e1);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_simRel;
      equation
        (i_simRel, i_preExp, i_varDecls) = daeExpRelationSim(Tpl.emptyTxt, i_rel, i_context, i_preExp, i_varDecls);
        str_1 = Tpl.textString(i_simRel);
        (txt, i_varDecls, i_preExp) = fun_585(txt, str_1, i_simRel, i_rel_operator, i_rel_exp2, i_varDecls, i_preExp, i_context, i_rel_exp1);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_context, in_i_rel_operator, in_i_rel_exp2, in_i_varDecls, in_i_preExp, in_i_rel_exp1)
    ...
    case ( txt,
      ...
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_rel_exp1, i_context, i_preExp, i_varDecls);
        (i_e2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_rel_exp2, i_context, i_preExp, i_varDecls);
        (i_res, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_boolean", i_varDecls);
        (txt, i_preExp) = fun_587(txt, i_rel_operator, i_e2, i_e1, i_res, i_preExp);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Exp i_rel;
      equation
        (txt, i_varDecls, i_preExp) = fun_588(txt, i_context, i_rel_operator, i_rel_exp2, i_varDecls, i_preExp, i_rel_exp1);
      then (txt, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_condExp;
      equation
        (i_condExp, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_expCond, i_context, i_preExp, i_varDecls);
        (i_condVar, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_boolean", i_varDecls);
        i_resVarType = expTypeFromExpArrayIf(Tpl.emptyTxt, i_expThen);
        (i_resVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_resVarType), i_varDecls);
        i_preExpThen = Tpl.emptyTxt;
        (i_eThen, i_preExpThen, i_varDecls) = daeExp(Tpl.emptyTxt, i_expThen, i_context, i_preExpThen, i_varDecls);
        i_preExpElse = Tpl.emptyTxt;
        (i_eElse, i_preExpElse, i_varDecls) = daeExp(Tpl.emptyTxt, i_expElse, i_context, i_preExpElse, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_593(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_594(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_596(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_call, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_var3 = Tpl.writeStr(Tpl.emptyTxt, ret_3);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_type;
      equation
        i_type = fun_591(Tpl.emptyTxt, i_ty);
        (i_var, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_type), i_varDecls);
        (i_var1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e1, i_context, i_preExp, i_varDecls);
        (i_var2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e2, i_context, i_preExp, i_varDecls);
        ret_5 = Util.escapeModelicaStringToCString(i_string);
        i_var3 = Tpl.writeStr(Tpl.emptyTxt, ret_5);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_retType;
      equation
        i_retType = expTypeArrayIf(Tpl.emptyTxt, i_arg_ty);
        (i_retVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_cast = fun_592(Tpl.emptyTxt, i_arg_ty);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_expVar;
      equation
        (i_expVar, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_array, i_context, i_preExp, i_varDecls);
        i_arr__tp__str = expTypeFromExpArray(Tpl.emptyTxt, i_array);
        txt_3 = expTypeFromExpModelica(Tpl.emptyTxt, i_array);
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(txt_3), i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tvar);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_var1;
      equation
        (i_var1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_A, i_context, i_preExp, i_varDecls);
        (i_var2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_n, i_context, i_preExp, i_varDecls);
        i_arr__tp__str = expTypeFromExpArray(Tpl.emptyTxt, i_A);
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_arr__tp__str), i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_var1;
      equation
        (i_var1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_v1, i_context, i_preExp, i_varDecls);
        (i_var2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_v2, i_context, i_preExp, i_varDecls);
        i_arr__tp__str = expTypeFromExpArray(Tpl.emptyTxt, i_v1);
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_arr__tp__str), i_varDecls);
    ...
    case ( txt,
      ...
      equation
        (i_var1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e1, i_context, i_preExp, i_varDecls);
        (i_var2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e2, i_context, i_preExp, i_varDecls);
        i_typeStr = expTypeFromExpShort(Tpl.emptyTxt, i_e1);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tvar;
      equation
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_string", i_varDecls);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tvar;
      equation
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_real", i_varDecls);
        (i_var1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        (i_var2, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_d, i_context, i_preExp, i_varDecls);
        (i_var3, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_delayMax, i_context, i_preExp, i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tvar);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tvar;
      equation
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_s1, i_context, i_preExp, i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tvar);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_argStr;
      equation
        (i_argStr, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_s1, i_context, i_preExp, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        (i_argStr, i_varDecls, i_preExp) = lm_593(i_argStr, i_expLst, i_varDecls, i_preExp, i_context);
    ...
    case ( txt,
      ...
      equation
        i_argStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_argStr, i_varDecls, i_preExp) = lm_594(i_argStr, i_expLst, i_varDecls, i_preExp, i_context);
        i_argStr = Tpl.popIter(i_argStr);
        i_funName = underscorePath(Tpl.emptyTxt, i_path);
        i_retType = Tpl.writeText(Tpl.emptyTxt, i_funName);
        i_retType = Tpl.writeTok(i_retType, Tpl.ST_STRING("_rettype"));
        (i_retVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_retType), i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_retVar);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(" = "));
    ...
    case ( txt,
      ...
      equation
        i_argStr = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_argStr, i_varDecls, i_preExp) = lm_596(i_argStr, i_expLst, i_varDecls, i_preExp, i_context);
        i_argStr = Tpl.popIter(i_argStr);
        i_funName = underscorePath(Tpl.emptyTxt, i_path);
        i_retType = Tpl.writeText(Tpl.emptyTxt, i_funName);
        i_retType = Tpl.writeTok(i_retType, Tpl.ST_STRING("_rettype"));
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context, in_i_scalar)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_prefix;
      equation
        i_prefix = fun_601(Tpl.emptyTxt, i_scalar, i_e);
        txt = Tpl.writeText(txt, i_prefix);
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_e, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_602(txt, rest, i_varDecls, i_preExp, i_context, i_scalar);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        i_arrayTypeStr = expTypeArray(Tpl.emptyTxt, i_ty);
        (i_arrayVar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_arrayTypeStr), i_varDecls);
        i_scalarPrefix = fun_599(Tpl.emptyTxt, i_scalar);
        i_scalarRef = fun_600(Tpl.emptyTxt, i_scalar);
        i_params = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_params, i_varDecls, i_preExp) = lm_602(i_params, i_array, i_varDecls, i_preExp, i_context, i_scalar);
  ...
  matchcontinue(in_txt, in_items, in_i_vars2, in_i_promote, in_i_context, in_i_varDecls, in_i_arrayTypeStr)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tmp;
      equation
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_arrayTypeStr), i_varDecls);
        (i_vars, i_promote, i_varDecls) = daeExpMatrixRow(Tpl.emptyTxt, i_row, Tpl.textString(i_arrayTypeStr), i_context, i_promote, i_varDecls);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_vars2, i_promote, i_varDecls) = lm_604(txt, rest, i_vars2, i_promote, i_context, i_varDecls, i_arrayTypeStr);
      then (txt, i_vars2, i_promote, i_varDecls);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_arrayTypeStr;
      equation
        i_arrayTypeStr = expTypeArray(Tpl.emptyTxt, i_m_ty);
        i_vars2 = Tpl.emptyTxt;
        i_promote = Tpl.emptyTxt;
        i_catAlloc = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_catAlloc, i_vars2, i_promote, i_varDecls) = lm_604(i_catAlloc, i_m_scalar, i_vars2, i_promote, i_context, i_varDecls, i_arrayTypeStr);
...
algorithm
  ...
  matchcontinue(in_txt, in_items, in_i_varLstStr, in_i_arrayTypeStr, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        i_scalarStr = fun_606(Tpl.emptyTxt, i_b);
        i_scalarRefStr = fun_607(Tpl.emptyTxt, i_b);
        (i_expVar, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, i_arrayTypeStr, i_varDecls);
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(");"));
        txt = Tpl.nextIter(txt);
        (txt, i_varLstStr, i_varDecls, i_preExp) = lm_608(txt, rest, i_varLstStr, i_arrayTypeStr, i_varDecls, i_preExp, i_context);
      then (txt, i_varLstStr, i_varDecls, i_preExp);
...
protected
  ...
  Tpl.Text i_varLstStr;
algorithm
  i_varLstStr := Tpl.emptyTxt;
  i_preExp2 := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_preExp2, i_varLstStr, out_i_varDecls, out_i_preExp) := lm_608(i_preExp2, i_row, i_varLstStr, i_arrayTypeStr, i_varDecls, i_preExp, i_context);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_ty, in_i_preExp, in_i_exp, in_i_varDecls, in_i_expVar)
    ...
    case ( txt,
      ...
      equation
        i_arrayTypeStr = expTypeArray(Tpl.emptyTxt, i_ty);
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_arrayTypeStr), i_varDecls);
        i_to = expTypeShort(Tpl.emptyTxt, i_ty);
        i_from = expTypeFromExpShort(Tpl.emptyTxt, i_exp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_expVar;
      equation
        (i_expVar, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        (txt, i_preExp, i_varDecls) = fun_610(txt, i_ty, i_preExp, i_exp, i_varDecls, i_expVar);
      then (txt, i_preExp, i_varDecls);
...
algorithm
  (out_txt, out_i_varDecls, out_i_preExp) :=
  matchcontinue(in_txt, in_i_exp, in_i_varDecls, in_i_preExp, in_i_context)
    local
      Tpl.Text txt;
      Tpl.Text i_varDecls;
      Tpl.Text i_preExp;
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_e1;
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        (i_idx1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_idx, i_context, i_preExp, i_varDecls);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("arrayGet("));
        txt = Tpl.writeText(txt, i_e1);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(","));
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (i_e1, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        i_typeShort = expTypeFromExpShort(Tpl.emptyTxt, i_e);
    ...
    case ( txt,
      ...
      equation
        ...
        (i_arrName, i_preExp, i_varDecls) = daeExpCrefRhs(Tpl.emptyTxt, ret_1, i_context, i_preExp, i_varDecls);
        (txt, i_varDecls, i_preExp) = fun_613(txt, i_context, i_varDecls, i_preExp, i_subs, i_ecr_ty, i_arrName);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) :=
  matchcontinue(in_txt, in_it, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    local
      Tpl.Text txt;
      DAE.Exp i_exp;
      SimCode.Context i_context;
    ...
    case ( txt,
           ...
           i_varDecls )
      equation
        (txt, i_varDecls, i_preExp) = fun_612(txt, i_exp, i_varDecls, i_preExp, i_context);
      then (txt, i_preExp, i_varDecls);
    ...
    case ( txt,
           ...
           i_varDecls )
      equation
        (txt, i_varDecls, i_preExp) = fun_614(txt, i_exp, i_varDecls, i_preExp, i_context);
      then (txt, i_preExp, i_varDecls);
  end matchcontinue;
end fun_615;
...
algorithm
  txt_0 := expTypeFromExpShort(Tpl.emptyTxt, i_exp);
  str_1 := Tpl.textString(txt_0);
  (out_txt, out_i_preExp, out_i_varDecls) := fun_615(txt, str_1, i_exp, i_context, i_preExp, i_varDecls);
end daeExpAsub;
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (i_expPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_exp, i_context, i_preExp, i_varDecls);
        (i_dimPart, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_dim, i_context, i_preExp, i_varDecls);
        (i_resVar, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_integer", i_varDecls);
        i_typeStr = expTypeArray(Tpl.emptyTxt, i_exp_ty);
        i_preExp = Tpl.writeText(i_preExp, i_resVar);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_identType;
      equation
        i_identType = expTypeFromExpModelica(Tpl.emptyTxt, i_expr);
        i_accFun = daeExpReductionFnName(Tpl.emptyTxt, i_op, Tpl.textString(i_identType));
        i_startValue = daeExpReductionStartValue(Tpl.emptyTxt, i_op, Tpl.textString(i_identType));
        (i_res, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(i_identType), i_varDecls);
        i_tmpExpPre = Tpl.emptyTxt;
        (i_tmpExpVar, i_tmpExpPre, i_varDecls) = daeExp(Tpl.emptyTxt, i_expr, i_context, i_tmpExpPre, i_varDecls);
        str_7 = Tpl.textString(i_accFun);
        i_cast = fun_618(Tpl.emptyTxt, str_7);
        i_body = Tpl.writeText(Tpl.emptyTxt, i_tmpExpPre);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_body, in_i_context, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_identType;
      equation
        i_identType = expTypeModelica(Tpl.emptyTxt, i_range_ty);
        i_identTypeShort = expTypeFromExpShort(Tpl.emptyTxt, i_expr);
    ...
    case ( txt,
      ...
      equation
        i_identType = expTypeFromExpModelica(Tpl.emptyTxt, i_expr);
        i_arrayType = expTypeFromExpArray(Tpl.emptyTxt, i_expr);
  ...
  matchcontinue(in_txt, in_items, in_i_preExpInner, in_i_varDeclsInner)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_preExpInner, i_varDeclsInner) = lm_627(txt, rest, i_preExpInner, i_varDeclsInner);
      then (txt, i_preExpInner, i_varDeclsInner);
...
protected function lm_628
  input Tpl.Text in_txt;
  input list<DAE.Exp> in_items;
  input Tpl.Text in_i_preExpInput;
  input SimCode.Context in_i_context;
  input Tpl.Text in_i_expInput;
  input Tpl.Text in_i_varDeclsInput;
  input Tpl.Text in_i_prefix;

  output Tpl.Text out_txt;
  output Tpl.Text out_i_preExpInput;
  output Tpl.Text out_i_expInput;
  output Tpl.Text out_i_varDeclsInput;
algorithm
  (out_txt, out_i_preExpInput, out_i_expInput, out_i_varDeclsInput) :=
  matchcontinue(in_txt, in_items, in_i_preExpInput, in_i_context, in_i_expInput, in_i_varDeclsInput, in_i_prefix)
    local
      Tpl.Text txt;
      Tpl.Text i_preExpInput;
      SimCode.Context i_context;
      Tpl.Text i_expInput;
      Tpl.Text i_varDeclsInput;
      Tpl.Text i_prefix;
    ...
    case ( txt,
           ...
           i_varDeclsInput,
           _ )
      then (txt, i_preExpInput, i_expInput, i_varDeclsInput);
    ...
    case ( txt,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        i_decl = Tpl.writeText(Tpl.emptyTxt, i_prefix);
        i_decl = Tpl.writeTok(i_decl, Tpl.ST_STRING("_in"));
        i_decl = Tpl.writeStr(i_decl, intString(i_i0));
        i_varDeclsInput = expTypeFromExpModelica(i_varDeclsInput, i_exp);
        i_varDeclsInput = Tpl.writeTok(i_varDeclsInput, Tpl.ST_STRING(" "));
        i_varDeclsInput = Tpl.writeText(i_varDeclsInput, i_decl);
        i_varDeclsInput = Tpl.writeTok(i_varDeclsInput, Tpl.ST_STRING(";"));
        i_varDeclsInput = Tpl.writeTok(i_varDeclsInput, Tpl.ST_NEW_LINE());
        i_expInput = Tpl.writeText(i_expInput, i_decl);
        i_expInput = Tpl.writeTok(i_expInput, Tpl.ST_STRING(" = "));
        (i_expInput, i_preExpInput, i_varDeclsInput) = daeExp(i_expInput, i_exp, i_context, i_preExpInput, i_varDeclsInput);
        i_expInput = Tpl.writeTok(i_expInput, Tpl.ST_STRING(";"));
        i_expInput = Tpl.writeTok(i_expInput, Tpl.ST_NEW_LINE());
        txt = Tpl.nextIter(txt);
        (txt, i_preExpInput, i_expInput, i_varDeclsInput) = lm_628(txt, rest, i_preExpInput, i_context, i_expInput, i_varDeclsInput, i_prefix);
      then (txt, i_preExpInput, i_expInput, i_varDeclsInput);
...
algorithm
  (out_txt, out_i_varDecls) :=
  matchcontinue(in_txt, in_i_et, in_i_varDecls)
    local
      Tpl.Text txt;
      Tpl.Text i_varDecls;
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_varDecls) = tempDecl(txt, Tpl.textString(txt_0), i_varDecls);
      then (txt, i_varDecls);
  end matchcontinue;
end fun_629;
...
protected function fun_630
  input Tpl.Text in_txt;
  input Absyn.MatchType in_i_exp_matchType;

  output Tpl.Text out_txt;
algorithm
  out_txt :=
  matchcontinue(in_txt, in_i_exp_matchType)
    local
      Tpl.Text txt;
...
protected function lm_633
  ...
  input Tpl.Text in_i_varDeclsCaseInner;
  input Tpl.Text in_i_onPatternFail;
  input Tpl.Text in_i_prefix;

  output Tpl.Text out_txt;
  output Tpl.Text out_i_assignments;
  output Tpl.Text out_i_varDeclsCaseInner;
  output Tpl.Text out_i_onPatternFail;
algorithm
  (out_txt, out_i_assignments, out_i_varDeclsCaseInner, out_i_onPatternFail) :=
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_varDeclsCaseInner, in_i_onPatternFail, in_i_prefix)
    local
      Tpl.Text txt;
      Tpl.Text i_assignments;
      Tpl.Text i_varDeclsCaseInner;
      Tpl.Text i_onPatternFail;
      Tpl.Text i_prefix;
    ...
    case ( txt,
           ...
           i_onPatternFail,
           _ )
      then (txt, i_assignments, i_varDeclsCaseInner, i_onPatternFail);
    ...
    case ( txt,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        txt_0 = Tpl.writeText(Tpl.emptyTxt, i_prefix);
        txt_0 = Tpl.writeTok(txt_0, Tpl.ST_STRING("_in"));
        txt_0 = Tpl.writeStr(txt_0, intString(i_i0));
        (txt, txt_0, i_onPatternFail, i_varDeclsCaseInner, i_assignments) = patternMatch(txt, i_lhs, txt_0, i_onPatternFail, i_varDeclsCaseInner, i_assignments);
        txt = Tpl.nextIter(txt);
        (txt, i_assignments, i_varDeclsCaseInner, i_onPatternFail) = lm_633(txt, rest, i_assignments, i_varDeclsCaseInner, i_onPatternFail, i_prefix);
      then (txt, i_assignments, i_varDeclsCaseInner, i_onPatternFail);
...
protected function lm_634
  ...
  output Tpl.Text out_i_varDeclsCaseInner;
algorithm
  (out_txt, out_i_varDeclsCaseInner) :=
  matchcontinue(in_txt, in_items, in_i_varDeclsCaseInner, in_i_context)
    local
      Tpl.Text txt;
      Tpl.Text i_varDeclsCaseInner;
      SimCode.Context i_context;
    ...
    case ( txt,
      ...
      local
        ...
        DAE.Statement i_stmt;
      equation
        (txt, i_varDeclsCaseInner) = algStatement(txt, i_stmt, i_context, i_varDeclsCaseInner);
        txt = Tpl.nextIter(txt);
        (txt, i_varDeclsCaseInner) = lm_634(txt, rest, i_varDeclsCaseInner, i_context);
      then (txt, i_varDeclsCaseInner);
...
protected function fun_635
  input Tpl.Text in_txt;
  input Option<DAE.Exp> in_i_c_result;
  input Tpl.Text in_i_varDeclsCaseInner;
  input Tpl.Text in_i_preRes;
  input SimCode.Context in_i_context;

  output Tpl.Text out_txt;
  output Tpl.Text out_i_varDeclsCaseInner;
  output Tpl.Text out_i_preRes;
algorithm
  (out_txt, out_i_varDeclsCaseInner, out_i_preRes) :=
  matchcontinue(in_txt, in_i_c_result, in_i_varDeclsCaseInner, in_i_preRes, in_i_context)
    local
      Tpl.Text txt;
      Tpl.Text i_varDeclsCaseInner;
      Tpl.Text i_preRes;
    ...
    case ( txt,
      ...
      local
        DAE.Exp i_e;
      equation
        (txt, i_preRes, i_varDeclsCaseInner) = daeExp(txt, i_e, i_context, i_preRes, i_varDeclsCaseInner);
      then (txt, i_varDeclsCaseInner, i_preRes);
...
protected function lm_636
  input Tpl.Text in_txt;
  input list<SimCode.Variable> in_items;
  input Tpl.Text in_i_preExpCaseInner;
  input Tpl.Text in_i_varDeclsCaseInner;

  output Tpl.Text out_txt;
  output Tpl.Text out_i_preExpCaseInner;
  output Tpl.Text out_i_varDeclsCaseInner;
algorithm
  (out_txt, out_i_preExpCaseInner, out_i_varDeclsCaseInner) :=
  matchcontinue(in_txt, in_items, in_i_preExpCaseInner, in_i_varDeclsCaseInner)
    local
      Tpl.Text txt;
      Tpl.Text i_preExpCaseInner;
      Tpl.Text i_varDeclsCaseInner;
    ...
    case ( txt,
           ...
           i_preExpCaseInner,
           i_varDeclsCaseInner )
      then (txt, i_preExpCaseInner, i_varDeclsCaseInner);
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Variable i_var;
      equation
        (txt, i_varDeclsCaseInner, i_preExpCaseInner) = varInit(txt, i_var, "", 0, i_varDeclsCaseInner, i_preExpCaseInner);
        (txt, i_preExpCaseInner, i_varDeclsCaseInner) = lm_636(txt, rest, i_preExpCaseInner, i_varDeclsCaseInner);
      then (txt, i_preExpCaseInner, i_varDeclsCaseInner);
...
algorithm
  out_txt :=
  matchcontinue(in_txt, in_i_c_result, in_i_caseRes, in_i_res, in_i_preRes)
    local
      Tpl.Text txt;
      Tpl.Text i_caseRes;
      Tpl.Text i_res;
    ...
    case ( txt,
           ...
           i_preRes )
      equation
        txt = Tpl.writeText(txt, i_preRes);
        txt = Tpl.writeText(txt, i_res);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" = "));
        txt = Tpl.writeText(txt, i_caseRes);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
      then txt;
  end matchcontinue;
...
protected function lm_638
  ...
  output Tpl.Text out_i_onPatternFail;
algorithm
  (out_txt, out_i_onPatternFail) :=
  matchcontinue(in_txt, in_items, in_i_done, in_i_res, in_i_context, in_i_onPatternFail, in_i_prefix)
    local
      Tpl.Text txt;
      Tpl.Text i_done;
      Tpl.Text i_res;
    ...
    case ( txt,
           ...
           i_onPatternFail,
           _ )
      then (txt, i_onPatternFail);

    case ( txt,
           (i_c as DAE.CASE(patterns = i_c_patterns, body = i_c_body, result = i_c_result, localDecls = i_c_localDecls)) :: rest,
           i_done,
           i_res,
           i_context,
           i_onPatternFail,
      ...
      equation
        i_i0 = Tpl.getIteri_i0(txt);
        i_varDeclsCaseInner = Tpl.emptyTxt;
        i_preExpCaseInner = Tpl.emptyTxt;
        i_assignments = Tpl.emptyTxt;
        i_preRes = Tpl.emptyTxt;
        i_patternMatching = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, SOME(Tpl.ST_STRING("")), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_patternMatching, i_assignments, i_varDeclsCaseInner, i_onPatternFail) = lm_633(i_patternMatching, i_c_patterns, i_assignments, i_varDeclsCaseInner, i_onPatternFail, i_prefix);
        i_patternMatching = Tpl.popIter(i_patternMatching);
        i_stmts = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_NEW_LINE()), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_stmts, i_varDeclsCaseInner) = lm_634(i_stmts, i_c_body, i_varDeclsCaseInner, i_context);
        i_stmts = Tpl.popIter(i_stmts);
        (i_caseRes, i_varDeclsCaseInner, i_preRes) = fun_635(Tpl.emptyTxt, i_c_result, i_varDeclsCaseInner, i_preRes, i_context);
        ret_8 = SimCode.elementVars(i_c_localDecls);
        (i_0__, i_preExpCaseInner, i_varDeclsCaseInner) = lm_636(Tpl.emptyTxt, ret_8, i_preExpCaseInner, i_varDeclsCaseInner);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("case "));
        txt = Tpl.writeStr(txt, intString(i_i0));
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(": {\n"));
        txt = Tpl.pushBlock(txt, Tpl.BT_INDENT(2));
        txt = Tpl.writeText(txt, i_varDeclsCaseInner);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_preExpCaseInner);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_patternMatching);
        txt = Tpl.softNewLine(txt);
        ...
        txt = Tpl.softNewLine(txt);
        txt = fun_637(txt, i_c_result, i_caseRes, i_res, i_preRes);
        txt = Tpl.softNewLine(txt);
        txt = Tpl.writeText(txt, i_done);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING_LIST({
                                    " = 1;\n",
                                    "break;\n"
                                }, true));
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
        txt = Tpl.nextIter(txt);
        (txt, i_onPatternFail) = lm_638(txt, rest, i_done, i_res, i_context, i_onPatternFail, i_prefix);
      then (txt, i_onPatternFail);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
           (i_exp as DAE.MATCHEXPRESSION(localDecls = i_localDecls, inputs = i_inputs, et = i_et, matchType = i_exp_matchType, cases = i_cases)),
           i_context,
           i_preExp,
           i_varDecls )
      local
        ...
        Tpl.Text i_preExpInner;
      equation
        i_preExpInner = Tpl.emptyTxt;
        i_preExpRes = Tpl.emptyTxt;
        i_varDeclsInput = Tpl.emptyTxt;
        i_varDeclsInner = Tpl.emptyTxt;
        i_ignore = Tpl.emptyTxt;
        ret_6 = SimCode.elementVars(i_localDecls);
        (i_ignore2, i_preExpInner, i_varDeclsInner) = lm_627(Tpl.emptyTxt, ret_6, i_preExpInner, i_varDeclsInner);
        i_prefix = Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("tmp"));
        ret_8 = System.tmpTick();
        i_prefix = Tpl.writeStr(i_prefix, intString(ret_8));
        i_preExpInput = Tpl.emptyTxt;
        i_expInput = Tpl.emptyTxt;
        i_ignore3 = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, SOME(Tpl.ST_STRING("")), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_ignore3, i_preExpInput, i_expInput, i_varDeclsInput) = lm_628(i_ignore3, i_inputs, i_preExpInput, i_context, i_expInput, i_varDeclsInput, i_prefix);
        i_ignore3 = Tpl.popIter(i_ignore3);
        (i_res, i_varDecls) = fun_629(Tpl.emptyTxt, i_et, i_varDecls);
        (i_ix, i_varDeclsInner) = tempDecl(Tpl.emptyTxt, "int", i_varDeclsInner);
        (i_done, i_varDeclsInner) = tempDecl(Tpl.emptyTxt, "int", i_varDeclsInner);
        i_onPatternFail = fun_630(Tpl.emptyTxt, i_exp_matchType);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("{ /* "));
        i_preExp = fun_631(i_preExp, i_exp_matchType);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_LINE(" */\n"));
        i_preExp = Tpl.pushBlock(i_preExp, Tpl.BT_INDENT(2));
        i_preExp = Tpl.writeText(i_preExp, i_varDeclsInput);
        i_preExp = Tpl.softNewLine(i_preExp);
        i_preExp = Tpl.writeText(i_preExp, i_preExpInput);
        i_preExp = Tpl.softNewLine(i_preExp);
        i_preExp = Tpl.writeText(i_preExp, i_expInput);
        i_preExp = Tpl.softNewLine(i_preExp);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_LINE("{\n"));
        i_preExp = Tpl.pushBlock(i_preExp, Tpl.BT_INDENT(2));
        ...
        i_preExp = Tpl.softNewLine(i_preExp);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("for ("));
        ...
        i_preExp = Tpl.writeText(i_preExp, i_ix);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(" < "));
        ret_16 = listLength(i_cases);
        i_preExp = Tpl.writeStr(i_preExp, intString(ret_16));
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(" && !"));
        i_preExp = Tpl.writeText(i_preExp, i_done);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("; "));
        i_preExp = Tpl.writeText(i_preExp, i_ix);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("++) "));
        i_preExp = fun_632(i_preExp, i_exp_matchType);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_LINE("{\n"));
        i_preExp = Tpl.pushBlock(i_preExp, Tpl.BT_INDENT(2));
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("switch ("));
        i_preExp = Tpl.writeText(i_preExp, i_ix);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_LINE(") {\n"));
        i_preExp = Tpl.pushIter(i_preExp, Tpl.ITER_OPTIONS(0, NONE(), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_preExp, i_onPatternFail) = lm_638(i_preExp, i_cases, i_done, i_res, i_context, i_onPatternFail, i_prefix);
        i_preExp = Tpl.popIter(i_preExp);
        i_preExp = Tpl.softNewLine(i_preExp);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_LINE("}\n"));
        i_preExp = Tpl.popBlock(i_preExp);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("}"));
        i_preExp = fun_639(i_preExp, i_exp_matchType);
        i_preExp = Tpl.softNewLine(i_preExp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        (txt, i_preExp, i_varDecls) = daeExp(txt, i_exp, i_context, i_preExp, i_varDecls);
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_641(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
...
algorithm
  ...
  i_dimsLenStr := Tpl.writeStr(Tpl.emptyTxt, intString(ret_2));
  i_dimsValuesStr := Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
  (i_dimsValuesStr, out_i_varDecls, out_i_preExp) := lm_641(i_dimsValuesStr, i_subs, i_varDecls, i_preExp, i_context);
  i_dimsValuesStr := Tpl.popIter(i_dimsValuesStr);
  str_4 := Tpl.textString(i_arrayType);
  out_txt := fun_642(txt, str_4, i_dimsLenStr, i_arrayType, i_dimsValuesStr, i_arrName);
end arrayScalarRhs;
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tmp;
      equation
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        (i_expPart, i_preExp, i_varDecls) = daeExpListToCons(Tpl.emptyTxt, i_valList, i_context, i_preExp, i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tmp);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(" = "));
        i_preExp = Tpl.writeText(i_preExp, i_expPart);
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING(";"));
  ...
  matchcontinue(in_txt, in_i_listItems, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_expPart;
      equation
        (i_expPart, i_preExp, i_varDecls) = daeExpMetaHelperConstant(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
        (i_restList, i_preExp, i_varDecls) = daeExpListToCons(Tpl.emptyTxt, i_rest, i_context, i_preExp, i_varDecls);
...
algorithm
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        (i_carExp, i_preExp, i_varDecls) = daeExpMetaHelperConstant(Tpl.emptyTxt, i_car, i_context, i_preExp, i_varDecls);
        (i_cdrExp, i_preExp, i_varDecls) = daeExp(Tpl.emptyTxt, i_cdr, i_context, i_preExp, i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tmp);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_647(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_start = daeExpMetaHelperBoxStart(Tpl.emptyTxt, ret_1);
        i_args = Tpl.pushIter(Tpl.emptyTxt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (i_args, i_varDecls, i_preExp) = lm_647(i_args, i_listExp, i_varDecls, i_preExp, i_context);
        i_args = Tpl.popIter(i_args);
        (i_tmp, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        i_preExp = Tpl.writeText(i_preExp, i_tmp);
        ...
        i_preExp = Tpl.writeTok(i_preExp, Tpl.ST_STRING("0"));
        str_4 = Tpl.textString(i_args);
        i_preExp = fun_648(i_preExp, str_4);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_651(txt, rest, i_varDecls, i_preExp, i_context);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_args, in_i_varDecls, in_i_preExp, in_i_context)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_651(txt, i_args, i_varDecls, i_preExp, i_context);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls, i_preExp);
  end matchcontinue;
end fun_652;
  ...
  matchcontinue(in_txt, in_i_exp, in_i_context, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        i_newIndex = Tpl.writeStr(Tpl.emptyTxt, intString(ret_1));
        (i_argsStr, i_varDecls, i_preExp) = fun_652(Tpl.emptyTxt, i_args, i_varDecls, i_preExp, i_context);
        i_box = Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("mmc_mk_box"));
...
protected
  ...
  Tpl.Text i_expPart;
algorithm
  (i_expPart, out_i_preExp, out_i_varDecls) := daeExp(Tpl.emptyTxt, i_e, i_context, i_preExp, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_varDecls, in_i_preExp, in_i_varname)
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_nameText;
      equation
        i_nameText = Tpl.writeText(Tpl.emptyTxt, i_varname);
        ...
        txt = Tpl.nextIter(txt);
        (txt, i_varDecls, i_preExp) = lm_655(txt, rest, i_varDecls, i_preExp, i_varname);
      then (txt, i_varDecls, i_preExp);
  ...
  matchcontinue(in_txt, in_i_varLst, in_i_varDecls, in_i_preExp, in_i_varname)
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(", "));
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, NONE(), SOME(Tpl.ST_STRING(", ")), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_varDecls, i_preExp) = lm_655(txt, i_varLst, i_varDecls, i_preExp, i_varname);
        txt = Tpl.popIter(txt);
      then (txt, i_varDecls, i_preExp);
  end matchcontinue;
end fun_656;
  ...
  matchcontinue(in_txt, in_i_type, in_i_varname, in_i_preExp, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        ret_2 = SimCode.incrementInt(ret_1, 1);
        i_start = daeExpMetaHelperBoxStart(Tpl.emptyTxt, ret_2);
        (i_args, i_varDecls, i_preExp) = fun_656(Tpl.emptyTxt, i_varLst, i_varDecls, i_preExp, i_varname);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("mmc_mk_box"));
...
public function daeExpMetaHelperConstantNameType
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_preExp, out_i_varDecls) := fun_657(txt, i_type, i_varname, i_preExp, i_varDecls);
  out_i_varname := i_varname;
...
protected
  Tpl.Text i_newVar;
algorithm
  i_newVar := Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("out"));
...
protected
  ...
  Tpl.Text i_newVar;
algorithm
  i_newVar := Tpl.writeTok(Tpl.emptyTxt, Tpl.ST_STRING("tmp"));
  ret_1 := System.tmpTick();
  ...
  matchcontinue(in_txt, in_i_var)
    ...
    case ( txt,
      ...
      local
        ...
        SimCode.Variable i_var;
      equation
        txt = fun_663(txt, i_instDims, i_var_ty);
      then txt;
...
public function expType
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_670(txt, i_array, i_ty);
end expType;
...
public function expTypeFlag
  ...
  output Tpl.Text out_txt;
algorithm
  out_txt := fun_682(txt, i_flag, i_ty);
end expTypeFlag;
...
algorithm
  out_txt :=
  matchcontinue(in_txt, in_i_p_exp, in_i_onPatternFail, in_i_urhs)
    local
      Tpl.Text txt;
      Tpl.Text i_onPatternFail;
      Tpl.Text i_urhs;
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(") "));
        txt = Tpl.writeText(txt, i_onPatternFail);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(";"));
        txt = Tpl.writeTok(txt, Tpl.ST_NEW_LINE());
      then txt;
...
protected function lm_698
  ...
  output Tpl.Text out_i_varDecls;
algorithm
  (out_txt, out_i_assignments, out_i_onPatternFail, out_i_varDecls) :=
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_onPatternFail, in_i_rhs, in_i_varDecls)
    local
      Tpl.Text txt;
      Tpl.Text i_assignments;
      Tpl.Text i_onPatternFail;
    ...
    case ( txt,
           ...
           _,
           i_varDecls )
      then (txt, i_assignments, i_onPatternFail, i_varDecls);
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeStr(txt, intString(i_i1));
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("));\n"));
        (txt, i_tvar, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p, i_tvar, i_onPatternFail, i_varDecls, i_assignments);
        txt = Tpl.nextIter(txt);
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_698(txt, rest, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
      then (txt, i_assignments, i_onPatternFail, i_varDecls);
...
protected function lm_699
  ...
  output Tpl.Text out_i_onPatternFail;
algorithm
  (out_txt, out_i_assignments, out_i_varDecls, out_i_onPatternFail) :=
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_varDecls, in_i_onPatternFail, in_i_rhs)
    local
      Tpl.Text txt;
      Tpl.Text i_assignments;
      Tpl.Text i_varDecls;
    ...
    case ( txt,
           ...
           i_onPatternFail,
           _ )
      then (txt, i_assignments, i_varDecls, i_onPatternFail);
    ...
    case ( txt,
      ...
      equation
        i_i1 = Tpl.getIteri_i1(txt);
        i_nrhs = Tpl.writeText(Tpl.emptyTxt, i_rhs);
        i_nrhs = Tpl.writeTok(i_nrhs, Tpl.ST_STRING(".targ"));
        i_nrhs = Tpl.writeStr(i_nrhs, intString(i_i1));
        (txt, i_nrhs, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p, i_nrhs, i_onPatternFail, i_varDecls, i_assignments);
        txt = Tpl.nextIter(txt);
        (txt, i_assignments, i_varDecls, i_onPatternFail) = lm_699(txt, rest, i_assignments, i_varDecls, i_onPatternFail, i_rhs);
      then (txt, i_assignments, i_varDecls, i_onPatternFail);
  ...
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_onPatternFail, in_i_rhs, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (i_tvar, i_varDecls) = tempDecl(Tpl.emptyTxt, Tpl.textString(txt_1), i_varDecls);
        txt = Tpl.writeText(txt, i_tvar);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(" = "));
        txt = Tpl.writeText(txt, i_rhs);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("."));
        ...
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(";\n"));
        (txt, i_tvar, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p, i_tvar, i_onPatternFail, i_varDecls, i_assignments);
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_700(txt, rest, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
      then (txt, i_assignments, i_onPatternFail, i_varDecls);
  ...
  matchcontinue(in_txt, in_items, in_i_assignments, in_i_onPatternFail, in_i_rhs, in_i_varDecls)
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_tvar, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p, i_tvar, i_onPatternFail, i_varDecls, i_assignments);
        txt = Tpl.nextIter(txt);
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_701(txt, rest, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
      then (txt, i_assignments, i_onPatternFail, i_varDecls);
...
public function patternMatch
  ...
  output Tpl.Text out_i_assignments;
algorithm
  (out_txt, out_i_rhs, out_i_onPatternFail, out_i_varDecls, out_i_assignments) :=
  matchcontinue(in_txt, in_i_pat, in_i_rhs, in_i_onPatternFail, in_i_varDecls, in_i_assignments)
    local
      Tpl.Text txt;
      Tpl.Text i_rhs;
      Tpl.Text i_onPatternFail;
    ...
    case ( txt,
      ...
      equation
        i_unboxBuf = Tpl.emptyTxt;
        (i_urhs, i_varDecls, i_unboxBuf) = fun_696(Tpl.emptyTxt, i_p_ty, i_varDecls, i_unboxBuf, i_rhs);
        txt = Tpl.writeText(txt, i_unboxBuf);
        txt = fun_697(txt, i_p_exp, i_onPatternFail, i_urhs);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        ...
        txt = Tpl.writeText(txt, i_rhs);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE("), 1));\n"));
        (txt, i_tvar, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p_pat, i_tvar, i_onPatternFail, i_varDecls, i_assignments);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      local
        ...
        Tpl.Text i_tvarHead;
      equation
        (i_tvarHead, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        (i_tvarTail, i_varDecls) = tempDecl(Tpl.emptyTxt, "modelica_metatype", i_varDecls);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING("if (listEmpty("));
        txt = Tpl.writeText(txt, i_rhs);
        txt = Tpl.writeTok(txt, Tpl.ST_STRING(")) "));
        txt = Tpl.writeText(txt, i_onPatternFail);
        ...
        txt = Tpl.writeText(txt, i_rhs);
        txt = Tpl.writeTok(txt, Tpl.ST_LINE(");\n"));
        (txt, i_tvarHead, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_head, i_tvarHead, i_onPatternFail, i_varDecls, i_assignments);
        (txt, i_tvarTail, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_tail, i_tvarTail, i_onPatternFail, i_varDecls, i_assignments);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_698(txt, i_patterns, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        txt = Tpl.pushIter(txt, Tpl.ITER_OPTIONS(0, SOME(Tpl.ST_STRING("")), NONE(), 0, 0, Tpl.ST_NEW_LINE(), 0, Tpl.ST_NEW_LINE()));
        (txt, i_assignments, i_varDecls, i_onPatternFail) = lm_699(txt, i_patterns, i_assignments, i_varDecls, i_onPatternFail, i_rhs);
        txt = Tpl.popIter(txt);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);

    case ( txt,
           DAE.PAT_CALL_NAMED(patterns = i_patterns),
           i_rhs,
           i_onPatternFail,
           i_varDecls,
           i_assignments )
      local
        list<tuple<DAE.Pattern, String, DAE.ExpType>> i_patterns;
      equation
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_700(txt, i_patterns, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_assignments, i_onPatternFail, i_varDecls) = lm_701(txt, i_patterns, i_assignments, i_onPatternFail, i_rhs, i_varDecls);
        txt = Tpl.popIter(txt);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
    ...
    case ( txt,
      ...
      equation
        ...
        (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments) = patternMatch(txt, i_p_pat, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
      then (txt, i_rhs, i_onPatternFail, i_varDecls, i_assignments);
