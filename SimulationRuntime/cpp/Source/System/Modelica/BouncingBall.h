...
#define BOOST_EXTENSION_EVENTHANDLING_DECL BOOST_EXTENSION_IMPORT_DECL
 ...
 #include "../../Math/Implementation/BoostArrayAssert.h"
...
* System class BouncingBall implements the Interface IDAESystem
*
*****************************************************************************/
typedef HistoryImpl<TextFileWriter,7,2> HistoryImplType;


class BouncingBall: public IDAESystem ,public IContinous ,public IEvent ,public ISystemProperties, public SystemDefaultImplementation
 { 
 public: 

	BouncingBall(IGlobalSettings& globalSettings); 
...
private:
	...
	//Member variables (parameters, constants, algebraic variables) 
	...
	bool $impact;
	 ...
	 //"true, if ball is flying"
	bool $flying;


	//Condition variables for each time event function (sample)
	//Condition variables for each zero crossing function 
	bool _condition1;
