...
IF(DGESV_INCLUDE_DIR)
  ...
  FIND_PATH(DGESV_SRC_DIR_F2C NAMES d_cnjg.c PATHS "${CMAKE_SOURCE_DIR}/../../3rdParty/dgesv/libf2c/" "${DGESV_HOME}/libf2c/" NO_DEFAULT_PATH)

  IF(DGESV_SRC_DIR_BLAS AND DGESV_SRC_DIR_LAPACK AND DGESV_SRC_DIR_F2C)
    FILE(GLOB DGESV_SRCS "${DGESV_SRC_DIR_BLAS}/*.c" "${DGESV_SRC_DIR_LAPACK}/*.c" "${DGESV_SRC_DIR_F2C}/*.c")
  ELSE()
