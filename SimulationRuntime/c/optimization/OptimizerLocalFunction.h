...
inline void res2file(OptData *optData, SOLVER_INFO* solverInfo,double * v);
inline void optData2ModelData(OptData *optData, double *vopt, const int index);
inline void diff_symColoredODE(OptData *optData, modelica_real **J, const int index, const long double * const scaldt);
inline void diff_symColoredLagrange(OptData *optData, modelica_real **J, const int index, const long double * const scaldt);
inline void diff_symColoredMayer(OptData *optData, modelica_real **J, const int index);
