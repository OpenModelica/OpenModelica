    ...
    string* outputFormat, string* variableFilter)
{
      ...
      || nystrchk != modelData->nVariablesString)
  {
    ...
    WARNING_AL2("| nx in initfile: %ld from model code: %ld", nxchk, modelData->nStates);
    WARNING_AL2("| ny in initfile: %ld from model code: %ld", nychk, modelData->nVariablesReal - 2*modelData->nStates);
    WARNING_AL2("| np in initfile: %ld from model code: %ld", npchk, modelData->nParametersReal);
    WARNING_AL2("| npint in initfile: %ld from model code: %ld", npintchk, modelData->nParametersInteger);
    WARNING_AL2("| nyint in initfile: %ld from model code: %ld", nyintchk, modelData->nVariablesInteger);
    WARNING_AL2("| npbool in initfile: %ld from model code: %ld", npboolchk, modelData->nParametersBoolean);
    WARNING_AL2("| nybool in initfile: %ld from model code: %ld", nyboolchk, modelData->nVariablesBoolean);
    WARNING_AL2("| npstr in initfile: %ld from model code: %ld", npstrchk, modelData->nParametersString);
    WARNING_AL2("| nystr in initfile: %ld from model code: %ld", nystrchk, modelData->nVariablesString);
    delete filename;
    XML_ParserFree(parser);
    fclose(file);
    EXIT(-1);
  ...
  for(int i=0; i<modelData->nStates; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file", modelData->realVarsData[i].info.name);
    read_value(mi.rSta[i]["valueReference"], &(modelData->realVarsData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.id);
    read_value(mi.rSta[i]["description"], &(modelData->realVarsData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s description \"%s\" from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.comment);
    read_value(mi.rSta[i]["fileName"], (modelica_string*)&(modelData->realVarsData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.info.filename);
    read_value(mi.rSta[i]["startLine"], (modelica_integer*)&(modelData->realVarsData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.info.lineStart);
    read_value(mi.rSta[i]["startColumn"], (modelica_integer*)&(modelData->realVarsData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.info.colStart);
    read_value(mi.rSta[i]["endLine"], (modelica_integer*)&(modelData->realVarsData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.info.lineEnd);
    read_value(mi.rSta[i]["endColumn"], (modelica_integer*)&(modelData->realVarsData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.info.colEnd);
    read_value(mi.rSta[i]["fileWritable"], (modelica_integer*)&(modelData->realVarsData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file", modelData->realVarsData[i].info.name, modelData->realVarsData[i].info.info.readonly);
  ...
  for(int i=0; i<modelData->nStates; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->realVarsData[modelData->nStates+i].info.name);
    read_value(mi.rDer[i]["valueReference"], &(modelData->realVarsData[modelData->nStates+i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.id);
    read_value(mi.rDer[i]["description"], &(modelData->realVarsData[modelData->nStates+i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.comment);
    read_value(mi.rDer[i]["fileName"], (modelica_string*)&(modelData->realVarsData[modelData->nStates+i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.info.filename);
    read_value(mi.rDer[i]["startLine"], (modelica_integer*) &(modelData->realVarsData[modelData->nStates+i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.info.lineStart);
    read_value(mi.rDer[i]["startColumn"], (modelica_integer*) &(modelData->realVarsData[modelData->nStates+i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.info.colStart);
    read_value(mi.rDer[i]["endLine"], (modelica_integer*) &(modelData->realVarsData[modelData->nStates+i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.info.lineEnd);
    read_value(mi.rDer[i]["endColumn"], (modelica_integer*) &(modelData->realVarsData[modelData->nStates+i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.info.colEnd);
    read_value(mi.rDer[i]["fileWritable"], (modelica_integer*) &(modelData->realVarsData[modelData->nStates+i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->realVarsData[modelData->nStates+i].info.name,modelData->realVarsData[modelData->nStates+i].info.info.readonly);
  ...
  DEBUG_INFO((LOG_SOLVER|LOG_DEBUG), "read xml file for real algebracis:");
  for(int i=0; i<(modelData->nVariablesReal - 2*modelData->nStates); i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->realVarsData[j].info.name);
    read_value(mi.rAlg[i]["valueReference"], &(modelData->realVarsData[j].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.id);
    read_value(mi.rAlg[i]["description"], &(modelData->realVarsData[j].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.comment);
    read_value(mi.rAlg[i]["fileName"], (modelica_string*)&(modelData->realVarsData[j].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.info.filename);
    read_value(mi.rAlg[i]["startLine"], (modelica_integer*) &(modelData->realVarsData[j].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.info.lineStart);
    read_value(mi.rAlg[i]["startColumn"], (modelica_integer*) &(modelData->realVarsData[j].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.info.colStart);
    read_value(mi.rAlg[i]["endLine"], (modelica_integer*) &(modelData->realVarsData[j].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.info.lineEnd);
    read_value(mi.rAlg[i]["endColumn"], (modelica_integer*) &(modelData->realVarsData[j].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.info.colEnd);
    read_value(mi.rAlg[i]["fileWritable"], (modelica_integer*) &(modelData->realVarsData[j].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->realVarsData[j].info.name,modelData->realVarsData[j].info.info.readonly);
  ...
  DEBUG_INFO((LOG_SOLVER|LOG_DEBUG), "read xml file for integer algebracis:");
  for(int i=0; i<modelData->nVariablesInteger; i++)
  {
    /* read var info */
    read_value(mi.iAlg[i]["name"], &(modelData->integerVarsData[i].info.name));
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->integerVarsData[i].info.name);
    read_value(mi.iAlg[i]["valueReference"], &(modelData->integerVarsData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.id);
    read_value(mi.iAlg[i]["description"], &(modelData->integerVarsData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.comment);
    read_value(mi.iAlg[i]["fileName"], (modelica_string*)&(modelData->integerVarsData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.info.filename);
    read_value(mi.iAlg[i]["startLine"], (modelica_integer*) &(modelData->integerVarsData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.info.lineStart);
    read_value(mi.iAlg[i]["startColumn"], (modelica_integer*) &(modelData->integerVarsData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.info.colStart);
    read_value(mi.iAlg[i]["endLine"], (modelica_integer*) &(modelData->integerVarsData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.info.lineEnd);
    read_value(mi.iAlg[i]["endColumn"], (modelica_integer*) &(modelData->integerVarsData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.info.colEnd);
    read_value(mi.iAlg[i]["fileWritable"], (modelica_integer*) &(modelData->integerVarsData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->integerVarsData[i].info.name,modelData->integerVarsData[i].info.info.readonly);
  ...
  DEBUG_INFO((LOG_SOLVER|LOG_DEBUG), "read xml file for boolean algebracis:");
  ...
  for(int i=0; i<modelData->nVariablesBoolean; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->booleanVarsData[i].info.name);
    read_value(mi.bAlg[i]["valueReference"], &(modelData->booleanVarsData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.id);
    read_value(mi.bAlg[i]["description"], &(modelData->booleanVarsData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.comment);
    read_value(mi.bAlg[i]["fileName"], (modelica_string*)&(modelData->booleanVarsData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.info.filename);
    read_value(mi.bAlg[i]["startLine"], (modelica_integer*) &(modelData->booleanVarsData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.info.lineStart);
    read_value(mi.bAlg[i]["startColumn"], (modelica_integer*) &(modelData->booleanVarsData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.info.colStart);
    read_value(mi.bAlg[i]["endLine"], (modelica_integer*) &(modelData->booleanVarsData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.info.lineEnd);
    read_value(mi.bAlg[i]["endColumn"], (modelica_integer*) &(modelData->booleanVarsData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.info.colEnd);
    read_value(mi.bAlg[i]["fileWritable"], (modelica_integer*) &(modelData->booleanVarsData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->booleanVarsData[i].info.name,modelData->booleanVarsData[i].info.info.readonly);
  ...
  DEBUG_INFO((LOG_SOLVER|LOG_DEBUG), "read xml file for string algebracis:");
  for(int i=0; i<modelData->nVariablesString; i++)
  {
    /* read var info */
    read_value(mi.sAlg[i]["name"], &(modelData->stringVarsData[i].info.name));
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->stringVarsData[i].info.name);
    read_value(mi.sAlg[i]["valueReference"], &(modelData->stringVarsData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.id);
    read_value(mi.sAlg[i]["description"], &(modelData->stringVarsData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.comment);
    read_value(mi.sAlg[i]["fileName"], (modelica_string*)&(modelData->stringVarsData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.info.filename);
    read_value(mi.sAlg[i]["startLine"], (modelica_integer*) &(modelData->stringVarsData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.info.lineStart);
    read_value(mi.sAlg[i]["startColumn"], (modelica_integer*) &(modelData->stringVarsData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.info.colStart);
    read_value(mi.sAlg[i]["endLine"], (modelica_integer*) &(modelData->stringVarsData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.info.lineEnd);
    read_value(mi.sAlg[i]["endColumn"], (modelica_integer*) &(modelData->stringVarsData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.info.colEnd);
    read_value(mi.sAlg[i]["fileWritable"], (modelica_integer*) &(modelData->stringVarsData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->stringVarsData[i].info.name,modelData->stringVarsData[i].info.info.readonly);
  ...
  for(int i=0; i<modelData->nParametersReal; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->realParameterData[i].info.name);
    read_value(mi.rPar[i]["valueReference"], &(modelData->realParameterData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.id);
    read_value(mi.rPar[i]["description"], &(modelData->realParameterData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.comment);
    read_value(mi.rPar[i]["fileName"], (modelica_string*)&(modelData->realParameterData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.info.filename);
    read_value(mi.rPar[i]["startLine"], (modelica_integer*) &(modelData->realParameterData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.info.lineStart);
    read_value(mi.rPar[i]["startColumn"], (modelica_integer*) &(modelData->realParameterData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.info.colStart);
    read_value(mi.rPar[i]["endLine"], (modelica_integer*) &(modelData->realParameterData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.info.lineEnd);
    read_value(mi.rPar[i]["endColumn"], (modelica_integer*) &(modelData->realParameterData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.info.colEnd);
    read_value(mi.rPar[i]["fileWritable"], (modelica_integer*) &(modelData->realParameterData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->realParameterData[i].info.name,modelData->realParameterData[i].info.info.readonly);
  ...
  for(int i=0; i<modelData->nParametersInteger; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->integerParameterData[i].info.name);
    read_value(mi.iPar[i]["valueReference"], &(modelData->integerParameterData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.id);
    read_value(mi.iPar[i]["description"], &(modelData->integerParameterData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.comment);
    read_value(mi.iPar[i]["fileName"], (modelica_string*)&(modelData->integerParameterData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.info.filename);
    read_value(mi.iPar[i]["startLine"], (modelica_integer*) &(modelData->integerParameterData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.info.lineStart);
    read_value(mi.iPar[i]["startColumn"], (modelica_integer*) &(modelData->integerParameterData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.info.colStart);
    read_value(mi.iPar[i]["endLine"], (modelica_integer*) &(modelData->integerParameterData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.info.lineEnd);
    read_value(mi.iPar[i]["endColumn"], (modelica_integer*) &(modelData->integerParameterData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.info.colEnd);
    read_value(mi.iPar[i]["fileWritable"], (modelica_integer*) &(modelData->integerParameterData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->integerParameterData[i].info.name,modelData->integerParameterData[i].info.info.readonly);
  ...
  for(int i=0; i<modelData->nParametersBoolean; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file", modelData->booleanParameterData[i].info.name);
    read_value(mi.bPar[i]["valueReference"], &(modelData->booleanParameterData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.id);
    read_value(mi.bPar[i]["description"], &(modelData->booleanParameterData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.comment);
    read_value(mi.bPar[i]["fileName"], (modelica_string*)&(modelData->booleanParameterData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.info.filename);
    read_value(mi.bPar[i]["startLine"], (modelica_integer*)&(modelData->booleanParameterData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.info.lineStart);
    read_value(mi.bPar[i]["startColumn"], (modelica_integer*)&(modelData->booleanParameterData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.info.colStart);
    read_value(mi.bPar[i]["endLine"], (modelica_integer*)&(modelData->booleanParameterData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.info.lineEnd);
    read_value(mi.bPar[i]["endColumn"], (modelica_integer*)&(modelData->booleanParameterData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.info.colEnd);
    read_value(mi.bPar[i]["fileWritable"], (modelica_integer*)&(modelData->booleanParameterData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file", modelData->booleanParameterData[i].info.name, modelData->booleanParameterData[i].info.info.readonly);
  ...
  for(int i=0; i<modelData->nParametersString; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->stringParameterData[i].info.name);
    read_value(mi.sPar[i]["valueReference"], &(modelData->stringParameterData[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.id);
    read_value(mi.sPar[i]["description"], &(modelData->stringParameterData[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.comment);
    read_value(mi.sPar[i]["fileName"], (modelica_string*)&(modelData->stringParameterData[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.info.filename);
    read_value(mi.sPar[i]["startLine"], (modelica_integer*) &(modelData->stringParameterData[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.info.lineStart);
    read_value(mi.sPar[i]["startColumn"], (modelica_integer*) &(modelData->stringParameterData[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.info.colStart);
    read_value(mi.sPar[i]["endLine"], (modelica_integer*) &(modelData->stringParameterData[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.info.lineEnd);
    read_value(mi.sPar[i]["endColumn"], (modelica_integer*) &(modelData->stringParameterData[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.info.colEnd);
    read_value(mi.sPar[i]["fileWritable"], (modelica_integer*) &(modelData->stringParameterData[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->stringParameterData[i].info.name,modelData->stringParameterData[i].info.info.readonly);
  ...
  for(int i=0; i<modelData->nAliasReal; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->realAlias[i].info.name);
    read_value(mi.rAli[i]["valueReference"], &(modelData->realAlias[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",(modelData->realAlias[i].info.name),modelData->realAlias[i].info.id);
    read_value(mi.rAli[i]["description"], &(modelData->realAlias[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->realAlias[i].info.name,modelData->realAlias[i].info.comment);
    read_value(mi.rAli[i]["fileName"], (modelica_string*)&(modelData->realAlias[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->realAlias[i].info.name,modelData->realAlias[i].info.info.filename);
    read_value(mi.rAli[i]["startLine"], (modelica_integer*) &(modelData->realAlias[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->realAlias[i].info.name,modelData->realAlias[i].info.info.lineStart);
    read_value(mi.rAli[i]["startColumn"], (modelica_integer*) &(modelData->realAlias[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->realAlias[i].info.name,modelData->realAlias[i].info.info.colStart);
    read_value(mi.rAli[i]["endLine"], (modelica_integer*) &(modelData->realAlias[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->realAlias[i].info.name,modelData->realAlias[i].info.info.lineEnd);
    read_value(mi.rAli[i]["endColumn"], (modelica_integer*) &(modelData->realAlias[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->realAlias[i].info.name,modelData->realAlias[i].info.info.colEnd);
    read_value(mi.rAli[i]["fileWritable"], (modelica_integer*) &(modelData->realAlias[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->realAlias[i].info.name,modelData->realAlias[i].info.info.readonly);
    ...
    DEBUG_INFO_AL2(LOG_DEBUG, "| read for %s negated %d from init file", modelData->realAlias[i].info.name, modelData->realAlias[i].negate);
    ...
    DEBUG_INFO_AL3(LOG_DEBUG, "| read for %s aliasID %d from %s from init file",
  ...
  for(int i=0; i<modelData->nAliasInteger; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->integerAlias[i].info.name);
    read_value(mi.iAli[i]["valueReference"], &(modelData->integerAlias[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.id);
    read_value(mi.iAli[i]["description"], &(modelData->integerAlias[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.comment);
    read_value(mi.iAli[i]["fileName"], (modelica_string*)&(modelData->integerAlias[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.info.filename);
    read_value(mi.iAli[i]["startLine"], (modelica_integer*) &(modelData->integerAlias[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.info.lineStart);
    read_value(mi.iAli[i]["startColumn"], (modelica_integer*) &(modelData->integerAlias[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.info.colStart);
    read_value(mi.iAli[i]["endLine"], (modelica_integer*) &(modelData->integerAlias[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.info.lineEnd);
    read_value(mi.iAli[i]["endColumn"], (modelica_integer*) &(modelData->integerAlias[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.info.colEnd);
    read_value(mi.iAli[i]["fileWritable"], (modelica_integer*) &(modelData->integerAlias[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].info.info.readonly);
    ...
    DEBUG_INFO_AL2(LOG_DEBUG, "| read for %s negated %d from init file",modelData->integerAlias[i].info.name,modelData->integerAlias[i].negate);
  ...
  for(int i=0; i<modelData->nAliasBoolean; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->booleanAlias[i].info.name);
    read_value(mi.bAli[i]["valueReference"], &(modelData->booleanAlias[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.id);
    read_value(mi.bAli[i]["description"], &(modelData->booleanAlias[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.comment);
    read_value(mi.bAli[i]["fileName"], (modelica_string*)&(modelData->booleanAlias[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.info.filename);
    read_value(mi.bAli[i]["startLine"], (modelica_boolean*) &(modelData->booleanAlias[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.info.lineStart);
    read_value(mi.bAli[i]["startColumn"], (modelica_boolean*) &(modelData->booleanAlias[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.info.colStart);
    read_value(mi.bAli[i]["endLine"], (modelica_boolean*) &(modelData->booleanAlias[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.info.lineEnd);
    read_value(mi.bAli[i]["endColumn"], (modelica_boolean*) &(modelData->booleanAlias[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.info.colEnd);
    read_value(mi.bAli[i]["fileWritable"], (modelica_boolean*) &(modelData->booleanAlias[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->booleanAlias[i].info.name,modelData->booleanAlias[i].info.info.readonly);
    ...
    DEBUG_INFO_AL2(LOG_DEBUG, "| read for %s negated %d from init file", modelData->booleanAlias[i].info.name, modelData->booleanAlias[i].negate);
  ...
  for(int i=0; i<modelData->nAliasString; i++)
  {
    ...
    DEBUG_INFO_AL1(LOG_DEBUG, "| read var %s from init file",modelData->stringAlias[i].info.name);
    read_value(mi.sAli[i]["valueReference"], &(modelData->stringAlias[i].info.id));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s id %d from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.id);
    read_value(mi.sAli[i]["description"], &(modelData->stringAlias[i].info.comment));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s comment %s from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.comment);
    read_value(mi.sAli[i]["fileName"], (modelica_string*)&(modelData->stringAlias[i].info.info.filename));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s filename %s from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.info.filename);
    read_value(mi.sAli[i]["startLine"], (modelica_string*) &(modelData->stringAlias[i].info.info.lineStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineStart %d from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.info.lineStart);
    read_value(mi.sAli[i]["startColumn"], (modelica_string*) &(modelData->stringAlias[i].info.info.colStart));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colStart %d from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.info.colStart);
    read_value(mi.sAli[i]["endLine"], (modelica_string*) &(modelData->stringAlias[i].info.info.lineEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s lineEnd %d from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.info.lineEnd);
    read_value(mi.sAli[i]["endColumn"], (modelica_string*) &(modelData->stringAlias[i].info.info.colEnd));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s colEnd %d from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.info.colEnd);
    read_value(mi.sAli[i]["fileWritable"], (modelica_string*) &(modelData->stringAlias[i].info.info.readonly));
    DEBUG_INFO_AL2(LOG_DEBUG, "| | read for %s readonly %d from init file",modelData->stringAlias[i].info.name,modelData->stringAlias[i].info.info.readonly);
    ...
    DEBUG_INFO_AL2(LOG_DEBUG, "| read for %s negated %d from init file", modelData->stringAlias[i].info.name, modelData->stringAlias[i].negate);
