...
function der_Tsat_p "Time derivative of Tsat(p)"
...
algorithm
  der_Tsat := SiemensPower.Media.TTSE.Utilities.Tsat_p_dp(p)*der_p;

  annotation (Documentation(info="<html>
<p>This function returns the time derivative of Tsat with the help of TTSE functions.</p>
</html>
<HTML>
       <p>
           <table>
