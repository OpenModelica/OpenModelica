...
regex = re.compile('_eqs_prof.json|_prof.json')

# file formats that will be deleted
fileFormats = ['exe','svg','plt','data','html','tmp','c','h','libs','makefile','csv','mat','o','log','dll','graphml','xml','realdata','intdata','exp','cpp','mos.mos']
#############################################################################
#functions
##########
