...
void string_array_create(string_array_t *dest, modelica_string_t *data, int ndims, ...);
...
modelica_string_t* calc_string_index(int ndims, const _index_t* idx_vec, const string_array_t * arr);
...
void simple_index_string_array1(const string_array_t * source,
                                int i1,
                                string_array_t* dest);
...
modelica_string_t* string_array_element_addr(const string_array_t * source,int ndims,
                                             ...);
