...
extern void put_real_element(m_real value,int i1,real_array_t* dest);
extern void put_real_matrix_element(m_real value, int r, int c, real_array_t* dest);
...
extern void array_scalar_real_array(real_array_t* dest,int n,m_real first,...);
extern void array_alloc_scalar_real_array(real_array_t* dest,int n,m_real first,...);

extern m_real* real_array_element_addr(const real_array_t* source,int ndims,...);
extern m_real* real_array_element_addr1(const real_array_t* source,int ndims,int dim1);
extern m_real* real_array_element_addr2(const real_array_t* source,int ndims,int dim1,int dim2);
...
extern void range_alloc_real_array(m_real start,m_real stop,m_real inc,
                            real_array_t* dest);
extern void range_real_array(m_real start,m_real stop, m_real inc,real_array_t* dest);
...
static inline int size_of_dimension_real_array(const real_array_t a, int i)
...
extern m_real scalar_real_array(const real_array_t* a);
...
extern void cast_integer_array_to_real(const integer_array_t* src, real_array_t* dest);
extern void cast_real_array_to_integer(const real_array_t* src, integer_array_t* dest);
