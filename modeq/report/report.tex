...
%  \ref{src:Inst}).  It needs to do static analysis of expressions,
...
naming scheme with dots between the name parts.  If topmost model
contains a sub-model named \code{a}, which contains a variable
\code{b}, the global name of the last variable will be \code{a.b}.
...
and with the suffix \code{.rml} appended.
