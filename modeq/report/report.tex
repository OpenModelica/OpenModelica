...
The DAEs are collected in a datastructure defined in the module
...
\chapter{Design notes for the RML specification}
\label{cha:design}
...
\fixme{remove} Unfortunately, this abstract syntax is not very
convenient for the semantic description of the instantiation process.
To address this problem, a second internal form, called
\firstref{SCode}, is introduced (section \ref{src:scode}).  Besides
some minor simplifications the SCode structure differs from the
abstract syntax in the following respects:
