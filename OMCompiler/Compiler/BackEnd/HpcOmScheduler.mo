...
algorithm
  (jacOut,tplOut) := matchcontinue(jacIn,tplIn)
    ...
    //TS,org//case(SOME(SimCode.JAC_MATRIX(jacCols,vars,name,sparsity,sparsityT,colCols,maxCol,jacIdx,partIdx,crefToSimVarHTJacobian)),(newIdx,ass))
      equation
   ...
   //TS,org//then (SOME(SimCode.JAC_MATRIX(jacCols,vars,name,sparsity,sparsityT,colCols,maxCol,jacIdx,partIdx,crefToSimVarHTJacobian)),(newIdx,ass));
   else (jacIn,tplIn);
  end matchcontinue;
