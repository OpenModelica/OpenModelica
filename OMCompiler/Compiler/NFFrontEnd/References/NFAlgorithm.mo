...
//Add to list of changed packages
//E.g Dictonary that states that NFAlgorithm is not a package that contains the uniontype UNFAlgorithm
uniontype UNFAlgorithm
  record ALGORITHM
