...
encapsulated package NFHashTableCrToExp
...
/* NFHashTableCrToExp instance specific code */
...
"Returns an empty HashTable.
 Using the bucketsize size"
  ...
  output HashTable hashTable;
algorithm
  hashTable := BaseHashTable.emptyHashTableWork(size,(ComponentRef.hash,ComponentRef.isEqual,ComponentRef.toString,Expression.toString));
end emptyHashTableSized;

annotation(__OpenModelica_Interface="frontend");
end NFHashTableCrToExp;
