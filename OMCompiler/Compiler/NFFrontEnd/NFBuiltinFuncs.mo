...
constant InstNode INT_PARAM = InstNode.COMPONENT_NODE("i",
  ...
  Pointer.createImmutable(INT_COMPONENT), NONE(), NONE(), NONE(),
...
constant InstNode REAL_PARAM = InstNode.COMPONENT_NODE("r",
  NONE(), Visibility.PUBLIC,
  Pointer.createImmutable(REAL_COMPONENT), NONE(), NONE(), NONE(),
  InstNodeType.NORMAL_COMP());
...
constant InstNode BOOL_PARAM = InstNode.COMPONENT_NODE("b",
  NONE(), Visibility.PUBLIC,
  Pointer.createImmutable(BOOL_COMPONENT), NONE(), NONE(), NONE(),
  InstNodeType.NORMAL_COMP());
...
constant InstNode STRING_PARAM = InstNode.COMPONENT_NODE("s",
  NONE(), Visibility.PUBLIC,
  Pointer.createImmutable(STRING_COMPONENT), NONE(), NONE(), NONE(),
  InstNodeType.NORMAL_COMP());
...
constant InstNode ENUM_PARAM = InstNode.COMPONENT_NODE("e",
  NONE(), Visibility.PUBLIC,
  Pointer.createImmutable(ENUM_COMPONENT), NONE(), NONE(), NONE(),
  InstNodeType.NORMAL_COMP());
...
constant InstNode INTEGER_DUMMY_NODE = NFInstNode.CLASS_NODE("Integer",
  ...
  EMPTY_NODE_CACHE,
  NONE(), NONE(), NONE(), InstNodeType.NORMAL_CLASS());
...
constant InstNode STRING_DUMMY_NODE = NFInstNode.CLASS_NODE("String",
  DUMMY_ELEMENT, Visibility.PUBLIC, Pointer.createImmutable(Class.NOT_INSTANTIATED()),
  EMPTY_NODE_CACHE, NONE(), NONE(), NONE(), InstNodeType.NORMAL_CLASS());

constant InstNode R_PARAM = InstNode.COMPONENT_NODE("r", NONE(),
  Visibility.PUBLIC, Pointer.createImmutable(REAL_COMPONENT), NONE(), NONE(), NONE(), InstNodeType.NORMAL_COMP());
constant InstNode I_PARAM = InstNode.COMPONENT_NODE("i", NONE(),
  Visibility.PUBLIC, Pointer.createImmutable(INT_COMPONENT), NONE(), NONE(), NONE(), InstNodeType.NORMAL_COMP());
constant InstNode B_PARAM = InstNode.COMPONENT_NODE("b", NONE(),
  Visibility.PUBLIC, Pointer.createImmutable(BOOL_COMPONENT), NONE(), NONE(), NONE(), InstNodeType.NORMAL_COMP());
constant InstNode E_PARAM = InstNode.COMPONENT_NODE("e", NONE(),
  Visibility.PUBLIC, Pointer.createImmutable(ENUM_COMPONENT), NONE(), NONE(), NONE(), InstNodeType.NORMAL_COMP());
...
constant InstNode FORMAT_PARAM = InstNode.COMPONENT_NODE("format", NONE(),
  Visibility.PUBLIC, Pointer.createImmutable(STRING_COMPONENT), NONE(), NONE(), NONE(), InstNodeType.NORMAL_COMP());
...
constant Function STRING_REAL = Function.FUNCTION(Path.IDENT("String"),
  NFInstNode.NodeHandle.VALUE(STRING_DUMMY_NODE), {REAL_PARAM, INT_PARAM, INT_PARAM, BOOL_PARAM}, {NFInstNode.NodeHandle.VALUE(STRING_PARAM)}, {}, NONE(), {
...
constant Function STRING_REAL_FORMAT = Function.FUNCTION(Path.IDENT("String"),
  NFInstNode.NodeHandle.VALUE(STRING_DUMMY_NODE), {REAL_PARAM, STRING_PARAM}, {NFInstNode.NodeHandle.VALUE(STRING_PARAM)}, {}, NONE(), {
    Slot.SLOT(R_PARAM, SlotType.POSITIONAL, NONE(), NONE(), 1, SlotEvalStatus.NOT_EVALUATED),
...
constant Function STRING_INT = Function.FUNCTION(Path.IDENT("String"),
  NFInstNode.NodeHandle.VALUE(STRING_DUMMY_NODE), {INT_PARAM, INT_PARAM, BOOL_PARAM}, {NFInstNode.NodeHandle.VALUE(STRING_PARAM)}, {}, NONE(), {
...
constant Function STRING_BOOL = Function.FUNCTION(Path.IDENT("String"),
  NFInstNode.NodeHandle.VALUE(STRING_DUMMY_NODE), {BOOL_PARAM, INT_PARAM, BOOL_PARAM}, {NFInstNode.NodeHandle.VALUE(STRING_PARAM)}, {}, NONE(), {
...
constant Function STRING_ENUM = Function.FUNCTION(Path.IDENT("String"),
  NFInstNode.NodeHandle.VALUE(STRING_DUMMY_NODE), {ENUM_PARAM, INT_PARAM, BOOL_PARAM}, {NFInstNode.NodeHandle.VALUE(STRING_PARAM)}, {}, NONE(), {
...
constant Function MAX_INT = Function.FUNCTION(Path.IDENT("max"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {INT_PARAM, INT_PARAM}, {NFInstNode.NodeHandle.VALUE(INT_PARAM)}, {}, NONE(), {},
    Type.INTEGER(), DAE.FUNCTION_ATTRIBUTES_BUILTIN, {}, {}, listArray({}),
    Pointer.createImmutable(FunctionStatus.BUILTIN), Pointer.createImmutable(0));

constant Function MAX_REAL = Function.FUNCTION(Path.IDENT("max"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {REAL_PARAM, REAL_PARAM}, {NFInstNode.NodeHandle.VALUE(REAL_PARAM)}, {}, NONE(), {},
    Type.REAL(), DAE.FUNCTION_ATTRIBUTES_BUILTIN, {}, {}, listArray({}),
    Pointer.createImmutable(FunctionStatus.BUILTIN), Pointer.createImmutable(0));
...
constant Function ARG_MIN_ARR_REAL = Function.FUNCTION(Path.IDENT("argmin"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {REAL_PARAM}, {NFInstNode.NodeHandle.VALUE(INT_PARAM)}, {}, NONE(), {},
    Type.REAL(), DAE.FUNCTION_ATTRIBUTES_BUILTIN, {}, {}, listArray({}),
    Pointer.createImmutable(FunctionStatus.BUILTIN), Pointer.createImmutable(0));
...
constant Function INTEGER_ENUM = Function.FUNCTION(Path.IDENT("Integer"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {ENUM_PARAM}, {NFInstNode.NodeHandle.VALUE(INT_PARAM)}, {}, NONE(), {},
    Type.INTEGER(), DAE.FUNCTION_ATTRIBUTES_BUILTIN, {}, {}, listArray({}),
    Pointer.createImmutable(FunctionStatus.BUILTIN), Pointer.createImmutable(0));
...
constant Function PROMOTE = Function.FUNCTION(Path.IDENT("promote"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {}, {}, {}, NONE(), {},
...
constant Function MAX_INT_ARR = Function.FUNCTION(Path.IDENT("max"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {INT_PARAM}, {NFInstNode.NodeHandle.VALUE(INT_PARAM)}, {}, NONE(), {},
    Type.INTEGER(), DAE.FUNCTION_ATTRIBUTES_BUILTIN, {}, {}, listArray({}),
    Pointer.createImmutable(FunctionStatus.BUILTIN), Pointer.createImmutable(0));
...
constant Function FMU_LOAD_RESOURCE = Function.FUNCTION(Path.IDENT("OpenModelica_fmuLoadResource"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {STRING_PARAM}, {NFInstNode.NodeHandle.VALUE(STRING_PARAM)}, {}, NONE(), {},
...
constant Function SAMPLE_CLOCKED = Function.FUNCTION(Path.IDENT("sample"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {REAL_PARAM, CLOCK_PARAM}, {NFInstNode.NodeHandle.VALUE(REAL_PARAM)}, {}, NONE(), {},
...
constant InstNode CLOCK_PARAM = InstNode.COMPONENT_NODE("s",
  NONE(), Visibility.PUBLIC,
  Pointer.createImmutable(CLOCK_COMPONENT), NONE(), NONE(), NONE(),
  InstNodeType.NORMAL_COMP());
...
constant Function CLOCK_INFERRED = Function.FUNCTION(Path.IDENT("Clock"),
  NFInstNode.NodeHandle.VALUE(CLOCK_DUMMY_NODE), {}, {NFInstNode.NodeHandle.VALUE(CLOCK_PARAM)}, {}, NONE(), {}, Type.CLOCK(),
...
constant InstNode C_PARAM = InstNode.COMPONENT_NODE("c", NONE(),
  Visibility.PUBLIC, Pointer.createImmutable(CLOCK_COMPONENT), NONE(), NONE(), NONE(), InstNodeType.NORMAL_COMP());
...
constant Function CLOCK_INT = Function.FUNCTION(Path.IDENT("Clock"),
  NFInstNode.NodeHandle.VALUE(CLOCK_DUMMY_NODE), {INT_PARAM, INT_PARAM}, {NFInstNode.NodeHandle.VALUE(CLOCK_PARAM)}, {}, NONE(), {
...
constant Function CLOCK_REAL = Function.FUNCTION(Path.IDENT("Clock"),
  NFInstNode.NodeHandle.VALUE(CLOCK_DUMMY_NODE), {REAL_PARAM}, {NFInstNode.NodeHandle.VALUE(CLOCK_PARAM)}, {}, NONE(), {
...
constant Function CLOCK_BOOL = Function.FUNCTION(Path.IDENT("Clock"),
  NFInstNode.NodeHandle.VALUE(CLOCK_DUMMY_NODE), {BOOL_PARAM, REAL_PARAM}, {NFInstNode.NodeHandle.VALUE(CLOCK_PARAM)}, {}, NONE(), {
...
constant Function CLOCK_SOLVER = Function.FUNCTION(Path.IDENT("Clock"),
  NFInstNode.NodeHandle.VALUE(CLOCK_DUMMY_NODE), {CLOCK_PARAM, STRING_PARAM}, {NFInstNode.NodeHandle.VALUE(CLOCK_PARAM)}, {}, NONE(), {
...
constant Function GET_PART_BOOL = Function.FUNCTION(Path.IDENT("$getPart"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {BOOL_PARAM}, {NFInstNode.NodeHandle.VALUE(BOOL_PARAM)}, {}, NONE(), {},
...
constant Function GET_PART_CLOCK = Function.FUNCTION(Path.IDENT("$getPart"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {CLOCK_PARAM}, {NFInstNode.NodeHandle.VALUE(CLOCK_PARAM)}, {}, NONE(), {},
    Type.BOOLEAN(), DAE.FUNCTION_ATTRIBUTES_BUILTIN, {}, {}, listArray({}),
    Pointer.createImmutable(FunctionStatus.BUILTIN), Pointer.createImmutable(0));

constant Function CLOCK_FIRE = Function.FUNCTION(Path.IDENT("$_clkfire"),
  NFInstNode.NodeHandle.VALUE(InstNode.EMPTY_NODE()), {INT_PARAM}, {}, {}, NONE(), {},
    Type.UNKNOWN(), DAE.FUNCTION_ATTRIBUTES_BUILTIN, {}, {}, listArray({}),
    Pointer.createImmutable(FunctionStatus.BUILTIN), Pointer.createImmutable(0));
