...
# config.guess reports Apple Silicon as aarch64, so the autotools build and the
# FMI 3.0 platform tuples both spell it that way; CMake spells it arm64.
set(OMC_TARGET_SYSTEM_PROCESSOR ${CMAKE_SYSTEM_PROCESSOR})
set(OPENMODELICA_SPEC_PLATFORM_ALTERNATIVE "")
if(APPLE AND (OMC_TARGET_SYSTEM_PROCESSOR STREQUAL "arm64" OR OMC_TARGET_SYSTEM_PROCESSOR STREQUAL "aarch64"))
  set(OMC_TARGET_SYSTEM_PROCESSOR "aarch64")
  set(OPENMODELICA_SPEC_PLATFORM_ALTERNATIVE "arm64-${OMC_TARGET_SYSTEM_NAME}")
endif()
set(OPENMODELICA_SPEC_PLATFORM ${OMC_TARGET_SYSTEM_PROCESSOR}-${OMC_TARGET_SYSTEM_NAME})
