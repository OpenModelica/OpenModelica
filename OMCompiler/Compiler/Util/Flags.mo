...
constant DebugFlag DUMP_LOOPS_VERBOSE = DEBUG_FLAG(154, "dumpLoopsVerbose", false,
...
constant DebugFlag DUMP_DATARECONCILIATION = DEBUG_FLAG(193, "dataReconciliation", false,
...
constant ConfigFlag SIMCODE_TARGET = CONFIG_FLAG(17, "simCodeTarget",
  ...
  SOME(STRING_OPTION({"None", "Adevs", "C", "Cpp","omsicpp", "ExperimentalEmbeddedC", "Java", "JavaScript", "omsic", "sfmi", "XML", "MidC"})),
