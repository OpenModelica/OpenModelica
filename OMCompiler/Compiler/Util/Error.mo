...
public constant Message SHADOWED_ITERATOR = MESSAGE(360, TRANSLATION(), WARNING(),
  Util.gettext("An iterator named ‘%s‘ is already declared in this scope."));
...
public constant Message STATE_STATESELECT_PREFER_REVERT = MESSAGE(600, TRANSLATION(), WARNING(),
  Util.gettext("Some equations could not be differentiated for following variables having attribute stateSelect=StateSelect.prefer. %s"));
...
public constant Message PACKAGE_FILE_NOT_FOUND_ERROR = MESSAGE(7019, SCRIPTING(), ERROR(),
  Util.gettext("Unable to find the package definition file. Looked for \"%s\", \"%s\", \"%s\" and \"%s\"."));
