...
protected
  constant array<Integer> lookup = listArrayLiteral({10, 20, 30, 31, 32, 33, 34, 35, 36, 1000, 9999});
algorithm
...
public function languageStandardString
  ...
  output String outString;
protected
  constant array<String> lookup = listArrayLiteral({"1.x","2.x","3.0","3.1","3.2","3.3","3.4","3.5","3.6","3.6","experimental" /*Change this to latest version if you add more versions!*/});
algorithm
