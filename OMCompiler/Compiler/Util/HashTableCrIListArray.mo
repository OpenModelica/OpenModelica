...
encapsulated package HashTableCrIListArray
...
public type Value = tuple<list<Integer>, array<Integer>>;
...
"Returns an empty HashTable.
 Using the bucketsize size."
  ...
  output HashTable hashTable;
algorithm
  hashTable := BaseHashTable.emptyHashTableWork(size,(ComponentReference.hashComponentRef,ComponentReferenceBasics.crefEqual,ComponentReference.printComponentRefStr,printIntListArrayStr));
end emptyHashTableSized;

public function printIntListArrayStr
  input tuple<list<Integer>,array<Integer>> iValue;
  output String res;
protected
  list<Integer> iList;
