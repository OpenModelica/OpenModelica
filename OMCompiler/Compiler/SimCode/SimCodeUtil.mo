...
algorithm
  (outLibs, outLibPaths, outIncludes, outIncludeDirs, outRecordDecls, outFunctions, outLiterals) :=
    SimCodeFunctionUtil.createFunctions(inProgram, functionTree);
end createFunctions;
...
algorithm
  (oVarToArrayIndexMapping, oVarToIndexMapping) := SimCodeFunctionUtil.createVarToArrayIndexMapping(iModelInfo);
...
algorithm
  numElems := SimCodeFunctionUtil.getNumElems(var);
end getNumElems;
...
algorithm
  arrayIndex := SimCodeFunctionUtil.getScalarElementIndex(arraySubscripts, arrayDimensions);
...
algorithm
  (currentVarIndices, varToArrayIndexMapping, varToIndexMapping) :=
    SimCodeFunctionUtil.addVarToArrayIndexMappings(vars, iVarType, currentVarIndices, varToArrayIndexMapping, varToIndexMapping);
end addVarToArrayIndexMappings;

public function addVarToArrayIndexMapping
  input SimCodeVar.SimVar iVar;
  input Integer iVarType;
  input output array<Integer> currentVarIndices;
  input output HashTableCrIListArray.HashTable varToArrayIndexMapping;
...
algorithm
  (currentVarIndices, varToArrayIndexMapping, varToIndexMapping) :=
    SimCodeFunctionUtil.addVarToArrayIndexMapping(iVar, iVarType, currentVarIndices, varToArrayIndexMapping, varToIndexMapping);
