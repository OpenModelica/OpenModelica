...
::= "Not in use."//dumpElements(program, false, packageContext)
end dumpProgram;
...
//     let returnType =
//       match SCodeUtil.getOutputElements(p.elementLst)
//         case {} then ""
//         case L as H::{} then '::<%dumpOutputs(SCodeUtil.getOutputElements(p.elementLst))%>'
//         case L as H::T then '::Tuple{<%dumpOutputs(SCodeUtil.getOutputElements(p.elementLst))%>}'
