  ...
  match CodegenUtil.getGeneralTarget(target)
    case "msvc" then
      match simCode
        ...
        let compilecmds = CodegenFMUCommon.getPlatformString2(CodegenUtilSimulation.modelNamePrefix(simCode), makefileParams.platform, fileNamePrefix, fmuTargetName, dirExtra, libsPos1, libsPos2, makefileParams.omhome, FMUVersion)
        let mkdir = match makefileParams.platform case "win32" case "win64" then '"mkdir.exe"' else 'mkdir'
        <<
        # Makefile generated by OpenModelica
