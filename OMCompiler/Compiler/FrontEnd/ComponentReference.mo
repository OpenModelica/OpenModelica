...
algorithm
  b := match(cr)
    ...
    case(DAE.CREF_IDENT(ident=s)) then if StringUtil.startsWith(s, "$outputAlias_") then true else StringUtil.startsWith(s, "$"); // allow exception for output alias variables
