...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT52,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(82)),_OMC_LIT47,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT48,_OMC_LIT49,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT51}};
...
tmpMeta10 = mmc_mk_box6(3, &SCode_EEquation_EQ__IF__desc, _expl, _eqll, _eql, _comment, _info);
tmpMeta1 = tmpMeta10;
goto tmp3_done;
}
case 4: {
...
tmpMeta15 = mmc_mk_box5(4, &SCode_EEquation_EQ__EQUALS__desc, _exp1, _exp2, _comment, _info);
tmpMeta1 = tmpMeta15;
goto tmp3_done;
}
case 5: {
...
tmpMeta21 = mmc_mk_box6(5, &SCode_EEquation_EQ__PDE__desc, _exp1, _exp2, _cref, _comment, _info);
tmpMeta1 = tmpMeta21;
goto tmp3_done;
}
case 6: {
...
tmpMeta26 = mmc_mk_box5(6, &SCode_EEquation_EQ__CONNECT__desc, _cref1, _cref2, _comment, _info);
tmpMeta1 = tmpMeta26;
goto tmp3_done;
}
case 7: {
...
_eql = omc_InstExtends_fixList(threadData, _cache, _inEnv, _eql, _tree, boxvar_InstExtends_fixEEquation);
tmpMeta32 = mmc_mk_box6(7, &SCode_EEquation_EQ__FOR__desc, _id, _optExp, _eql, _comment, _info);
tmpMeta1 = tmpMeta32;
goto tmp3_done;
}
case 8: {
...
tmpMeta38 = mmc_mk_box6(8, &SCode_EEquation_EQ__WHEN__desc, _exp, _eql, _whenlst, _comment, _info);
tmpMeta1 = tmpMeta38;
goto tmp3_done;
}
case 9: {
...
tmpMeta44 = mmc_mk_box6(9, &SCode_EEquation_EQ__ASSERT__desc, _exp1, _exp2, _exp3, _comment, _info);
tmpMeta1 = tmpMeta44;
goto tmp3_done;
}
case 10: {
...
_info = tmpMeta47;
_exp = omc_InstExtends_fixExp(threadData, _cache, _inEnv, _exp, _tree);
tmpMeta48 = mmc_mk_box4(10, &SCode_EEquation_EQ__TERMINATE__desc, _exp, _comment, _info);
tmpMeta1 = tmpMeta48;
goto tmp3_done;
}
case 11: {
...
_exp1 = omc_InstExtends_fixExp(threadData, _cache, _inEnv, _exp1, _tree);
_exp = omc_InstExtends_fixExp(threadData, _cache, _inEnv, _exp, _tree);
tmpMeta53 = mmc_mk_box5(11, &SCode_EEquation_EQ__REINIT__desc, _exp1, _exp, _comment, _info);
tmpMeta1 = tmpMeta53;
goto tmp3_done;
}
case 12: {
...
_info = tmpMeta56;
_exp = omc_InstExtends_fixExp(threadData, _cache, _inEnv, _exp, _tree);
tmpMeta57 = mmc_mk_box4(12, &SCode_EEquation_EQ__NORETCALL__desc, _exp, _comment, _info);
tmpMeta1 = tmpMeta57;
goto tmp3_done;
}
}
...
tmp8 = (modelica_boolean)referenceEq(_eeq1, _eeq2);
if(tmp8)
{
tmpMeta9 = _inEq;
}
...
{
tmpMeta7 = mmc_mk_box2(3, &SCode_Equation_EQUATION__desc, _eeq2);
tmpMeta9 = tmpMeta7;
}
tmpMeta1 = tmpMeta9;
goto tmp3_done;
...
_eeq1 = tmpMeta10;
tmp11 = omc_Flags_isSet(threadData, _OMC_LIT3);
if (1 != tmp11) goto goto_2;
tmpMeta12 = stringAppend(_OMC_LIT11,omc_SCodeDump_equationStr(threadData, _eeq1, _OMC_LIT5));
...
tmpMeta40 = stringAppend(_OMC_LIT12,omc_SCodeDump_classDefStr(threadData, _cd, _OMC_LIT5));
...
{
tmpMeta69 = mmc_mk_box9(5, &SCode_Element_CLASS__desc, _name, _prefixes, _OMC_LIT13, _partialPrefix, _restriction, _classDef2, _comment, _info);
tmpMeta71 = tmpMeta69;
}
tmpMeta1 = tmpMeta71;
goto tmp3_done;
...
{
tmpMeta80 = mmc_mk_box9(5, &SCode_Element_CLASS__desc, _name, _prefixes, _OMC_LIT13, _partialPrefix, _restriction, _classDef2, _comment, _info);
tmpMeta82 = tmpMeta80;
}
tmpMeta1 = tmpMeta82;
goto tmp3_done;
...
tmpMeta92 = stringAppend(_OMC_LIT14,omc_SCodeDump_unparseElementStr(threadData, _elt, _OMC_LIT5));
...
tmp9 += 2;
tmpMeta12 = mmc_mk_box3(0, _el, _OMC_LIT15, mmc_mk_boolean(_b));
...
tmp20 = (modelica_boolean)valueEq(_cmod, _OMC_LIT15);
if(tmp20)
{
...
omc_Error_assertionOrAddSourceMessage(threadData, isNone(_extdecl), _OMC_LIT27, tmpMeta22, _info);
...
omc_Error_addSourceMessage(threadData, _OMC_LIT32, tmpMeta37, _inInfo);
goto goto_2;
goto tmp3_done;
}
case 5: {
...
tmpMeta59 = mmc_mk_box3(0, _elt, _OMC_LIT15, mmc_mk_boolean(1));
...
tmpMeta109 = mmc_mk_box3(0, _elt, _OMC_LIT15, mmc_mk_boolean(1));
...
MMC_SO();
_tailrecursive: OMC_LABEL_UNUSED
tmpMeta1 = stringAppend(_OMC_LIT36,_inClassName);
...
tmpMeta13 = stringAppend(_OMC_LIT38,_name);
...
omc_Error_addSourceMessage(threadData, _OMC_LIT46, tmpMeta27, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el), 6))));
}
goto goto_14;
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmp16_1,1,5) == 0) goto tmp15_end;
tmp16 += 3;
if (!omc_Flags_getConfigBool(threadData, _OMC_LIT52)) goto tmp15_end;
goto tmp15_done;
}
case 3: {
modelica_metatype tmpMeta34;
...
{
tmpMeta35 = mmc_mk_box3(0, _el, _OMC_LIT15, mmc_mk_boolean(0));
...
tmp16 += 1;
tmpMeta37 = mmc_mk_box3(0, _el, _OMC_LIT15, mmc_mk_boolean(0));
...
tmpMeta40 = mmc_mk_box3(0, _el, _OMC_LIT15, mmc_mk_boolean(0));
...
tmpMeta42 = stringAppend(_OMC_LIT53,_inClassName);
...
tmpMeta46 = stringAppend(tmpMeta45,_OMC_LIT54);
tmpMeta47 = stringAppend(tmpMeta46,_OMC_LIT56);
tmpMeta48 = stringAppend(tmpMeta47,omc_Mod_printModStr(threadData, _outMod));
tmpMeta49 = stringAppend(tmpMeta48,_OMC_LIT54);
tmpMeta50 = stringAppend(tmpMeta49,_OMC_LIT57);
