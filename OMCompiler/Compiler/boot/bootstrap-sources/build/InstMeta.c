...
#else
#define OMC_FILE "/home/per/workspace/OpenModelica/OMCompiler/Compiler/boot/build/tmp/InstMeta.c"
#endif
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT5_6,1591187546.0);
