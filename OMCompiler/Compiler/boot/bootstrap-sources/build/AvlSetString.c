...
#else
#define OMC_FILE "/home/per/workspace/OpenModelica/OMCompiler/Compiler/boot/build/tmp/AvlSetString.c"
#endif
...
case 5: {
tmpMeta[1] = mmc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, _inKey);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 3: {
...
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = omc_AvlSetString_add(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 4))), _inKey);
_tree = tmpMeta[1];
}
else
{
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(6));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_tree), 6*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = omc_AvlSetString_add(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 5))), _inKey);
_tree = tmpMeta[1];
}
}
tmpMeta[0] = ((_key_comp == ((modelica_integer) 0))?_tree:omc_AvlSetString_balance(threadData, _tree));
goto tmp2_done;
}
case 4: {
...
{
tmpMeta[1] = mmc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, _inKey);
tmpMeta[2] = mmc_mk_box5(3, &AvlSetString_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 2))), mmc_mk_integer(((modelica_integer) 2)), tmpMeta[1], _OMC_LIT0);
_outTree = tmpMeta[2];
}
else
{
...
{
tmpMeta[1] = mmc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, _inKey);
tmpMeta[2] = mmc_mk_box5(3, &AvlSetString_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 2))), mmc_mk_integer(((modelica_integer) 2)), _OMC_LIT0, tmpMeta[1]);
_outTree = tmpMeta[2];
}
else
{
...
if (-1 != tmp8_1) goto tmp7_end;
if (mmc__uniontype__metarecord__typedef__equal(tmp8_2,0,4) == 0) goto tmp7_end;
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp8_2), 4));
_tree = tmpMeta[0];
_inTree = _tree;
goto _tailrecursive;
goto tmp7_done;
...
tmpMeta[1] = omc_AvlSetString_listKeys(threadData, _tree1, tmpMeta[0]);
...
_keylist1 = tmpMeta[3];
tmpMeta[0] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[1] = omc_AvlSetString_listKeys(threadData, _tree2, tmpMeta[0]);
if (listEmpty(tmpMeta[1])) MMC_THROW_INTERNAL();
tmpMeta[2] = MMC_CAR(tmpMeta[1]);
tmpMeta[3] = MMC_CDR(tmpMeta[1]);
_k2 = tmpMeta[2];
...
case 4: {
tmpMeta[0] = omc_AvlSetString_add(threadData, _tree, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_treeToJoin), 2))));
goto tmp2_done;
}
}
goto tmp2_end;
...
_left = tmpMeta[0];
_right = tmpMeta[1];
tmpMeta[0] = stringAppend(omc_AvlSetString_printTreeStr2(threadData, _left, 1, _OMC_LIT2),omc_AvlSetString_printNodeStr(threadData, _inTree));
tmpMeta[1] = stringAppend(tmpMeta[0],_OMC_LIT3);
tmpMeta[2] = stringAppend(tmpMeta[1],omc_AvlSetString_printTreeStr2(threadData, _right, 0, _OMC_LIT2));
tmp1 = tmpMeta[2];
goto tmp3_done;
}
}
...
tmpMeta[1] = stringAppend(omc_AvlSetString_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 4))), 1, tmpMeta[0]),_inIndent);
tmpMeta[2] = stringAppend(tmpMeta[1],(_isLeft?_OMC_LIT6:_OMC_LIT7));
tmpMeta[3] = stringAppend(tmpMeta[2],_OMC_LIT8);
tmpMeta[4] = stringAppend(tmpMeta[3],omc_AvlSetString_printNodeStr(threadData, _inTree));
tmpMeta[5] = stringAppend(tmpMeta[4],_OMC_LIT3);
tmpMeta[6] = stringAppend(_inIndent,(_isLeft?_OMC_LIT5:_OMC_LIT4));
tmpMeta[7] = stringAppend(tmpMeta[5],omc_AvlSetString_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 5))), 0, tmpMeta[6]));
tmp1 = tmpMeta[7];
goto tmp3_done;
}
case 1: {
...
tmpMeta[0] = omc_AvlSetString_setTreeLeftRight(threadData, _child, _node, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_child), 5))));
goto tmp2_done;
}
case 1: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,4) == 0) goto tmp2_end;
...
tmpMeta[0] = omc_AvlSetString_setTreeLeftRight(threadData, _child, _node, _OMC_LIT0);
goto tmp2_done;
}
case 2: {
tmpMeta[0] = _inNode;
...
tmpMeta[0] = omc_AvlSetString_setTreeLeftRight(threadData, _child, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_child), 4))), _node);
goto tmp2_done;
}
case 1: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,4) == 0) goto tmp2_end;
...
tmpMeta[0] = omc_AvlSetString_setTreeLeftRight(threadData, _child, _OMC_LIT0, _node);
goto tmp2_done;
}
case 2: {
tmpMeta[0] = _inNode;
...
tmpMeta[1] = mmc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 2))));
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 1: {
...
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,4) == 0) goto tmp2_end;
tmp5 = (modelica_boolean)(omc_AvlSetString_referenceEqOrEmpty(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 4))), _left) && omc_AvlSetString_referenceEqOrEmpty(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 5))), _right));
if(tmp5)
{
tmpMeta[2] = _orig;
}
...
{
tmpMeta[1] = mmc_mk_box5(3, &AvlSetString_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 2))), mmc_mk_integer(((modelica_integer) 1) + modelica_integer_max((modelica_integer)(omc_AvlSetString_height(threadData, _left)),(modelica_integer)(omc_AvlSetString_height(threadData, _right)))), _left, _right);
tmpMeta[2] = tmpMeta[1];
}
tmpMeta[0] = tmpMeta[2];
goto tmp2_done;
