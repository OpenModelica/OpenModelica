...
#else
#define OMC_FILE "/home/per/workspace/OpenModelica/OMCompiler/Compiler/boot/build/tmp/DAE.c"
#endif
...
case 5: {
tmpMeta[1] = mmc_mk_box3(4, &DAE_AvlTreePathFunction_Tree_LEAF__desc, _inKey, _inValue);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 3: {
...
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = omc_DAE_AvlTreePathFunction_add(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 5))), _inKey, _inValue, ((modelica_fnptr) _conflictFunc));
_tree = tmpMeta[1];
}
else
{
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_tree), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[6] = omc_DAE_AvlTreePathFunction_add(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 6))), _inKey, _inValue, ((modelica_fnptr) _conflictFunc));
_tree = tmpMeta[1];
}
else
{
...
tmpMeta[0] = ((_key_comp == ((modelica_integer) 0))?_tree:omc_DAE_AvlTreePathFunction_balance(threadData, _tree));
goto tmp2_done;
}
case 4: {
...
{
tmpMeta[1] = mmc_mk_box3(4, &DAE_AvlTreePathFunction_Tree_LEAF__desc, _inKey, _inValue);
tmpMeta[2] = mmc_mk_box6(3, &DAE_AvlTreePathFunction_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 3))), mmc_mk_integer(((modelica_integer) 2)), tmpMeta[1], _OMC_LIT0);
_outTree = tmpMeta[2];
}
else
{
...
{
tmpMeta[1] = mmc_mk_box3(4, &DAE_AvlTreePathFunction_Tree_LEAF__desc, _inKey, _inValue);
tmpMeta[2] = mmc_mk_box6(3, &DAE_AvlTreePathFunction_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 3))), mmc_mk_integer(((modelica_integer) 2)), _OMC_LIT0, tmpMeta[1]);
_outTree = tmpMeta[2];
}
else
{
...
tmpMeta[0] = ((_key_comp == ((modelica_integer) 0))?_outTree:omc_DAE_AvlTreePathFunction_balance(threadData, _outTree));
goto tmp2_done;
}
}
goto tmp2_end;
...
tmp7_1 = omc_DAE_AvlTreePathFunction_keyCompare(threadData, _key, _k);
tmp7_2 = _tree;
{
...
tmp6_1 = omc_DAE_AvlTreePathFunction_keyCompare(threadData, _key, _k);
tmp6_2 = _tree;
{
...
case 4: {
tmpMeta[0] = omc_DAE_AvlTreePathFunction_add(threadData, _tree, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_treeToJoin), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_treeToJoin), 3))), ((modelica_fnptr) _conflictFunc));
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[0] = stringAppend(_OMC_LIT2,omc_DAE_AvlTreePathFunction_keyStr(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inNode), 2)))));
tmpMeta[1] = stringAppend(tmpMeta[0],_OMC_LIT3);
tmpMeta[2] = stringAppend(tmpMeta[1],omc_DAE_AvlTreePathFunction_valueStr(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inNode), 3)))));
...
_left = tmpMeta[0];
_right = tmpMeta[1];
tmpMeta[0] = stringAppend(omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, _left, 1, _OMC_LIT6),omc_DAE_AvlTreePathFunction_printNodeStr(threadData, _inTree));
tmpMeta[1] = stringAppend(tmpMeta[0],_OMC_LIT7);
tmpMeta[2] = stringAppend(tmpMeta[1],omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, _right, 0, _OMC_LIT6));
tmp1 = tmpMeta[2];
goto tmp3_done;
}
}
...
case 0: {
if (mmc__uniontype__metarecord__typedef__equal(tmp4_1,0,5) == 0) goto tmp3_end;
tmpMeta[0] = stringAppend(_inIndent,(_isLeft?_OMC_LIT8:_OMC_LIT9));
tmpMeta[1] = stringAppend(omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 5))), 1, tmpMeta[0]),_inIndent);
tmpMeta[2] = stringAppend(tmpMeta[1],(_isLeft?_OMC_LIT10:_OMC_LIT11));
tmpMeta[3] = stringAppend(tmpMeta[2],_OMC_LIT12);
tmpMeta[4] = stringAppend(tmpMeta[3],omc_DAE_AvlTreePathFunction_printNodeStr(threadData, _inTree));
tmpMeta[5] = stringAppend(tmpMeta[4],_OMC_LIT7);
tmpMeta[6] = stringAppend(_inIndent,(_isLeft?_OMC_LIT9:_OMC_LIT8));
tmpMeta[7] = stringAppend(tmpMeta[5],omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 6))), 0, tmpMeta[6]));
tmp1 = tmpMeta[7];
goto tmp3_done;
}
case 1: {
...
tmpMeta[0] = omc_DAE_AvlTreePathFunction_setTreeLeftRight(threadData, _child, _node, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_child), 6))));
goto tmp2_done;
}
case 1: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,5) == 0) goto tmp2_end;
...
tmpMeta[0] = omc_DAE_AvlTreePathFunction_setTreeLeftRight(threadData, _child, _node, _OMC_LIT0);
goto tmp2_done;
}
case 2: {
tmpMeta[0] = _inNode;
...
tmpMeta[0] = omc_DAE_AvlTreePathFunction_setTreeLeftRight(threadData, _child, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_child), 5))), _node);
goto tmp2_done;
}
case 1: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,5) == 0) goto tmp2_end;
...
tmpMeta[0] = omc_DAE_AvlTreePathFunction_setTreeLeftRight(threadData, _child, _OMC_LIT0, _node);
goto tmp2_done;
}
case 2: {
tmpMeta[0] = _inNode;
...
tmpMeta[1] = mmc_mk_box3(4, &DAE_AvlTreePathFunction_Tree_LEAF__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 3))));
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 1: {
...
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,5) == 0) goto tmp2_end;
tmp5 = (modelica_boolean)(omc_DAE_AvlTreePathFunction_referenceEqOrEmpty(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 5))), _left) && omc_DAE_AvlTreePathFunction_referenceEqOrEmpty(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 6))), _right));
if(tmp5)
{
tmpMeta[2] = _orig;
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[0],0,10) == 0) goto tmp3_end;
