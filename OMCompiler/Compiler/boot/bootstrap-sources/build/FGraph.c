...
#else
#define OMC_FILE "/home/per/workspace/OpenModelica/OMCompiler/Compiler/boot/build/tmp/FGraph.c"
#endif
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT32,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(109)),_OMC_LIT29,MMC_IMMEDIATE(MMC_TAGFIXNUM(1)),_OMC_LIT31}};
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[1],3,5) == 0) goto tmp6_end;
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 2));
_data = tmpMeta[1];
_el = tmpMeta[2];
_el = omc_SCodeUtil_makeClassPartial(threadData, _el);
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_data), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[2] = _el;
_data = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_node), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[6] = _data;
_node = tmpMeta[1];
tmpMeta[0] = _node;
goto tmp6_done;
}
...
tmp5 = omc_AbsynUtil_pathPrefixOf(threadData, _p, omc_FGraph_getGraphName(threadData, _inEnv));
...
tmpMeta[0] = omc_FGraph_setScope(threadData, _inEnv, _cs);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmp5 = omc_FNode_refHasChild(threadData, _refParent, _inName);
if (1 != tmp5) goto goto_1;
_ref = omc_FNode_child(threadData, _refParent, _inName);
tmp6 = omc_FNode_refHasChild(threadData, _ref, _OMC_LIT0);
...
{
tmpMeta[1] = mmc_mk_cons(_ref, MMC_REFSTRUCTLIT(mmc_nil));
_g = omc_FGraph_node(threadData, _g, _OMC_LIT0, tmpMeta[1], _inStatus ,&_n);
...
case 1: {
_g = tmp3_1;
tmpMeta[1] = stringAppend(_OMC_LIT1,omc_FGraph_getGraphNameStr(threadData, _g));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT2);
tmpMeta[3] = stringAppend(tmpMeta[2],_inName);
...
switch (MMC_SWITCH_CAST(tmp4)) {
case 0: {
tmpMeta[0] = omc_FNode_refData(threadData, omc_FNode_child(threadData, omc_FGraph_lastScopeRef(threadData, _inEnv), _inName));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[0],3,5) == 0) goto goto_2;
tmpMeta[1] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[0]), 6));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[1],7,1) == 0) goto goto_2;
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 2));
_outName = tmpMeta[2];
tmp1 = _outName;
goto tmp3_done;
...
_crefPrefix = omc_PrefixUtil_prefixAdd(threadData, _inSourceName, tmpMeta[2], tmpMeta[3], _inPrefix, _OMC_LIT5, _OMC_LIT8, _OMC_LIT10);
tmpMeta[2] = stringAppend(_inTargetClassName,_OMC_LIT11);
tmpMeta[3] = stringAppend(tmpMeta[2],omc_AbsynUtil_pathString(threadData, omc_AbsynUtil_stringListPath(threadData, listReverse(omc_AbsynUtil_pathToStringList(threadData, omc_PrefixUtil_prefixToPath(threadData, _crefPrefix)))), _OMC_LIT11, 0, 0));
_name = tmpMeta[3];
tmp1_c0 = _name;
...
case 2: {
modelica_boolean tmp6;
tmp6 = (((omc_Config_acceptMetaModelicaGrammar(threadData) || omc_FGraph_isTargetClassBuiltin(threadData, _inTargetClassEnv, _inTargetClass)) || omc_FGraph_inFunctionScope(threadData, _inSourceEnv)) || omc_SCodeUtil_isOperatorRecord(threadData, _inTargetClass));
...
tmp7 = (stringEqual(omc_AbsynUtil_pathFirstIdent(threadData, omc_FGraph_getGraphName(threadData, _inTargetClassEnv)), _OMC_LIT12));
...
tmpMeta[3] = mmc_mk_cons(_sourceRef, omc_FGraph_currentScope(threadData, _inSourceEnv));
tmpMeta[3];
...
tmpMeta[3] = omc_FNode_refData(threadData, _classRef);
...
tmpMeta[3] = mmc_mk_box2(10, &FCore_Status_CLS__INSTANCE__desc, _targetClassName);
_classRef = omc_FGraph_updateClassElement(threadData, _classRef, _c, _crefPrefix, _inMod, tmpMeta[3], omc_FGraph_empty(threadData));
omc_FNode_addChildRef(threadData, _targetClassParentRef, _newTargetClassName, _classRef, 0);
tmpMeta[3] = mmc_mk_cons(_classRef, omc_FGraph_currentScope(threadData, _gclass));
_sourceRef = omc_FGraph_updateSourceTargetScope(threadData, _sourceRef, tmpMeta[3]);
_ih = _inIH;
tmpMeta[0+0] = _gclass;
tmpMeta[0+1] = _c;
tmpMeta[0+2] = _ih;
...
tmpMeta[3] = stringAppend(_OMC_LIT13,omc_FGraph_getGraphNameStr(threadData, _inSourceEnv));
tmpMeta[4] = stringAppend(tmpMeta[3],_OMC_LIT14);
tmpMeta[5] = stringAppend(tmpMeta[4],_inSourceName);
tmpMeta[6] = stringAppend(tmpMeta[5],_OMC_LIT15);
tmpMeta[7] = stringAppend(tmpMeta[6],omc_FGraph_getGraphNameStr(threadData, _inTargetClassEnv));
tmpMeta[8] = stringAppend(tmpMeta[7],_OMC_LIT16);
tmpMeta[9] = stringAppend(tmpMeta[8],_targetClassName);
tmpMeta[10] = stringAppend(tmpMeta[9],omc_SCodeDump_printModStr(threadData, omc_Mod_unelabMod(threadData, _inMod), _OMC_LIT17));
tmpMeta[11] = stringAppend(tmpMeta[10],_OMC_LIT18);
tmpMeta[12] = stringAppend(tmpMeta[11],_newTargetClassName);
tmpMeta[13] = stringAppend(tmpMeta[12],_OMC_LIT3);
omc_Error_addCompilerWarning(threadData, tmpMeta[13]);
tmpMeta[0+0] = _inTargetClassEnv;
tmpMeta[0+1] = _inTargetClass;
tmpMeta[0+2] = _inIH;
goto tmp3_done;
...
_r = tmpMeta[2];
tmpMeta[0] = omc_List_map(threadData, omc_FNode_filter(threadData, _r, boxvar_FNode_isRefComponent), boxvar_FNode_refName);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[2] = mmc_mk_cons(_r, _inAcc);
_g = omc_FGraph_splitGraphScope__dispatch(threadData, _g, tmpMeta[2] ,&_s);
}
else
{
_g = _inGraph;
...
_outRealGraph = omc_FGraph_splitGraphScope__dispatch(threadData, _inGraph, tmpMeta[0] ,&_outForScope);
_return: OMC_LABEL_UNUSED
if (out_outForScope) { *out_outForScope = _outForScope; }
return _outRealGraph;
}
...
_ref = tmpMeta[1];
_rest = tmpMeta[2];
if (!(!omc_FNode_isRefTop(threadData, _ref))) goto tmp2_end;
...
_path_1 = omc_AbsynUtil_joinPaths(threadData, _path, tmpMeta[1]);
_opath = mmc_mk_some(_path_1);
}
else
{
tmpMeta[1] = mmc_mk_box2(4, &Absyn_Path_IDENT__desc, _id);
_opath = mmc_mk_some(tmpMeta[1]);
}
}
tmpMeta[0] = _opath;
goto tmp2_done;
...
tmpMeta[2] = MMC_CDR(tmp3_1);
_r = tmpMeta[1];
if (!omc_FNode_isRefClass(threadData, _r)) goto tmp2_end;
tmpMeta[0] = omc_SCodeUtil_getClassRestriction(threadData, omc_FNode_getElement(threadData, omc_FNode_fromRef(threadData, _r)));
goto tmp2_done;
}
case 1: {
if (listEmpty(tmp3_1)) goto tmp2_end;
...
tmpMeta[2] = MMC_CDR(tmp3_1);
_r = tmpMeta[1];
tmpMeta[1] = omc_FNode_fromRef(threadData, _r);
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 6));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[2],21,1) == 0) goto goto_1;
...
_st = tmpMeta[4];
tmpMeta[0] = omc_FGraph_scopeTypeToRestriction(threadData, _st);
goto tmp2_done;
}
case 2: {
tmpMeta[0] = omc_FGraph_getScopeRestriction(threadData, listRest(_inScope));
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[1] = MMC_CDR(tmp4_1);
_r = tmpMeta[0];
tmp6 = omc_FNode_isRefClass(threadData, _r);
if (1 != tmp6) goto goto_2;
_restr = omc_SCodeUtil_getClassRestriction(threadData, omc_FNode_getElement(threadData, omc_FNode_fromRef(threadData, _r)));
tmp7 = valueEq(omc_FGraph_restrictionToScopeType(threadData, _restr), _inScopeType);
if (1 != tmp7) goto goto_2;
tmp1 = 1;
goto tmp3_done;
}
...
tmpMeta[1] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[0]), 6));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[1],21,1) == 0) goto goto_2;
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 2));
_st = tmpMeta[2];
tmp8 = valueEq(_st, _inScopeType);
...
tmpMeta[0] = omc_FGraphBuildEnv_mkElementNode(threadData, _inDu, _r, _OMC_LIT26, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_g = tmp3_1;
_r = omc_FGraph_lastScopeRef(threadData, _g);
tmpMeta[0] = omc_FGraphBuildEnv_mkElementNode(threadData, _inImport, _r, _OMC_LIT26, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_g = tmp3_1;
_r = omc_FGraph_lastScopeRef(threadData, _g);
tmpMeta[1] = mmc_mk_cons(_inType, MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[0] = omc_FGraphBuildEnv_mkTypeNode(threadData, tmpMeta[1], _r, _inName, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[1],3,5) == 0) goto goto_1;
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 6));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[2],7,1) == 0) goto goto_1;
tmpMeta[0] = _g;
goto tmp2_done;
}
case 1: {
...
_g = tmp3_1;
_r = omc_FGraph_lastScopeRef(threadData, _g);
tmpMeta[0] = omc_FGraphBuildEnv_mkClassNode(threadData, _inClass, _inPrefix, _inMod, _r, _OMC_LIT26, _g, _checkDuplicate);
goto tmp2_done;
}
}
goto tmp2_end;
...
_n = tmpMeta[1];
_c = tmp3_3;
tmp5 = (stringEqual(_n, omc_SCodeUtil_elementName(threadData, _c)));
if (0 != tmp5) goto goto_1;
tmpMeta[1] = stringAppend(_OMC_LIT27,omc_SCodeUtil_elementName(threadData, _c));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT28);
tmpMeta[3] = stringAppend(tmpMeta[2],_n);
tmpMeta[4] = stringAppend(tmpMeta[3],_OMC_LIT3);
omc_Error_addCompilerError(threadData, tmpMeta[4]);
goto goto_1;
goto tmp2_done;
}
case 1: {
...
_i = tmp3_5;
_cg = tmp3_6;
tmp6 = (stringEqual(_n, omc_SCodeUtil_elementName(threadData, _c)));
if (1 != tmp6) goto goto_1;
_r = omc_FGraph_lastScopeRef(threadData, _g);
_g = omc_FGraphBuildEnv_mkCompNode(threadData, _c, _r, _OMC_LIT26, _g);
tmpMeta[0] = omc_FGraph_updateVarAndMod(threadData, _g, _v, _m, _i, _cg);
goto tmp2_done;
}
}
goto tmp2_end;
...
_id1 = tmpMeta[1];
_env_path = tmp3_2;
if (!(!(stringEqual(_id1, omc_AbsynUtil_pathFirstIdent(threadData, _env_path))))) goto tmp2_end;
tmpMeta[0] = _inPath;
goto tmp2_done;
}
}
...
case 0: {
modelica_boolean tmp5;
tmp5 = omc_Flags_isSet(threadData, _OMC_LIT32);
if (0 != tmp5) goto goto_1;
tmpMeta[0] = _inPath;
goto tmp2_done;
}
case 1: {
modelica_boolean tmp6;
tmpMeta[1] = omc_FGraph_getScopePath(threadData, _inEnv);
if (optionNone(tmpMeta[1])) goto goto_1;
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 1));
_env_path = tmpMeta[2];
...
if (1 != tmp5) goto goto_1;
tmpMeta[0] = omc_FGraph_crefStripGraphScopePrefix2(threadData, _cref, _env_path, _stripPartial);
goto tmp2_done;
}
case 1: {
modelica_boolean tmp6;
...
_id1 = tmpMeta[1];
_env_path = tmp3_2;
tmp7 = (stringEqual(_id1, omc_AbsynUtil_pathFirstIdent(threadData, _env_path)));
...
tmp6 = omc_AbsynUtil_crefEqual(threadData, _cref1, _cref2);
if (0 != tmp6) goto goto_1;
tmpMeta[0] = _cref2;
goto tmp2_done;
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,9,1) == 0) goto tmp2_end;
tmpMeta[1] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp3_1), 2));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[1],5,0) == 0) goto tmp2_end;
tmpMeta[0] = _OMC_LIT22;
goto tmp2_done;
}
case 2: {
...
memcpy(MMC_UNTAGPTR(tmpMeta[0]), MMC_UNTAGPTR(_graph), 4*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[0]))[3] = _inScope;
_graph = tmpMeta[0];
goto tmp2_done;
}
}
...
tmpMeta[0] = MMC_TAGPTR(mmc_alloc_words(4));
memcpy(MMC_UNTAGPTR(tmpMeta[0]), MMC_UNTAGPTR(_graph), 4*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[0]))[3] = listAppend(_inScope, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_graph), 3))));
_graph = tmpMeta[0];
goto tmp2_done;
}
}
...
case 0: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,2) == 0) goto tmp2_end;
tmpMeta[1] = mmc_mk_cons(_inRef, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_graph), 3))));
tmpMeta[0] = MMC_TAGPTR(mmc_alloc_words(4));
memcpy(MMC_UNTAGPTR(tmpMeta[0]), MMC_UNTAGPTR(_graph), 4*sizeof(modelica_metatype));
...
MMC_SO();
_tailrecursive: OMC_LABEL_UNUSED
tmpMeta[0] = listReverse(omc_FGraph_currentScope(threadData, _inGraph));
...
_outPath = omc_AbsynUtil_stringListPath(threadData, tmpMeta[0]);
_return: OMC_LABEL_UNUSED
return _outPath;
}
DLLExport
...
MMC_SO();
_tailrecursive: OMC_LABEL_UNUSED
tmpMeta[0] = omc_FGraph_currentScope(threadData, _inGraph);
if (listEmpty(tmpMeta[0])) MMC_THROW_INTERNAL();
tmpMeta[1] = MMC_CAR(tmpMeta[0]);
tmpMeta[2] = MMC_CDR(tmpMeta[0]);
_r = tmpMeta[1];
...
for (tmpMeta[0] = _s; !listEmpty(tmpMeta[0]); tmpMeta[0]=MMC_CDR(tmpMeta[0]))
{
_r = MMC_CAR(tmpMeta[0]);
tmpMeta[1] = mmc_mk_box3(3, &Absyn_Path_QUALIFIED__desc, omc_FNode_refName(threadData, _r), _p);
_p = tmpMeta[1];
}
}
tmpMeta[0] = _p;
...
case 0: {
modelica_boolean tmp5;
tmpMeta[1] = omc_FGraph_currentScope(threadData, _inGraph);
if (listEmpty(tmpMeta[1])) goto goto_1;
tmpMeta[2] = MMC_CAR(tmpMeta[1]);
tmpMeta[3] = MMC_CDR(tmpMeta[1]);
if (!listEmpty(tmpMeta[3])) goto goto_1;
_r = tmpMeta[2];
tmp5 = omc_FNode_isRefTop(threadData, _r);
if (1 != tmp5) goto goto_1;
tmpMeta[0] = mmc_mk_none();
goto tmp2_done;
}
...
tmpMeta[0] = omc_FGraph_pushScopeRef(threadData, _g, _r);
goto tmp2_done;
}
case 1: {
_g = tmp3_1;
...
tmpMeta[2] = mmc_mk_box2(24, &FCore_Data_ND__desc, _inScopeType);
_g = omc_FGraph_node(threadData, _g, _n, tmpMeta[1], tmpMeta[2] ,&_no);
_r = omc_FNode_toRef(threadData, _no);
tmpMeta[0] = omc_FGraph_pushScopeRef(threadData, _g, _r);
goto tmp2_done;
}
case 3: {
tmpMeta[1] = stringAppend(_OMC_LIT41,omc_FGraph_getGraphNameStr(threadData, _inGraph));
...
case 1: {
tmpMeta[1] = stringAppend(_OMC_LIT43,omc_FGraph_getGraphNameStr(threadData, _inGraph));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT42);
tmpMeta[3] = stringAppend(tmpMeta[2],omc_Util_stringOption(threadData, _inName));
tmpMeta[4] = stringAppend(tmpMeta[3],_OMC_LIT3);
omc_Error_addCompilerError(threadData, tmpMeta[4]);
goto goto_1;
goto tmp2_done;
...
case 0: {
_g = tmp3_1;
tmpMeta[1] = mmc_mk_box9(6, &SCode_Element_COMPONENT__desc, _name, _OMC_LIT50, _OMC_LIT55, _OMC_LIT56, _OMC_LIT57, _OMC_LIT58, mmc_mk_none(), _OMC_LIT10);
_c = tmpMeta[1];
tmpMeta[1] = mmc_mk_box7(3, &DAE_Attributes_ATTR__desc, _OMC_LIT59, _OMC_LIT52, _variability, _OMC_LIT53, _OMC_LIT48, _OMC_LIT45);
tmpMeta[2] = mmc_mk_box7(3, &DAE_Var_TYPES__VAR__desc, _name, tmpMeta[1], _ty, _binding, mmc_mk_boolean(0), _constOfForIteratorRange);
_v = tmpMeta[2];
_r = omc_FGraph_lastScopeRef(threadData, _g);
_g = omc_FGraphBuildEnv_mkCompNode(threadData, _c, _r, _OMC_LIT60, _g);
tmpMeta[0] = omc_FGraph_updateVarAndMod(threadData, _g, _v, _OMC_LIT61, _OMC_LIT62, omc_FGraph_empty(threadData));
goto tmp2_done;
}
}
goto tmp2_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[5],3,5) == 0) goto goto_1;
tmpMeta[6] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[5]), 5));
_id = tmp5;
_p = tmpMeta[3];
_c = tmpMeta[4];
_k = tmpMeta[6];
tmpMeta[1] = mmc_mk_box6(6, &FCore_Data_CL__desc, _e, _inPrefix, _inMod, _k, _instStatus);
tmpMeta[2] = mmc_mk_box6(3, &FCore_Node_N__desc, _n, mmc_mk_integer(_id), _p, _c, tmpMeta[1]);
tmpMeta[0] = omc_FNode_updateRef(threadData, _r, tmpMeta[2]);
goto tmp2_done;
}
}
goto tmp2_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[6],3,5) == 0) goto goto_1;
...
_e = tmp3_2;
_pr = omc_FGraph_lastScopeRef(threadData, _g);
tmp6 = omc_FNode_isImplicitRefName(threadData, _pr);
if (1 != tmp6) goto goto_1;
_g = omc_FGraph_stripLastScopeRef(threadData, _g, NULL);
tmpMeta[0] = omc_FGraph_updateClass(threadData, _g, _e, _inPrefix, _inMod, _instStatus, _inTargetGraph);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[5] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 5));
tmpMeta[6] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 6));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[6],4,4) == 0) goto goto_1;
...
_e = tmpMeta[7];
_k = tmpMeta[8];
tmpMeta[1] = mmc_mk_box5(7, &FCore_Data_CO__desc, _e, _inMod, _k, _instStatus);
tmpMeta[2] = mmc_mk_box6(3, &FCore_Node_N__desc, _n, mmc_mk_integer(_id), _p, _c, tmpMeta[1]);
_r = omc_FNode_updateRef(threadData, _r, tmpMeta[2]);
...
if (1 != tmp6) goto goto_1;
_g = omc_FGraph_stripLastScopeRef(threadData, _g, NULL);
tmpMeta[0] = omc_FGraph_updateVarAndMod(threadData, _g, _v, _inMod, _instStatus, _inTargetGraph);
goto tmp2_done;
}
case 2: {
tmpMeta[0] = _inGraph;
...
_r = omc_FNode_updateRef(threadData, _r, omc_FNode_setData(threadData, omc_FNode_fromRef(threadData, _r), tmpMeta[1]));
tmpMeta[0] = _inRef;
goto tmp2_done;
}
case 1: {
tmpMeta[1] = stringAppend(_OMC_LIT63,omc_FNode_toPathStr(threadData, omc_FNode_fromRef(threadData, _inRef)));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT64);
tmpMeta[3] = stringAppend(tmpMeta[2],omc_Types_printVarStr(threadData, _inVar));
omc_Error_addCompilerError(threadData, tmpMeta[3]);
goto goto_1;
goto tmp2_done;
}
}
...
tmpMeta[1] = mmc_mk_box2(23, &FCore_Data_REF__desc, _inTargetScope);
_r = omc_FNode_updateRef(threadData, _r, omc_FNode_setData(threadData, omc_FNode_fromRef(threadData, _r), tmpMeta[1]));
tmpMeta[0] = _inRef;
goto tmp2_done;
}
case 1: {
_r = tmp3_1;
tmpMeta[1] = stringAppend(_OMC_LIT65,omc_FNode_toPathStr(threadData, omc_FNode_fromRef(threadData, _r)));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT66);
tmpMeta[3] = stringAppend(tmpMeta[2],omc_FNode_scopeStr(threadData, _inTargetScope));
tmpMeta[4] = stringAppend(tmpMeta[3],_OMC_LIT3);
omc_Error_addCompilerWarning(threadData, tmpMeta[4]);
tmpMeta[0] = _inRef;
goto tmp2_done;
}
}
...
_m = tmpMeta[8];
_k = tmpMeta[9];
tmpMeta[1] = mmc_mk_box5(7, &FCore_Data_CO__desc, _e, _m, _k, _instStatus);
tmpMeta[2] = mmc_mk_box6(3, &FCore_Node_N__desc, _n, mmc_mk_integer(_id), _p, _c, tmpMeta[1]);
_r = omc_FNode_updateRef(threadData, _r, tmpMeta[2]);
_r = omc_FGraph_updateSourceTargetScope(threadData, _r, omc_FGraph_currentScope(threadData, _inTargetGraph));
_r = omc_FGraph_updateInstance(threadData, _r, _v);
...
if (1 != tmp6) goto goto_1;
_g = omc_FGraph_stripLastScopeRef(threadData, _g, NULL);
tmpMeta[0] = omc_FGraph_updateComp(threadData, _g, _v, _instStatus, _inTargetGraph);
goto tmp2_done;
}
case 2: {
tmpMeta[0] = _inGraph;
...
tmpMeta[1] = mmc_mk_box5(3, &FCore_Top_GTOP__desc, _ag, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_t), 3))), _nt, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_t), 5))));
_t = tmpMeta[1];
tmpMeta[1] = mmc_mk_box3(3, &FCore_Graph_G__desc, _t, _s);
_g = tmpMeta[1];
...
tmpMeta[0] = MMC_REFSTRUCTLIT(mmc_nil);
_n = omc_FNode_new(threadData, _OMC_LIT69, _id, tmpMeta[0], _OMC_LIT70);
...
tmpMeta[0] = mmc_mk_box2(3, &FCore_Extra_EXTRA__desc, _inPath);
tmpMeta[1] = mmc_mk_box5(3, &FCore_Top_GTOP__desc, _ag, _inGraphName, _nr, tmpMeta[0]);
_top = tmpMeta[1];
tmpMeta[0] = mmc_mk_box3(3, &FCore_Graph_G__desc, _top, _s);
_outGraph = tmpMeta[0];
tmpMeta[0] = mmc_mk_cons(_nr, MMC_REFSTRUCTLIT(mmc_nil));
...
case 0: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,2) == 0) goto tmp2_end;
tmpMeta[0] = arrayGet((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inGraph), 2)))), 2))), ((modelica_integer) 1));
goto tmp2_done;
}
}
goto tmp2_end;
...
_outRef = tmpMeta[3];
_s = tmpMeta[4];
tmpMeta[0] = mmc_mk_box3(3, &FCore_Graph_G__desc, _t, _s);
_outGraph = tmpMeta[0];
_return: OMC_LABEL_UNUSED
...
case 0: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,2) == 0) goto tmp2_end;
tmpMeta[2] = mmc_mk_cons(_inRef, listRest((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outGraph), 3)))));
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(4));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outGraph), 4*sizeof(modelica_metatype));
...
case 0: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,2) == 0) goto tmp2_end;
tmpMeta[0] = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inGraph), 2)))), 5)));
goto tmp2_done;
}
}
goto tmp2_end;
...
case 0: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,2) == 0) goto tmp2_end;
tmpMeta[0] = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inGraph), 2)))), 4)));
goto tmp2_done;
}
}
goto tmp2_end;
