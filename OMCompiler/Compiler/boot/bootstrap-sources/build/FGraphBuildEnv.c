...
_g = omc_FGraphBuildEnv_addIterators(threadData, tmpMeta12, _ref, _k, _g);
tmpMeta16 = mmc_mk_box3(0, _ref, _k, _g);
omc_SCodeUtil_traverseStatementExps(threadData, _stmt, boxvar_FGraphBuildEnv_traverseExp, tmpMeta16, &tmpMeta14);
...
_g = omc_FGraphBuildEnv_addIterators(threadData, tmpMeta25, _ref, _k, _g);
tmpMeta29 = mmc_mk_box3(0, _ref, _k, _g);
omc_SCodeUtil_traverseStatementExps(threadData, _stmt, boxvar_FGraphBuildEnv_traverseExp, tmpMeta29, &tmpMeta27);
...
omc_SCodeUtil_traverseStatementExps(threadData, _stmt, boxvar_FGraphBuildEnv_traverseExp, tmpMeta39, &tmpMeta37);
...
tmpMeta5 = mmc_mk_box2(0, boxvar_FGraphBuildEnv_analyseStatementTraverser, tmpMeta4);
...
_g = omc_FGraphBuildEnv_addIterators(threadData, tmpMeta12, _ref, _k, _g);
tmpMeta16 = mmc_mk_box3(0, _ref, _k, _g);
tmpMeta17 = omc_SCodeUtil_traverseEEquationExps(threadData, _equf, boxvar_FGraphBuildEnv_traverseExp, tmpMeta16, &tmpMeta14);
_equ = tmpMeta17;
tmpMeta15 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta14), 3));
_g = tmpMeta15;
...
tmpMeta29 = mmc_mk_box3(0, _ref, _k, _g);
tmpMeta30 = omc_SCodeUtil_traverseEEquationExps(threadData, _equr, boxvar_FGraphBuildEnv_traverseExp, tmpMeta29, &tmpMeta27);
_equ = tmpMeta30;
tmpMeta28 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta27), 3));
_g = tmpMeta28;
...
tmpMeta40 = mmc_mk_box3(0, _ref, _k, _g);
tmpMeta41 = omc_SCodeUtil_traverseEEquationExps(threadData, _equ, boxvar_FGraphBuildEnv_traverseExp, tmpMeta40, &tmpMeta38);
_equ = tmpMeta41;
...
tmpMeta7 = mmc_mk_box2(0, boxvar_FGraphBuildEnv_analyseEEquationTraverser, tmpMeta6);
...
_cref = tmpMeta6;
_g = tmp4_2;
tmpMeta1 = omc_FGraphBuildEnv_analyseCref(threadData, _cref, _inRef, _inKind, _g);
goto tmp3_done;
}
case 1: {
modelica_metatype tmpMeta7;
...
_iters = tmpMeta8;
_g = tmp4_2;
tmpMeta1 = omc_FGraphBuildEnv_addIterators(threadData, _iters, _inRef, _inKind, _g);
goto tmp3_done;
}
case 2: {
modelica_metatype tmpMeta9;
...
_g = tmp4_2;
tmpMeta1 = omc_FGraphBuildEnv_addMatchScope(threadData, _inExp, _inRef, _inKind, _g);
goto tmp3_done;
}
case 5: {
tmpMeta1 = _inGraph;
...
omc_AbsynUtil_traverseExpBidir(threadData, _inExp, boxvar_FGraphBuildEnv_analyseExpTraverserEnter, boxvar_FGraphBuildEnv_analyseExpTraverserExit, tmpMeta3, &tmpMeta1);
