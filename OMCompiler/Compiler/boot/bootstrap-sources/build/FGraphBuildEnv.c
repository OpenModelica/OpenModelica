...
#endif
PROTECTED_FUNCTION_STATIC modelica_metatype omc_FGraphBuildEnv_analyseStatementTraverser(threadData_t *threadData, modelica_metatype _inTuple);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_FGraphBuildEnv_traverseExp(threadData_t *threadData, modelica_metatype _inExp, modelica_metatype _inTuple, modelica_metatype *out_outTuple);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_FGraphBuildEnv_analyseEEquationTraverser(threadData_t *threadData, modelica_metatype _inTuple);
static const MMC_DEFSTRUCTLIT(boxvar_lit_FGraphBuildEnv_analyseEEquationTraverser,2,0) {(void*) boxptr_FGraphBuildEnv_analyseEEquationTraverser,0}};
#define boxvar_FGraphBuildEnv_analyseEEquationTraverser MMC_REFSTRUCTLIT(boxvar_lit_FGraphBuildEnv_analyseEEquationTraverser)
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_FGraphBuildEnv_analyseExpTraverserExit(threadData_t *threadData, modelica_metatype _inExp, modelica_metatype _inTuple, modelica_metatype *out_outTuple);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_FGraphBuildEnv_analyseExp2(threadData_t *threadData, modelica_metatype _inExp, modelica_metatype _inRef, modelica_metatype _inKind, modelica_metatype _inGraph);
static const MMC_DEFSTRUCTLIT(boxvar_lit_FGraphBuildEnv_analyseExp2,2,0) {(void*) boxptr_FGraphBuildEnv_analyseExp2,0}};
#define boxvar_FGraphBuildEnv_analyseExp2 MMC_REFSTRUCTLIT(boxvar_lit_FGraphBuildEnv_analyseExp2)
PROTECTED_FUNCTION_STATIC modelica_metatype omc_FGraphBuildEnv_analyseExpTraverserEnter(threadData_t *threadData, modelica_metatype _inExp, modelica_metatype _inTuple, modelica_metatype *out_outTuple);
...
tmpMeta[0] = omc_FGraphBuildEnv_addIterators__helper(threadData, _inIterators, _nr, _inKind, _g);
goto tmp2_done;
}
case 1: {
_g = tmp3_1;
...
_g = omc_FGraphBuildEnv_addIterators(threadData, tmpMeta[1], _ref, _k, _g);
tmpMeta[3] = mmc_mk_box3(0, _ref, _k, _g);
omc_SCodeUtil_traverseStatementExps(threadData, _stmt, boxvar_FGraphBuildEnv_traverseExp, tmpMeta[3], &tmpMeta[1]);
...
tmpMeta[4] = mmc_mk_box2(0, boxvar_FGraphBuildEnv_analyseStatementTraverser, tmpMeta[3]);
...
MMC_SO();
_tailrecursive: OMC_LABEL_UNUSED
_outExp = omc_AbsynUtil_traverseExpBidir(threadData, _inExp, boxvar_FGraphBuildEnv_analyseExpTraverserEnter, boxvar_FGraphBuildEnv_analyseExpTraverserExit, _inTuple ,&_outTuple);
_return: OMC_LABEL_UNUSED
...
_g = omc_FGraphBuildEnv_addIterators(threadData, tmpMeta[1], _ref, _k, _g);
tmpMeta[3] = mmc_mk_box3(0, _ref, _k, _g);
tmpMeta[4] = omc_SCodeUtil_traverseEEquationExps(threadData, _equf, boxvar_FGraphBuildEnv_traverseExp, tmpMeta[3], &tmpMeta[1]);
_equ = tmpMeta[4];
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 3));
_g = tmpMeta[2];
tmpMeta[1] = mmc_mk_box3(0, _ref, _k, _g);
...
_k = tmpMeta[6];
_g = tmpMeta[7];
_g = omc_FGraphBuildEnv_analyseCref(threadData, _cref1, _ref, _k, _g);
tmpMeta[3] = mmc_mk_box3(0, _ref, _k, _g);
tmpMeta[4] = omc_SCodeUtil_traverseEEquationExps(threadData, _equr, boxvar_FGraphBuildEnv_traverseExp, tmpMeta[3], &tmpMeta[1]);
_equ = tmpMeta[4];
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 3));
_g = tmpMeta[2];
tmpMeta[1] = mmc_mk_box3(0, _ref, _k, _g);
...
tmpMeta[3] = mmc_mk_box3(0, _ref, _k, _g);
tmpMeta[4] = omc_SCodeUtil_traverseEEquationExps(threadData, _equ, boxvar_FGraphBuildEnv_traverseExp, tmpMeta[3], &tmpMeta[1]);
_equ = tmpMeta[4];
tmpMeta[2] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[1]), 3));
_g = tmpMeta[2];
tmpMeta[1] = mmc_mk_box3(0, _ref, _k, _g);
...
_equ = tmpMeta[1];
tmpMeta[3] = mmc_mk_box3(0, _inParentRef, _inKind, _inGraph);
tmpMeta[4] = mmc_mk_box2(0, boxvar_FGraphBuildEnv_analyseEEquationTraverser, tmpMeta[3]);
...
case 1: {
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkCrefNode(threadData, _inCref, _inParentRef, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_cref = tmpMeta[1];
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_analyseCref(threadData, _cref, _inRef, _inKind, _g);
goto tmp2_done;
}
case 1: {
...
_iters = tmpMeta[2];
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_addIterators(threadData, _iters, _inRef, _inKind, _g);
goto tmp2_done;
}
case 2: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,11,2) == 0) goto tmp2_end;
...
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_addMatchScope(threadData, _inExp, _inRef, _inKind, _g);
goto tmp2_done;
}
case 5: {
tmpMeta[0] = _inGraph;
...
_k = tmpMeta[2];
_g = tmpMeta[3];
_g = omc_FGraphBuildEnv_analyseExp2(threadData, _inExp, _ref, _k, _g);
_exp = _inExp;
...
_exp = tmpMeta[1];
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_analyseExp(threadData, _exp, _inRef, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
omc_AbsynUtil_traverseExpBidir(threadData, _inExp, boxvar_FGraphBuildEnv_analyseExpTraverserEnter, boxvar_FGraphBuildEnv_analyseExpTraverserExit, tmpMeta[2], &tmpMeta[0]);
...
tmpMeta[0] = omc_FGraphBuildEnv_mkCrefsFromExps(threadData, omc_List_consOption(threadData, _oae, _exps), _nr, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _inName, _nr, 0);
tmpMeta[0] = omc_List_fold2(threadData, _inAlgs, boxvar_FGraphBuildEnv_analyseAlgorithm, _nr, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _inName, _nr, 0);
tmpMeta[0] = omc_List_fold2(threadData, _inEqs, boxvar_FGraphBuildEnv_analyseEquation, _nr, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _name, _nr, 0);
tmpMeta[0] = omc_FGraphBuildEnv_mkDimsNode(threadData, _OMC_LIT8, omc_List_mkOption(threadData, omc_AbsynUtil_getSubsFromCref(threadData, _inCref, 1, 1)), _nr, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _inName, _nr, 0);
tmpMeta[0] = omc_FGraphBuildEnv_analyseExp(threadData, _e, _nr, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_e = tmpMeta[1];
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkExpressionNode(threadData, _OMC_LIT9, _e, _inParentRef, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_g = omc_FGraphBuildEnv_mkRefNode(threadData, _OMC_LIT11, tmpMeta[0], _nr, _g);
_outGraph = _g;
_return: OMC_LABEL_UNUSED
return _outGraph;
}
...
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _inName, _nr, 0);
tmpMeta[0] = omc_FGraphBuildEnv_mkDimsNode__helper(threadData, ((modelica_integer) 0), _a, _nr, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_g = tmp3_1;
tmpMeta[1] = mmc_mk_cons(_inParentRef, MMC_REFSTRUCTLIT(mmc_nil));
_g = omc_FGraph_node(threadData, _g, _OMC_LIT13, tmpMeta[1], _OMC_LIT15 ,&_n);
...
_g = omc_FGraph_node(threadData, _g, _OMC_LIT16, tmpMeta[1], tmpMeta[3] ,&_n);
_r = omc_FNode_toRef(threadData, _n);
...
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkCompNode(threadData, _inElement, _inParentRef, _inKind, _g);
goto tmp2_done;
}
case 5: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,2,8) == 0) goto tmp2_end;
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkClassNode(threadData, _inElement, _OMC_LIT17, _OMC_LIT18, _inParentRef, _inKind, _g, 0);
goto tmp2_done;
}
case 4: {
...
tmpMeta[1] = mmc_mk_cons(_inParentRef, MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[2] = mmc_mk_box3(8, &FCore_Data_EX__desc, _inElement, _OMC_LIT18);
_g = omc_FGraph_node(threadData, _g, _name, tmpMeta[1], tmpMeta[2] ,&_n);
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _name, _nr, 0);
_g = omc_FGraphBuildEnv_mkModNode(threadData, _OMC_LIT19, _m, _nr, _inKind, _g);
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[0] = omc_FGraphBuildEnv_mkRefNode(threadData, _OMC_LIT11, tmpMeta[1], _nr, _g);
goto tmp2_done;
}
case 3: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,3) == 0) goto tmp2_end;
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkImportNode(threadData, _inElement, _inParentRef, _inKind, _g);
goto tmp2_done;
}
case 7: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,4,5) == 0) goto tmp2_end;
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkUnitsNode(threadData, _inElement, _inParentRef, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[0] = omc_FGraphBuildEnv_mkExternalNode(threadData, _OMC_LIT25, _externalDecl, _inParentRef, _inKind, _g);
goto tmp2_done;
}
case 1: {
...
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[0] = omc_FGraphBuildEnv_mkRefNode(threadData, _OMC_LIT11, tmpMeta[1], _inParentRef, _g);
goto tmp2_done;
}
case 2: {
...
_e = tmpMeta[1];
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkExpressionNode(threadData, _OMC_LIT27, _e, _inParentRef, _inKind, _g);
goto tmp2_done;
}
}
goto tmp2_end;
...
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _name, _nr, 0);
tmpMeta[0] = omc_FGraphBuildEnv_mkBindingNode(threadData, _b, _nr, _inKind, _g);
goto tmp2_done;
}
case 3: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_2,0,5) == 0) goto tmp2_end;
...
_nr = omc_FNode_toRef(threadData, _n);
omc_FNode_addChildRef(threadData, _inParentRef, _name, _nr, 0);
tmpMeta[0] = omc_FGraphBuildEnv_mkElementNode(threadData, _e, _nr, _inKind, _g);
goto tmp2_done;
}
case 5: {
_name = tmp3_1;
...
_name = tmpMeta[2];
tmpMeta[1] = mmc_mk_cons(_inParentRef, MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[2] = mmc_mk_box6(6, &FCore_Data_CL__desc, _cls, _inPrefix, _inMod, _inKind, _OMC_LIT32);
_g = omc_FGraph_node(threadData, _g, _name, tmpMeta[1], tmpMeta[2] ,&_n);
_nr = omc_FNode_toRef(threadData, _n);
...
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,2,8) == 0) goto tmp2_end;
_g = tmp3_2;
tmpMeta[0] = omc_FGraphBuildEnv_mkClassNode(threadData, _inClass, _OMC_LIT17, _OMC_LIT18, _inParentRef, _inKind, _g, _checkDuplicate);
goto tmp2_done;
}
}
goto tmp2_end;
...
for (tmpMeta[0] = _inProgram; !listEmpty(tmpMeta[0]); tmpMeta[0]=MMC_CDR(tmpMeta[0]))
{
_cls = MMC_CAR(tmpMeta[0]);
