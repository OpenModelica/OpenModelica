...
#else
#define OMC_FILE "HashTableStringToProgram.c"
#endif
...
MMC_SO();
_tailrecursive: OMC_LABEL_UNUSED
tmpMeta1 = mmc_mk_box4(0, boxvar_stringHashDjb2Mod, boxvar_stringEq, boxvar_Util_id, boxvar_HashTableStringToProgram_dummyStr);
