...
#else
#define OMC_FILE "HashTableStringToPath.c"
#endif
...
tmpMeta1 = mmc_mk_box4(0, boxvar_stringHashDjb2Mod, boxvar_stringEq, boxvar_Util_id, boxvar_AbsynUtil_pathStringDefault);
