...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT62,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(123)),_OMC_LIT9,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT58,_OMC_LIT59,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT61}};
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (14 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT4), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (16 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT14), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
tmpMeta[4] = mmc_mk_box2(3, &Absyn_CodeNode_C__TYPENAME__desc, _className);
tmpMeta[5] = mmc_mk_box3(28, &DAE_Exp_CODE__desc, tmpMeta[4], _OMC_LIT15);
tmpMeta[3] = mmc_mk_cons(tmpMeta[5], mmc_mk_cons(_outputFile, mmc_mk_cons(_dumpExtractionSteps, MMC_REFSTRUCTLIT(mmc_nil))));
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT14, tmpMeta[3], _OMC_LIT5);
tmpMeta[0+2] = _OMC_LIT7;
goto tmp3_done;
}
case 4: {
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (17 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT36), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
tmpMeta[3] = mmc_mk_box2(5, &DAE_Exp_SCONST__desc, _cname_str);
_cache = omc_Static_getOptionalNamedArg(threadData, _cache, _env, _impl, _OMC_LIT17, _OMC_LIT5, _args, tmpMeta[3], _pre, _info ,&_filenameprefix);
_recordtype = _OMC_LIT35;
tmpMeta[4] = mmc_mk_box2(3, &Absyn_CodeNode_C__TYPENAME__desc, _className);
tmpMeta[5] = mmc_mk_box3(28, &DAE_Exp_CODE__desc, tmpMeta[4], _OMC_LIT15);
tmpMeta[3] = mmc_mk_cons(tmpMeta[5], mmc_mk_cons(_filenameprefix, MMC_REFSTRUCTLIT(mmc_nil)));
tmpMeta[6] = mmc_mk_box3(3, &DAE_Properties_PROP__desc, _recordtype, _OMC_LIT6);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT36, tmpMeta[3], _OMC_LIT5);
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (17 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT37), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
tmpMeta[6] = mmc_mk_box3(3, &DAE_Properties_PROP__desc, _recordtype, _OMC_LIT6);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT37, tmpMeta[3], _OMC_LIT5);
tmpMeta[0+2] = tmpMeta[6];
goto tmp3_done;
}
case 6: {
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (17 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT38), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
tmpMeta[6] = mmc_mk_box3(3, &DAE_Properties_PROP__desc, _recordtype, _OMC_LIT6);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT38, tmpMeta[3], _OMC_LIT5);
tmpMeta[0+2] = tmpMeta[6];
goto tmp3_done;
}
case 7: {
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (10 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT39), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (15 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT44), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (8 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT45), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
tmpMeta[3] = mmc_mk_box3(3, &DAE_Properties_PROP__desc, _recordtype, _OMC_LIT6);
tmpMeta[0+0] = _cache;
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (10 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT46), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (9 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT47), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (8 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT48), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (8 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT49), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],2,1) == 0) goto tmp3_end;
...
tmpMeta[3] = mmc_mk_cons(_crefExp, MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT49, tmpMeta[3], _OMC_LIT5);
tmpMeta[0+2] = _OMC_LIT7;
goto tmp3_done;
}
case 14: {
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (6 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT50), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
if (listEmpty(tmp4_4)) goto tmp3_end;
tmpMeta[4] = MMC_CAR(tmp4_4);
tmpMeta[5] = MMC_CDR(tmp4_4);
if (!listEmpty(tmpMeta[5])) goto tmp3_end;
...
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT50, tmpMeta[3], _OMC_LIT51);
...
if (mmc__uniontype__metarecord__typedef__equal(tmp4_3,2,2) == 0) goto tmp3_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_3), 2));
if (20 != MMC_STRLEN(tmpMeta[3]) || strcmp(MMC_STRINGDATA(_OMC_LIT54), MMC_STRINGDATA(tmpMeta[3])) != 0) goto tmp3_end;
_cache = tmp4_1;
_args = tmp4_5;
tmp4 += 3;
_excludeList = omc_Static_getOptionalNamedArgExpList(threadData, _OMC_LIT53, _args);
_excludeListSize = listLength(_excludeList);
tmpMeta[5] = mmc_mk_box2(3, &DAE_Dimension_DIM__INTEGER__desc, mmc_mk_integer(_excludeListSize));
tmpMeta[4] = mmc_mk_cons(tmpMeta[5], MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[6] = mmc_mk_box3(9, &DAE_Type_T__ARRAY__desc, _OMC_LIT15, tmpMeta[4]);
tmpMeta[7] = mmc_mk_box4(19, &DAE_Exp_ARRAY__desc, tmpMeta[6], mmc_mk_boolean(0), _excludeList);
tmpMeta[3] = mmc_mk_cons(tmpMeta[7], MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT54, tmpMeta[3], _OMC_LIT5);
...
tmpMeta[6] = mmc_mk_box3(9, &DAE_Type_T__ARRAY__desc, _OMC_LIT15, tmpMeta[4]);
tmpMeta[7] = mmc_mk_box4(19, &DAE_Exp_ARRAY__desc, tmpMeta[6], mmc_mk_boolean(0), _excludeList);
tmpMeta[8] = mmc_mk_box2(5, &DAE_Exp_SCONST__desc, _str);
tmpMeta[3] = mmc_mk_cons(tmpMeta[7], mmc_mk_cons(tmpMeta[8], MMC_REFSTRUCTLIT(mmc_nil)));
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT54, tmpMeta[3], _OMC_LIT5);
tmpMeta[0+2] = _OMC_LIT56;
goto tmp3_done;
...
tmpMeta[6] = mmc_mk_box3(9, &DAE_Type_T__ARRAY__desc, _OMC_LIT15, tmpMeta[4]);
tmpMeta[7] = mmc_mk_box4(19, &DAE_Exp_ARRAY__desc, tmpMeta[6], mmc_mk_boolean(0), _excludeList);
tmpMeta[8] = mmc_mk_box2(3, &Absyn_CodeNode_C__TYPENAME__desc, _className);
tmpMeta[9] = mmc_mk_box3(28, &DAE_Exp_CODE__desc, tmpMeta[8], _OMC_LIT15);
tmpMeta[3] = mmc_mk_cons(tmpMeta[7], mmc_mk_cons(tmpMeta[9], MMC_REFSTRUCTLIT(mmc_nil)));
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT54, tmpMeta[3], _OMC_LIT5);
tmpMeta[0+2] = _OMC_LIT56;
goto tmp3_done;
...
tmpMeta[8] = mmc_mk_box2(3, &Absyn_CodeNode_C__TYPENAME__desc, _className);
tmpMeta[9] = mmc_mk_box3(28, &DAE_Exp_CODE__desc, tmpMeta[8], _OMC_LIT15);
tmpMeta[10] = mmc_mk_box2(5, &DAE_Exp_SCONST__desc, _str);
tmpMeta[3] = mmc_mk_cons(tmpMeta[7], mmc_mk_cons(tmpMeta[9], mmc_mk_cons(tmpMeta[10], MMC_REFSTRUCTLIT(mmc_nil))));
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = omc_Expression_makePureBuiltinCall(threadData, _OMC_LIT54, tmpMeta[3], _OMC_LIT5);
tmpMeta[0+2] = _OMC_LIT56;
goto tmp3_done;
...
for (tmpMeta[0] = _args; !listEmpty(tmpMeta[0]); tmpMeta[0]=MMC_CDR(tmpMeta[0]))
{
_arg = MMC_CAR(tmpMeta[0]);
if((!listMember((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_arg), 2))), _OMC_LIT91)))
{
tmpMeta[1] = mmc_mk_cons(_callName, mmc_mk_cons((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_arg), 2))), MMC_REFSTRUCTLIT(mmc_nil)));
...
_cache = omc_Ceval_ceval(threadData, _cache, _env, _exp, 1, tmpMeta[2], ((modelica_integer) 0) ,&_v);
tmpMeta[2] = omc_CevalScript_evalCodeTypeName(threadData, _v, _env);
...
tmpMeta[3] = mmc_mk_box2(3, &Absyn_CodeNode_C__TYPENAME__desc, _className);
tmpMeta[4] = mmc_mk_box3(28, &DAE_Exp_CODE__desc, tmpMeta[3], _OMC_LIT15);
...
_pre = tmp4_6;
_info = tmp4_7;
tmpMeta[6] = omc_Static_getOptionalNamedArg(threadData, _cache, _env, _impl, _OMC_LIT72, _OMC_LIT51, _args, _OMC_LIT93, _pre, _info, &tmpMeta[4]);
_cache = tmpMeta[6];
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],1,1) == 0) goto goto_2;
tmpMeta[5] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[4]), 2));
tmp6 = mmc_unbox_real(tmpMeta[5]);
_rstepTime = tmp6;
tmpMeta[6] = omc_Static_getOptionalNamedArg(threadData, _cache, _env, _impl, _OMC_LIT69, _OMC_LIT51, _args, omc_CevalScriptBackend_getSimulationOption(threadData, _inSimOpt, _OMC_LIT69), _pre, _info, &tmpMeta[4]);
_cache = tmpMeta[6];
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],1,1) == 0) goto goto_2;
tmpMeta[5] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[4]), 2));
tmp7 = mmc_unbox_real(tmpMeta[5]);
_startTime = tmpMeta[4];
_rstartTime = tmp7;
tmpMeta[6] = omc_Static_getOptionalNamedArg(threadData, _cache, _env, _impl, _OMC_LIT70, _OMC_LIT51, _args, omc_CevalScriptBackend_getSimulationOption(threadData, _inSimOpt, _OMC_LIT70), _pre, _info, &tmpMeta[4]);
_cache = tmpMeta[6];
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[4],1,1) == 0) goto goto_2;
tmpMeta[5] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[4]), 2));
...
_intervals = ((modelica_integer)floor((_rstopTime - _rstartTime) / tmp9));
tmpMeta[4] = mmc_mk_box2(3, &DAE_Exp_ICONST__desc, mmc_mk_integer(_intervals));
_numberOfIntervals = tmpMeta[4];
tmpMeta[0+0] = _cache;
