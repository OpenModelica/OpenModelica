...
_exp = tmpMeta[1];
tmpMeta[0] = stringAppend(_OMC_LIT1,omc_Dump_printExpStr(threadData, _exp));
tmp1 = tmpMeta[0];
goto tmp3_done;
}
case 2: {
...
switch (MMC_SWITCH_CAST(tmp4)) {
case 0: {
tmpMeta[0] = stringAppend((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inSubMod), 2))),_OMC_LIT1);
tmpMeta[1] = stringAppend(tmpMeta[0],omc_Mod_unparseModStr(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inSubMod), 3)))));
tmp1 = tmpMeta[1];
goto tmp3_done;
}
}
...
_sub_str = omc_List_toString(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 4))), boxvar_Mod_unparseSubModStr, _OMC_LIT0, _OMC_LIT4, _OMC_LIT5, _OMC_LIT6, 0);
_binding_str = omc_Mod_unparseBindingStr(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 5))));
tmpMeta[0] = stringAppend(_final_str,_each_str);
tmpMeta[1] = stringAppend(tmpMeta[0],_sub_str);
tmpMeta[2] = stringAppend(tmpMeta[1],_binding_str);
tmp1 = tmpMeta[2];
goto tmp3_done;
}
case 4: {
...
tmpMeta[2] = stringAppend(tmpMeta[1],_el_str);
tmp1 = tmpMeta[2];
goto tmp3_done;
}
}
...
for (tmpMeta[1] = _inSubMods; !listEmpty(tmpMeta[1]); tmpMeta[1]=MMC_CDR(tmpMeta[1]))
{
_submod = MMC_CAR(tmpMeta[1]);
tmpMeta[2] = _submod;
...
{
tmpMeta[3] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _id, _mod);
tmpMeta[2] = mmc_mk_cons(tmpMeta[3], _outSubMods);
_outSubMods = tmpMeta[2];
}
}
}
...
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = omc_Mod_filterRedeclaresSubMods(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outMod), 4))));
_outMod = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = mmc_mk_none();
_outMod = tmpMeta[1];
tmpMeta[0] = (listEmpty((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outMod), 4))))?_OMC_LIT9:_outMod);
goto tmp2_done;
}
case 1: {
tmpMeta[0] = _outMod;
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = _inEqMod;
_outMod = tmpMeta[1];
tmpMeta[0] = _outMod;
goto tmp2_done;
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[3],0,5) == 0) MMC_THROW_INTERNAL();
tmpMeta[4] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[3]), 3));
if (optionNone(tmpMeta[4])) MMC_THROW_INTERNAL();
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[2],3,5) == 0) goto goto_1;
...
case 3: {
tmpMeta[0] = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 6)));
goto tmp2_done;
}
case 4: {
tmpMeta[0] = omc_SCodeUtil_elementInfo(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 4))));
goto tmp2_done;
}
default:
...
tmpMeta[2] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _id, _m);
...
_finalPrefix = tmpMeta[1];
_el = tmpMeta[2];
_mod = tmpMeta[3];
tmp3 += 1;
tmpMeta[1] = mmc_mk_box5(4, &DAE_Mod_REDECL__desc, _finalPrefix, _OMC_LIT12, _el, _mod);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 2: {
...
_eq = tmpMeta[3];
_info = tmpMeta[4];
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _finalPrefix, _OMC_LIT12, _subs, _eq, _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 3: {
tmpMeta[1] = stringAppend(_OMC_LIT13,omc_Mod_printModStr(threadData, _inMod));
...
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _finalPrefix, _eachPrefix, _subs, _eq, _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 5: {
tmpMeta[1] = stringAppend(_OMC_LIT15,omc_Mod_printModStr(threadData, _inMod));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT14);
fputs(MMC_STRINGDATA(tmpMeta[2]),stdout);
goto goto_1;
goto tmp2_done;
...
_m1 = tmpMeta[4];
_subs = tmpMeta[2];
tmp5 = (modelica_boolean)(stringEqual(_s1, _componentName));
if(tmp5)
{
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[4] = tmpMeta[1];
...
case 4: {
tmpMeta[0] = ((stringEqual(omc_SCodeUtil_elementName(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 4)))), _componentModified))?_OMC_LIT9:_inMod);
goto tmp2_done;
}
case 3: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,5) == 0) goto tmp2_end;
...
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _e, _subs, _oem, _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[3],1,4) == 0) goto tmp2_end;
_subs = tmpMeta[2];
_isubs = _subs;
goto _tailrecursive;
goto tmp2_done;
...
tmpMeta[1] = mmc_mk_cons(_sm, _osubs);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
}
...
_info = tmpMeta[5];
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[2] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _each_, tmpMeta[1], _eq, _info);
tmpMeta[0] = tmpMeta[2];
goto tmp2_done;
}
case 1: {
...
_subs = tmpMeta[1];
tmpMeta[1] = omc_Mod_removeRedecl(threadData, _subs);
...
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _each_, _subs, _eq, _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 3: {
...
tmpMeta[0] = listAppend(_crefs, _inCrefs);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[2]), 2));
_exp = tmpMeta[3];
tmpMeta[0] = omc_AbsynUtil_getCrefFromExp(threadData, _exp, 1, 1);
goto tmp2_done;
}
case 1: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,5) == 0) goto tmp2_end;
...
_submods = tmpMeta[1];
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[0] = omc_List_fold(threadData, _submods, boxvar_Mod_getUntypedCrefFromSubMod, tmpMeta[1]);
goto tmp2_done;
}
case 2: {
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
...
tmpMeta[1] = MMC_CAR(tmp3_1);
tmpMeta[2] = MMC_CDR(tmp3_1);
_rest_mods = tmpMeta[2];
tmpMeta[0] = omc_Mod_getUnelabedSubMod2(threadData, _rest_mods, _inIdent);
goto tmp2_done;
}
}
goto tmp2_end;
...
_tailrecursive: OMC_LABEL_UNUSED
tmpMeta[0] = _inMod;
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[0],0,5) == 0) MMC_THROW_INTERNAL();
...
_cr = tmpMeta[0];
_mod = tmpMeta[1];
tmpMeta[0] = stringAppend(omc_ComponentReference_printComponentRefStr(threadData, _cr),_OMC_LIT16);
tmpMeta[1] = stringAppend(tmpMeta[0],omc_Mod_prettyPrintMod(threadData, _mod, _inDepth));
tmp1 = tmpMeta[1];
goto tmp3_done;
}
case 1: {
...
_subMod = tmpMeta[1];
tmpMeta[0] = stringAppend(omc_ComponentReference_printComponentRefStr(threadData, _cr),_OMC_LIT16);
tmpMeta[1] = stringAppend(tmpMeta[0],omc_Mod_prettyPrintSubmod(threadData, _subMod));
tmp1 = tmpMeta[1];
goto tmp3_done;
}
}
...
_rest = tmpMeta[2];
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
_cref = omc_ComponentReference_joinCrefs(threadData, _inTopCref, omc_ComponentReference_makeCrefIdent(threadData, _id, _OMC_LIT17, tmpMeta[1]));
...
tmp5 = (modelica_boolean)listEmpty(_fullMods1);
if(tmp5)
{
tmpMeta[2] = mmc_mk_box3(4, &Mod_FullMod_SUB__MOD__desc, _cref, _subMod);
tmpMeta[1] = mmc_mk_cons(tmpMeta[2], _fullMods1);
tmpMeta[3] = tmpMeta[1];
}
else
{
tmpMeta[3] = _fullMods1;
}
tmpMeta[0] = listAppend(tmpMeta[3], _fullMods2);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[0] = MMC_REFSTRUCTLIT(mmc_nil);
_cref = omc_ComponentReference_makeCrefIdent(threadData, _id, _OMC_LIT17, tmpMeta[0]);
_cref = omc_ComponentReference_joinCrefs(threadData, _inTopCref, _cref);
tmpMeta[0] = mmc_mk_box3(3, &Mod_FullMod_MOD__desc, _cref, _inRedeclare);
_outFullMod = tmpMeta[0];
_return: OMC_LABEL_UNUSED
return _outFullMod;
}
PROTECTED_FUNCTION_STATIC modelica_metatype omc_Mod_getFullModsFromMod(threadData_t *threadData, modelica_metatype _inTopCref, modelica_metatype _inMod)
...
case 3: {
tmpMeta[0] = omc_Mod_getFullModsFromSubMods(threadData, _inTopCref, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 4))));
goto tmp2_done;
}
case 4: {
tmpMeta[1] = mmc_mk_cons(omc_Mod_getFullModFromModRedeclare(threadData, _inTopCref, _inMod), MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
}
...
tmp6 = ((((modelica_integer) 0) == omc_System_strncmp(threadData, _i, _idx, _len1)) || (((modelica_integer) 0) == omc_System_strncmp(threadData, _idx, _i, _len2)));
...
MMC_SO();
_tailrecursive: OMC_LABEL_UNUSED
tmpMeta[0] = stringAppend(intString(_i),_OMC_LIT18);
_str = tmpMeta[0];
_return: OMC_LABEL_UNUSED
return _str;
}
...
_id = tmpMeta[1];
_mod = tmpMeta[2];
if (!(stringEqual(_id, _oldIdent))) goto tmp2_end;
tmpMeta[1] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _newIdent, _mod);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 1: {
...
tmpMeta[0] = mmc_mk_cons(_OMC_LIT19, mmc_mk_cons(_str, mmc_mk_cons(_OMC_LIT20, mmc_mk_cons(_str2, mmc_mk_cons(_OMC_LIT21, mmc_mk_cons(_e_val_str, MMC_REFSTRUCTLIT(mmc_nil)))))));
...
_str = omc_ExpressionDump_printExpStr(threadData, _e);
_str2 = omc_Types_printPropStr(threadData, _prop);
tmpMeta[0] = mmc_mk_cons(_OMC_LIT19, mmc_mk_cons(_str, mmc_mk_cons(_OMC_LIT22, mmc_mk_cons(_str2, MMC_REFSTRUCTLIT(mmc_nil)))));
tmp1 = stringAppendList(tmpMeta[0]);
goto tmp3_done;
}
case 3: {
...
tmpMeta[0] = stringAppend(_OMC_LIT23,_str);
tmp1 = tmpMeta[0];
goto tmp3_done;
}
case 4: {
...
tmpMeta[0] = stringAppend(_n,_OMC_LIT20);
tmpMeta[1] = stringAppend(tmpMeta[0],_mod_str);
tmp1 = tmpMeta[1];
goto tmp3_done;
}
}
...
tmpMeta[1] = mmc_mk_cons(_s1, _res);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
}
...
tmpMeta[0] = stringAppend(_id,_OMC_LIT25);
tmpMeta[1] = stringAppend(tmpMeta[0],(omc_SCodeUtil_eachBool(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_m), 3))))?_OMC_LIT3:_OMC_LIT0));
tmpMeta[2] = stringAppend(tmpMeta[1],(omc_SCodeUtil_finalBool(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_m), 2))))?_OMC_LIT2:_OMC_LIT0));
tmpMeta[3] = stringAppend(tmpMeta[2],_s1);
tmpMeta[4] = stringAppend(tmpMeta[3],_OMC_LIT6);
tmp1 = tmpMeta[4];
goto tmp3_done;
}
case 1: {
...
tmpMeta[0] = stringAppend(_id,_s2);
tmp1 = tmpMeta[0];
goto tmp3_done;
}
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[3],1,4) == 0) goto tmp3_end;
_id = tmpMeta[2];
tmpMeta[0] = stringAppend(_OMC_LIT26,_id);
...
tmpMeta[0] = stringAppend(_OMC_LIT4,_id);
tmpMeta[1] = stringAppend(tmpMeta[0],_s2);
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT27);
tmpMeta[3] = stringAppend(tmpMeta[2],_id);
tmp1 = tmpMeta[3];
goto tmp3_done;
}
}
...
_eq = tmpMeta[2];
tmp4 += 2;
tmpMeta[0] = stringAppend((omc_SCodeUtil_finalBool(threadData, _fp)?_OMC_LIT2:_OMC_LIT0),_OMC_LIT1);
tmpMeta[1] = stringAppend(tmpMeta[0],omc_Types_unparseEqMod(threadData, _eq));
tmp1 = tmpMeta[1];
goto tmp3_done;
}
case 2: {
...
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 2));
tmpMeta[1] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 3));
_finalPrefix = tmpMeta[0];
_eachPrefix = tmpMeta[1];
tmp4 += 1;
tmpMeta[0] = stringAppend(omc_SCodeDump_finalStr(threadData, _finalPrefix),omc_SCodeDump_eachStr(threadData, _eachPrefix));
_prefix = tmpMeta[0];
_str = omc_SCodeDump_unparseElementStr(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 4))), _OMC_LIT7);
tmpMeta[0] = mmc_mk_cons(_OMC_LIT4, mmc_mk_cons(_prefix, mmc_mk_cons(_str, mmc_mk_cons(_OMC_LIT6, MMC_REFSTRUCTLIT(mmc_nil)))));
tmp1 = stringAppendList(tmpMeta[0]);
goto tmp3_done;
}
case 2: {
...
tmp6 = (modelica_boolean)(!listEmpty(_subs));
if(tmp6)
{
tmpMeta[0] = stringAppend(_OMC_LIT30,_s1_1);
...
tmpMeta[0] = mmc_mk_cons(_prefix, mmc_mk_cons(_s1_1, mmc_mk_cons(_s2, MMC_REFSTRUCTLIT(mmc_nil))));
tmp1 = stringAppendList(tmpMeta[0]);
goto tmp3_done;
}
case 3: {
...
tmp6 = omc_Mod_valEqual(threadData, _v1, _v2, _equal);
if (1 != tmp6) goto goto_2;
tmp1 = 1;
goto tmp3_done;
}
...
_aexp2 = tmpMeta[3];
tmp4 += 2;
tmp7 = omc_AbsynUtil_expEqual(threadData, _aexp1, _aexp2);
...
_aexp2 = tmpMeta[3];
tmp4 += 1;
tmp8 = omc_AbsynUtil_expEqual(threadData, _aexp1, _aexp2);
...
_aexp1 = tmpMeta[1];
_aexp2 = tmpMeta[3];
tmp9 = omc_AbsynUtil_expEqual(threadData, _aexp1, _aexp2);
...
if (1 != tmp6) goto goto_2;
tmp7 = omc_Mod_modEqual(threadData, _mod1, _mod2);
if (1 != tmp7) goto goto_2;
tmp8 = omc_Mod_subModsEqual(threadData, _subModLst1, _subModLst2);
if (1 != tmp8) goto goto_2;
tmp1 = 1;
goto tmp3_done;
}
...
tmp7 = omc_Mod_modEqual(threadData, _mod1, _mod2);
if (1 != tmp7) goto goto_2;
tmp8 = omc_Mod_subModsEqual(threadData, _rest1, _rest2);
if (1 != tmp8) goto goto_2;
tmp1 = 1;
goto tmp3_done;
}
...
tmp4 += 3;
tmp6 = omc_Mod_eqModEqual(threadData, _eqMod1, _eqMod2);
if (1 != tmp6) goto goto_2;
tmp1 = 1;
goto tmp3_done;
}
...
_f1 = tmpMeta[0];
_f2 = tmpMeta[2];
tmp6 = omc_SCodeUtil_finalEqual(threadData, _f1, _f2);
if (1 != tmp6) goto goto_2;
tmp1 = 1;
goto tmp3_done;
}
...
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_2), 5));
_eqmod1 = tmpMeta[0];
_eqmod2 = tmpMeta[3];
tmp7 = omc_Mod_eqModSubsetOrEqual(threadData, _eqmod1, _eqmod2);
if (1 != tmp7) goto goto_2;
tmp1 = 1;
goto tmp3_done;
}
...
_eqmod2 = tmpMeta[7];
tmp4 += 2;
tmp8 = omc_SCodeUtil_finalEqual(threadData, _f1, _f2);
if (1 != tmp8) goto goto_2;
tmp9 = omc_SCodeUtil_eachEqual(threadData, _each1, _each2);
if (1 != tmp9) goto goto_2;
tmp10 = omc_Mod_subModsEqual(threadData, _submods1, _submods2);
if (1 != tmp10) goto goto_2;
tmp11 = omc_Mod_eqModSubsetOrEqual(threadData, _eqmod1, _eqmod2);
...
_each2 = tmpMeta[3];
tmp4 += 1;
tmp12 = omc_SCodeUtil_finalEqual(threadData, _f1, _f2);
if (1 != tmp12) goto goto_2;
tmp13 = omc_SCodeUtil_eachEqual(threadData, _each1, _each2);
if (1 != tmp13) goto goto_2;
tmp14 = omc_SCodeUtil_elementEqual(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod1), 4))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod2), 4))));
...
case 3: {
tmpMeta[0] = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 5)));
goto tmp2_done;
}
}
goto tmp2_end;
...
for (tmpMeta[1] = _inSubMods1; !listEmpty(tmpMeta[1]); tmpMeta[1]=MMC_CDR(tmpMeta[1]))
{
_sm1 = MMC_CAR(tmpMeta[1]);
...
tmpMeta[2] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _name, _m1);
_sm1 = tmpMeta[2];
}
tmpMeta[2] = mmc_mk_cons(_sm1, _outSubMods);
_outSubMods = tmpMeta[2];
}
}
...
tmpMeta[1] = mmc_mk_box2(3, &Mod_ModScope_COMPONENT__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el1), 2))));
_dmod1 = omc_Mod_elabUntypedMod(threadData, _smod1, tmpMeta[1]);
...
tmpMeta[1] = mmc_mk_box2(3, &Mod_ModScope_COMPONENT__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el2), 2))));
_dmod2 = omc_Mod_elabUntypedMod(threadData, _smod2, tmpMeta[1]);
...
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_el1), 10*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[6] = omc_Mod_unelabMod(threadData, _dmod);
_el1 = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(10));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_el1), 10*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[3] = omc_SCodeUtil_propagatePrefixes(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el2), 3))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el1), 3))));
_el1 = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(10));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_el1), 10*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = omc_SCodeUtil_propagateAttributes(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el2), 4))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el1), 4))), 0);
_el1 = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(6));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 6*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = _el1;
_outMod = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(6));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 6*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = _emod;
_outMod = tmpMeta[1];
tmpMeta[0] = _outMod;
goto tmp2_done;
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmp3_2,1,4) == 0) goto tmp2_end;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp3_2), 4));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[3],2,8) == 0) goto tmp2_end;
tmpMeta[4] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp3_2), 5));
_el1 = tmpMeta[1];
_emod1 = tmpMeta[2];
_el2 = tmpMeta[3];
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(10));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_el1), 10*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[3] = omc_SCodeUtil_propagatePrefixes(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el2), 3))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_el2), 3))));
_el1 = tmpMeta[1];
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(10));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_el1), 10*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[6] = _res;
_el1 = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(10));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_el1), 10*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[9] = _info;
_el1 = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(6));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 6*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = _el1;
...
tmpMeta[1] = mmc_mk_box5(4, &DAE_Mod_REDECL__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inModInner), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inModInner), 3))), _el2, _emod);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 6: {
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[9],10,4) == 0) goto tmp2_end;
_submods = tmpMeta[1];
_eqmod = tmpMeta[7];
_val = tmpMeta[9];
...
for (tmpMeta[1] = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_val), 3))); !listEmpty(tmpMeta[1]); tmpMeta[1]=MMC_CDR(tmpMeta[1]))
{
...
case 0: {
tmpMeta[4] = omc_List_deleteMemberOnTrue(threadData, _name, _submods, boxvar_Mod_isSubModNamed, &tmpMeta[2]);
_submods = tmpMeta[4];
if (optionNone(tmpMeta[2])) goto goto_5;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[2]), 1));
_submod = tmpMeta[3];
...
tmpMeta[2] = mmc_mk_cons(_v, _vals);
_vals = tmpMeta[2];
}
}
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(6));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_val), 6*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[3] = listReverse(_vals);
_val = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_eqmod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[3] = mmc_mk_some(_val);
_eqmod = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = mmc_mk_some(_eqmod);
_outMod = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = omc_Mod_stripSubModBindings(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inModInner), 4))));
_outMod = tmpMeta[1];
tmpMeta[0] = _outMod;
goto tmp2_done;
}
...
tmpMeta[4] = omc_List_deleteMemberOnTrue(threadData, _name, _submods, boxvar_Mod_isSubModNamed, &tmpMeta[2]);
_submods = tmpMeta[4];
if (optionNone(tmpMeta[2])) goto goto_9;
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[2]), 1));
_submod = tmpMeta[3];
_v = omc_Mod_subModValue(threadData, _submod);
goto tmp10_done;
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = omc_Mod_stripSubModBindings(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outMod), 4))));
_outMod = tmpMeta[1];
tmpMeta[0] = _outMod;
goto tmp2_done;
}
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[4] = omc_Mod_mergeSubs(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outMod), 4))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inModInner), 4))), _inCheckFinal);
_outMod = tmpMeta[1];
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(7));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 7*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = omc_Mod_mergeEq(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outMod), 5))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inModInner), 5))));
_outMod = tmpMeta[1];
tmpMeta[0] = _outMod;
goto tmp2_done;
}
...
tmpMeta[0] = mmc_mk_cons(_inElementName, mmc_mk_cons(_mod_str, MMC_REFSTRUCTLIT(mmc_nil)));
tmpMeta[1] = mmc_mk_cons(omc_Mod_getModInfo(threadData, _inModInner), mmc_mk_cons(omc_Mod_getModInfo(threadData, _inModOuter), MMC_REFSTRUCTLIT(mmc_nil)));
omc_Error_addMultiSourceMessage(threadData, _OMC_LIT37, tmpMeta[0], tmpMeta[1]);
MMC_THROW_INTERNAL();
}
else
{
...
for (tmpMeta[1] = _inIndices; !listEmpty(tmpMeta[1]); tmpMeta[1]=MMC_CDR(tmpMeta[1]))
{
_i = MMC_CAR(tmpMeta[1]);
if((!omc_Types_isArray(threadData, _ty)))
{
tmpMeta[2] = mmc_mk_cons(omc_ExpressionDump_printExpStr(threadData, _exp), MMC_REFSTRUCTLIT(mmc_nil));
omc_Error_addSourceMessage(threadData, _OMC_LIT41, tmpMeta[2], _inInfo);
goto _return;
}
_ty = omc_Types_unliftArray(threadData, _ty);
tmpMeta[2] = mmc_mk_cons(_i, MMC_REFSTRUCTLIT(mmc_nil));
_exp = omc_ExpressionSimplify_simplify1(threadData, omc_Expression_makeASUB(threadData, _exp, tmpMeta[2]), NULL);
}
}
if(isSome(_oval))
{
...
tmpMeta[2] = mmc_mk_box6(3, &DAE_EqMod_TYPED__desc, _exp, _oval, tmpMeta[1], _aexp, _info);
tmpMeta[0] = mmc_mk_some(tmpMeta[2]);
goto tmp2_done;
}
case 2: {
modelica_boolean tmp5;
tmp5 = omc_Flags_isSet(threadData, _OMC_LIT45);
if (1 != tmp5) goto goto_1;
tmpMeta[1] = stringAppend(_OMC_LIT46,omc_Types_unparseEqMod(threadData, _eq));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT47);
tmpMeta[3] = stringAppend(tmpMeta[2],omc_ExpressionDump_printExpListStr(threadData, _inIndices));
...
tmpMeta[1] = mmc_mk_cons(_inIndex, MMC_REFSTRUCTLIT(mmc_nil));
_eq = omc_Mod_indexEqmod(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 5))), tmpMeta[1], (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 6))));
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 3))), _subs, _eq, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 6))));
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 3: {
...
{
tmpMeta[3] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _name, _mod);
tmpMeta[2] = mmc_mk_cons(tmpMeta[3], _outSubMods);
_outSubMods = tmpMeta[2];
}
}
...
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 3))), _subs, mmc_mk_none(), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 6))));
_mod2 = tmpMeta[1];
_mod2 = omc_Mod_merge(threadData, _mod2, _mod1, _OMC_LIT0, 1);
tmpMeta[1] = mmc_mk_cons(_inIndex, MMC_REFSTRUCTLIT(mmc_nil));
_eq = omc_Mod_indexEqmod(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 5))), tmpMeta[1], (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 6))));
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[2] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _OMC_LIT48, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 3))), tmpMeta[1], _eq, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inMod), 6))));
_mod1 = tmpMeta[2];
tmpMeta[0] = omc_Mod_merge(threadData, _mod2, _mod1, _OMC_LIT0, 1);
goto tmp2_done;
}
case 3: {
modelica_boolean tmp5;
...
tmpMeta[1] = stringAppend(_OMC_LIT5,omc_ExpressionDump_printExpStr(threadData, _inIndex));
...
case 1: {
tmpMeta[1] = omc_Mod_lookupNamedSubMod(threadData, _inSubModLst, _inIdent);
...
tmpMeta[0] = stringAppend((_addParan?_OMC_LIT4:_OMC_LIT0),_s);
tmpMeta[1] = stringAppend(tmpMeta[0],(_addParan?_OMC_LIT6:_OMC_LIT0));
_s = tmpMeta[1];
_return: OMC_LABEL_UNUSED
return _s;
}
...
tmpMeta[1] = MMC_TAGPTR(mmc_alloc_words(6));
memcpy(MMC_UNTAGPTR(tmpMeta[1]), MMC_UNTAGPTR(_outMod), 6*sizeof(modelica_metatype));
((modelica_metatype*)MMC_UNTAGPTR(tmpMeta[1]))[5] = omc_Mod_merge(threadData, _inBinding, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outMod), 5))), _OMC_LIT0, 1);
_outMod = tmpMeta[1];
tmpMeta[0] = _outMod;
goto tmp2_done;
}
...
{
modelica_metatype _s;
for (tmpMeta[0] = _inSubMods1; !listEmpty(tmpMeta[0]); tmpMeta[0]=MMC_CDR(tmpMeta[0]))
{
...
tmpMeta[2] = mmc_mk_cons(_info1, mmc_mk_cons(_info2, MMC_REFSTRUCTLIT(mmc_nil)));
omc_Error_addMultiSourceMessage(threadData, _OMC_LIT53, tmpMeta[1], tmpMeta[2]);
}
}
}
...
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,1,4) == 0) goto tmp2_end;
if (mmc__uniontype__metarecord__typedef__equal(tmp3_2,0,5) == 0) goto tmp2_end;
tmpMeta[0] = omc_Mod_mergeRedeclareWithBinding(threadData, _mod1, _mod2);
goto tmp2_done;
}
case 3: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,5) == 0) goto tmp2_end;
if (mmc__uniontype__metarecord__typedef__equal(tmp3_2,1,4) == 0) goto tmp2_end;
tmpMeta[0] = omc_Mod_mergeRedeclareWithBinding(threadData, _mod2, _mod1);
goto tmp2_done;
}
case 4: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_2,0,5) == 0) goto tmp2_end;
...
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod2), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod2), 3))), _submods, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod2), 5))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod2), 6))));
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 5: {
...
if (!optionNone(tmpMeta[1])) goto tmp2_end;
_submods = omc_Mod_checkDuplicateModifications2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod1), 4))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod2), 4))), _n);
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod1), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod1), 3))), _submods, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod1), 5))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod1), 6))));
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 6: {
if (mmc__uniontype__metarecord__typedef__equal(tmp3_1,0,5) == 0) goto tmp2_end;
if (mmc__uniontype__metarecord__typedef__equal(tmp3_2,0,5) == 0) goto tmp2_end;
tmpMeta[1] = mmc_mk_cons(_n, mmc_mk_cons(_OMC_LIT0, MMC_REFSTRUCTLIT(mmc_nil)));
tmpMeta[2] = mmc_mk_cons(omc_Mod_getModInfo(threadData, _mod1), mmc_mk_cons(omc_Mod_getModInfo(threadData, _mod2), MMC_REFSTRUCTLIT(mmc_nil)));
omc_Error_addMultiSourceMessage(threadData, _OMC_LIT56, tmpMeta[1], tmpMeta[2]);
tmpMeta[0] = _mod2;
goto tmp2_done;
}
}
...
tmpMeta[3] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[2]), 1));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[3],10,4) == 0) goto goto_1;
tmpMeta[4] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[3]), 3));
...
for (tmpMeta[0] = _names; !listEmpty(tmpMeta[0]); tmpMeta[0]=MMC_CDR(tmpMeta[0]))
{
_name = MMC_CAR(tmpMeta[0]);
tmpMeta[1] = _values;
if (listEmpty(tmpMeta[1])) goto goto_1;
tmpMeta[2] = MMC_CAR(tmpMeta[1]);
tmpMeta[3] = MMC_CDR(tmpMeta[1]);
...
tmpMeta[1] = mmc_mk_box3(3, &DAE_Properties_PROP__desc, _ty, _OMC_LIT57);
tmpMeta[2] = mmc_mk_box6(3, &DAE_EqMod_TYPED__desc, _e, mmc_mk_some(_v), tmpMeta[1], _ae, _info);
_eq_mod = tmpMeta[2];
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[2] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _inFinal, _inEach, tmpMeta[1], mmc_mk_some(_eq_mod), _inInfo);
_outMod = tmpMeta[2];
break;
}
}
...
case 2: {
tmpMeta[0] = omc_Mod_checkDuplicateModifications(threadData, _subMod, _eqMod, _n);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[0] = omc_Mod_selectEqMod(threadData, _mod1, _mod2, _n);
goto tmp2_done;
}
}
goto tmp2_end;
...
tmpMeta[2] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _n, _m);
tmpMeta[1] = mmc_mk_cons(tmpMeta[2], MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[3] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _e, tmpMeta[1], mmc_mk_none(), _info);
_m = tmpMeta[3];
_m = omc_Mod_merge(threadData, _inMod, _m, _OMC_LIT0, 1);
tmpMeta[0] = omc_Mod_mergeSubMods(threadData, _inMods, _m, _f, _e, _rest);
goto tmp2_done;
}
case 2: {
if (listEmpty(tmp3_1)) goto tmp2_end;
...
tmpMeta[2] = MMC_CDR(tmp3_1);
_rest = tmpMeta[2];
tmpMeta[0] = omc_Mod_mergeSubMods(threadData, _inMods, _inMod, _f, _e, _rest);
goto tmp2_done;
}
}
goto tmp2_end;
...
_e = tmpMeta[2];
_sl = tmpMeta[3];
tmpMeta[0] = omc_Mod_mergeSubMods(threadData, _inMods, _inMod, _f, _e, _sl);
goto tmp2_done;
}
case 1: {
tmpMeta[0] = _inMod;
...
tmpMeta[0] = omc_Mod_mergeModifiers(threadData, _inMods, _m, _inSMod);
goto tmp2_done;
}
case 1: {
tmpMeta[0] = omc_Mod_mergeModifiers(threadData, _inMods, _OMC_LIT9, _inSMod);
goto tmp2_done;
}
}
goto tmp2_end;
...
_mod1 = omc_Mod_lookupCompModification2(threadData, _subs, _n);
_mod2 = omc_Mod_lookupComplexCompModification(threadData, _eqMod, _n, _f, _e, _info);
tmpMeta[0] = omc_Mod_checkDuplicateModifications(threadData, _mod1, _mod2, _n);
goto tmp2_done;
}
case 1: {
tmpMeta[0] = _OMC_LIT9;
...
_m = tmp3_1;
tmp3 += 2;
tmpMeta[0] = omc_Mod_lookupCompModification(threadData, _m, _n);
goto tmp2_done;
}
case 1: {
...
_m = tmp3_1;
tmp3 += 1;
tmpMeta[0] = omc_Mod_lookupModificationP(threadData, _m, _p);
goto tmp2_done;
}
case 2: {
...
tmpMeta[0] = omc_Mod_lookupModificationP(threadData, _mod, _p);
goto tmp2_done;
}
case 3: {
...
tmpMeta[2] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _i, _m_1);
tmpMeta[1] = mmc_mk_cons(tmpMeta[2], MMC_REFSTRUCTLIT(mmc_nil));
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
...
_i = tmpMeta[1];
_smod = tmpMeta[2];
tmpMeta[0] = mmc_mk_box2(3, &Mod_ModScope_COMPONENT__desc, _i);
_outCache = omc_Mod_elabMod(threadData, _inCache, _inEnv, _inIH, _inPrefix, _smod, _inBoolean, tmpMeta[0], _info ,&_dmod);
tmpMeta[0] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _i, _dmod);
...
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 2));
_name = tmpMeta[0];
tmpMeta[0] = stringAppend(omc_System_gettext(threadData, _OMC_LIT60),_name);
tmp1 = tmpMeta[0];
goto tmp3_done;
}
case 4: {
...
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 2));
_path = tmpMeta[0];
tmpMeta[0] = stringAppend(omc_System_gettext(threadData, _OMC_LIT61),omc_AbsynUtil_pathString(threadData, _path, _OMC_LIT18, 1, 0));
tmp1 = tmpMeta[0];
goto tmp3_done;
}
case 5: {
...
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 2));
_path = tmpMeta[0];
tmpMeta[0] = stringAppend(omc_System_gettext(threadData, _OMC_LIT62),omc_AbsynUtil_pathString(threadData, _path, _OMC_LIT18, 1, 0));
tmp1 = tmpMeta[0];
goto tmp3_done;
}
}
...
_submod = omc_Mod_mergeSubModsInSameScope(threadData, _inExistingMod, _inNewMod, tmpMeta[2], _inModScope);
tmpMeta[0+0] = _submod;
tmp1_c1 = 1;
goto tmp3_done;
}
...
tmpMeta[0] = MMC_REFSTRUCTLIT(mmc_nil);
tmpMeta[1] = MMC_REFSTRUCTLIT(mmc_nil);
_submods = omc_List_fold2(threadData, _inSubMods, boxvar_Mod_compactSubMod, _inModScope, tmpMeta[0], tmpMeta[1]);
...
tmpMeta[0] = MMC_REFSTRUCTLIT(mmc_nil);
_outCache = omc_Mod_elabSubmods2(threadData, _inCache, _inEnv, _inIH, _inPrefix, _submods, _inBoolean, _info, tmpMeta[0] ,&_outTypesSubModLst);
_return: OMC_LABEL_UNUSED
...
tmpMeta[1] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_none(), _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 2: {
...
tmp3 += 1;
_subs_1 = omc_Mod_elabUntypedSubmods(threadData, _subs, _inModScope);
tmpMeta[1] = mmc_mk_box2(4, &DAE_EqMod_UNTYPED__desc, _e);
tmpMeta[2] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_some(tmpMeta[1]), _info);
tmpMeta[0] = tmpMeta[2];
goto tmp2_done;
}
case 3: {
...
_each_ = tmpMeta[2];
_elem = tmpMeta[3];
tmpMeta[1] = mmc_mk_box5(4, &DAE_Mod_REDECL__desc, _finalPrefix, _each_, _elem, _OMC_LIT9);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 4: {
...
tmpMeta[3] = mmc_mk_box3(3, &DAE_SubMod_NAMEMOD__desc, _i, _m_1);
tmpMeta[2] = tmpMeta[3];
goto tmp3_done;
}
}
...
tmpMeta[4] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_5), 4));
...
tmpMeta[7] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[6]), 2));
tmpMeta[8] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_5), 6));
_f = tmpMeta[2];
_each_ = tmpMeta[3];
_subs = tmpMeta[4];
_e = tmpMeta[7];
...
tmpMeta[2] = mmc_mk_box6(3, &DAE_EqMod_TYPED__desc, _e_2, mmc_mk_none(), _prop, _e, _info);
tmpMeta[3] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _each_, _subs_1, mmc_mk_some(tmpMeta[2]), _info);
omc_Debug_traceln(threadData, omc_Mod_printModStr(threadData, tmpMeta[3]));
}
tmpMeta[2] = mmc_mk_box6(3, &DAE_EqMod_TYPED__desc, _e_2, _e_val, _prop, _e, _info);
tmpMeta[3] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _each_, _subs_1, mmc_mk_some(tmpMeta[2]), _info);
tmpMeta[0+0] = _cache;
...
tmpMeta[11] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_5), 6));
_f = tmpMeta[2];
_each_ = tmpMeta[3];
_subs = tmpMeta[4];
_e_1 = tmpMeta[7];
...
tmp4 += 1;
_cache = omc_Mod_updateSubmods(threadData, _cache, _env, _ih, _pre, _subs, _impl, _info ,&_subs_1);
tmpMeta[2] = mmc_mk_box6(3, &DAE_EqMod_TYPED__desc, _e_1, _e_val, _p, _e, _info);
tmpMeta[3] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _each_, _subs_1, mmc_mk_some(tmpMeta[2]), _info);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = tmpMeta[3];
goto tmp3_done;
...
_impl = tmp4_6;
_cache = omc_Mod_updateSubmods(threadData, _cache, _env, _ih, _pre, _subs, _impl, _info ,&_subs_1);
tmpMeta[2] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _f, _each_, _subs_1, mmc_mk_none(), _info);
tmpMeta[0+0] = _cache;
...
modelica_boolean tmp6;
_m = tmp4_5;
tmp6 = omc_Flags_isSet(threadData, _OMC_LIT45);
if (1 != tmp6) goto goto_2;
_str = omc_Mod_printModStr(threadData, _m);
tmpMeta[2] = stringAppend(_OMC_LIT70,_str);
omc_Debug_traceln(threadData, tmpMeta[2]);
goto goto_2;
goto tmp3_done;
}
...
if (tmp2 == 0) {
tmpMeta[2] = mmc_mk_box2(3, &Absyn_Exp_INTEGER__desc, _i);
...
_outSCodeSubscriptLst = tmpMeta[0];
_return: OMC_LABEL_UNUSED
...
tmpMeta[3] = mmc_mk_box3(3, &SCode_SubMod_NAMEMOD__desc, _i, _m_1);
tmpMeta[2] = tmpMeta[3];
goto tmp3_done;
}
}
...
tmpMeta[1] = mmc_mk_box6(3, &SCode_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_none(), _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 2: {
...
tmp3 += 3;
_subs_1 = omc_Mod_unelabSubmods(threadData, _subs);
tmpMeta[1] = mmc_mk_box6(3, &SCode_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_some(_e), _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 3: {
...
tmpMeta[1] = mmc_mk_box6(3, &SCode_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_some(_e_1), _info);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 4: {
...
_each_ = tmpMeta[2];
_elem = tmpMeta[3];
tmpMeta[1] = mmc_mk_box4(4, &SCode_Mod_REDECL__desc, _finalPrefix, _each_, _elem);
tmpMeta[0] = tmpMeta[1];
goto tmp2_done;
}
case 6: {
_mod = tmp3_1;
tmpMeta[1] = stringAppend(_OMC_LIT72,omc_Mod_printModStr(threadData, _mod));
tmpMeta[2] = stringAppend(tmpMeta[1],_OMC_LIT14);
_str = tmpMeta[2];
tmpMeta[1] = mmc_mk_cons(_str, MMC_REFSTRUCTLIT(mmc_nil));
omc_Error_addMessage(threadData, _OMC_LIT75, tmpMeta[1]);
goto goto_1;
goto tmp2_done;
}
}
...
tmpMeta[2] = mmc_mk_box3(3, &Absyn_TypeSpec_TPATH__desc, _p1, mmc_mk_none());
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = tmpMeta[2];
goto tmp3_done;
}
...
_cref = tmpMeta[3];
tmpMeta[2] = MMC_REFSTRUCTLIT(mmc_nil);
_cache = omc_InstUtil_elabArraydim(threadData, _cache, _env, _cref, _p, _dims, mmc_mk_none(), _impl, 1, 0, _pre, _info, tmpMeta[2] ,&_edims);
...
_cache = omc_Inst_makeFullyQualified(threadData, _cache, _env, _p ,&_p1);
tmpMeta[2] = mmc_mk_box3(3, &Absyn_TypeSpec_TPATH__desc, _p1, mmc_mk_some(_dims));
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = tmpMeta[2];
goto tmp3_done;
}
...
tmpMeta[11] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 6));
tmpMeta[12] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 7));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[12],2,3) == 0) goto tmp3_end;
...
tmpMeta[16] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 8));
tmpMeta[17] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 9));
_cn = tmpMeta[2];
_prefixes = tmpMeta[3];
_vis = tmpMeta[4];
_redecl = tmpMeta[5];
...
tmpMeta[2] = mmc_mk_box6(3, &SCode_Prefixes_PREFIXES__desc, _vis, _redecl, _fi, _io, _repl);
tmpMeta[3] = mmc_mk_box4(5, &SCode_ClassDef_DERIVED__desc, _tp1, _mod, _attr1);
tmpMeta[4] = mmc_mk_box9(5, &SCode_Element_CLASS__desc, _cn, tmpMeta[2], _enc, _p, _restr, tmpMeta[3], _cmt, _i);
...
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[2],10,0) == 0) goto tmp3_end;
tmpMeta[0+0] = _inElt;
tmpMeta[0+1] = _OMC_LIT9;
goto tmp3_done;
}
...
tmpMeta[14] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 9));
_compname = tmpMeta[2];
_prefixes = tmpMeta[3];
_vis = tmpMeta[4];
_redecl = tmpMeta[5];
...
_mod = omc_Mod_unelabMod(threadData, _emod);
tmpMeta[2] = mmc_mk_box6(3, &SCode_Prefixes_PREFIXES__desc, _vis, _redecl, _fi, _io, _repl);
tmpMeta[3] = mmc_mk_box9(6, &SCode_Element_COMPONENT__desc, _compname, tmpMeta[2], _attr, _tp1, _mod, _cmt, _cond, _i);
...
case 4: {
_element = tmp4_1;
tmpMeta[2] = stringAppend(_OMC_LIT76,omc_SCodeDump_unparseElementStr(threadData, _element, _OMC_LIT7));
...
_ident = tmpMeta[2];
_subs = tmpMeta[1];
tmp5 = omc_ClassInf_isBasicTypeComponentName(threadData, _ident);
if (1 != tmp5) goto goto_1;
_inSubs = _subs;
goto _tailrecursive;
;
...
tmp9_1 = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod), 5)));
{
...
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp9_1), 1));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[0],0,5) == 0) goto tmp8_end;
tmpMeta[1] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[0]), 2));
_e = tmpMeta[1];
omc_Expression_traverseExpBottomUp(threadData, _e, boxvar_Expression_isInvariantExpNoTraverse, mmc_mk_boolean(1), &tmpMeta[0]);
tmp11 = mmc_unbox_integer(tmpMeta[0]);
_b = tmp11;
tmp6 = _b;
goto tmp8_done;
}
...
if (optionNone(tmp9_1)) goto tmp8_end;
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp9_1), 1));
if (mmc__uniontype__metarecord__typedef__equal(tmpMeta[0],1,1) == 0) goto tmp8_end;
tmpMeta[1] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[0]), 2));
_exp = tmpMeta[1];
omc_AbsynUtil_traverseExp(threadData, _exp, boxvar_AbsynUtil_isInvariantExpNoTraverse, mmc_mk_boolean(1), &tmpMeta[0]);
...
for (tmpMeta[0] = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_mod), 4))); !listEmpty(tmpMeta[0]); tmpMeta[0]=MMC_CDR(tmpMeta[0]))
{
_sm = MMC_CAR(tmpMeta[0]);
...
tmpMeta[0] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp9_1), 1));
_e = tmpMeta[0];
omc_AbsynUtil_traverseExp(threadData, _e, boxvar_AbsynUtil_isInvariantExpNoTraverse, mmc_mk_boolean(1), &tmpMeta[0]);
tmp11 = mmc_unbox_integer(tmpMeta[0]);
_b = tmp11;
tmp6 = _b;
goto tmp8_done;
...
tmpMeta[2] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_none(), _info);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = tmpMeta[2];
goto tmp3_done;
}
...
if (optionNone(tmpMeta[5])) goto tmp3_end;
tmpMeta[6] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta[5]), 1));
tmpMeta[7] = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_5), 6));
_finalPrefix = tmpMeta[2];
_each_ = tmpMeta[3];
_subs = tmpMeta[4];
_e = tmpMeta[6];
...
_cache = omc_PrefixUtil_prefixExp(threadData, _cache, _env, _ih, _e_1, _pre ,&_e_2);
tmpMeta[2] = mmc_mk_box6(3, &DAE_EqMod_TYPED__desc, _e_2, _e_val, _prop, _e, _info);
tmpMeta[3] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_some(tmpMeta[2]), _info);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = tmpMeta[3];
goto tmp3_done;
}
...
_impl = tmp4_6;
_cache = omc_Mod_elabSubmods(threadData, _cache, _env, _ih, _pre, _subs, _impl, _inModScope, _info ,&_subs_1);
tmpMeta[2] = mmc_mk_box2(4, &DAE_EqMod_UNTYPED__desc, _e);
tmpMeta[3] = mmc_mk_box6(3, &DAE_Mod_MOD__desc, _finalPrefix, _each_, _subs_1, mmc_mk_some(tmpMeta[2]), _info);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = tmpMeta[3];
goto tmp3_done;
...
tmpMeta[2] = mmc_mk_box5(4, &DAE_Mod_REDECL__desc, _finalPrefix, _each_, _elem, _dm);
tmpMeta[0+0] = _cache;
tmpMeta[0+1] = tmpMeta[2];
goto tmp3_done;
}
