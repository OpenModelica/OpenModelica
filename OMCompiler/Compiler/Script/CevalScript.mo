...
protected
  ...
  String fileDLL = workDir + fileprefix + Autoconf.dllExt,
         ...
         fileCompileLOG = workDir + fileprefix + ".compile.log";
...
algorithm
  ...
  if System.systemCall(s_call, fileLOG) <> 0 then
    // We failed, print error
    if System.regularFileExists(fileLOG) then
      Error.addMessage(Error.SIMULATOR_BUILD_ERROR, {System.readFile(fileLOG)});
      // on Windows we have .log generated by OMC and .compile.log generated by Compile.bat
      if System.regularFileExists(fileCompileLOG) then
        Error.addMessage(Error.SIMULATOR_BUILD_ERROR, {System.readFile(fileCompileLOG)});
      end if;
    ...
    else // on Windows we have .log generated by OMC and .compile.log generated by Compile.bat
      if System.regularFileExists(fileCompileLOG) then
        Error.addMessage(Error.SIMULATOR_BUILD_ERROR, {System.readFile(fileCompileLOG)});
      end if;
    end if;
