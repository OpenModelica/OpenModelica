...
AlgLoopSolverFactory::AlgLoopSolverFactory(shared_ptr<IGlobalSettings> global_settings, PATH library_path,
    ...
    shared_ptr<INonLinearAlgLoop> algLoop)
{
    try
    {
        ...
        shared_ptr<INonLinearAlgLoopSolver> algsolver =
            createNonLinSolver(nonlinsolver_name, algsolversetting, algLoop);
