...
/* Subroutine */
int dassl::ddaskr_(S_fp res, int* neq, double* t,
...
/* Subroutine */
int dassl::drchek_(int* job, UC_fp rt, int* nrt, int*
...
/* Subroutine */
int dassl::droots_(int* nrt, double* hmin, int* jflag,
...
/* Subroutine */
int dassl::ddasic_(double* x, double* y, double* yprime,
...
L200:
    if (info[11] == 0)
    {
        ddasid_(x, &y[1], &yprime[1], neq, icopt, &id[1], (S_fp)res, (Jd_fp)jac, NULL, h__, tscale, &wt[1], &jskip, par,
                &savr[1], &delta[1], &e[1], &yic[1], &ypic[1], &pwk[1], &wm[1], &iwm[1], &cj, uround, epli, sqrtn,
                rsqrtn, epconi, &ratemx, stptol, jflg, icnflg, &icnstr[1], &iernls);
    }
    else
    {
...
/* Subroutine */
int dassl::dyypnw_(int* neq, double* y, double* yprime,
...
/* Subroutine */
int dassl::ddstp_(double* x, double* y, double* yprime,
...
/* Subroutine */
int dassl::dcnstr_(int* neq, double* y, double* ynew,
...
/* Subroutine */
int dassl::dcnst0_(int* neq, double* y, int* icnstr,
                   int* iret)
{
    /* Initialized data */
...
/* Subroutine */
int dassl::ddawts_(int* neq, int* iwt, double* rtol,
...
/* Subroutine */
int dassl::dinvwt_(int* neq, double* wt, int* ier)
{
    /* System generated locals */
    int i__1;
...
/* Subroutine */
int dassl::ddatrp_(double* x, double* xout, double*
...
/* Subroutine */
int dassl::ddasid_(double* x, double* y, double* yprime,
...
L300:
    ...
    dnsid_(x, &y[1], &yprime[1], neq, icopt, &id[1], (S_fp)res, &wt[1], par, &delta[1], &r__[1], &yic[1], &ypic[1],
           &wm[1], &iwm[
...
/* Subroutine */
int dassl::dnsid_(double* x, double* y, double* yprime,
...
/* Subroutine */
int dassl::dlinsd_(int* neq, double* y, double* t,
...
/* Subroutine */
int dassl::dfnrmd_(int* neq, double* y, double* t,
...
/* Subroutine */
int dassl::dnedd_(double* x, double* y, double* yprime,
...
L300:
    ...
    temp1 = 2. / (*cj / *cjold + 1.);
    dnsd_(x, &y[1], &yprime[1], neq, (S_fp)res, pdum, &wt[1], par, dumsvr, &delta[1], &e[1], &wm[1], &iwm[1], cj, dums,
          dumr,
...
/* Subroutine */
int dassl::dnsd_(double* x, double* y, double* yprime,
...
/* Subroutine */
int dassl::dmatd_(int* neq, double* x, double* y,
...
/* Subroutine */
int dassl::dslvd_(int* neq, double* delta, double* wm, int* iwm)
{
    ...
    case 1: case 2:
        ...
        break;
    case 4: case 5: meband = (iwm[1] << 1) + iwm[2] + 1;
        dgbtrs_(&trans, neq, &iwm[1], &iwm[2], &c__1, &wm[1], &meband, &iwm[lipvt], &delta[1], neq, &info, (int)1);
        break;
    }
...
/* Subroutine */
int dassl::ddasik_(double* x, double* y, double* yprime,
...
/* Subroutine */
int dassl::dnsik_(double* x, double* y, double* yprime,
...
/* Subroutine */
int dassl::dlinsk_(int* neq, double* y, double* t,
...
/* Subroutine */
int dassl::dfnrmk_(int* neq, double* y, double* t,
...
/* Subroutine */
int dassl::dnedk_(double* x, double* y, double* yprime,
...
L300:
    ...
    dnsk_(x, &y[1], &yprime[1], neq, (S_fp)res, (P_fp)psol, &wt[1], par, &savr[1], &delta[1], &e[1], &wm[1], &iwm[1],
          cj, sqrtn,
...
/* Subroutine */
int dassl::dnsk_(double* x, double* y, double* yprime,
...
/* Subroutine */
int dassl::dslvk_(int* neq, double* y, double* tn,
...
/* Subroutine */
int dassl::dspigm_(int* neq, double* tn, double* y,
...
/* Subroutine */
int dassl::datv_(int* neq, double* y, double* tn,
...
/* Subroutine */
int dassl::dorth_(double* vnew, double* v, double* hes,
...
/* Subroutine */
int dassl::dheqr_(double* a, int* lda, int* n,
...
/* Subroutine */
int dassl::dhels_(double* a, int* lda, int* n,
                  double* q, double* b)
{
    /* System generated locals */
    int a_dim1, a_offset, i__1, i__2;
                   ...
                   double* r1, double* r2, int msg_len)
{
    ...
    if (*ni == 2)
    {
        std::cout << "      In above message,  I1 =   " << *i1 << std::endl << "      In above message,  I2 =   " << *i2
            << std::endl;
    }
    if (*nr == 1)
    {
    ...
    if (*nr == 2)
    {
        std::cout << "      In above message,  I1 =   " << *r1 << std::endl << "      In above message,  I2 =   " << *r2
            << std::endl;
    }
...
int dassl::solve(S_fp res, int& _dimSys, double& t, double* y, double* yprime, double& tout, void* par, Ja_fp jac,
                 P_fp psol, UC_fp rt, int& nrt, int* jroot, bool cont = false)
{
    if (!cont)
    {
        info[0] = 0;
        ...
        liw = 40 + _dimSys;
        ddaskr_(res, &_dimSys, &t, y, yprime, &tout, &info[0], &rtol, &atol, &idid, &rwork[0], &lrw, &iwork[0], &liw,
                par, jac, psol, rt, &nrt, jroot);
        return idid;
    }
    else
    {
