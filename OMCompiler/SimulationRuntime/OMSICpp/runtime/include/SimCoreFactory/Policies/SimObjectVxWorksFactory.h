...
extern "C" IAlgLoopSolverFactory* createAlgLoopSolverFactoryFunction(IGlobalSettings* globalSettings, PATH library_path,
...
public:
    ...
    {
        return shared_ptr<IAlgLoopSolverFactory>(createAlgLoopSolverFactoryFunction(
