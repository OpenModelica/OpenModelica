...
const char *FLAG_NAME[FLAG_MAX+1] = {
  ...
  /* FLAG_SR */                           "gS",
  /* FLAG_MR */                        "gM",
  /* FLAG_SR_PAR */                       "embeddedRKLim",
  /* FLAG_MR_PAR */                    "gSMratio",
  /* FLAG_SR_CTRL */             "gSctrl",
  /* FLAG_SR_NLS */                       "gSnls",
  /* FLAG_RT */                           "rt",
  /* FLAG_S */                            "s",
...
const char *FLAG_DESC[FLAG_MAX+1] = {
  ...
  /* FLAG_SR */                           "value specifies the chosen Runge-Kutta scheme (default 0)",
  /* FLAG_MR */                        "value specifies the chosen (multirate) Runge-Kutta scheme (default 0)",
  /* FLAG_SR_PAR */                       "tune embedded method",
  /* FLAG_MR_PAR */                    "define percentage of states for the fast states selection",
  /* FLAG_SR_CTRL */             "gSctrl",
  /* FLAG_SR_NLS */                       "non-linear solver method used by solver genericRK",
...
const char *FLAG_DETAILED_DESC[FLAG_MAX+1] = {
  ...
  /* FLAG_SR_CTRL */
  "  step size controller (IController, PIController, etc.)",
  /* FLAG_SR_NLS */
  "  Non-linear solver method used in implicit runge-kutta methods: Valid values:\n\n"
  "  * newton [default]\n"
  "  * kinsol\n",
  /* FLAG_RT */
...
const flag_repeat_policy FLAG_REPEAT_POLICIES[FLAG_MAX] = {
  ...
  /* FLAG_SR_PAR */                       FLAG_REPEAT_POLICY_FORBID,
...
const char *RK_NLS_METHOD_NAME[RK_NLS_MAX] = {
  /* RK_NLS_UNKNOWN = 0*/ "unknown",
  /* RK_NLS_NEWTON */     "newton",
  /* RK_NLS_KINSOL */     "kinsol"
};

const char *RK_NLS_METHOD_DESC[RK_NLS_MAX] = {
  /* RK_NLS_UNKNOWN = 0*/ "unknown",
...
const char *SOLVER_METHOD_DESC[S_MAX] = {
  ...
  /* S_GSODE */         "gSode",
  /* S_GMODE */         "gMode - generic multirate ODE solver - implicit, explicit, step size control, arbitrary order",
