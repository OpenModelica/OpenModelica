...
const char *FLAG_DESC[FLAG_MAX+1] = {
  ...
  /* FLAG_RK_MR_PAR */                    "define percentage of states for the fast states selection",
  /* FLAG_RK_STEPSIZE_CTRL */             "controlRKStep",
...
const flag_repeat_policy FLAG_REPEAT_POLICIES[FLAG_MAX] = {
  ...
  /* FLAG_RK_MR_PAR */                    FLAG_REPEAT_POLICY_FORBID,
...
const int FLAG_TYPE[FLAG_MAX] = {
  ...
  /* FLAG_RK_MR_PAR */                    FLAG_TYPE_OPTION,
...
const char *SOLVER_METHOD_NAME[S_MAX] = {
  ...
  /* S_GENERIC_RK */    "genericRK",
  /* S_GENERIC_RK_MR */ "genericRKmr",
  /* S_IRKSCO */        "irksco",
  /* S_DASSL */         "dassl",
  /* S_IDA */           "ida",
  /* S_CVODE */         "cvode",
...
const char *SOLVER_METHOD_DESC[S_MAX] = {
  ...
  /* S_GENERIC_RK */    "genericRK - generic RK solver - implicit, explicit, step size control, order variable",
  /* S_GENERIC_RK_MR */ "genericRKmr - multirate solver",
