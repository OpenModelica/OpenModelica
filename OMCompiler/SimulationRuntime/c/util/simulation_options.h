...
extern const char *GB_SINGLERATE_METHOD_NAME[RK_MAX];
extern const char *GB_SINGLERATE_METHOD_DESC[RK_MAX];
...
extern const char *GB_NLS_METHOD_NAME[RK_NLS_MAX];
extern const char *GB_NLS_METHOD_DESC[RK_NLS_MAX];
