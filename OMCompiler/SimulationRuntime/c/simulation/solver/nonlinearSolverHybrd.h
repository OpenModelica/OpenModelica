...
extern
void hybrj_( void(*) (const integer*, const double*, double*, double *, const integer*, integer*, void*),  const integer *n, double *x, double *fvec, double *fjac, const integer *ldfjac,
