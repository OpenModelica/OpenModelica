...
DLLDirection extern int modelTermination;     /* Becomes non-zero when simulation terminates. */
DLLDirection extern int terminationTerminate; /* Becomes non-zero when user terminates simulation. */
DLLDirection extern int terminationAssert;    /* Becomes non-zero when model call assert simulation. */
DLLDirection extern int warningLevelAssert;   /* Becomes non-zero when model call assert with warning level. */
DLLDirection extern FILE_INFO TermInfo;       /* message for termination. */

DLLDirection extern char* TermMsg; /* message for termination. */
