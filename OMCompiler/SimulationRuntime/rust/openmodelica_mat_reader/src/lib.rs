...
//! `SimulationResults` package and the simulation runtimes' `-iif` need: opening
//! an OpenModelica MATLAB v4 result file
//! (`Aclass`/`name`/`description`/`dataInfo`/`data_1`/`data_2`), looking up
...
//! Dymola-produced reference files use).
