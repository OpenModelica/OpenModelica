...
extern jl_function_t *Absyn_ClassDef_CLASS__EXTENDS;
extern jl_function_t *Absyn_ClassDef_CLASS__EXTENDS_type;
static inline jl_value_t* Absyn__CLASS_5fEXTENDS(jl_value_t *baseClassName,jl_value_t *modifications,jl_value_t *comment,jl_value_t *parts,jl_value_t *ann) {
  ...
  return jl_call(Absyn_ClassDef_CLASS__EXTENDS, values, 5);
}
...
static inline jl_value_t* Absyn__LEXER_5fCOMMENT(jl_value_t *comment) {
  return jl_call1(Absyn_ElementItem_LEXER__COMMENT, comment);
}
...
static inline jl_value_t* Absyn__DEFINEUNIT(jl_value_t *name,jl_value_t *args) {
  return jl_call2(Absyn_Element_DEFINEUNIT, name, args);
}
...
extern jl_function_t *Absyn_InnerOuter_INNER__OUTER;
extern jl_function_t *Absyn_InnerOuter_INNER__OUTER_type;
#define Absyn__INNER_5fOUTER jl_call0(Absyn_InnerOuter_INNER__OUTER)
...
static inline jl_value_t* Absyn__GROUP_5fIMPORT(jl_value_t *prefix,jl_value_t *groups) {
  return jl_call2(Absyn_Import_GROUP__IMPORT, prefix, groups);
}

extern jl_function_t *Absyn_Import_UNQUAL__IMPORT;
extern jl_function_t *Absyn_Import_UNQUAL__IMPORT_type;
static inline jl_value_t* Absyn__UNQUAL_5fIMPORT(jl_value_t *path) {
  return jl_call1(Absyn_Import_UNQUAL__IMPORT, path);
}

extern jl_function_t *Absyn_Import_QUAL__IMPORT;
extern jl_function_t *Absyn_Import_QUAL__IMPORT_type;
static inline jl_value_t* Absyn__QUAL_5fIMPORT(jl_value_t *path) {
  return jl_call1(Absyn_Import_QUAL__IMPORT, path);
}

extern jl_function_t *Absyn_Import_NAMED__IMPORT;
extern jl_function_t *Absyn_Import_NAMED__IMPORT_type;
...
static inline jl_value_t* Absyn__GROUP_5fIMPORT_5fRENAME(jl_value_t *rename,jl_value_t *name) {
  return jl_call2(Absyn_GroupImport_GROUP__IMPORT__RENAME, rename, name);
}

extern jl_function_t *Absyn_GroupImport_GROUP__IMPORT__NAME;
extern jl_function_t *Absyn_GroupImport_GROUP__IMPORT__NAME_type;
...
static inline jl_value_t* Absyn__EQ_5fFAILURE(jl_value_t *equ) {
  return jl_call1(Absyn_Equation_EQ__FAILURE, equ);
}

extern jl_function_t *Absyn_Equation_EQ__NORETCALL;
extern jl_function_t *Absyn_Equation_EQ__NORETCALL_type;
static inline jl_value_t* Absyn__EQ_5fNORETCALL(jl_value_t *functionName,jl_value_t *functionArgs) {
  return jl_call2(Absyn_Equation_EQ__NORETCALL, functionName, functionArgs);
}

extern jl_function_t *Absyn_Equation_EQ__WHEN__E;
extern jl_function_t *Absyn_Equation_EQ__WHEN__E_type;
static inline jl_value_t* Absyn__EQ_5fWHEN_5fE(jl_value_t *whenExp,jl_value_t *whenEquations,jl_value_t *elseWhenEquations) {
  return jl_call3(Absyn_Equation_EQ__WHEN__E, whenExp, whenEquations, elseWhenEquations);
}

extern jl_function_t *Absyn_Equation_EQ__FOR;
extern jl_function_t *Absyn_Equation_EQ__FOR_type;
static inline jl_value_t* Absyn__EQ_5fFOR(jl_value_t *iterators,jl_value_t *forEquations) {
  return jl_call2(Absyn_Equation_EQ__FOR, iterators, forEquations);
}

extern jl_function_t *Absyn_Equation_EQ__CONNECT;
extern jl_function_t *Absyn_Equation_EQ__CONNECT_type;
static inline jl_value_t* Absyn__EQ_5fCONNECT(jl_value_t *connector1,jl_value_t *connector2) {
  return jl_call2(Absyn_Equation_EQ__CONNECT, connector1, connector2);
}

extern jl_function_t *Absyn_Equation_EQ__PDE;
extern jl_function_t *Absyn_Equation_EQ__PDE_type;
static inline jl_value_t* Absyn__EQ_5fPDE(jl_value_t *leftSide,jl_value_t *rightSide,jl_value_t *domain) {
  return jl_call3(Absyn_Equation_EQ__PDE, leftSide, rightSide, domain);
}

extern jl_function_t *Absyn_Equation_EQ__EQUALS;
extern jl_function_t *Absyn_Equation_EQ__EQUALS_type;
static inline jl_value_t* Absyn__EQ_5fEQUALS(jl_value_t *leftSide,jl_value_t *rightSide) {
  return jl_call2(Absyn_Equation_EQ__EQUALS, leftSide, rightSide);
}

extern jl_function_t *Absyn_Equation_EQ__IF;
extern jl_function_t *Absyn_Equation_EQ__IF_type;
...
extern jl_function_t *Absyn_Algorithm_ALG__TRY;
extern jl_function_t *Absyn_Algorithm_ALG__TRY_type;
static inline jl_value_t* Absyn__ALG_5fTRY(jl_value_t *body,jl_value_t *elseBody) {
  return jl_call2(Absyn_Algorithm_ALG__TRY, body, elseBody);
}

extern jl_function_t *Absyn_Algorithm_ALG__FAILURE;
extern jl_function_t *Absyn_Algorithm_ALG__FAILURE_type;
static inline jl_value_t* Absyn__ALG_5fFAILURE(jl_value_t *equ) {
  return jl_call1(Absyn_Algorithm_ALG__FAILURE, equ);
}

extern jl_function_t *Absyn_Algorithm_ALG__BREAK;
extern jl_function_t *Absyn_Algorithm_ALG__BREAK_type;
#define Absyn__ALG_5fBREAK jl_call0(Absyn_Algorithm_ALG__BREAK)

extern jl_function_t *Absyn_Algorithm_ALG__RETURN;
extern jl_function_t *Absyn_Algorithm_ALG__RETURN_type;
#define Absyn__ALG_5fRETURN jl_call0(Absyn_Algorithm_ALG__RETURN)

extern jl_function_t *Absyn_Algorithm_ALG__NORETCALL;
extern jl_function_t *Absyn_Algorithm_ALG__NORETCALL_type;
static inline jl_value_t* Absyn__ALG_5fNORETCALL(jl_value_t *functionCall,jl_value_t *functionArgs) {
  return jl_call2(Absyn_Algorithm_ALG__NORETCALL, functionCall, functionArgs);
}

extern jl_function_t *Absyn_Algorithm_ALG__WHEN__A;
extern jl_function_t *Absyn_Algorithm_ALG__WHEN__A_type;
static inline jl_value_t* Absyn__ALG_5fWHEN_5fA(jl_value_t *boolExpr,jl_value_t *whenBody,jl_value_t *elseWhenAlgorithmBranch) {
  return jl_call3(Absyn_Algorithm_ALG__WHEN__A, boolExpr, whenBody, elseWhenAlgorithmBranch);
}

extern jl_function_t *Absyn_Algorithm_ALG__WHILE;
extern jl_function_t *Absyn_Algorithm_ALG__WHILE_type;
static inline jl_value_t* Absyn__ALG_5fWHILE(jl_value_t *boolExpr,jl_value_t *whileBody) {
  return jl_call2(Absyn_Algorithm_ALG__WHILE, boolExpr, whileBody);
}

extern jl_function_t *Absyn_Algorithm_ALG__PARFOR;
extern jl_function_t *Absyn_Algorithm_ALG__PARFOR_type;
static inline jl_value_t* Absyn__ALG_5fPARFOR(jl_value_t *iterators,jl_value_t *parforBody) {
  return jl_call2(Absyn_Algorithm_ALG__PARFOR, iterators, parforBody);
}

extern jl_function_t *Absyn_Algorithm_ALG__FOR;
extern jl_function_t *Absyn_Algorithm_ALG__FOR_type;
static inline jl_value_t* Absyn__ALG_5fFOR(jl_value_t *iterators,jl_value_t *forBody) {
  return jl_call2(Absyn_Algorithm_ALG__FOR, iterators, forBody);
}

extern jl_function_t *Absyn_Algorithm_ALG__IF;
extern jl_function_t *Absyn_Algorithm_ALG__IF_type;
static inline jl_value_t* Absyn__ALG_5fIF(jl_value_t *ifExp,jl_value_t *trueBranch,jl_value_t *elseIfAlgorithmBranch,jl_value_t *elseBranch) {
  ...
  return jl_call(Absyn_Algorithm_ALG__IF, values, 4);
}

extern jl_function_t *Absyn_Algorithm_ALG__ASSIGN;
extern jl_function_t *Absyn_Algorithm_ALG__ASSIGN_type;
...
static inline jl_value_t* Absyn__CALL(jl_value_t *function_,jl_value_t *functionArgs) {
  return jl_call2(Absyn_Exp_CALL, function_, functionArgs);
}
...
static inline jl_value_t* Absyn__C_5fMODIFICATION(jl_value_t *modification) {
  return jl_call1(Absyn_CodeNode_C__MODIFICATION, modification);
}

extern jl_function_t *Absyn_CodeNode_C__EXPRESSION;
extern jl_function_t *Absyn_CodeNode_C__EXPRESSION_type;
static inline jl_value_t* Absyn__C_5fEXPRESSION(jl_value_t *exp) {
  return jl_call1(Absyn_CodeNode_C__EXPRESSION, exp);
}

extern jl_function_t *Absyn_CodeNode_C__ELEMENT;
extern jl_function_t *Absyn_CodeNode_C__ELEMENT_type;
static inline jl_value_t* Absyn__C_5fELEMENT(jl_value_t *element) {
  return jl_call1(Absyn_CodeNode_C__ELEMENT, element);
}

extern jl_function_t *Absyn_CodeNode_C__ALGORITHMSECTION;
extern jl_function_t *Absyn_CodeNode_C__ALGORITHMSECTION_type;
static inline jl_value_t* Absyn__C_5fALGORITHMSECTION(jl_value_t *boolean,jl_value_t *algorithmItemLst) {
  return jl_call2(Absyn_CodeNode_C__ALGORITHMSECTION, boolean, algorithmItemLst);
}

extern jl_function_t *Absyn_CodeNode_C__EQUATIONSECTION;
extern jl_function_t *Absyn_CodeNode_C__EQUATIONSECTION_type;
static inline jl_value_t* Absyn__C_5fEQUATIONSECTION(jl_value_t *boolean,jl_value_t *equationItemLst) {
  return jl_call2(Absyn_CodeNode_C__EQUATIONSECTION, boolean, equationItemLst);
}

extern jl_function_t *Absyn_CodeNode_C__CONSTRAINTSECTION;
extern jl_function_t *Absyn_CodeNode_C__CONSTRAINTSECTION_type;
static inline jl_value_t* Absyn__C_5fCONSTRAINTSECTION(jl_value_t *boolean,jl_value_t *equationItemLst) {
  return jl_call2(Absyn_CodeNode_C__CONSTRAINTSECTION, boolean, equationItemLst);
}

extern jl_function_t *Absyn_CodeNode_C__VARIABLENAME;
extern jl_function_t *Absyn_CodeNode_C__VARIABLENAME_type;
static inline jl_value_t* Absyn__C_5fVARIABLENAME(jl_value_t *componentRef) {
  return jl_call1(Absyn_CodeNode_C__VARIABLENAME, componentRef);
}

extern jl_function_t *Absyn_CodeNode_C__TYPENAME;
extern jl_function_t *Absyn_CodeNode_C__TYPENAME_type;
...
static inline jl_value_t* Absyn__FOR_5fITER_5fFARG(jl_value_t *exp,jl_value_t *iterType,jl_value_t *iterators) {
  return jl_call3(Absyn_FunctionArgs_FOR__ITER__FARG, exp, iterType, iterators);
}
...
extern jl_function_t *Absyn_Operator_UMINUS__EW;
extern jl_function_t *Absyn_Operator_UMINUS__EW_type;
#define Absyn__UMINUS_5fEW jl_call0(Absyn_Operator_UMINUS__EW)

extern jl_function_t *Absyn_Operator_UPLUS__EW;
extern jl_function_t *Absyn_Operator_UPLUS__EW_type;
#define Absyn__UPLUS_5fEW jl_call0(Absyn_Operator_UPLUS__EW)

extern jl_function_t *Absyn_Operator_POW__EW;
extern jl_function_t *Absyn_Operator_POW__EW_type;
#define Absyn__POW_5fEW jl_call0(Absyn_Operator_POW__EW)

extern jl_function_t *Absyn_Operator_DIV__EW;
extern jl_function_t *Absyn_Operator_DIV__EW_type;
#define Absyn__DIV_5fEW jl_call0(Absyn_Operator_DIV__EW)

extern jl_function_t *Absyn_Operator_MUL__EW;
extern jl_function_t *Absyn_Operator_MUL__EW_type;
#define Absyn__MUL_5fEW jl_call0(Absyn_Operator_MUL__EW)

extern jl_function_t *Absyn_Operator_SUB__EW;
extern jl_function_t *Absyn_Operator_SUB__EW_type;
#define Absyn__SUB_5fEW jl_call0(Absyn_Operator_SUB__EW)

extern jl_function_t *Absyn_Operator_ADD__EW;
extern jl_function_t *Absyn_Operator_ADD__EW_type;
#define Absyn__ADD_5fEW jl_call0(Absyn_Operator_ADD__EW)
...
extern jl_function_t *Absyn_ComponentRef_CREF__IDENT;
extern jl_function_t *Absyn_ComponentRef_CREF__IDENT_type;
static inline jl_value_t* Absyn__CREF_5fIDENT(jl_value_t *name,jl_value_t *subscripts) {
  return jl_call2(Absyn_ComponentRef_CREF__IDENT, name, subscripts);
}

extern jl_function_t *Absyn_ComponentRef_CREF__QUAL;
extern jl_function_t *Absyn_ComponentRef_CREF__QUAL_type;
static inline jl_value_t* Absyn__CREF_5fQUAL(jl_value_t *name,jl_value_t *subscripts,jl_value_t *componentRef) {
  return jl_call3(Absyn_ComponentRef_CREF__QUAL, name, subscripts, componentRef);
}

extern jl_function_t *Absyn_ComponentRef_CREF__FULLYQUALIFIED;
extern jl_function_t *Absyn_ComponentRef_CREF__FULLYQUALIFIED_type;
...
extern jl_function_t *Absyn_Restriction_R__METARECORD;
extern jl_function_t *Absyn_Restriction_R__METARECORD_type;
static inline jl_value_t* Absyn__R_5fMETARECORD(jl_value_t *name,jl_value_t *index,jl_value_t *singleton,jl_value_t *moved,jl_value_t *typeVars) {
  ...
  return jl_call(Absyn_Restriction_R__METARECORD, values, 5);
}

extern jl_function_t *Absyn_Restriction_R__UNIONTYPE;
extern jl_function_t *Absyn_Restriction_R__UNIONTYPE_type;
#define Absyn__R_5fUNIONTYPE jl_call0(Absyn_Restriction_R__UNIONTYPE)

extern jl_function_t *Absyn_Restriction_R__PREDEFINED__CLOCK;
extern jl_function_t *Absyn_Restriction_R__PREDEFINED__CLOCK_type;
#define Absyn__R_5fPREDEFINED_5fCLOCK jl_call0(Absyn_Restriction_R__PREDEFINED__CLOCK)

extern jl_function_t *Absyn_Restriction_R__PREDEFINED__ENUMERATION;
extern jl_function_t *Absyn_Restriction_R__PREDEFINED__ENUMERATION_type;
#define Absyn__R_5fPREDEFINED_5fENUMERATION jl_call0(Absyn_Restriction_R__PREDEFINED__ENUMERATION)

extern jl_function_t *Absyn_Restriction_R__PREDEFINED__BOOLEAN;
extern jl_function_t *Absyn_Restriction_R__PREDEFINED__BOOLEAN_type;
#define Absyn__R_5fPREDEFINED_5fBOOLEAN jl_call0(Absyn_Restriction_R__PREDEFINED__BOOLEAN)

extern jl_function_t *Absyn_Restriction_R__PREDEFINED__STRING;
extern jl_function_t *Absyn_Restriction_R__PREDEFINED__STRING_type;
#define Absyn__R_5fPREDEFINED_5fSTRING jl_call0(Absyn_Restriction_R__PREDEFINED__STRING)

extern jl_function_t *Absyn_Restriction_R__PREDEFINED__REAL;
extern jl_function_t *Absyn_Restriction_R__PREDEFINED__REAL_type;
#define Absyn__R_5fPREDEFINED_5fREAL jl_call0(Absyn_Restriction_R__PREDEFINED__REAL)

extern jl_function_t *Absyn_Restriction_R__PREDEFINED__INTEGER;
extern jl_function_t *Absyn_Restriction_R__PREDEFINED__INTEGER_type;
#define Absyn__R_5fPREDEFINED_5fINTEGER jl_call0(Absyn_Restriction_R__PREDEFINED__INTEGER)

extern jl_function_t *Absyn_Restriction_R__ENUMERATION;
extern jl_function_t *Absyn_Restriction_R__ENUMERATION_type;
#define Absyn__R_5fENUMERATION jl_call0(Absyn_Restriction_R__ENUMERATION)

extern jl_function_t *Absyn_Restriction_R__OPERATOR__RECORD;
extern jl_function_t *Absyn_Restriction_R__OPERATOR__RECORD_type;
#define Absyn__R_5fOPERATOR_5fRECORD jl_call0(Absyn_Restriction_R__OPERATOR__RECORD)

extern jl_function_t *Absyn_Restriction_R__OPERATOR;
extern jl_function_t *Absyn_Restriction_R__OPERATOR_type;
#define Absyn__R_5fOPERATOR jl_call0(Absyn_Restriction_R__OPERATOR)

extern jl_function_t *Absyn_Restriction_R__FUNCTION;
extern jl_function_t *Absyn_Restriction_R__FUNCTION_type;
static inline jl_value_t* Absyn__R_5fFUNCTION(jl_value_t *functionRestriction) {
  return jl_call1(Absyn_Restriction_R__FUNCTION, functionRestriction);
}

extern jl_function_t *Absyn_Restriction_R__PACKAGE;
extern jl_function_t *Absyn_Restriction_R__PACKAGE_type;
#define Absyn__R_5fPACKAGE jl_call0(Absyn_Restriction_R__PACKAGE)

extern jl_function_t *Absyn_Restriction_R__TYPE;
extern jl_function_t *Absyn_Restriction_R__TYPE_type;
#define Absyn__R_5fTYPE jl_call0(Absyn_Restriction_R__TYPE)

extern jl_function_t *Absyn_Restriction_R__EXP__CONNECTOR;
extern jl_function_t *Absyn_Restriction_R__EXP__CONNECTOR_type;
#define Absyn__R_5fEXP_5fCONNECTOR jl_call0(Absyn_Restriction_R__EXP__CONNECTOR)

extern jl_function_t *Absyn_Restriction_R__CONNECTOR;
extern jl_function_t *Absyn_Restriction_R__CONNECTOR_type;
#define Absyn__R_5fCONNECTOR jl_call0(Absyn_Restriction_R__CONNECTOR)

extern jl_function_t *Absyn_Restriction_R__BLOCK;
extern jl_function_t *Absyn_Restriction_R__BLOCK_type;
#define Absyn__R_5fBLOCK jl_call0(Absyn_Restriction_R__BLOCK)

extern jl_function_t *Absyn_Restriction_R__RECORD;
extern jl_function_t *Absyn_Restriction_R__RECORD_type;
#define Absyn__R_5fRECORD jl_call0(Absyn_Restriction_R__RECORD)

extern jl_function_t *Absyn_Restriction_R__MODEL;
extern jl_function_t *Absyn_Restriction_R__MODEL_type;
#define Absyn__R_5fMODEL jl_call0(Absyn_Restriction_R__MODEL)

extern jl_function_t *Absyn_Restriction_R__OPTIMIZATION;
extern jl_function_t *Absyn_Restriction_R__OPTIMIZATION_type;
#define Absyn__R_5fOPTIMIZATION jl_call0(Absyn_Restriction_R__OPTIMIZATION)

extern jl_function_t *Absyn_Restriction_R__CLASS;
...
extern jl_function_t *Absyn_FunctionRestriction_FR__PARALLEL__FUNCTION;
extern jl_function_t *Absyn_FunctionRestriction_FR__PARALLEL__FUNCTION_type;
#define Absyn__FR_5fPARALLEL_5fFUNCTION jl_call0(Absyn_FunctionRestriction_FR__PARALLEL__FUNCTION)

extern jl_function_t *Absyn_FunctionRestriction_FR__OPERATOR__FUNCTION;
extern jl_function_t *Absyn_FunctionRestriction_FR__OPERATOR__FUNCTION_type;
#define Absyn__FR_5fOPERATOR_5fFUNCTION jl_call0(Absyn_FunctionRestriction_FR__OPERATOR__FUNCTION)

extern jl_function_t *Absyn_FunctionRestriction_FR__NORMAL__FUNCTION;
extern jl_function_t *Absyn_FunctionRestriction_FR__NORMAL__FUNCTION_type;
...
static inline jl_value_t* Absyn__RIM(jl_value_t *im) {
  return jl_call1(Absyn_Ref_RIM, im);
}

extern jl_function_t *Absyn_Ref_RTS;
extern jl_function_t *Absyn_Ref_RTS_type;
static inline jl_value_t* Absyn__RTS(jl_value_t *ts) {
  return jl_call1(Absyn_Ref_RTS, ts);
}

extern jl_function_t *Absyn_Ref_RCR;
extern jl_function_t *Absyn_Ref_RCR_type;
static inline jl_value_t* Absyn__RCR(jl_value_t *cr) {
