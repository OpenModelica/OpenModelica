  module Error
    ...
    prefixToStr = Function
        ...
        MessageTokens = List  #= \\\"Tokens\\\" to insert into message at
        ...
        T = Any
        function getCurrentComponent()::Tuple{String, Bool, ModelicaInteger, String}
          ...
          (filename, read_only, sline, scol, eline, ecol, str)
        end
        ...
        function addMultiSourceMessage(inErrorMsg::Message, inMessageTokens::MessageTokens, inInfo::List)
              _ = begin
                  local info::SourceInfo
                  local rest_info::List
        ...
        function addMessageOrSourceMessage(inErrorMsg::Message, inMessageTokens::MessageTokens, inInfoOpt::Option)
              _ = begin
                  local info::SourceInfo
        ...
        function addTotalMessages(messages::List)
              for msg in messages
                addTotalMessage(msg)
              end
        end
        ...
        function printMessagesStr(warningsAsErrors::Bool)::String
              local res::String
        ...
        function printMessagesStrLst()::List
        ...
        function printMessagesStrLstType(inMessageType::MessageType)::List
              local outStringLst::List
        ...
        function printMessagesStrLstSeverity(inSeverity::Severity)::List
              local outStringLst::List
