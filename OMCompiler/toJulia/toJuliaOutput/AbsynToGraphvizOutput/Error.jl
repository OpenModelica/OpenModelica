  ...
  look up message string and type and severity =#
        ...
        MessageTokens = IList  #= \\\"Tokens\\\" to insert into message at
        ...
        function addMessage(inErrorMsg::Message, inMessageTokens::MessageTokens)
              ...
              if ! Flags.getConfigBool(Flags.DEMO_MODE)
                ...
                #= This is crazy code =#MESSAGE(error_id, msg_type, severity, msg) = inErrorMsg
        ...
        function addMultiSourceMessage(inErrorMsg::Message, inMessageTokens::MessageTokens, inInfo::IList)
              _ = begin
                  local info::SourceInfo
                  local rest_info::IList
        ...
        function addTotalMessage(message::TotalMessage)
              ...
              #= This is crazy code =#TOTALMESSAGE(msg = msg, info = info) = message
              addSourceMessage(msg, list(), info)
        end

        function addTotalMessages(messages::IList)
              for msg in messages
                addTotalMessage(msg)
              end
        end
        ...
        function printMessagesStrLst()::IList
        ...
        function printMessagesStrLstType(inMessageType::MessageType)::IList
              local outStringLst::IList
        ...
        function printMessagesStrLstSeverity(inSeverity::Severity)::IList
              local outStringLst::IList
        ...
        function addInternalError(message::String, info::SourceInfo)
              ...
              if Config.getRunningTestsuite()
                #= This is crazy code =#SOURCEINFO(fileName = filename) = info
