  module Tpl
    ...
    Tpl_Fun = Function
        ...
        Tokens = IList
         ...
         @Uniontype BlockTypeFileText begin
              @Record BT_FILE_TEXT begin
                       ...
                       isstart::Bool
                       tell #= Usage depends on bt; stores the last file position to know if it is empty or not. =#::MArray
                       septok::MArray
              end
         end
        ...
        ArgType1 = polymorphic
        ArgType2 = polymorphic
        ArgType3 = polymorphic
        ArgType4 = polymorphic
        ...
        function writeChars(inText::Text, inChars::IList)::Text
              local outText::Text
        ...
        function takeLineOrString(inChars::IList)::Tuple{Bool, IList, IList}
              local outIsLine::Bool
              local outRestChars::IList
              local outTillNewLineChars::IList

              (outTillNewLineChars, outRestChars, outIsLine) = begin
                  local char::String
                  local tnlchars::IList
                  local restchars::IList
                  local chars::IList
                  local isline::Bool
                @match inChars begin
                   nil()  => begin
        ...
        function stringListString(inStringList::IList, inActualPositionOnLine::ModelicaInteger, inAtStartOfLine::Bool, inAfterNewLineIndent::ModelicaInteger)::Tuple{ModelicaInteger, Bool, ModelicaInteger}
              local outAfterNewLineIndent::ModelicaInteger
              local outAtStartOfLine::Bool
              local outActualPositionOnLine::ModelicaInteger
        ...
        function stringListFile(file::File.File, inStringList::IList, nchars::ModelicaInteger, isstart::Bool, aind::ModelicaInteger)::Tuple{ModelicaInteger, Bool, ModelicaInteger}
        ...
        function tplCallWithFailError(inFun::Tpl_Fun, inArg::ArgType1, txt::Text = emptyTxt)::Text
              ...
              txt = tplCallHandleErrors(@ExtendedAnonFunction inFun(inArgA = inArg), txt)
          txt
        end
        ...
        function tplCallWithFailError2(inFun::Tpl_Fun, inArgA::ArgType1, inArgB::ArgType2, txt::Text = emptyTxt)::Text
              ...
              txt = tplCallHandleErrors(@ExtendedAnonFunction inFun(inArgA = inArgA, inArgB = inArgB), txt)
          txt
        end
        ...
        function tplCallWithFailError3(inFun::Tpl_Fun, inArgA::ArgType1, inArgB::ArgType2, inArgC::ArgType3, txt::Text = emptyTxt)::Text
              ...
              txt = tplCallHandleErrors(@ExtendedAnonFunction inFun(inArgA = inArgA, inArgB = inArgB, inArgC = inArgC), txt)
          txt
        end
