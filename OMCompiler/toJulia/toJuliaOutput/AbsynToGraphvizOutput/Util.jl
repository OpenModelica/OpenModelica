  module Util
    ...
    FuncT = Function
        ...
        function flagValue(flag::String, arguments::IList)::String
              local flagVal::String

              local arg::String
              local rest::IList = arguments
        ...
        function selectFirstNonEmptyString(inStrings::IList)::String
        ...
        function optTuple22(inTuple::Option)::T2
              ...
              #= This is crazy code =#SOME((_, outValue)) = inTuple
          outValue
        end
        ...
        Usefull for heavy string operations(causes malloc error on some models when generating init file).
         =#
        function stringDelimitListPrintBuf(inStringLst::IList, inDelimiter::String)
              _ = begin
                  local f::String
                  local delim::String
                  local str1::String
        ...
        function stringDelimitListAndSeparate(str::IList, sep1::String, sep2::String, n::ModelicaInteger)::String
              local res::String
        ...
        function stringDelimitListAndSeparate2(inStringLst1::IList, inString2::String, inString3::String, inInteger4::ModelicaInteger, inInteger5::ModelicaInteger)
              _ = begin
                  local s::String
                  local str1::String
                  local str::String
        ...
        function stringDelimitListNonEmptyElts(lst::IList, delim::String)::String
              local str::String
        ...
        function stringSplitAtChar(string::String, token::String)::IList
              local strings::IList = list()

              local ch::ModelicaInteger = stringCharInt(token)
              local cur::IList = list()
        ...
        function modelicaStringToCStr(str::String, changeDerCall::Bool #= if true, first change 'DER(v)' to $derivativev =#)::String
              ...
              res_str = begin
                ...
                @matchcontinue (str, changeDerCall) begin
                  (s, false)  => begin
                      @assert false == (Flags.getConfigBool(Flags.TRANSLATE_DAE_STRING))
                    s
                  end
        ...
        function modelicaStringToCStr2(inDerName::String)::String
         ...
         #=  =#
        function modelicaStringToCStr1(inString::String, inReplacePatternLst::IList)::String
              local outString::String
        ...
        function cStrToModelicaString1(inString::String, inReplacePatternLst::IList)::String
              local outString::String
        ...
        function boolOrList(inBooleanLst::IList)::Bool
        ...
        function boolAndList(inBooleanLst::IList)::Bool
        ...
        function makeOptionOnTrue(inCondition::Bool, inValue::T)::Option
              local outOption::Option = if inCondition
                    SOME(inValue)
                  else
                    NONE()
                  end
        ...
        function getOption(inOption::Option)::T
              ...
              #= This is crazy code =#SOME(outValue) = inOption
          outValue
        end
        ...
        function mulListIntegerOpt(inList::IList, inAccum::ModelicaInteger = 1)::ModelicaInteger
        ...
        function buildMapStr(inLst1::IList, inLst2::IList, inMiddleDelimiter::String, inEndDelimiter::String)::String
              local outStr::String
        ...
        Key = Any
        Val = Any
        function assoc(inKey::Key, inList::IList)::Val
              local outValue::Val
        ...
        T = Any
        function allCombinations(lst::IList, maxTotalSize::Option, info::SourceInfo)::IList
              local out::IList
              ...
              out = begin
                ...
                @matchcontinue (lst, maxTotalSize, info) begin
                  ...
                  (_, SOME(_), _)  => begin
                      Error.addSourceMessage(Error.COMPILER_NOTIFICATION, list("Util.allCombinations failed because the input was too large"), info)
                    fail()
                  end
                end
              end
         ...
         #= {{1,2,3},{4,5},{6}} => {{1,4,6},{1,5,6},{2,4,6},...}.
          ...
          This function screams WARNING I USE COMBINATORIAL EXPLOSION. =#
        T = Any
        function allCombinations2(ilst::IList)::IList
              local out::IList
        ...
        T = Any
        function allCombinations3(ilst1::IList, ilst2::IList, iacc::IList)::IList
              local out::IList
        ...
        T = Any
        function allCombinations4(x::T, ilst::IList, iacc::IList)::IList
              local out::IList
        ...
        function stringEqCaseInsensitive(str1::String, str2::String)::Bool
         ...
         #= SOME(a) => {a}
           NONE()  => {} =#
        T = Any
        function optionList(inOption::Option)::IList
              local outList::IList
        ...
        function intProduct(lst::IList)::ModelicaInteger
        ...
        function intLstString(lst::IList)::String
              local s::String
