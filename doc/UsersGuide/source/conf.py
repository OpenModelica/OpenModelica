...
with open("omreleaselink.inc", "w") as f:
  f.write(releaselink)
...
# OM_DOWithAnnotations.rst is included by optimization.rst; without excluding
# it Sphinx also builds it as a document of its own and every label in it is
# defined twice.
exclude_patterns = ['omsimulator/**', 'api/**', 'OM_DOWithAnnotations.rst', 'tmp.rst']
