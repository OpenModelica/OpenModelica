...
/* $ANTLR 2.7.1: "flat_modelica_lexer.g" -> "flat_modelica_lexer.hpp"$ */
...
class flat_modelica_lexer : public ANTLR_USE_NAMESPACE(antlr)CharScanner, public flatmodelicaTokenTypes
 {
#line 1 "flat_modelica_lexer.g"
