  ...
  */
    ...
    rounding s-is<e to zero. */
      ...
      protected 
        ...
        Integer pno=is + 1;
      algorithm 
        x := if pno == 1 then PartType.shape(s - is, d.parts1) else if pno == 2 then 
                PartType.shape(s - is, d.parts2) else if pno == 3 then 
          ...
          if pno == 7 then PartType.shape(s - is, d.parts7) else if pno == 8 then 
    ...
    rounding s-is<e to zero. */
      ...
      algorithm 
        for i in 1:d.p.n loop
          j2 := j1 + numbers[i] - 1;
          x[j1:j2, :] := if i == 1 then PartType.points(numbers[i], d.parts1) else 
                  if i == 2 then PartType.points(numbers[i], d.parts2) else if 
            i == 3 then PartType.points(numbers[i], d.parts3) else if i == 4 then 
