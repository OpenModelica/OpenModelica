  ...
  : QWidget(pParent)
{
  ...
  QString showAllProblemsMsg = tr("Show All Problems");
  mpShowAllProblemsToolButton->setText(showAllProblemsMsg);
  mpShowAllProblemsToolButton->setToolTip(showAllProblemsMsg);
  ...
  QString clearProblemsMsg = tr("Clear All Problems");
  mpClearProblemsToolButton->setIcon(QIcon(":/Resources/icons/clearproblems.png"));
  mpClearProblemsToolButton->setText(clearProblemsMsg);
  mpClearProblemsToolButton->setToolTip(clearProblemsMsg);
