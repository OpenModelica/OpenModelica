...
private:
  ...
  QDoubleSpinBox *mpOriginXSpinBox;
  Label *mpOriginYLabel;
  QDoubleSpinBox *mpOriginYSpinBox;
  Label *mpRotationLabel;
  QDoubleSpinBox *mpRotationSpinBox;
  QGroupBox *mpExtentGroupBox;
  Label *mpExtent1XLabel;
  QDoubleSpinBox *mpExtent1XSpinBox;
  Label *mpExtent1YLabel;
  QDoubleSpinBox *mpExtent1YSpinBox;
  Label *mpExtent2XLabel;
  QDoubleSpinBox *mpExtent2XSpinBox;
  Label *mpExtent2YLabel;
  QDoubleSpinBox *mpExtent2YSpinBox;
  ...
  QDoubleSpinBox *mpStartAngleSpinBox;
  Label *mpEndAngleLabel;
  QDoubleSpinBox *mpEndAngleSpinBox;
