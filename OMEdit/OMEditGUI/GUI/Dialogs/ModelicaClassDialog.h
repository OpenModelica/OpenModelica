...
private:
  ...
  Label *mpLeftLabel;
  QDoubleSpinBox *mpLeftSpinBox;
  Label *mpBottomLabel;
  QDoubleSpinBox *mpBottomSpinBox;
  Label *mpRightLabel;
  QDoubleSpinBox *mpRightSpinBox;
  Label *mpTopLabel;
  QDoubleSpinBox *mpTopSpinBox;
  QGroupBox *mpGridGroupBox;
  Label *mpHorizontalLabel;
  QDoubleSpinBox *mpHorizontalSpinBox;
  Label *mpVerticalLabel;
  QDoubleSpinBox *mpVerticalSpinBox;
  QGroupBox *mpComponentGroupBox;
  Label *mpScaleFactorLabel;
  QDoubleSpinBox *mpScaleFactorSpinBox;
