...
QString Helper::textRelMinSize;
QString Helper::textAnnotation;
QString Helper::textOverdrawFactor;
...
void Helper::initHelperVariables()
{
  ...
  Helper::textRelMinSize = tr("Minimum text size (rel. to system default):");
  Helper::textAnnotation = tr("Text annotation");
  Helper::textOverdrawFactor = tr("Text overdraw factor:");
