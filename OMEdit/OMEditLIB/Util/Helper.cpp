...
QString Helper::interactiveSimulationTip;
...
QString Helper::newOMSimulatorModel;
QString Helper::newOMSimulatorModelTip;
...
void Helper::initHelperVariables()
{
  ...
  Helper::simulateTip = tr("Simulates the model");
  ...
  Helper::reSimulateTip = tr("Re-simulates the model");
  ...
  Helper::simulateWithTransformationalDebuggerTip = tr("Simulates the model with Transformational Debugger");
  Helper::simulateWithAlgorithmicDebugger = tr("Simulate with Algorithmic Debugger");
  Helper::simulateWithAlgorithmicDebuggerTip = tr("Simulates the model with Algorithmic Debugger");
  Helper::simulateWithAnimation = tr("Simulate with Animation");
  Helper::simulateWithAnimationTip = tr("Simulates the model with Animation");
  ...
  Helper::interactiveSimulationTip = tr("Simulates the model in interactive mode");
