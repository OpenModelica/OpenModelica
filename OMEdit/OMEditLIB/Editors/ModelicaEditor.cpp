...
void ModelicaEditor::contentsHasChanged(int position, int charsRemoved, int charsAdded)
{
  ...
  if (mpModelWidget->isVisible()) {
    ...
    } else if (mpModelWidget->isComponentMode() && !mForceSetPlainText) {
      mpInfoBar->showMessage(tr("<b>Warning: </b>Cannot modify the text in the component mode. Your changes will not be saved."));
