...
class CRMLEditor : public BaseEditor
{
  Q_OBJECT
public:
  CRMLEditor(QWidget *pParent);
...
class CRMLHighlighter : public QSyntaxHighlighter
{
  Q_OBJECT
public:
  CRMLHighlighter(CRMLEditorPage *pCRMLEditorPage, QPlainTextEdit *pPlainTextEdit = 0);
