                                      ...
                                      const char *curveStyle, const char *legendPosition, const char *footer, const char *autoScale, const char *variables)
{
  ...
  if (pMainWindow) {
    ...
    if (QString(logX) == "true") {
      ...
      throw OMPlot::InvalidInputException(pPlotWindow, QString(logX));
    }
    if (QString(logY) == "true") {
      ...
      throw OMPlot::InvalidInputException(pPlotWindow, QString(logY));
    }
    ...
    if (QString(autoScale) == "true") {
      ...
      throw OMPlot::InvalidInputException(pPlotWindow, QString(autoScale));
    }
    // plot variables
