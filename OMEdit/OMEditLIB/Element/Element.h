...
public:
  ...
  void updateElementTransformations(const Transformation &oldTransformation);
  void updateComponentTransformations(const Transformation &oldTransformation) {updateElementTransformations(oldTransformation);}
