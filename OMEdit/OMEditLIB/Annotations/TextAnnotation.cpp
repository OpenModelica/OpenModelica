...
void TextAnnotation::drawAnnotation(QPainter *painter)
{
  ...
  painter->setTransform(QTransform(qAbs(painterTransform.m11()), invx * painterTransform.m12(), painterTransform.m13(),
  ...
  QRectF mappedBoundingRect = QRectF(xtl, ytl, boundingRectangle.width(), boundingRectangle.height());
