...
class DynamicAnnotation
{
  ...
  private:
    FlatModelica::Expression evaluate_wrap_helper(FlatModelica::Expression *pExpression, ModelInstance::Model *pModel,
                                                  bool readFromResultFileForDynamicSelect, double time);
    FlatModelica::Expression evaluate_helper(FlatModelica::Expression *pExpression, ModelInstance::Model *pModel,
