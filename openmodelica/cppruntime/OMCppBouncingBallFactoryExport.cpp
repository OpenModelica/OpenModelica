...
{
    return new BouncingBallExtension(globalSettings, algLoopSolverFactory, simData, simVars);
}
...
extern "C" ISimData* createSimData()
{
  ...
  {
      boost::shared_ptr<IMixedSystem> system( new BouncingBallExtension(globalSettings, algLoopSolverFactory, simData,simVars) );
      return system;
  }
...
BOOST_EXTENSION_TYPE_MAP_FUNCTION
{
  ...
  types.get<std::map<std::string, system_factory> >()["BouncingBall"]
    .system_factory::set<BouncingBallExtension>();
}
#endif