...
{
    return new CoupledInductorsExtension(globalSettings, algLoopSolverFactory, simData, simVars);
}
...
extern "C" ISimData* createSimData()
{
  ...
  {
      boost::shared_ptr<IMixedSystem> system( new CoupledInductorsExtension(globalSettings, algLoopSolverFactory, simData,simVars) );
      return system;
  }
...
BOOST_EXTENSION_TYPE_MAP_FUNCTION
{
  ...
  types.get<std::map<std::string, system_factory> >()["CoupledInductors"]
    .system_factory::set<CoupledInductorsExtension>();
}
#endif