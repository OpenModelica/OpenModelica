...
class CoupledInductorsJacobian : virtual public CoupledInductors
{
public:
  CoupledInductorsJacobian(IGlobalSettings* globalSettings, boost::shared_ptr<IAlgLoopSolverFactory> nonlinsolverfactory, boost::shared_ptr<ISimData> sim_data, boost::shared_ptr<ISimVars> sim_vars);
  virtual ~CoupledInductorsJacobian();
...
protected:
  ...
  double& _C1_vinternalSeedA;
  double& _C2_vinternalSeedA;
  double& _L1_iinternalSeedA;
  double& _L2_iinternalSeedA;
  double& _L3_iinternalSeedA;
