...
*
*****************************************************************************/
class BouncingBallExtension: public ISystemInitialization, public IMixedSystem,public IWriteOutput, public IStateSelection, public BouncingBallWriteOutput, public BouncingBallInitialize, public BouncingBallJacobian,public BouncingBallStateSelection
{
public:
  BouncingBallExtension(IGlobalSettings* globalSettings, boost::shared_ptr<IAlgLoopSolverFactory> nonlinsolverfactory, boost::shared_ptr<ISimData> sim_data, boost::shared_ptr<ISimVars> sim_vars);
  virtual ~BouncingBallExtension();
