...
class Functions;
class CauerLowPassSCAlgloop166: public IAlgLoop, public AlgLoopDefaultImplementation
{
public:
   //typedef for A- Matrix
  typedef StatArrayDim2<double,11,11> AMATRIX;

    CauerLowPassSCAlgloop166( CauerLowPassSC* system
                                      ,double* z,double* zDot, bool* conditions
                                     ,boost::shared_ptr<DiscreteEvents> discrete_events
                                    );
    virtual ~CauerLowPassSCAlgloop166();
