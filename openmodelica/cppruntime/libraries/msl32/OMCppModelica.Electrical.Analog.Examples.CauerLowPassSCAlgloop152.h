...
class Functions;
class CauerLowPassSCAlgloop152: public IAlgLoop, public AlgLoopDefaultImplementation
{
public:
   //typedef for A- Matrix
  typedef StatArrayDim2<double,11,11> AMATRIX;

    CauerLowPassSCAlgloop152( CauerLowPassSC* system
                                      ,double* z,double* zDot, bool* conditions
                                     ,boost::shared_ptr<DiscreteEvents> discrete_events
                                    );
    virtual ~CauerLowPassSCAlgloop152();
