...
model LoopBreakerT "Temperature loop breaker for the water solution connector"
  annotation(Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Polygon(points={{0,100},{100,0},{0,-100},{-100,0},{0,100}}, fillPattern=FillPattern.Solid, lineColor={127,0,255}, fillColor={223,159,159}),Line(points={{0,100},{0,-100}}, color={0,0,255}),Text(lineColor={0,0,255}, extent={{-42,38},{38,-42}}, fillColor={0,0,255}, textString="T")}), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Polygon(points={{0,100},{100,0},{0,-100},{-100,0},{0,100}}, fillPattern=FillPattern.Solid, lineColor={127,0,255}, fillColor={223,159,159}),Line(points={{0,100},{0,-100}}, color={0,0,255}),Text(lineColor={0,0,255}, extent={{-40,38},{40,-42}}, fillColor={0,0,255}, textString="T")}), Documentation(info="<html>
