...
model SinkP "Flue gas sink with fixed pressure"
  ...
  annotation(Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{-90,0},{-40,0},{-58,10}}),Line(color={0,0,255}, points={{-40,0},{-58,-10}}),Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillColor={127,255,0}, fillPattern=FillPattern.Backward),Text(lineColor={0,0,255}, extent={{-94,28},{98,-28}}, textString="P"),Text(lineColor={0,0,255}, extent={{40,28},{64,6}}, fillColor={0,0,255}, textString="P")}), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{-90,0},{-40,0},{-58,10}}),Line(color={0,0,255}, points={{-40,0},{-58,-10}}),Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillColor={127,255,0}, fillPattern=FillPattern.Backward),Text(lineColor={0,0,255}, extent={{-94,28},{98,-28}}, textString="P"),Text(lineColor={0,0,255}, extent={{40,28},{64,6}}, fillColor={0,0,255}, textString="P")}), Documentation(info="<html>
...
"));
  ...
  InstrumentationAndControl.Connectors.InputReal IPressure annotation(Placement(transformation(x=50.0, y=0.0, scale=0.1, aspectRatio=1.0, flipHorizontal=true, flipVertical=false), iconTransformation(x=50.0, y=0.0, scale=0.1, aspectRatio=1.0, flipHorizontal=true, flipVertical=false)));
equation
  C.P=P;
  C.Q=Q;
  C.T=T;
