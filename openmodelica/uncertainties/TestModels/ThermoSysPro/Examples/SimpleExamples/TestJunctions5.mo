...
model TestJunctions5
  ...
  ThermoSysPro.WaterSteam.Junctions.Splitter2 splitter2_1 annotation(Placement(transformation(x=-40.0, y=10.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false)));
  ThermoSysPro.WaterSteam.Junctions.Splitter2 splitter2_2 annotation(Placement(transformation(x=-40.0, y=-50.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false)));
equation
  ...
  connect(pipe1.C2,splitter2_1.Ce) annotation(Line(points={{-60,10},{-50,10}}, color={0,0,255}));
  connect(splitter2_1.Cs1,valve1.C1) annotation(Line(points={{-36,20},{-36,70},{-10,70}}, color={0,0,255}));
  connect(splitter2_1.Cs2,valve2.C1) annotation(Line(points={{-36,0},{-36,-4},{-20,-4},{-20,10},{-10,10}}, color={0,0,255}));
  connect(pipe2.C2,splitter2_2.Ce) annotation(Line(points={{-60,-50},{-50,-50}}, color={0,0,255}));
  connect(splitter2_2.Cs1,valve3.C1) annotation(Line(points={{-36,-40},{-36,-36},{-20,-36},{-20,-50},{-10,-50}}, color={0,0,255}));
  connect(splitter2_2.Cs2,valve4.C1) annotation(Line(points={{-36,-60},{-36,-90},{-10,-90}}, color={0,0,255}));
end TestJunctions5;
