...
"));
  ...
  Connectors.FluidInlet Ce2 annotation(Placement(transformation(x=0.0, y=98.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false), iconTransformation(x=0.0, y=98.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false)));
  ...
  Connectors.FluidOutlet Cs2 annotation(Placement(transformation(x=0.0, y=-100.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false), iconTransformation(x=0.0, y=-100.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false)));
initial equation
