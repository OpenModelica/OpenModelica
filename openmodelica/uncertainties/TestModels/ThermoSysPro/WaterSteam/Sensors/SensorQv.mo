...
model SensorQv "Volumetric flow sensor"
  ...
  annotation(Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Ellipse(lineColor={0,0,255}, extent={{-60,92},{60,-28}}, fillPattern=FillPattern.Solid, fillColor={0,255,0}),Line(color={0,0,255}, points={{0,-30},{0,-80}}),Line(color={0,0,255}, points={{-98,-80},{102,-80}}),Text(lineColor={0,0,255}, extent={{-60,64},{60,4}}, textString="Qv")}), Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Ellipse(lineColor={0,0,255}, extent={{-60,92},{60,-28}}, fillPattern=FillPattern.Solid, fillColor={0,255,0}),Line(color={0,0,255}, points={{0,-30},{0,-80}}),Line(color={0,0,255}, points={{-98,-80},{102,-80}}),Text(lineColor={0,0,255}, extent={{-60,64},{60,4}}, textString="Qv")}), Documentation(info="<html>
...
protected
  Modelica.SIunits.Time facteur=if output_unit == 1 then 3600 else 1 "Unit factor";
equation
  C1.P=C2.P;
  C1.h=C2.h;
  C1.Q=C2.Q;
