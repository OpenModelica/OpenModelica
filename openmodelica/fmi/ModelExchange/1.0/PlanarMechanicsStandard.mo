within ;
package PlanarMechanicsStandard
  ...
  package Joints "Planar joint models"
    ...
    model Prismatic "A prismatic joint"
      ...
      SI.Distance s(stateSelect = if enforceStates then StateSelect.always else StateSelect.prefer)
...
<p><br/><b>Beware! </b>Due to a sign-switch all angular sizes contained in plots are incorrect and must be negated.</p>
...
<p><br/><br/><b>Beware! </b>Due to a sign-switch all angular sizes contained in plots are incorrect and must be negated.</p><p><br/><br/>SELECTED&nbsp;CONTINUOUS&nbsp;TIME&nbsp;STATES</p>
<p>&nbsp;&nbsp;revolute.phi</p>
<p>&nbsp;&nbsp;revolute.w</p>
<p>&nbsp;&nbsp;revolute1.phi</p>
<p>&nbsp;&nbsp;revolute1.w</p>
...
<p>dirk.zimmer@dlr.de</p>
    ...
    model ControlledCraneCrab
      ...
      Joints.ActuatedRevolute actuatedRevolute(initialize=true, phi_start=-0.69813170079773)
                              annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={-10,0})));
...
<p>dirk.zimmer@dlr.de</p>
    ...
    model InvertedCraneCrab
      ...
      Joints.ActuatedPrismatic actuatedPrismatic(r={1,0},
        initialize=true)
        annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
      Joints.ActuatedRevolute actuatedRevolute(initialize=false)
                              annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={-10,0})));
...
<p><b>Beware! </b>Due to a sign-switch all angular sizes contained in plots are incorrect and must be negated.</p>
<p><br/>SELECTED&nbsp;CONTINUOUS&nbsp;TIME&nbsp;STATES</p>
...
<p><br/><br/><br/><b>Beware! </b>Due to a sign-switch all angular sizes contained in plots are incorrect and must be negated.</p><p><br/><br/><br/>Warning:&nbsp;The&nbsp;initial&nbsp;conditions&nbsp;for&nbsp;variables&nbsp;of&nbsp;type&nbsp;Real&nbsp;are&nbsp;not&nbsp;fully&nbsp;specified.</p>
<p>Assuming&nbsp;fixed&nbsp;start&nbsp;value&nbsp;for&nbsp;the&nbsp;continuous&nbsp;states:</p>
...
Copyright &copy; 2010-2012, dr.dirk.zimmer@gmail.com
</p>
