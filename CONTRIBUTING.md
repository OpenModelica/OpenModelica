...
`bootstrap-sources/Makefile.sources` is not regenerated. It was only read by the removed
autotools `bootstrap-from-tarball`; the CMake build of `bomc` globs
`bootstrap-sources/build/*.c`.
