...
// [flattening/modelica/scodeinst/OperatorOverloadBinaryAmbiguousTwoRecords.mo:58:3-58:15:writable] Error: Ambiguous matching overloaded operator functions found for c1 + d1.
// Candidates are:
//   C.'+'.self(C i, C j) => C
//   C.'+'.rightD(C i, D j) => C
//   D.'+'.leftC(C i, D j) => D
