...
//   constant Real r1[1,4] = 0.0;
//   constant Real r1[2,1] = 0.0;
//   constant Real r1[2,2] = 2.0;
//   constant Real r1[2,3] = 0.0;
//   constant Real r1[2,4] = 0.0;
//   constant Real r1[3,1] = 0.0;
//   constant Real r1[3,2] = 0.0;
//   constant Real r1[3,3] = 3.0;
//   constant Real r1[3,4] = 0.0;
//   constant Real r1[4,1] = 0.0;
//   constant Real r1[4,2] = 0.0;
//   constant Real r1[4,3] = 0.0;
//   constant Real r1[4,4] = 4.0;
// end CevalDiagonal1;
// endResult
