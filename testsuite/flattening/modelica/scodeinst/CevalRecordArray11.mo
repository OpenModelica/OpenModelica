...
//   final parameter Real pumPriHdr.pum[1].per.V_flow[1] = pumPriHdr.dat.per[1].V_flow[1];
//   final parameter Real pumPriHdr.pum[1].per.V_flow[2] = pumPriHdr.dat.per[1].V_flow[2];
//   final parameter Real pumPriHdr.pum[1].per.V_flow[3] = pumPriHdr.dat.per[1].V_flow[3];
//   parameter Real pumPriHdr.pum[1].eff.V_flow[1] = pumPriHdr.pum[1].per.V_flow[1];
//   parameter Real pumPriHdr.pum[1].eff.V_flow[2] = pumPriHdr.pum[1].per.V_flow[2];
//   parameter Real pumPriHdr.pum[1].eff.V_flow[3] = pumPriHdr.pum[1].per.V_flow[3];
//   final parameter Integer pumPriHdr.pum[1].eff.curve = 3;
//   final parameter Real pumPriHdr.pum[2].per.V_flow[1] = pumPriHdr.dat.per[2].V_flow[1];
//   final parameter Real pumPriHdr.pum[2].per.V_flow[2] = pumPriHdr.dat.per[2].V_flow[2];
//   final parameter Real pumPriHdr.pum[2].per.V_flow[3] = pumPriHdr.dat.per[2].V_flow[3];
//   parameter Real pumPriHdr.pum[2].eff.V_flow[1] = 0.0;
//   parameter Real pumPriHdr.pum[2].eff.V_flow[2] = 1.0;
//   parameter Real pumPriHdr.pum[2].eff.V_flow[3] = 2.0;
