...
//   SO1.port.fooFlow + m2A[1].port1.fooFlow = 0.0;
//   SO2.port.fooFlow + m2A[3].port2.fooFlow = 0.0;
//   m2A[2].port1.fooFlow + m2A[1].port2.fooFlow = 0.0;
//   m2A[3].port1.fooFlow + m2A[2].port2.fooFlow = 0.0;
