...
int main(void) {
  ...
  omc_flag[FLAG_F] = 1;
  omc_flagValue[FLAG_F] = "/home/andreas/workdir/OpenModelica/testsuite/CTest/SimulationRuntime/c/inputXML/unit/resources/RealArrayVariable_init.xml";
  ...
  // Validate
  if (test_success && strcmp(modelData.realVarsData[0].info.name, "x") != 0) {
  ...
  if (test_success && strcmp(modelData.integerParameterData[0].info.name, "p") != 0) {
