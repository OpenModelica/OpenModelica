...
model TSP_Splitter3_Inv
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.SourceP sourceP3 annotation(
    Placement(visible = true, transformation(origin = {-90, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  singularPressureLoss1.Q = 0;
  singularPressureLoss2.Q = 0;
  singularPressureLoss3.Q = 0;
  ...
  connect(sourceP3.C, singularPressureLoss3.C1) annotation(
    Line(points = {{-80, -30}, {-60, -30}, {-60, -30}, {-60, -30}}, color = {0, 0, 255}));
end TSP_Splitter3_Inv;
