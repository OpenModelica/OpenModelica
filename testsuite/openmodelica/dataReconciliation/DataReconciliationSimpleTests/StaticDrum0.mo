...
model StaticDrum0 "Static drum"
  parameter Real x = 1 "Vapor separation efficiency at the outlet";

  Modelica.SIunits.MassFlowRate Q_ex "Extra mass flow rate";
...
equation
/* Extra mass flow rate */
  Q_ex = 0 annotation( __OpenModelica_ExactConstantEquation = true);
/* Fluid pressure */
  P = Ce_steam.P;
  P = Ce_eco.P;
  P = Cs_sup.P;
...
/* Mass balance equation */
  Ce_eco.Q + Ce_steam.Q - Cs_sup.Q + Q_ex = 0;
