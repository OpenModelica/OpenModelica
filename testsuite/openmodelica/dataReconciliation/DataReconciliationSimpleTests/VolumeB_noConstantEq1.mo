...
model VolumeB_noConstantEq1 "Mixing volume with 2 inlets and 2 outlets"
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce2 annotation(
...
/* Energy balance equation */
  BH = Ce1.Q * Ce1.h + Ce2.Q * Ce2.h - Cs2.Q * Cs2.h;
