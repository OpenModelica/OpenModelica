...
model TSP_FourFlows6
  Sink sink1(h0 = 1e6)  annotation(
  ...
  SingularPressureLoss singularPressureLoss2( Pm(start=15e5),Q( start=2.10,uncertain=Uncertainty.refine), T( start=470,uncertain=Uncertainty.refine), continuous_flow_reversal = true, deltaP(start=1.e5)) annotation(
    Placement(visible = true, transformation(origin = {0, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SingularPressureLoss singularPressureLoss3( Pm(start=15e5),Q( start=2.10,uncertain=Uncertainty.refine), T( start=470,uncertain=Uncertainty.refine), continuous_flow_reversal = true, deltaP(start=1.e5)) annotation(
    Placement(visible = true, transformation(origin = {0, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SingularPressureLoss singularPressureLoss4( Pm(start=15e5),Q( start=2.10,uncertain=Uncertainty.refine), T( start=470,uncertain=Uncertainty.refine), continuous_flow_reversal = true, deltaP(start=1.e5)) annotation(
  ...
  Source source1(h0 = 1e6)  annotation(
    Placement(visible = true, transformation(origin = {-90, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
