...
equation
  //P01 = 3 annotation(__OpenModelica_BoundaryCondition = true); // Boundary condition
  //Q02 = 1 annotation(__OpenModelica_BoundaryCondition = true); // Boundary condition
  //Q03 = 1 annotation(__OpenModelica_BoundaryCondition = true); // Boundary condition
