...
public
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce_eva
    annotation (Placement(transformation(extent={{-104,-44},{-84,-24}},
          rotation=0)));
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce_eco
    annotation (Placement(transformation(extent={{-50,-104},{-30,-84}},
          rotation=0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Cs_sup
    annotation (Placement(transformation(extent={{84,24},{104,44}}, rotation=0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Cs_eva
    annotation (Placement(transformation(extent={{30,-104},{50,-84}}, rotation=
            0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Cs_sur
    annotation (Placement(transformation(extent={{28,84},{48,104}}, rotation=0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Cs_purg
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce_steam
    annotation (Placement(transformation(extent={{-48,84},{-28,104}}, rotation=
            0)));
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce_sup
...
equation
  ...
  if (cardinality(Ce_steam) == 0) then
    Ce_steam.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Ce_steam.h = 1.e5;
    Ce_steam.b = true;
  end if;
  ...
  if (cardinality(Ce_sup) == 0) then
    Ce_sup.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Ce_sup.h = 1.e5;
    Ce_sup.b = true;
  end if;
  ...
  if (cardinality(Ce_eva) == 0) then
    Ce_eva.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Ce_eva.h = 1.e5;
    Ce_eva.b = true;
  end if;
  ...
  if (cardinality(Ce_eco) == 0) then
    Ce_eco.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Ce_eco.h = 1.e5;
    Ce_eco.b = true;
  end if;
  ...
  if (cardinality(Cs_eva) == 0) then
    Cs_eva.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Cs_eva.h = 1.e5;
    Cs_eva.a = true;
  end if;
  ...
  if (cardinality(Cs_purg) == 0) then
    Cs_purg.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Cs_purg.h = 1.e5;
    Cs_purg.a = true;
  end if;
  ...
  if (cardinality(Cs_sup) == 0) then
    Cs_sup.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Cs_sup.h = 1.e5;
    Cs_sup.a = true;
  end if;
  ...
  if (cardinality(Cs_sur) == 0) then
    Cs_sur.Q = 0 annotation( __OpenModelica_ExactConstantEquation = true);
    Cs_sur.h = 1.e5;
    Cs_sur.a = true;
  end if;
