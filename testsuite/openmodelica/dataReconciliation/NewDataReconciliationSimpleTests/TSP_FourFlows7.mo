...
model TSP_FourFlows7 "OK"
  NewDataReconciliationSimpleTests.SingularPressureLoss singularPressureLoss1(Pm(displayUnit = "Pa", uncertain = Uncertainty.refine),Q(start = 100.3, uncertain = Uncertainty.refine), T(displayUnit = "K", uncertain = Uncertainty.refine), flow_reversal = false, mode = 1, p_rho(displayUnit = "kg/m3") = 998, rho(displayUnit = "kg/m3"), specific_enthalpy_as_state_variable = false) annotation(
    Placement(visible = true, transformation(origin = {-60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  NewDataReconciliationSimpleTests.SingularPressureLoss singularPressureLoss2(Pm(displayUnit = "Pa", uncertain = Uncertainty.refine),Q(start = 50.3, uncertain = Uncertainty.refine), T(displayUnit = "K", uncertain = Uncertainty.refine), flow_reversal = false, mode = 1, p_rho(displayUnit = "kg/m3") = 998, rho(displayUnit = "kg/m3"), specific_enthalpy_as_state_variable = false) annotation(
    Placement(visible = true, transformation(origin = {0, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  NewDataReconciliationSimpleTests.SingularPressureLoss singularPressureLoss3(Pm(displayUnit = "Pa", uncertain = Uncertainty.refine),Q(start = 49.0, uncertain = Uncertainty.refine), T(displayUnit = "K", uncertain = Uncertainty.refine), flow_reversal = false, mode = 1, p_rho(displayUnit = "kg/m3") = 998, rho(displayUnit = "kg/m3"), specific_enthalpy_as_state_variable = false) annotation(
    Placement(visible = true, transformation(origin = {0, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  NewDataReconciliationSimpleTests.SingularPressureLoss singularPressureLoss4(Pm(displayUnit = "Pa", uncertain = Uncertainty.refine),Q(start = 99.5, uncertain = Uncertainty.refine), T(displayUnit = "K", uncertain = Uncertainty.refine), flow_reversal = false, mode = 1, p_rho(displayUnit = "kg/m3") = 998, rho(displayUnit = "kg/m3"), specific_enthalpy_as_state_variable = false) annotation(
    Placement(visible = true, transformation(origin = {60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Junctions.Splitter2 splitter21(P(displayUnit = "Pa"), mode = 1)  annotation(
    Placement(visible = true, transformation(origin = {-24, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Junctions.Mixer2 mixer21(P(displayUnit = "Pa"), mode = 1)  annotation(
    Placement(visible = true, transformation(origin = {24, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
