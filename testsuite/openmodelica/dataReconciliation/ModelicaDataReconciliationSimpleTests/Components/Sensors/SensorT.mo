...
protected
  ...
  parameter Modelica.Units.SI.MassFlowRate Qeps=1.e-3 "Minimum mass flow rate for continuous flow reversal";
equation
  C1.P = C2.P;
  C1.h = C2.h;
  C1.Q = C2.Q;
  ...
  annotation (
    Diagram(coordinateSystem(
        ...
        grid={2,2}), graphics={Ellipse(
          ...
          extent={{-60,90},{60,-30}},
          endAngle=360),Line(points={{0,-30},{0,-80}}),Line(points={{-98,-80},{102,-80}}),Text(
          lineColor={0,0,255},
          fillColor={127,255,0},
          fillPattern=FillPattern.Solid,
          extent={{-60,60},{60,0}},
    ...
    Icon(coordinateSystem(
        ...
        grid={2,2}), graphics={Ellipse(
          ...
          fillPattern=FillPattern.Solid,
          extent={{-60,90},{60,-30}},
          endAngle=360),Line(points={{0,-30},{0,-80}}),Line(points={{-98,-80},{102,-80}}),Text(extent={{-60,60},{60,0}}, textString="T")}),
    Window(
      x=0.22,
      y=0.21,
      width=0.6,
