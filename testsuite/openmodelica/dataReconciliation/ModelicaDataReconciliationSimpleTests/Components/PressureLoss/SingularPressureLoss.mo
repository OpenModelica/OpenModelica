within ModelicaDataReconciliationSimpleTests.Components.PressureLoss;
model SingularPressureLoss "Singular pressure loss"
  ...
  parameter Boolean continuous_flow_reversal=false "true: continuous flow reversal - false: discontinuous flow reversal (active if flow_reversal=true)";
  ...
  Real deltaP "Singular pressure loss";
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidInlet C1 annotation (Placement(transformation(extent={{-110,-10},{-90,10}}, rotation=0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet C2 annotation (Placement(transformation(extent={{90,-10},{110,10}}, rotation=0)));
protected
  constant Real pi=Modelica.Constants.pi "pi";
  parameter Real eps=1.e-3 "Small number for pressure loss equation";
  parameter Modelica.Units.SI.MassFlowRate Qeps=1.e-3 "Small mass flow for continuous flow reversal";
equation
  ...
  annotation (
    Diagram(coordinateSystem(
        ...
        grid={2,2}), graphics={Polygon(
          ...
          points={{-60,40},{-40,20},{-20,10},{0,8},{20,10},{40,20},{60,40},{-60,40}}),Polygon(
          lineColor={0,0,255},
          fillColor={128,255,0},
          fillPattern=FillPattern.Solid,
