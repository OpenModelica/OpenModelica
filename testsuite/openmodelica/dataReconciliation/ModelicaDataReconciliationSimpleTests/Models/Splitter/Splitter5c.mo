...
model Splitter5c
  Real Q1(uncertain=Uncertainty.refine, start=2);
  // Variable of interest
  Real Q2(uncertain=Uncertainty.refine, start=1);
  // Variable of interest
  Real Q3(uncertain=Uncertainty.refine, start=1);
  // Variable of interest
  ...
  // Boundary condition
  parameter Real h01=1e5 annotation (__OpenModelica_BoundaryCondition=true);
  // Boundary condition
  parameter Real h02=1e5 annotation (__OpenModelica_BoundaryCondition=true);
  // Boundary condition
  parameter Real h03=1e5 annotation (__OpenModelica_BoundaryCondition=true);
  // Boundary condition
...
equation
  ...
  annotation (__OpenModelica_simulationFlags(
      ...
      s="dassl",
      sx="modelica://ModelicaDataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.Splitter5c_Inputs.csv"));
end Splitter5c;
