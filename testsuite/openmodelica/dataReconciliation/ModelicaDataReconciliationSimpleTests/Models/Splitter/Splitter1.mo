...
model Splitter1
  ...
  Real P01=3 annotation (__OpenModelica_BoundaryCondition=true);
  Real P02=1 annotation (__OpenModelica_BoundaryCondition=true);
  Real P03=1 annotation (__OpenModelica_BoundaryCondition=true);
  Real T1_P1;
  Real T1_P2;
  Real T2_P1;
  Real T2_P2;
...
equation
  ...
  annotation (__OpenModelica_simulationFlags(
      ...
      s="dassl",
      sx="modelica://ModelicaDataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.Splitter1_Inputs.csv"));
end Splitter1;
