...
model Splitter2
  ...
  parameter Real Q02=2 annotation (__OpenModelica_BoundaryCondition=true);
  parameter Real Q03=2 annotation (__OpenModelica_BoundaryCondition=true);
  Real T1_P1;
  Real T1_P2;
  Real T2_P1;
  Real T2_P2;
...
equation
  ...
  annotation (__OpenModelica_simulationFlags(
      ...
      s="dassl",
      sx="modelica://ModelicaDataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.Splitter2_Inputs.csv"));
end Splitter2;
