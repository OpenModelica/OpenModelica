within ModelicaDataReconciliationSimpleTests.Models.FourFlows;
model FourFlows
...
equation
  ...
  annotation (__OpenModelica_simulationFlags(
      ...
      s="dassl",
      sx="modelica://ModelicaDataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.FourFlows_Inputs.csv"));
end FourFlows;
