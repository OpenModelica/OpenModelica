...
equation
  ...
  annotation (
    __OpenModelica_simulationFlags(
      ...
      eps="0.023",
      s="dassl",
      sx="modelica://TSP_DataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.TSP_FourFlows7_Inputs.csv"));
end TSP_FourFlows7;
