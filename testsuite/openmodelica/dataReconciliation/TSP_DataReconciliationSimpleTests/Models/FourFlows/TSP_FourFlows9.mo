...
model TSP_FourFlows9
  "NOK - Division by zero at time 0"
...
equation
  ...
  annotation (
    __OpenModelica_simulationFlags(
      ...
      eps="0.023",
      s="dassl",
      sx="modelica://TSP_DataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.TSP_FourFlows9_Inputs.csv"));
end TSP_FourFlows9;
