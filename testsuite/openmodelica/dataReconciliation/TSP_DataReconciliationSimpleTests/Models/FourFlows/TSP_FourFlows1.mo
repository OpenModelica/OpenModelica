...
model TSP_FourFlows1
  ...
  Components.PressureLoss.SingularPressureLoss singularPressureLoss4(
    ...
    rho(
      displayUnit="kg/m3"))
    annotation (Placement(visible=true,transformation(origin={60,0},extent={{-10,-10},{10,10}},rotation=0)));
  ThermoSysPro.WaterSteam.Junctions.Splitter2 splitter21
...
equation
  ...
  connect(singularPressureLoss2.C2,mixer21.Ce1)
    annotation (Line(points={{10,20},{20,20},{20,10}},color={0,0,255}));
  connect(splitter21.Cs1,singularPressureLoss2.C1)
    annotation (Line(points={{-20,10},{-20,20},{-10,20}},color={0,0,255}));
  connect(splitter21.Cs2,singularPressureLoss3.C1)
    annotation (Line(points={{-20,-10},{-20,-20},{-10,-20}},color={0,0,255}));
  connect(mixer21.Cs,singularPressureLoss4.C1)
    annotation (Line(points={{34,0},{50,0},{50,2},{50,2},{50,0},{50,0}},color={0,0,255}));
  connect(singularPressureLoss1.C2,splitter21.Ce)
    annotation (Line(points={{-50,0},{-34,0},{-34,0},{-34,0}},color={0,0,255}));
  connect(constante1.y,splitter21.Ialpha1)
    annotation (Line(points={{-58,30},{-40,30},{-40,6},{-22,6},{-22,6}},color={0,0,255}));
  connect(sourceP1.C,singularPressureLoss1.C1)
    annotation (Line(points={{-80,0},{-70,0},{-70,0},{-70,0}},color={0,0,255}));
  connect(singularPressureLoss4.C2,sink1.C)
    annotation (Line(points={{70,0},{82,0},{82,0},{82,0}},color={0,0,255}));
  annotation (
    __OpenModelica_simulationFlags(
      lv="LOG_JAC",
      eps="0.023",
      s="dassl",
      sx="modelica://TSP_DataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.TSP_FourFlows1_Inputs.csv"));
end TSP_FourFlows1;
