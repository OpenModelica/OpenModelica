...
model TSP_FourFlows2
  ...
  ThermoSysPro.WaterSteam.Junctions.StaticDrum staticDrum2
    annotation (Placement(visible=true,transformation(origin={28,0},extent={{-10,-10},{10,10}},rotation=0)));
  Components.BoundaryConditions.Source source1
    annotation (Placement(visible=true,transformation(origin={-90,0},extent={{-10,-10},{10,10}},rotation=0)));
equation
  ...
  connect(singularPressureLoss3.C2,staticDrum2.Ce_eco)
    annotation (Line(points={{10,-20},{24,-20},{24,-10},{24,-10}},color={0,0,255}));
  connect(singularPressureLoss2.C2,staticDrum2.Ce_steam)
    annotation (Line(points={{10,20},{24,20},{24,10},{24,10},{24,10}},color={0,0,255}));
  connect(source1.C,singularPressureLoss1.C1)
    annotation (Line(points={{-80,0},{-60,0},{-60,0},{-60,0}},color={0,0,255}));
  connect(staticDrum2.Cs_sup,singularPressureLoss4.C1)
    annotation (Line(points={{38,4},{50,4},{50,0},{50,0}},color={0,0,255}));
  annotation (
