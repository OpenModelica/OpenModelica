...
equation
  connect(mixer21.Cs,singularPressureLoss1.C1)
    annotation (Line(points={{12,0},{40,0},{40,0},{40,0}},color={0,0,255}));
  ...
  connect(sourceQ1.C,singularPressureLoss3.C1)
    annotation (Line(points={{-80,-30},{-60,-30},{-60,-30},{-60,-30}},color={0,0,255}));
  annotation (
    __OpenModelica_simulationFlags(
      ...
      eps="0.023",
      s="dassl",
      sx="modelica://TSP_DataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.TSP_Splitter2_Inputs.csv"));
end TSP_Splitter2;
