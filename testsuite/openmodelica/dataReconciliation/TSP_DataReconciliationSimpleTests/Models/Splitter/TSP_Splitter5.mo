...
model TSP_Splitter5
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.SourceP sourceP(
    ...
    annotation (Placement(visible=true,transformation(origin={-92,-30},extent={{-10,-10},{10,10}},rotation=0)));
equation
  ...
  connect(sourceP.C,singularPressureLoss3.C1)
    annotation (Line(points={{-82,-30},{-60,-30}},color={0,0,255}));
  annotation (
    __OpenModelica_simulationFlags(
      lv="LOG_JAC",
      eps="0.023",
      s="dassl",
      sx="modelica://TSP_DataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.TSP_Splitter5_Inputs.csv"));
end TSP_Splitter5;
