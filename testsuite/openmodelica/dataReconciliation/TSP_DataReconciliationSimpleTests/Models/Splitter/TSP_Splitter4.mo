...
equation
  ...
  connect(singularPressureLoss3.C2,mixer21.Ce2)
    annotation (Line(points={{-40,-30},{0,-30},{0,-10},{0,-10}},color={0,0,255}));
  connect(sourcePQ1.C,singularPressureLoss2.C1)
  ...
  connect(sourceQ1.C,singularPressureLoss3.C1)
    annotation (Line(points={{-80,-30},{-62,-30},{-62,-30},{-60,-30}},color={0,0,255}));
  annotation (
    __OpenModelica_simulationFlags(
      lv="LOG_JAC",
      eps="0.023",
      s="dassl",
      sx="modelica://TSP_DataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.TSP_Splitter4_Inputs.csv"));
end TSP_Splitter4;
