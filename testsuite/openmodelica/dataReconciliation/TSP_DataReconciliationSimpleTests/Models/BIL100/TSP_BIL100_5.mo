...
model TSP_BIL100_5
  ...
  Components.BoundaryConditions.SinkQ sinkQ4
    annotation (Placement(visible=true,transformation(extent={{86,-36},{106,-16}},rotation=0)));
  Components.Volumes.SGVALI GV4(
    ...
    SG_volume(
      ...
      T(
        uncertain=Uncertainty.refine)))
    annotation (Placement(visible=true,transformation(extent={{52,-30},{72,-10}},rotation=0)));
  ThermoSysPro.Thermal.BoundaryConditions.HeatSink heatSink3
    annotation (Placement(visible=true,transformation(origin={30,-16},extent={{-10,10},{10,-10}},rotation=-90)));
  Components.PressureLoss.SingularPressureLossVALI DP_GV4(
    Q(
      uncertain=Uncertainty.refine))
    annotation (Placement(visible=true,transformation(origin={60,30},extent={{-10,-10},{10,10}},rotation=90)));
equation
  ...
  connect(heatSink3.C[1],GV4.thermalPort)
    annotation (Line(points={{40,-16},{58,-16}}));
  connect(GV4.C2_pur,sinkQ4.C)
    annotation (Line(points={{66,-24},{86,-24},{86,-26}},color={255,0,0}));
  connect(DP_GV4.C1,GV4.C3_vvp)
    annotation (Line(points={{60,20},{62,20},{62,-10}},color={0,0,255}));
  connect(GV3.C1_are,SEP_ARE.Cs3)
    annotation (Line(points={{-46,-32},{-50,-32},{-50,-60}},color={0,0,255}));
  connect(SEP_ARE.Cs4,GV4.C1_are)
    annotation (Line(points={{-42,-60},{-42,-50},{62,-50},{62,-30}},color={0,0,255}));
  connect(MEL_GCT.Ce3,DP_GV3.C2)
    annotation (Line(points={{-50,54},{-46,54},{-46,40}},color={0,0,255}));
  connect(DP_GV4.C2,MEL_GCT.Ce4)
    annotation (Line(points={{60,40},{60,46},{-42,46},{-42,54}},color={0,0,255}));
  annotation (
    Icon(
      coordinateSystem(
    ...
    __OpenModelica_simulationFlags(
      ...
      s="dassl",
      sx="modelica://EDF_NewDataReconciliationSimpleTests/resources/NewDataReconciliationSimpleTests.TSP_BIL100_5_Inputs.csv"));
end TSP_BIL100_5;
