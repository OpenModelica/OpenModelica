...
model VolumeBTh
  ...
  Modelica.Units.SI.Power BH
    "Right hand side of the energybalance equation";
  ThermoSysPro.Thermal.Connectors.ThermalPort Cth
    annotation (Placement(visible=true,transformation(extent={{-50,40},{-30,60}},rotation=0),iconTransformation(extent={{-50,40},{-30,60}},rotation=0)));
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Cs1
    annotation (Placement(visible=true,transformation(extent={{-8,90},{12,110}},rotation=0),iconTransformation(extent={{-8,90},{12,110}},rotation=0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Cs2
    annotation (Placement(transformation(extent={{-10,-108},{10,-88}},rotation=0)));
equation
