...
model Mixer4
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce2
    annotation (Placement(transformation(extent={{-50,-110},{-30,-90}},rotation=0)));
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Ialpha1
    "Extraction coefficient for inlet 1 (<=1)"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}},rotation=0)));
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Ialpha2
    "Extraction coefficient for inlet 2 (<=1)"
    annotation (Placement(transformation(extent={{-80,-88},{-60,-68}},rotation=0)));
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce4
    annotation (Placement(transformation(extent={{-110,-48},{-90,-28}},rotation=0)));
equation
  if cardinality(
    Ialpha1) == 0 then
    Ialpha1.signal=1;
    ...
    Diagram(
      ...
      graphics={
        Polygon(
          ...
          points={{-100,60},{-60,60},{-60,100},{-20,100},{-20,60},{-20,20},{100,20},{100,-20},{-20,-20},{-20,-100},{-60,-100},{-60,-60},{-100,-60},{-100,-20},{-60,-20},{-60,20},{-100,20},{-100,60}}),
        Text(
          extent={{-60,90},{-20,50}},
          textString="1"),
        Text(
