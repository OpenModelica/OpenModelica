...
model Splitter44
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ce
    annotation (Placement(transformation(extent={{-110,-8},{-90,12}},rotation=0)));
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputReal Oalpha2
    annotation (Placement(transformation(extent={{60,-90},{80,-70}},rotation=0)));
equation
  if cardinality(
    Ialpha1) == 0 then
    Ialpha1.signal=1;
    ...
    Diagram(
      ...
      graphics={
        Polygon(
          ...
          points={{-100,20},{20,20},{20,100},{60,100},{60,60},{100,60},{100,20},{60,20},{60,-20},{100,-20},{100,-60},{60,-60},{60,-100},{20,-100},{20,-20},{-100,-20},{-100,20}}),
        Text(
          lineColor={0,0,255},
          fillColor={255,255,0},
          fillPattern=FillPattern.Solid,
