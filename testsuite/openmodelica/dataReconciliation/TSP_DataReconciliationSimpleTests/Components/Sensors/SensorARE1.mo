...
model SensorARE1
  ...
  TSP_DataReconciliationSimpleTests.Components.Sensors.SensorP N20YP(
    flow_reversal=flow_reversal)
...
equation
  ...
  connect(N20YD.C2,N20YP.C1)
    annotation (Line(points={{0.2,-60},{20,-60}},color={0,0,255}));
  connect(N20YP.C2,fluidOutletI)
