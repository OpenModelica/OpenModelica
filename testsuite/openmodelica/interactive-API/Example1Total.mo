  ...
  package Examples
    ...
    package Basic
      model Example1
        ...
        Buildings.Fluid.Sources.Boundary_pT sin(redeclare package Medium = Buildings.Media.Air, T = 273.15 + 10, p(displayUnit = "Pa") = 101325, nPorts = 1) "Pressure boundary condition";
        Buildings.Fluid.Movers.FlowControlled_m_flow mov(redeclare package Medium = Buildings.Media.Air, energyDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, redeclare Buildings.Fluid.Movers.Data.Fans.Greenheck.BIDW12 per, show_T = true, m_flow_nominal = 1);
        Buildings.Fluid.FixedResistances.PressureDrop res(redeclare package Medium = Buildings.Media.Air, allowFlowReversal = false, m_flow_nominal = 0.2, dp_nominal = 10) "Fixed resistance";
...
model Example1_total
  extends BL.Examples.Basic.Example1;
end Example1_total;
