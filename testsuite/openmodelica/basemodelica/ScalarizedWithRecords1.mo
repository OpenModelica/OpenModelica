...
//     constant Real 'cr2'.'ra[1]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'cr2'.'ra[2]'.'x' = 0.0;
//     constant Real 'cr2'.'ra[2]'.'y' = 0.0;
//     constant Real 'cr2'.'ra[2]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'cr2'.'ra[3]'.'x' = 0.0;
//     constant Real 'cr2'.'ra[3]'.'y' = 0.0;
//     constant Real 'cr2'.'ra[3]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant 'R2' 'cr2'('w' = 0.0);
//     'R1' 'r1';
//     Real 'ra1[1]'.'z'[3];
//     Real 'ra1[2]'.'x';
//     Real 'ra1[2]'.'y';
...
//     constant Real 'm.cr2'.'ra[1]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'm.cr2'.'ra[2]'.'x' = 0.0;
//     constant Real 'm.cr2'.'ra[2]'.'y' = 0.0;
//     constant Real 'm.cr2'.'ra[2]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'm.cr2'.'ra[3]'.'x' = 0.0;
//     constant Real 'm.cr2'.'ra[3]'.'y' = 0.0;
//     constant Real 'm.cr2'.'ra[3]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant 'm.R2' 'm.cr2'('w' = 0.0);
//     'm.R1' 'm.r1';
//     Real 'm.ra1[1]'.'z'[3];
//     Real 'm.ra1[2]'.'x';
//     Real 'm.ra1[2]'.'y';
...
//     'm.R2' 'm.r2';
//     'm.R1' 'm.ra2[1]'.'r';
//     Real 'm.ra2[1]'.'ra[1]'.'z'[3];
//     Real 'm.ra2[1]'.'ra[2]'.'x';
//     Real 'm.ra2[1]'.'ra[2]'.'y';
//     Real 'm.ra2[1]'.'ra[2]'.'z'[3];
//     Real 'm.ra2[1]'.'ra[3]'.'x';
//     Real 'm.ra2[1]'.'ra[3]'.'y';
//     Real 'm.ra2[1]'.'ra[3]'.'z'[3];
//     Real 'm.ra2[1]'.'w';
//     'm.R1' 'm.ra2[2]'.'r';
//     Real 'm.ra2[2]'.'ra[1]'.'x';
//     Real 'm.ra2[2]'.'ra[1]'.'y';
//     Real 'm.ra2[2]'.'ra[1]'.'z'[3];
//     Real 'm.ra2[2]'.'ra[2]'.'x';
//     Real 'm.ra2[2]'.'ra[2]'.'y';
//     Real 'm.ra2[2]'.'ra[2]'.'z'[3];
//     Real 'm.ra2[2]'.'ra[3]'.'x';
//     Real 'm.ra2[2]'.'ra[3]'.'y';
//     Real 'm.ra2[2]'.'ra[3]'.'z'[3];
//     Real 'm.ra2[2]'.'w';
//     'm.R1' 'm.ra2[3]'.'r';
//     Real 'm.ra2[3]'.'ra[1]'.'x';
//     Real 'm.ra2[3]'.'ra[1]'.'y';
//     Real 'm.ra2[3]'.'ra[1]'.'z'[3];
//     Real 'm.ra2[3]'.'ra[2]'.'x';
//     Real 'm.ra2[3]'.'ra[2]'.'y';
//     Real 'm.ra2[3]'.'ra[2]'.'z'[3];
//     Real 'm.ra2[3]'.'ra[3]'.'x';
//     Real 'm.ra2[3]'.'ra[3]'.'y';
//     Real 'm.ra2[3]'.'ra[3]'.'z'[3];
//     Real 'm.ra2[3]'.'w';
...
//     constant Real 'ma[1].cr2'.'ra[1]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'ma[1].cr2'.'ra[2]'.'x' = 0.0;
//     constant Real 'ma[1].cr2'.'ra[2]'.'y' = 0.0;
//     constant Real 'ma[1].cr2'.'ra[2]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'ma[1].cr2'.'ra[3]'.'x' = 0.0;
//     constant Real 'ma[1].cr2'.'ra[3]'.'y' = 0.0;
//     constant Real 'ma[1].cr2'.'ra[3]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant 'ma.R2' 'ma[1].cr2'('w' = 0.0);
//     'ma.R1' 'ma[1].r1';
//     Real 'ma[1].ra1[1]'.'z'[3];
//     Real 'ma[1].ra1[2]'.'x';
//     Real 'ma[1].ra1[2]'.'y';
...
//     constant Real 'ma[2].cr2'.'ra[1]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'ma[2].cr2'.'ra[2]'.'x' = 0.0;
//     constant Real 'ma[2].cr2'.'ra[2]'.'y' = 0.0;
//     constant Real 'ma[2].cr2'.'ra[2]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'ma[2].cr2'.'ra[3]'.'x' = 0.0;
//     constant Real 'ma[2].cr2'.'ra[3]'.'y' = 0.0;
//     constant Real 'ma[2].cr2'.'ra[3]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant 'ma.R2' 'ma[2].cr2'('w' = 0.0);
//     'ma.R1' 'ma[2].r1';
//     Real 'ma[2].ra1[1]'.'z'[3];
//     Real 'ma[2].ra1[2]'.'x';
//     Real 'ma[2].ra1[2]'.'y';
...
//     constant Real 'ma[3].cr2'.'ra[1]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'ma[3].cr2'.'ra[2]'.'x' = 0.0;
//     constant Real 'ma[3].cr2'.'ra[2]'.'y' = 0.0;
//     constant Real 'ma[3].cr2'.'ra[2]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant Real 'ma[3].cr2'.'ra[3]'.'x' = 0.0;
//     constant Real 'ma[3].cr2'.'ra[3]'.'y' = 0.0;
//     constant Real 'ma[3].cr2'.'ra[3]'.'z'[3] = {0.0, 0.0, 0.0};
//     constant 'ma.R2' 'ma[3].cr2'('w' = 0.0);
//     'ma.R1' 'ma[3].r1';
//     Real 'ma[3].ra1[1]'.'z'[3];
//     Real 'ma[3].ra1[2]'.'x';
//     Real 'ma[3].ra1[2]'.'y';
