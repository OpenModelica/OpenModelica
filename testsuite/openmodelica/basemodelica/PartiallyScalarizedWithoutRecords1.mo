// name: PartiallyScalarizedWithoutRecords1
// status: correct
...
model PartiallyScalarizedWithoutRecords1
  extends M;
  M m;
  M ma[3];
equation
  ...
  ma[1].r1.z[2] = 0;
  ma[1].r1 = cr1;
  annotation(__OpenModelica_commandLineOptions="-d=newInst -f --baseModelicaFormat=withoutRecords");
end PartiallyScalarizedWithoutRecords1;

// Result:
// //! base 0.1.0
// package 'PartiallyScalarizedWithoutRecords1'
//   record 'R1'
//     Real 'x';
//     Real 'y';
//     Real 'z'[3];
