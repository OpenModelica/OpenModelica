...
#define MODEL_GUID "{5fd3c7f4-7210-4e77-bdbd-76a822a4cb7f}"
...
#define FMI2_FUNCTION_PREFIX TestFMU_
...
extern void TestFMU_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc TestFMU_setupDataStruc
...
OMC_DISABLE_OPT
void setDefaultStartValues(ModelInstance *comp) {
  comp->fmuData->modelData->realVarsData[0].attribute.start = 10.0;
  comp->fmuData->modelData->realVarsData[1].attribute.start = 0;
  comp->fmuData->modelData->realVarsData[2].attribute.start = -20.0;
  comp->fmuData->modelData->realVarsData[3].attribute.start = 10.0;
}
// Set values for all variables that define a start value
OMC_DISABLE_OPT
void setStartValues(ModelInstance *comp) {
