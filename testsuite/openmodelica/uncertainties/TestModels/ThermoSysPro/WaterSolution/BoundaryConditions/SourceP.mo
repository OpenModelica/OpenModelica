...
model SourceP "Pressure source"
  ...
  annotation(Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{40,0},{90,0},{72,10}}),Line(color={0,0,255}, points={{90,0},{72,-10}}),Text(lineColor={0,0,255}, extent={{-58,30},{-40,10}}, textString="P"),Text(lineColor={0,0,255}, extent={{-28,60},{-10,40}}, textString="T"),Text(lineColor={0,0,255}, extent={{-28,-40},{-10,-60}}, textString="Xh20"),Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillPattern=FillPattern.Solid, fillColor={160,160,160}),Polygon(lineColor={0,0,255}, points={{-40,40},{-40,-40},{40,-40},{-40,40}}, fillPattern=FillPattern.Solid, pattern=LinePattern.None, lineThickness=1.0, fillColor={223,159,159}),Text(lineColor={0,0,255}, extent={{-96,28},{96,-28}}, textString="S")}), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Line(color={0,0,255}, points={{40,0},{90,0},{72,10}}),Line(color={0,0,255}, points={{90,0},{72,-10}}),Text(lineColor={0,0,255}, extent={{-28,60},{-10,40}}, textString="T"),Text(lineColor={0,0,255}, extent={{-58,30},{-40,10}}, textString="P"),Text(lineColor={0,0,255}, extent={{-28,-40},{-10,-60}}, textString="h"),Rectangle(lineColor={0,0,255}, extent={{-40,40},{40,-40}}, fillPattern=FillPattern.Solid, fillColor={160,160,160}),Polygon(lineColor={0,0,255}, points={{-40,40},{-40,-40},{40,-40},{-40,40}}, fillPattern=FillPattern.Solid, pattern=LinePattern.None, lineThickness=1.0, fillColor={223,159,159}),Text(lineColor={0,0,255}, extent={{-96,28},{96,-28}}, textString="S")}), Documentation(info="<html>
...
"));
  ...
  Connectors.WaterSolutionOutlet C annotation(Placement(transformation(x=100.0, y=0.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false), iconTransformation(x=100.0, y=0.0, scale=0.1, aspectRatio=1.0, flipHorizontal=false, flipVertical=false)));
equation
  C.P=P;
  C.Q=Q;
  C.T=T;
