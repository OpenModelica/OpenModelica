...
model InvSingularPressureLoss "Inverse singular pressure loss"
  ...
  ThermoSysPro.Units.DifferentialPressure deltaP(start=100.0) "Singular pressure loss";
  ...
  annotation(Diagram(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Polygon(points={{-60,40},{-40,20},{-20,10},{0,8},{20,10},{40,20},{60,40},{-60,40}}, lineColor={0,0,255}, fillColor={255,255,0}, fillPattern=FillPattern.Backward),Polygon(points={{-60,-40},{-40,-20},{-20,-12},{0,-10},{20,-12},{40,-20},{60,-40},{-60,-40}}, lineColor={0,0,255}, fillColor={255,255,0}, fillPattern=FillPattern.Backward)}), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={Polygon(points={{-60,40},{-40,20},{-20,10},{0,8},{20,10},{40,20},{60,40},{-60,40}}, lineColor={0,0,255}, fillColor={255,255,0}, fillPattern=FillPattern.Backward),Polygon(points={{-60,-40},{-40,-20},{-20,-12},{0,-10},{20,-12},{40,-20},{60,-40},{-60,-40}}, lineColor={0,0,255}, fillColor={255,255,0}, fillPattern=FillPattern.Backward)}), Documentation(info="<html>
...
protected
  ...
  parameter Modelica.SIunits.MassFlowRate Qeps=0.001 "Small mass flow";
equation
  C1.P - C2.P=deltaP;
  C1.T=C2.T;
  C1.Q=C2.Q;
  ...
  C2.Xso2=C1.Xso2;
  Q=C1.Q;
  deltaP=if noEvent(abs(Q) < Qeps) then 10000000000.0 else K*ThermoSysPro.Functions.ThermoSquare(Q, eps)/rho;
  P=(C1.P + C2.P)/2;
  T=C1.T;
  if p_rho > 0 then
    rho=p_rho;
