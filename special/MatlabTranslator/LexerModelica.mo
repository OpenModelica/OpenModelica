encapsulated package LexerModelica // OMCCp v0.10.0 OpenModelica lexer and parser generator (2014) "Implements the DFA of OMCC"
import Types;
...
algorithm
  ...
  if (baseCond==mm_finish) then
    ...
    (tok,mm_startSt,buffer2) := LexerCodeModelica.action(act,mm_startSt,mm_currSt,mm_pos,mm_sPos,mm_ePos,mm_linenr,lineNrStart,buffer,debug,fileName,fileContents);
